...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='s1060alteracao',
            name='localamb',
            field=models.IntegerField(choices=[(1, '1 - Estabelecimento do pr\xf3prio empregador'), (2, '2 - Estabelecimento de terceiros'), (3, '3 - Presta\xe7\xe3o de servi\xe7os em instala\xe7\xf5es de terceiros n\xe3o consideradas como lota\xe7\xf5es dos tipos 03 a 09 da tabela 10.')], null=True),
        ),
        migrations.AlterField(
            model_name='s1060alteracao',
            name='nmamb',
