# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-18 23:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('s1060', '0003_auto_20181010_2058'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='s1060alteracao',
            options={'managed': True, 'ordering': ['s1060_evttabambiente', 'codamb', 'inivalid', 'nmamb', 'dscamb', 'localamb']},
        ),
        migrations.AlterModelOptions(
        ...
        migrations.AlterModelOptions(
            name='s1060exclusao',
            options={'managed': True, 'ordering': ['s1060_evttabambiente', 'codamb', 'inivalid']},
        ),
        migrations.AlterModelOptions(
            name='s1060inclusao',
            options={'managed': True, 'ordering': ['s1060_evttabambiente', 'codamb', 'inivalid', 'nmamb', 'dscamb', 'localamb']},
        ...
        migrations.AlterField(
            ...
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1060alteracao_s1060_evttabambiente', to='esocial.s1060evtTabAmbiente'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1060alteracaonovavalidade_s1060_alteracao', to='s1060.s1060alteracao'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s1060exclusao',
            name='s1060_evttabambiente',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1060exclusao_s1060_evttabambiente', to='esocial.s1060evtTabAmbiente'),
        ),
        migrations.AlterField(
            model_name='s1060inclusao',
            name='codamb',
        ...
        migrations.AlterField(
            model_name='s1060inclusao',
            name='s1060_evttabambiente',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1060inclusao_s1060_evttabambiente', to='esocial.s1060evtTabAmbiente'),
        ),
    ]
