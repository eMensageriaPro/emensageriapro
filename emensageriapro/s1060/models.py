...
CHOICES_S1060_ALTERACAO_CODFATRIS = (
...
CHOICES_S1060_INCLUSAO_CODFATRIS = (
    ('01.01.001', u'01.01.001 - Infrassom e sons de baixa frequência'),
    ('01.01.002', u'01.01.002 - Ruído contínuo ou Intermitente'),
    ('01.01.003', u'01.01.003 - Ruído impulsivo ou de Impacto'),
    ('01.01.004', u'01.01.004 - Ultrassom'),
...
class s1060alteracaofatorRisco(models.Model):
    ...
    codfatris = models.CharField(choices=CHOICES_S1060_ALTERACAO_CODFATRIS, max_length=10)
    criado_em = models.DateTimeField(blank=True)
    criado_por = models.ForeignKey('controle_de_acesso.Usuarios',
        related_name='%(class)s_criado_por', blank=True, null=True)
    modificado_em = models.DateTimeField(blank=True, null=True)
...
class s1060inclusaofatorRisco(models.Model):
    ...
    def evento(self): return self.s1060_inclusao.evento()
    codfatris = models.CharField(choices=CHOICES_S1060_INCLUSAO_CODFATRIS, max_length=10)
    criado_em = models.DateTimeField(blank=True)
    criado_por = models.ForeignKey('controle_de_acesso.Usuarios',
        related_name='%(class)s_criado_por', blank=True, null=True)
    modificado_em = models.DateTimeField(blank=True, null=True)
