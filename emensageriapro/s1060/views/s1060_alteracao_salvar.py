...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1060.can_view_s1060alteracao'):
        ...
        s1060_alteracao_form = disabled_form_fields(s1060_alteracao_form, request.user.has_perm('s1060.change_s1060alteracao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1060_alteracao_id, tabela='s1060_alteracao').all()
