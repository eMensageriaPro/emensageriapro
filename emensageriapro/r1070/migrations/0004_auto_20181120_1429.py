# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-20 14:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='r1070alteracao',
            name='indautoria',
            field=models.IntegerField(choices=[(1, '1 - Pr\xf3prio contribuinte'), (2, '2 - Outra entidade ou empresa')]),
        ),
        migrations.AlterField(
            model_name='r1070alteracao',
            name='inivalid',
        ...
        migrations.AlterField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='r1070alteracao_r1070_evttabprocesso', to='efdreinf.r1070evtTabProcesso'),
        ),
        migrations.AlterField(
            model_name='r1070alteracao',
            name='tpproc',
        ...
        migrations.AlterField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='r1070alteracaodadosprocjud_r1070_alteracao', to='r1070.r1070alteracao'),
        ),
        migrations.AlterField(
            model_name='r1070alteracaodadosprocjud',
            name='ufvara',
        ...
        migrations.AlterField(
            model_name='r1070alteracaoinfosusp',
            name='indsusp',
            field=models.CharField(choices=[(b'01', '01 - Liminar em Mandado de Seguran\xe7a'), (b'02', '02 - Dep\xf3sito Judicial do Montante Integral'), (b'03', '03 - Dep\xf3sito Administrativo do Montante Integral'), (b'04', '04 - Antecipa\xe7\xe3o de Tutela'), (b'05', '05 - Liminar em Medida Cautelar'), (b'08', '08 - Senten\xe7a em Mandado de Seguran\xe7a Favor\xe1vel ao Contribuinte'), (b'09', '09 - Senten\xe7a em A\xe7\xe3o Ordin\xe1ria Favor\xe1vel ao Contribuinte e Confirmada pelo TRF'), (b'10', '10 - Ac\xf3rd\xe3o do TRF Favor\xe1vel ao Contribuinte'), (b'11', '11 - Ac\xf3rd\xe3o do STJ em Recurso Especial Favor\xe1vel ao Contribuinte'), (b'12', '12 - Ac\xf3rd\xe3o do STF em Recurso Extraordin\xe1rio Favor\xe1vel ao Contribuinte'), (b'13', '13 - Senten\xe7a 1\xaa inst\xe2ncia n\xe3o transitada em julgado com efeito suspensivo'), (b'90', '90 - Decis\xe3o Definitiva a favor do contribuinte'), (b'92', '92 - Sem suspens\xe3o da exigibilidade')], max_length=2),
        ),
        migrations.AlterField(
            model_name='r1070alteracaoinfosusp',
            name='r1070_alteracao',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='r1070alteracaoinfosusp_r1070_alteracao', to='r1070.r1070alteracao'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='r1070alteracaonovavalidade',
            name='r1070_alteracao',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='r1070alteracaonovavalidade_r1070_alteracao', to='r1070.r1070alteracao'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='r1070exclusao',
            name='r1070_evttabprocesso',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='r1070exclusao_r1070_evttabprocesso', to='efdreinf.r1070evtTabProcesso'),
        ),
        migrations.AlterField(
            model_name='r1070exclusao',
            name='tpproc',
        ...
        migrations.AlterField(
            model_name='r1070inclusao',
            name='r1070_evttabprocesso',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='r1070inclusao_r1070_evttabprocesso', to='efdreinf.r1070evtTabProcesso'),
        ),
        migrations.AlterField(
            model_name='r1070inclusao',
            name='tpproc',
        ...
        migrations.AlterField(
            model_name='r1070inclusaodadosprocjud',
            name='r1070_inclusao',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='r1070inclusaodadosprocjud_r1070_inclusao', to='r1070.r1070inclusao'),
        ),
        migrations.AlterField(
            model_name='r1070inclusaodadosprocjud',
            name='ufvara',
        ...
        migrations.AlterField(
            model_name='r1070inclusaoinfosusp',
            name='r1070_inclusao',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='r1070inclusaoinfosusp_r1070_inclusao', to='r1070.r1070inclusao'),
        ),
    ]
