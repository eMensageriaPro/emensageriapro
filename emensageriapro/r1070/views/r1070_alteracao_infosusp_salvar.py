...
def salvar(request, hash):
    ...
    if r1070_alteracao_infosusp_id:
        ...
        r1070_alteracao_infosusp = get_object_or_404(r1070alteracaoinfoSusp, id=r1070_alteracao_infosusp_id)
        dados_evento = r1070_alteracao_infosusp.evento()

    if request.user.has_perm('r1070.can_view_r1070alteracaoinfoSusp'):
        ...
        r1070_alteracao_infosusp_form = disabled_form_fields(r1070_alteracao_infosusp_form, request.user.has_perm('r1070.change_r1070alteracaoinfoSusp'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r1070_alteracao_infosusp_id, tabela='r1070_alteracao_infosusp').all()
