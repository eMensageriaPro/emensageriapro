...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r1070_alteracao_infosusp = get_object_or_404(r1070alteracaoinfoSusp, id=pk)
        evento_dados = r1070_alteracao_infosusp.evento()

    if request.user.has_perm('r1070.can_see_r1070alteracaoinfoSusp'):
        ...
        if request.method == 'POST':
            ...
            if r1070_alteracao_infosusp_form.is_valid():
                ...
                if not pk:
                    ...
                    gravar_auditoria(
                        json.dumps(
                            model_to_dict(r1070_alteracao_infosusp), 
                            indent=4, 
                            sort_keys=True, 
                            default=str),
                        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r1070_alteracao_infosusp_apagar', 
                    'r1070_alteracao_infosusp_salvar', 
                    'r1070_alteracao_infosusp'):
        ...
        r1070_alteracao_infosusp_form = disabled_form_fields(
            r1070_alteracao_infosusp_form, 
            request.user.has_perm('r1070.change_r1070alteracaoinfoSusp'))
        ...
        if tab or 'r1070_alteracao_infosusp' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r1070_alteracao_infosusp_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r1070_alteracao_infosusp').all()
        ...
        context = {
            ...
            'modulos': ['r1070', ],
            'paginas': ['r1070_alteracao_infosusp', ],
