...
def listar(request, output=None):
    ...
    if request.user.has_perm('r1070.can_see_r1070alteracaoinfoSusp'):
        ...
        r1070_alteracao_infosusp_lista = r1070alteracaoinfoSusp.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        r1070_alteracao_lista = r1070alteracao.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r1070_alteracao_infosusp.csv', context)
