...
def apagar(request, hash):
    ...
    pagina = ConfigPaginas.objects.using( db_slug ).get(excluido = False, endereco='r1070_inclusao')
    ...
    r1070_inclusao = get_object_or_404(r1070inclusao.objects.using( db_slug ), excluido = False, id = r1070_inclusao_id)
    dados_evento = {}
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            situacao_anterior = json.dumps(model_to_dict(r1070_inclusao), indent=4, sort_keys=True, default=str)
            r1070inclusao.objects.using( db_slug ).filter(id = r1070_inclusao_id).delete()
            #r1070_inclusao_apagar_custom
            #r1070_inclusao_apagar_custom
            messages.success(request, 'Apagado com sucesso!')
            gravar_auditoria(situacao_anterior,
                             '',
                             'r1070_inclusao', r1070_inclusao_id, usuario_id, 3)
        else:
            messages.error(request, 'Não foi possivel apagar o evento, somente é possível apagar os eventos com status "Cadastrado"!')
   
        if request.session['retorno_pagina']== 'r1070_inclusao_salvar':
            return redirect('r1070_inclusao', hash=request.session['retorno_hash'])
        else:
    ...
    return render(request, 'r1070_inclusao_apagar.html', context)

from rest_framework import generics
from rest_framework.permissions import IsAdminUser


class r1070inclusaoList(generics.ListCreateAPIView):
    db_slug = 'default'
    queryset = r1070inclusao.objects.using(db_slug).all()
    serializer_class = r1070inclusaoSerializer
    permission_classes = (IsAdminUser,)


class r1070inclusaoDetail(generics.RetrieveUpdateDestroyAPIView):
    db_slug = 'default'
    queryset = r1070inclusao.objects.using(db_slug).all()
    serializer_class = r1070inclusaoSerializer
    permission_classes = (IsAdminUser,)
...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        r1070_inclusao_lista = r1070inclusao.objects.using( db_slug ).filter(**dict_qs).filter(excluido = False).exclude(id=0).all()
        ...
        request.session["retorno_pagina"] = 'r1070_inclusao'
        context = {
        ...
        if for_print in (0,1):
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('tables/r1070_inclusao_csv.html', context)
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r1070_inclusao_id:
            r1070_inclusao_form = form_r1070_inclusao(request.POST or None, instance = r1070_inclusao, slug = db_slug)
        else:
            r1070_inclusao_form = form_r1070_inclusao(request.POST or None, slug = db_slug, initial={})
        if request.method == 'POST':
            if r1070_inclusao_form.is_valid():
                ...
                if r1070_inclusao_id:
                    if dados_evento['status'] == 0:
                        ...
                        #r1070_inclusao_campos_multiple_passo1
                        r1070inclusao.objects.using(db_slug).filter(id=r1070_inclusao_id).update(**dados)
                        obj = r1070inclusao.objects.using(db_slug).get(id=r1070_inclusao_id)
                        #r1070_inclusao_editar_custom
                        #r1070_inclusao_campos_multiple_passo2
                    ...
                    #r1070_inclusao_cadastrar_campos_multiple_passo1
                    obj = r1070inclusao(**dados)
                    obj.save(using = db_slug)
                    #r1070_inclusao_cadastrar_custom
                    #r1070_inclusao_cadastrar_campos_multiple_passo2
        ...
        for field in r1070_inclusao_form.fields.keys():
            r1070_inclusao_form.fields[field].widget.attrs['ng-model'] = 'r1070_inclusao_'+field
        ...
        if r1070_inclusao_id:
            ...
            r1070_inclusao_infosusp_form = form_r1070_inclusao_infosusp(initial={ 'r1070_inclusao': r1070_inclusao }, slug=db_slug)
            r1070_inclusao_infosusp_form.fields['r1070_inclusao'].widget.attrs['readonly'] = True
            r1070_inclusao_infosusp_lista = r1070inclusaoinfoSusp.objects.using( db_slug ).filter(excluido = False, r1070_inclusao_id=r1070_inclusao.id).all()
            r1070_inclusao_dadosprocjud_form = form_r1070_inclusao_dadosprocjud(initial={ 'r1070_inclusao': r1070_inclusao }, slug=db_slug)
            r1070_inclusao_dadosprocjud_form.fields['r1070_inclusao'].widget.attrs['readonly'] = True
            r1070_inclusao_dadosprocjud_lista = r1070inclusaodadosProcJud.objects.using( db_slug ).filter(excluido = False, r1070_inclusao_id=r1070_inclusao.id).all()
        else:
            r1070_inclusao = None
        ...
        controle_alteracoes = Auditoria.objects.using( db_slug ).filter(identidade=r1070_inclusao_id, tabela='r1070_inclusao').all()
        context = {
