...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='r1070_alteracao_novavalidade')
    ...
    if permissao.permite_listar:
        ...
        r1070_alteracao_novavalidade_lista = r1070alteracaonovaValidade.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/r1070_alteracao_novavalidade_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r1070_alteracao_novavalidade.csv', context)
