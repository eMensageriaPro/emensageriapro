...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = r1070_exclusao.evento()
    ...
    if request.user.has_perm('r1070.can_see_r1070exclusao'):
        ...
        if request.method == 'POST':
            ...
            if r1070_exclusao_form.is_valid():
                ...
                if request.session['return_page'] not in (
                    'r1070_exclusao_apagar', 
                    'r1070_exclusao_salvar', 
                    'r1070_exclusao'):
        ...
        r1070_exclusao_form = disabled_form_fields(
            r1070_exclusao_form, 
            request.user.has_perm('r1070.change_r1070exclusao'))
        ...
        if tab or 'r1070_exclusao' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r1070_exclusao_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r1070_exclusao').all()
