...
def salvar(request, hash):
    ...
    if request.user.has_perm('r1070.can_view_r1070inclusao'):
        ...
        r1070_inclusao_form = disabled_form_fields(r1070_inclusao_form, request.user.has_perm('r1070.change_r1070inclusao'))
