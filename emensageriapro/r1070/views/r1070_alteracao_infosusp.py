...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            r1070alteracaoinfoSusp.objects.using( db_slug ).filter(id = r1070_alteracao_infosusp_id).delete()
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r1070_alteracao_infosusp_id:
            r1070_alteracao_infosusp_form = form_r1070_alteracao_infosusp(request.POST or None, instance = r1070_alteracao_infosusp, slug = db_slug)
        else:
            r1070_alteracao_infosusp_form = form_r1070_alteracao_infosusp(request.POST or None, slug = db_slug, initial={})
        if request.method == 'POST':
            if r1070_alteracao_infosusp_form.is_valid():
                ...
                if r1070_alteracao_infosusp_id:
                    if dados_evento['status'] == 0:
                        ...
                        #r1070_alteracao_infosusp_campos_multiple_passo1
                        r1070alteracaoinfoSusp.objects.using(db_slug).filter(id=r1070_alteracao_infosusp_id).update(**dados)
                        obj = r1070alteracaoinfoSusp.objects.using(db_slug).get(id=r1070_alteracao_infosusp_id)
                        #r1070_alteracao_infosusp_editar_custom
                        #r1070_alteracao_infosusp_campos_multiple_passo2
                    ...
                    #r1070_alteracao_infosusp_cadastrar_campos_multiple_passo1
                    obj = r1070alteracaoinfoSusp(**dados)
                    obj.save(using = db_slug)
                    #r1070_alteracao_infosusp_cadastrar_custom
                    #r1070_alteracao_infosusp_cadastrar_campos_multiple_passo2
