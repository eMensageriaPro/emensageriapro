            ...
            if r2060_tipocod_form.is_valid():
                ...
                if r2060_tipocod_id:
                    if dados_evento['status'] == 0:
                        ...
                        #r2060_tipocod_campos_multiple_passo1
                        r2060tipoCod.objects.using(db_slug).filter(id=r2060_tipocod_id).update(**dados)
                        obj = r2060tipoCod.objects.using(db_slug).get(id=r2060_tipocod_id)
                        #r2060_tipocod_editar_custom
                        #r2060_tipocod_campos_multiple_passo2
                    ...
                    #r2060_tipocod_cadastrar_campos_multiple_passo1
                    obj = r2060tipoCod(**dados)
                    obj.save(using = db_slug)
                    #r2060_tipocod_cadastrar_custom
                    #r2060_tipocod_cadastrar_campos_multiple_passo2
...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            r2060tipoCod.objects.using( db_slug ).filter(id = r2060_tipocod_id).delete()
