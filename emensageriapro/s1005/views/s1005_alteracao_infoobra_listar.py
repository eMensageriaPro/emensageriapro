...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1005_alteracao_infoobra')
    ...
    if permissao.permite_listar:
        ...
        s1005_alteracao_infoobra_lista = s1005alteracaoinfoObra.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1005_alteracao_infoobra_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1005_alteracao_infoobra.csv', context)
