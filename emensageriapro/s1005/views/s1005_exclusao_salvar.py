...
def salvar(request, hash):
    ...
    if s1005_exclusao_id:
        ...
        s1005_exclusao = get_object_or_404(s1005exclusao, id=s1005_exclusao_id)
        dados_evento = s1005_exclusao.evento()

    if request.user.has_perm('s1005.can_view_s1005exclusao'):
        ...
        s1005_exclusao_form = disabled_form_fields(s1005_exclusao_form, request.user.has_perm('s1005.change_s1005exclusao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1005_exclusao_id, tabela='s1005_exclusao').all()
