...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1005_inclusao_infopcd')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1005_inclusao_infopcd_id:
        s1005_inclusao_infopcd = get_object_or_404(s1005inclusaoinfoPCD, id = s1005_inclusao_infopcd_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1005_inclusao_infopcd_id, tabela='s1005_inclusao_infopcd').all()
        context = {
