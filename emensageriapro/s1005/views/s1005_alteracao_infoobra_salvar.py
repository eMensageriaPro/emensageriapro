...
def salvar(request, hash):
    ...
    if s1005_alteracao_infoobra_id:
        ...
        s1005_alteracao_infoobra = get_object_or_404(s1005alteracaoinfoObra, id=s1005_alteracao_infoobra_id)
        dados_evento = s1005_alteracao_infoobra.evento()

    if request.user.has_perm('s1005.can_view_s1005alteracaoinfoObra'):
        ...
        s1005_alteracao_infoobra_form = disabled_form_fields(s1005_alteracao_infoobra_form, request.user.has_perm('s1005.change_s1005alteracaoinfoObra'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1005_alteracao_infoobra_id, tabela='s1005_alteracao_infoobra').all()
