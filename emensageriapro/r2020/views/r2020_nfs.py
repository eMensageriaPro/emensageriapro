            ...
            if r2020_nfs_form.is_valid():
                ...
                if r2020_nfs_id:
                    if dados_evento['status'] == 0:
                        ...
                        #r2020_nfs_campos_multiple_passo1
                        r2020nfs.objects.using(db_slug).filter(id=r2020_nfs_id).update(**dados)
                        obj = r2020nfs.objects.using(db_slug).get(id=r2020_nfs_id)
                        #r2020_nfs_editar_custom
                        #r2020_nfs_campos_multiple_passo2
                    ...
                    #r2020_nfs_cadastrar_campos_multiple_passo1
                    obj = r2020nfs(**dados)
                    obj.save(using = db_slug)
                    #r2020_nfs_cadastrar_custom
                    #r2020_nfs_cadastrar_campos_multiple_passo2
...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            r2020nfs.objects.using( db_slug ).filter(id = r2020_nfs_id).delete()
