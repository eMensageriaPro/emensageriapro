...
def salvar(request, hash):
    ...
    if r2020_infoprocretad_id:
        ...
        r2020_infoprocretad = get_object_or_404(r2020infoProcRetAd, id=r2020_infoprocretad_id)
        dados_evento = r2020_infoprocretad.evento()

    if request.user.has_perm('r2020.can_view_r2020infoProcRetAd'):
        ...
        r2020_infoprocretad_form = disabled_form_fields(r2020_infoprocretad_form, request.user.has_perm('r2020.change_r2020infoProcRetAd'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2020_infoprocretad_id, tabela='r2020_infoprocretad').all()
