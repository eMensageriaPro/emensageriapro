...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r2030_recursosrec_id:
            r2030_recursosrec_form = form_r2030_recursosrec(request.POST or None, instance = r2030_recursosrec,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            r2030_recursosrec_form = form_r2030_recursosrec(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
