...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        r2030_inforecurso_lista = r2030infoRecurso.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/r2030_inforecurso_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
