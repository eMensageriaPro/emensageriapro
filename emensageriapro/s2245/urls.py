...
from emensageriapro.s2245.views import s2245_ideprofresp_apagar as s2245_ideprofresp_apagar_views
from emensageriapro.s2245.views import s2245_ideprofresp_listar as s2245_ideprofresp_listar_views
from emensageriapro.s2245.views import s2245_ideprofresp_salvar as s2245_ideprofresp_salvar_views
...
urlpatterns = [
    ...
    url(r'^s2245-ideprofresp/api/$',
        s2245_ideprofresp_api_views.s2245ideProfRespList.as_view() ),
