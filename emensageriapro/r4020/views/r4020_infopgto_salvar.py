...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r4020_infopgto_id:
            r4020_infopgto_form = form_r4020_infopgto(request.POST or None, instance = r4020_infopgto,  
        ...
        r4020_infopgto_form = disabled_form_fields(r4020_infopgto_form, permissao.permite_editar)
