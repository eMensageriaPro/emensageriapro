...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r4020_infoprocret = get_object_or_404(r4020infoProcRet, id=pk)
        evento_dados = r4020_infoprocret.evento()
    ...
    if request.user.has_perm('r4020.can_see_r4020infoProcRet'):
        ...
        if request.method == 'POST':
            ...
            if r4020_infoprocret_form.is_valid():
                ...
                #    gravar_auditoria(
                #        json.dumps(
                #            model_to_dict(r4020_infoprocret), 
                #            indent=4, 
                #            sort_keys=True, 
                #            default=str),
                #        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r4020_infoprocret_apagar', 
                    'r4020_infoprocret_salvar', 
                    'r4020_infoprocret'):
        ...
        r4020_infoprocret_form = disabled_form_fields(
            r4020_infoprocret_form, 
            request.user.has_perm('r4020.change_r4020infoProcRet'))
        ...
        if tab or 'r4020_infoprocret' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r4020_infoprocret_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r4020_infoprocret').all()
