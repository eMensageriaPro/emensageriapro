...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r4020_infoprocret_id:
            r4020_infoprocret_form = form_r4020_infoprocret(request.POST or None, instance = r4020_infoprocret,  
        ...
        r4020_infoprocret_form = disabled_form_fields(r4020_infoprocret_form, permissao.permite_editar)
