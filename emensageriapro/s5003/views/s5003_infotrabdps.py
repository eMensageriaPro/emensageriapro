...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s5003infoTrabDps.objects.using( db_slug ).filter(id = s5003_infotrabdps_id).delete()
            ...
            if s5003_infotrabdps_form.is_valid():
                ...
                if s5003_infotrabdps_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s5003_infotrabdps_campos_multiple_passo1
                        s5003infoTrabDps.objects.using(db_slug).filter(id=s5003_infotrabdps_id).update(**dados)
                        obj = s5003infoTrabDps.objects.using(db_slug).get(id=s5003_infotrabdps_id)
                        #s5003_infotrabdps_editar_custom
                        #s5003_infotrabdps_campos_multiple_passo2
                    ...
                    #s5003_infotrabdps_cadastrar_campos_multiple_passo1
                    obj = s5003infoTrabDps(**dados)
                    obj.save(using = db_slug)
                    #s5003_infotrabdps_cadastrar_custom
                    #s5003_infotrabdps_cadastrar_campos_multiple_passo2
