...
def salvar(request, hash):
    ...
    if s5003_baseperante_id:
        ...
        s5003_baseperante = get_object_or_404(s5003basePerAntE, id=s5003_baseperante_id)
        dados_evento = s5003_baseperante.evento()

    if request.user.has_perm('s5003.can_view_s5003basePerAntE'):
        ...
        s5003_baseperante_form = disabled_form_fields(s5003_baseperante_form, request.user.has_perm('s5003.change_s5003basePerAntE'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5003_baseperante_id, tabela='s5003_baseperante').all()
