...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if dados_evento['status'] == STATUS_EVENTO_CADASTRADO:
            ...
            obj = s5003infoTrabDps.objects.get(id=pk)
        ...
        if 's5003_infotrabdps' in request.session['return_page']:
        
            return redirect('s5003_infotrabdps')
