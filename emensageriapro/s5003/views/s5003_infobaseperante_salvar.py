...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5003_infobaseperante')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s5003_infobaseperante_id:
            s5003_infobaseperante_form = form_s5003_infobaseperante(request.POST or None, instance = s5003_infobaseperante,  
