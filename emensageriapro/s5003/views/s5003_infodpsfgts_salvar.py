...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5003_infodpsfgts')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s5003_infodpsfgts_id:
            s5003_infodpsfgts_form = form_s5003_infodpsfgts(request.POST or None, instance = s5003_infodpsfgts,  
