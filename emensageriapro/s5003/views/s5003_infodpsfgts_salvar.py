...
def salvar(request, hash):
    ...
    if s5003_infodpsfgts_id:
        ...
        s5003_infodpsfgts = get_object_or_404(s5003infoDpsFGTS, id=s5003_infodpsfgts_id)
        dados_evento = s5003_infodpsfgts.evento()

    if request.user.has_perm('s5003.can_view_s5003infoDpsFGTS'):
        ...
        s5003_infodpsfgts_form = disabled_form_fields(s5003_infodpsfgts_form, request.user.has_perm('s5003.change_s5003infoDpsFGTS'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5003_infodpsfgts_id, tabela='s5003_infodpsfgts').all()
