...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5003_infobasefgts')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s5003_infobasefgts_id:
        s5003_infobasefgts = get_object_or_404(s5003infoBaseFGTS, id = s5003_infobasefgts_id)
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s5003_infobasefgts_id:
            s5003_infobasefgts_form = form_s5003_infobasefgts(request.POST or None, instance = s5003_infobasefgts,  
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5003_infobasefgts_id, tabela='s5003_infobasefgts').all()
        context = {
