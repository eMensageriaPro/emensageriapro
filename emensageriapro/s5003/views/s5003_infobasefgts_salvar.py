...
def salvar(request, hash):
    ...
    if request.user.has_perm('s5003.can_view_s5003infoBaseFGTS'):
        ...
        s5003_infobasefgts_form = disabled_form_fields(s5003_infobasefgts_form, request.user.has_perm('s5003.change_s5003infoBaseFGTS'))
