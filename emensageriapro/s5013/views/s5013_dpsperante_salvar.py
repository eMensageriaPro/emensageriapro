...
def salvar(request, hash):
    ...
    if s5013_dpsperante_id:
        ...
        s5013_dpsperante = get_object_or_404(s5013dpsPerAntE, id=s5013_dpsperante_id)
        dados_evento = s5013_dpsperante.evento()

    if request.user.has_perm('s5013.can_view_s5013dpsPerAntE'):
        ...
        s5013_dpsperante_form = disabled_form_fields(s5013_dpsperante_form, request.user.has_perm('s5013.change_s5013dpsPerAntE'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5013_dpsperante_id, tabela='s5013_dpsperante').all()
