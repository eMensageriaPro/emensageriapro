...
def salvar(request, hash):
    ...
    if s5013_infodpsfgts_id:
        ...
        s5013_infodpsfgts = get_object_or_404(s5013infoDpsFGTS, id=s5013_infodpsfgts_id)
        dados_evento = s5013_infodpsfgts.evento()

    if request.user.has_perm('s5013.can_view_s5013infoDpsFGTS'):
        ...
        s5013_infodpsfgts_form = disabled_form_fields(s5013_infodpsfgts_form, request.user.has_perm('s5013.change_s5013infoDpsFGTS'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5013_infodpsfgts_id, tabela='s5013_infodpsfgts').all()
