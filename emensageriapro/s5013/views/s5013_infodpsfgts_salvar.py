...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5013_infodpsfgts')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s5013_infodpsfgts_id:
            s5013_infodpsfgts_form = form_s5013_infodpsfgts(request.POST or None, instance = s5013_infodpsfgts,  
