...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s5013_baseperante_id:
            s5013_baseperante_form = form_s5013_baseperante(request.POST or None, instance = s5013_baseperante,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            s5013_baseperante_form = form_s5013_baseperante(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
