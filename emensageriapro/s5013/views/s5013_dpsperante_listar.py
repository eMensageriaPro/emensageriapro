...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = { 
                's5013_infodpsperante__icontains': 's5013_infodpsperante__icontains',
                'tpdpse__icontains': 'tpdpse__icontains',
                'vrfgtse__icontains': 'vrfgtse__icontains', }
        ...
        s5013_dpsperante_lista = s5013dpsPerAntE.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s5013_dpsperante_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s5013_dpsperante.csv', context)
