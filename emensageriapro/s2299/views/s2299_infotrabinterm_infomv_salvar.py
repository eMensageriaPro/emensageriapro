...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s2299_infotrabinterm_infomv.evento()
    ...
    if request.user.has_perm('s2299.can_see_s2299infoTrabInterminfoMV'):
        ...
        if request.method == 'POST':
            ...
            if s2299_infotrabinterm_infomv_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's2299-infotrabinterm-infomv' not in request.session['return_page']:
