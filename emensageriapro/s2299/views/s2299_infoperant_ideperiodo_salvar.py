...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2299_infoperant_ideperiodo')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2299_infoperant_ideperiodo_id:
            s2299_infoperant_ideperiodo_form = form_s2299_infoperant_ideperiodo(request.POST or None, instance = s2299_infoperant_ideperiodo,  
