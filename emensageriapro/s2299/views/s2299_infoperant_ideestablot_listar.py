...
def listar(request, output=None):
    ...
    if request.user.has_perm('s2299.can_see_s2299infoPerAntideEstabLot'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's2299_infoperant_ideperiodo__icontains': 's2299_infoperant_ideperiodo__icontains',
        ...
        s2299_infoperant_ideestablot_lista = s2299infoPerAntideEstabLot.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s2299_infoperant_ideperiodo_lista = s2299infoPerAntidePeriodo.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s2299_infoperant_ideestablot.csv', context)
