...
def salvar(request, hash):
    ...
    if request.user.has_perm('s2299.can_view_s2299infoPerApur'):
        ...
        s2299_infoperapur_form = disabled_form_fields(s2299_infoperapur_form, request.user.has_perm('s2299.change_s2299infoPerApur'))
