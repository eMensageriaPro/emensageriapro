...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2299_infoperapur')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2299_infoperapur_id:
            s2299_infoperapur_form = form_s2299_infoperapur(request.POST or None, instance = s2299_infoperapur,  
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2299_infoperapur_id, tabela='s2299_infoperapur').all()
        context = {
