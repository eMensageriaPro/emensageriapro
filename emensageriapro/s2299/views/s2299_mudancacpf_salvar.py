...
def salvar(request, hash):
    ...
    if s2299_mudancacpf_id:
        ...
        s2299_mudancacpf = get_object_or_404(s2299mudancaCPF, id=s2299_mudancacpf_id)
        dados_evento = s2299_mudancacpf.evento()

    if request.user.has_perm('s2299.can_view_s2299mudancaCPF'):
        ...
        s2299_mudancacpf_form = disabled_form_fields(s2299_mudancacpf_form, request.user.has_perm('s2299.change_s2299mudancaCPF'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2299_mudancacpf_id, tabela='s2299_mudancacpf').all()
