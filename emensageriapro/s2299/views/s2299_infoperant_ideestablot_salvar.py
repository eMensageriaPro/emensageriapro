...
def salvar(request, hash):
    ...
    if s2299_infoperant_ideestablot_id:
        ...
        s2299_infoperant_ideestablot = get_object_or_404(s2299infoPerAntideEstabLot, id=s2299_infoperant_ideestablot_id)
        dados_evento = s2299_infoperant_ideestablot.evento()

    if request.user.has_perm('s2299.can_view_s2299infoPerAntideEstabLot'):
        ...
        if request.method == 'POST':
            ...
            if s2299_infoperant_ideestablot_form.is_valid():
                ...
                if not s2299_infoperant_ideestablot_id:
        ...
        s2299_infoperant_ideestablot_form = disabled_form_fields(s2299_infoperant_ideestablot_form, request.user.has_perm('s2299.change_s2299infoPerAntideEstabLot'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2299_infoperant_ideestablot_id, tabela='s2299_infoperant_ideestablot').all()
