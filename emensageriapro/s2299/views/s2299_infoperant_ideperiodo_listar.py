...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = { 
                's2299_infoperant_ideadc__icontains': 's2299_infoperant_ideadc__icontains',
        ...
        s2299_infoperant_ideperiodo_lista = s2299infoPerAntidePeriodo.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s2299_infoperant_ideperiodo_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s2299_infoperant_ideperiodo.csv', context)
