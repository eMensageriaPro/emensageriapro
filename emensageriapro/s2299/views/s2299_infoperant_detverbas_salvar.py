...
def salvar(request, hash):
    ...
    if s2299_infoperant_detverbas_id:
        s2299_infoperant_detverbas = get_object_or_404(s2299infoPerAntdetVerbas, id = s2299_infoperant_detverbas_id)
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2299_infoperant_detverbas_id:
            s2299_infoperant_detverbas_form = form_s2299_infoperant_detverbas(request.POST or None, instance = s2299_infoperant_detverbas,  
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2299_infoperant_detverbas_id, tabela='s2299_infoperant_detverbas').all()
        context = {
