...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2299_transftit')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s2299_transftit_id:
        s2299_transftit = get_object_or_404(s2299transfTit, id = s2299_transftit_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2299_transftit_id, tabela='s2299_transftit').all()
        context = {
