...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2299_infoperant_detverbas')
    ...
    if permissao.permite_listar:
        ...
        s2299_infoperant_detverbas_lista = s2299infoPerAntdetVerbas.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s2299_infoperant_detverbas_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
