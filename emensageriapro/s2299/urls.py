...
from emensageriapro.s2299.views import s2299_mudancacpf as s2299_mudancacpf_views
...
url(r'^s2299-mudancacpf/apagar/(?P<hash>.*)/$', 
        s2299_mudancacpf_views.apagar, 
        name='s2299_mudancacpf_apagar'),

url(r'^s2299-mudancacpf/api/$',
            s2299_mudancacpf_views.s2299mudancaCPFList.as_view() ),

        url(r'^s2299-mudancacpf/api/(?P<pk>[0-9]+)/$',
            s2299_mudancacpf_views.s2299mudancaCPFDetail.as_view() ),

url(r'^s2299-mudancacpf/listar/(?P<hash>.*)/$', 
        s2299_mudancacpf_views.listar, 
        name='s2299_mudancacpf'),

url(r'^s2299-mudancacpf/salvar/(?P<hash>.*)/$', 
        s2299_mudancacpf_views.salvar, 
