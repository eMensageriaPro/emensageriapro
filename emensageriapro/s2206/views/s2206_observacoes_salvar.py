...
def salvar(request, hash):
    ...
    if request.user.has_perm('s2206.can_view_s2206observacoes'):
        ...
        s2206_observacoes_form = disabled_form_fields(s2206_observacoes_form, request.user.has_perm('s2206.change_s2206observacoes'))
