...
def salvar(request, hash):
    ...
    if request.user.has_perm('s2206.can_view_s2206horContratual'):
        ...
        s2206_horcontratual_form = disabled_form_fields(s2206_horcontratual_form, request.user.has_perm('s2206.change_s2206horContratual'))
