...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2206_horcontratual')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s2206_horcontratual_id:
        s2206_horcontratual = get_object_or_404(s2206horContratual, id = s2206_horcontratual_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2206_horcontratual_id, tabela='s2206_horcontratual').all()
        context = {
