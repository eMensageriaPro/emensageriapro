...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2206_infoceletista')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s2206_infoceletista_id:
        s2206_infoceletista = get_object_or_404(s2206infoCeletista, id = s2206_infoceletista_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2206_infoceletista_id, tabela='s2206_infoceletista').all()
        context = {
