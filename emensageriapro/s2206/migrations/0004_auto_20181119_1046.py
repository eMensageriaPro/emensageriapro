# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-19 10:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('s2206', '0003_auto_20181010_2117'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='s2206horcontratual',
            options={'managed': True, 'ordering': ['s2206_evtaltcontratual', 'tpjornada', 'tmpparc']},
        ),
        migrations.AlterModelOptions(
            name='s2206infoceletista',
            options={'managed': True, 'ordering': ['s2206_evtaltcontratual', 'tpregjor', 'natatividade', 'cnpjsindcategprof']},
        ),
        migrations.AlterModelOptions(
            name='s2206infoestatutario',
            options={'managed': True, 'ordering': ['s2206_evtaltcontratual', 'tpplanrp']},
        ),
        migrations.AlterModelOptions(
            name='s2206localtrabdom',
            options={'managed': True, 'ordering': ['s2206_evtaltcontratual', 'tplograd', 'dsclograd', 'nrlograd', 'cep', 'codmunic', 'uf']},
        ),
        migrations.AlterModelOptions(
            name='s2206localtrabgeral',
            options={'managed': True, 'ordering': ['s2206_evtaltcontratual', 'tpinsc', 'nrinsc']},
        ),
