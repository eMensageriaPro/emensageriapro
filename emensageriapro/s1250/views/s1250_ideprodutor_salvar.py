...
def salvar(request, hash):
    ...
    if s1250_ideprodutor_id:
        ...
        s1250_ideprodutor = get_object_or_404(s1250ideProdutor, id=s1250_ideprodutor_id)
    ...
    if request.user.has_perm('s1250.can_view_s1250ideProdutor'):
        ...
        s1250_ideprodutor_form = disabled_form_fields(s1250_ideprodutor_form, request.user.has_perm('s1250.change_s1250ideProdutor'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1250_ideprodutor_id, tabela='s1250_ideprodutor').all()
