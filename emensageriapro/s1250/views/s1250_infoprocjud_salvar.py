...
def salvar(request, hash):
    ...
    if s1250_infoprocjud_id:
        ...
        s1250_infoprocjud = get_object_or_404(s1250infoProcJud, id=s1250_infoprocjud_id)
    ...
    if request.user.has_perm('s1250.can_view_s1250infoProcJud'):
        ...
        s1250_infoprocjud_form = disabled_form_fields(s1250_infoprocjud_form, request.user.has_perm('s1250.change_s1250infoProcJud'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1250_infoprocjud_id, tabela='s1250_infoprocjud').all()
