...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if dados_evento['status'] == STATUS_EVENTO_CADASTRADO:
            ...
            situacao_anterior = json.dumps(model_to_dict(s1250_tpaquis), sort_keys=True, default=str)
        ...
        if 'return_page' in request.session and request.session['return_page'] and 's1250-tpaquis' in request.session['return_page']:
