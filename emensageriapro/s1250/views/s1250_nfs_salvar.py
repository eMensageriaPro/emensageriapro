...
def salvar(request, hash):
    ...
    if s1250_nfs_id:
        ...
        s1250_nfs = get_object_or_404(s1250nfs, id=s1250_nfs_id)
    ...
    if request.user.has_perm('s1250.can_view_s1250nfs'):
        ...
        s1250_nfs_form = disabled_form_fields(s1250_nfs_form, request.user.has_perm('s1250.change_s1250nfs'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1250_nfs_id, tabela='s1250_nfs').all()
