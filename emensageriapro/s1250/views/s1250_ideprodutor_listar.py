...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1250_ideprodutor')
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'tpinscprod__icontains': 'tpinscprod__icontains',
        ...
        s1250_ideprodutor_lista = s1250ideProdutor.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1250_ideprodutor_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1250_ideprodutor.csv', context)
