...
def salvar(request, hash):
    ...
    if s1080_alteracao_novavalidade_id:
        ...
        s1080_alteracao_novavalidade = get_object_or_404(s1080alteracaonovaValidade, id=s1080_alteracao_novavalidade_id)
        dados_evento = s1080_alteracao_novavalidade.evento()

    if request.user.has_perm('s1080.can_view_s1080alteracaonovaValidade'):
        ...
        s1080_alteracao_novavalidade_form = disabled_form_fields(s1080_alteracao_novavalidade_form, request.user.has_perm('s1080.change_s1080alteracaonovaValidade'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1080_alteracao_novavalidade_id, tabela='s1080_alteracao_novavalidade').all()
