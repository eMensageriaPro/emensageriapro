...
def listar(request, output=None):
    ...
    if request.user.has_perm('s1080.can_see_s1080alteracaonovaValidade'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's1080_alteracao__icontains': 's1080_alteracao__icontains',
        ...
        s1080_alteracao_novavalidade_lista = s1080alteracaonovaValidade.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s1080_alteracao_lista = s1080alteracao.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1080_alteracao_novavalidade.csv', context)
