...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s3000_idetrabalhador')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s3000_idetrabalhador_id:
        s3000_idetrabalhador = get_object_or_404(s3000ideTrabalhador, id = s3000_idetrabalhador_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s3000_idetrabalhador_id, tabela='s3000_idetrabalhador').all()
        context = {
