...
def salvar(request, hash):
    ...
    if request.user.has_perm('s3000.can_view_s3000ideTrabalhador'):
        ...
        s3000_idetrabalhador_form = disabled_form_fields(s3000_idetrabalhador_form, request.user.has_perm('s3000.change_s3000ideTrabalhador'))
