...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1000_inclusao_infoop')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1000_inclusao_infoop_id:
        s1000_inclusao_infoop = get_object_or_404(s1000inclusaoinfoOP, id = s1000_inclusao_infoop_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1000_inclusao_infoop_id, tabela='s1000_inclusao_infoop').all()
        context = {
