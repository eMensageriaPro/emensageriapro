...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1000.can_view_s1000inclusaoinfoOP'):
        ...
        s1000_inclusao_infoop_form = disabled_form_fields(s1000_inclusao_infoop_form, request.user.has_perm('s1000.change_s1000inclusaoinfoOP'))
