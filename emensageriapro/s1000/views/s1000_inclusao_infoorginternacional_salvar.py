...
def salvar(request, hash):
    ...
    if s1000_inclusao_infoorginternacional_id:
        ...
        s1000_inclusao_infoorginternacional = get_object_or_404(s1000inclusaoinfoOrgInternacional, id=s1000_inclusao_infoorginternacional_id)
        dados_evento = s1000_inclusao_infoorginternacional.evento()

    if request.user.has_perm('s1000.can_view_s1000inclusaoinfoOrgInternacional'):
        ...
        s1000_inclusao_infoorginternacional_form = disabled_form_fields(s1000_inclusao_infoorginternacional_form, request.user.has_perm('s1000.change_s1000inclusaoinfoOrgInternacional'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1000_inclusao_infoorginternacional_id, tabela='s1000_inclusao_infoorginternacional').all()
        ...
        context = {
            ...
            'usuario': usuario, 
            'modulos': ['s1000', ],
            'paginas': ['s1000_inclusao_infoorginternacional', ],
            'hash': hash, 
