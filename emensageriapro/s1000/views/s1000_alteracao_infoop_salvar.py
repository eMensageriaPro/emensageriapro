...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s1000_alteracao_infoop.evento()
    ...
    if request.user.has_perm('s1000.can_see_s1000alteracaoinfoOP'):
        ...
        if request.method == 'POST':
            ...
            if s1000_alteracao_infoop_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's1000-alteracao-infoop' not in request.session['return_page']:
