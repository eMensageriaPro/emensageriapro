...
def salvar(request, hash):
    ...
    if s1000_inclusao_id:
        ...
        s1000_inclusao = get_object_or_404(s1000inclusao, id=s1000_inclusao_id)
        dados_evento = s1000_inclusao.evento()

    if request.user.has_perm('s1000.can_view_s1000inclusao'):
        ...
        s1000_inclusao_form = disabled_form_fields(s1000_inclusao_form, request.user.has_perm('s1000.change_s1000inclusao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1000_inclusao_id, tabela='s1000_inclusao').all()
