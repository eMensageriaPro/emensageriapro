...
def salvar(request, hash):
    ...
    if s1000_inclusao_situacaopf_id:
        ...
        s1000_inclusao_situacaopf = get_object_or_404(s1000inclusaosituacaoPF, id=s1000_inclusao_situacaopf_id)
        dados_evento = s1000_inclusao_situacaopf.evento()

    if request.user.has_perm('s1000.can_view_s1000inclusaosituacaoPF'):
        ...
        if request.method == 'POST':
            ...
            if s1000_inclusao_situacaopf_form.is_valid():
                ...
                if not s1000_inclusao_situacaopf_id:
        ...
        s1000_inclusao_situacaopf_form = disabled_form_fields(s1000_inclusao_situacaopf_form, request.user.has_perm('s1000.change_s1000inclusaosituacaoPF'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1000_inclusao_situacaopf_id, tabela='s1000_inclusao_situacaopf').all()
