...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1000_inclusao_situacaopf')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1000_inclusao_situacaopf_id:
            s1000_inclusao_situacaopf_form = form_s1000_inclusao_situacaopf(request.POST or None, instance = s1000_inclusao_situacaopf,  
