...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1000_alteracao_infoop_id:
            s1000_alteracao_infoop_form = form_s1000_alteracao_infoop(request.POST or None, instance = s1000_alteracao_infoop,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            s1000_alteracao_infoop_form = form_s1000_alteracao_infoop(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
