...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s1000alteracaoinfoEnte.objects.using( db_slug ).filter(id = s1000_alteracao_infoente_id).delete()
            ...
            if s1000_alteracao_infoente_form.is_valid():
                ...
                if s1000_alteracao_infoente_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s1000_alteracao_infoente_campos_multiple_passo1
                        s1000alteracaoinfoEnte.objects.using(db_slug).filter(id=s1000_alteracao_infoente_id).update(**dados)
                        obj = s1000alteracaoinfoEnte.objects.using(db_slug).get(id=s1000_alteracao_infoente_id)
                        #s1000_alteracao_infoente_editar_custom
                        #s1000_alteracao_infoente_campos_multiple_passo2
                    ...
                    #s1000_alteracao_infoente_cadastrar_campos_multiple_passo1
                    obj = s1000alteracaoinfoEnte(**dados)
                    obj.save(using = db_slug)
                    #s1000_alteracao_infoente_cadastrar_custom
                    #s1000_alteracao_infoente_cadastrar_campos_multiple_passo2
