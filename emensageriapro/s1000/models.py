...
class s1000alteracao(SoftDeletionModel):
    ...
    classtrib = models.CharField(choices=CHOICES_S1000_CLASSTRIB_ALTERACAO, max_length=2, null=True, )
...
class s1000inclusao(SoftDeletionModel):
    ...
    fimvalid = models.CharField(choices=PERIODOS, max_length=7, blank=True, null=True, )
    nmrazao = models.CharField(max_length=100, null=True, )
    classtrib = models.CharField(choices=CHOICES_S1000_CLASSTRIB_INCLUSAO, max_length=2, null=True, )
    natjurid = models.TextField(blank=True, null=True, )
