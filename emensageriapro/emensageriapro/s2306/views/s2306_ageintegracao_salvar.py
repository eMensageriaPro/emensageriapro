...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s2306_ageintegracao.evento()
    ...
    if request.user.has_perm('s2306.can_see_s2306ageIntegracao'):
        ...
        if request.method == 'POST':
            ...
            if s2306_ageintegracao_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's2306-ageintegracao' not in request.session['return_page']:
