...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get(endereco='config_paginas')
    permissao = ConfigPermissoes.objects.get(config_paginas=pagina, config_perfis=usuario.config_perfis)
    
    if config_paginas_id:
        config_paginas = get_object_or_404(ConfigPaginas, id=config_paginas_id)
    ...
    if permissao.permite_visualizar:
        ...
        if config_paginas_id:
            config_paginas_form = form_config_paginas(request.POST or None, instance=config_paginas)
        ...
        if request.method == 'POST':
            if config_paginas_form.is_valid():
                ...
                obj = config_paginas_form.save(request=request)
