...
def listar(request, hash):
    ...
    if True:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = { 
                'config_modulos__icontains': 'config_modulos__icontains',
                'titulo__icontains': 'titulo__icontains',
                'endereco__icontains': 'endereco__icontains',
                'exibe_menu__icontains': 'exibe_menu__icontains',
        ...
        config_paginas_lista = ConfigPaginas.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/config_paginas.csv', context)
