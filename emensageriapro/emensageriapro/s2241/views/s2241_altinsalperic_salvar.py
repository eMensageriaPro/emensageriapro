...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s2241_altinsalperic.evento()
    ...
    if request.user.has_perm('s2241.can_see_s2241altInsalPeric'):
        ...
        if request.method == 'POST':
            ...
            if s2241_altinsalperic_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's2241-altinsalperic' not in request.session['return_page']:
