...
def listar(request, output=None):
    ...
    if request.user.has_perm('s1207.can_see_s1207infoPerApurremunPerApur'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's1207_infoperapur_ideestab__icontains': 's1207_infoperapur_ideestab__icontains', }
        ...
        s1207_infoperapur_remunperapur_lista = s1207infoPerApurremunPerApur.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s1207_infoperapur_ideestab_lista = s1207infoPerApurideEstab.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1207_infoperapur_remunperapur.csv', context)
