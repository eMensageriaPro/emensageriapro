    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperant_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperant_modificado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'managed': True,
                'ordering': ['s1207_dmdev'],
                'db_table': 's1207_infoperant',
                'permissions': (('can_view_s1207_infoperant', 'Can view s1207_infoperant'),),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperantremunperant_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperantremunperant_modificado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'managed': True,
                'ordering': ['s1207_infoperant_ideestab'],
                'db_table': 's1207_infoperant_remunperant',
                'permissions': (('can_view_s1207_infoperant_remunperant', 'Can view s1207_infoperant_remunperant'),),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperapur_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperapur_modificado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'managed': True,
                'ordering': ['s1207_dmdev'],
                'db_table': 's1207_infoperapur',
                'permissions': (('can_view_s1207_infoperapur', 'Can view s1207_infoperapur'),),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperapurremunperapur_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperapurremunperapur_modificado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'managed': True,
                'ordering': ['s1207_infoperapur_ideestab'],
                'db_table': 's1207_infoperapur_remunperapur',
                'permissions': (('can_view_s1207_infoperapur_remunperapur', 'Can view s1207_infoperapur_remunperapur'),),
            },
        ),
        migrations.AlterModelOptions(
            name='s1207infoperantideadc',
            options={'managed': True, 'ordering': ['s1207_infoperant', 'tpacconv', 'dsc'], 'permissions': (('can_view_s1207_infoperant_ideadc', 'Can view s1207_infoperant_ideadc'),)},
        ),
        migrations.AlterModelOptions(
            name='s1207infoperantitensremun',
            options={'managed': True, 'ordering': ['s1207_infoperant_remunperant', 'codrubr', 'idetabrubr', 'vrrubr'], 'permissions': (('can_view_s1207_infoperant_itensremun', 'Can view s1207_infoperant_itensremun'),)},
        ),
        migrations.AlterModelOptions(
            name='s1207infoperapurideestab',
            options={'managed': True, 'ordering': ['s1207_infoperapur', 'tpinsc', 'nrinsc'], 'permissions': (('can_view_s1207_infoperapur_ideestab', 'Can view s1207_infoperapur_ideestab'),)},
        ),
        migrations.AlterModelOptions(
            name='s1207infoperapuritensremun',
            options={'managed': True, 'ordering': ['s1207_infoperapur_remunperapur', 'codrubr', 'idetabrubr', 'vrrubr'], 'permissions': (('can_view_s1207_infoperapur_itensremun', 'Can view s1207_infoperapur_itensremun'),)},
        ),
        ...
        migrations.AddField(
            ...
            name='s1207_dmdev',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperapur_s1207_dmdev', to='s1207.s1207dmDev'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='s1207_dmdev',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperant_s1207_dmdev', to='s1207.s1207dmDev'),
        ),
        migrations.AddField(
            model_name='s1207infoperantideadc',
