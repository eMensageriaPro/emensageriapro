...
def listar(request, output=None):
    ...
    if request.user.has_perm('r2020.can_see_r2020infoProcRetAd'):
        ...
        r2020_infoprocretad_lista = r2020infoProcRetAd.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        r2020_evtservprest_lista = r2020evtServPrest.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r2020_infoprocretad.csv', context)
