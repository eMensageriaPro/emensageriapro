...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='indautoria',
            field=models.IntegerField(choices=[(1, '1 - Pr\xf3prio contribuinte'), (2, '2 - Outra entidade ou empresa.')], null=True),
        ),
        migrations.AlterField(
            model_name='r1070alteracao',
            name='inivalid',
