...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='s1000alteracao',
            name='inddesfolha',
            field=models.IntegerField(choices=[(0, '0 - N\xe3o Aplic\xe1vel'), (1, '1 - Empresa enquadrada nos art. 7\xba a 9\xba da Lei 12.546/2011.')], null=True),
        ),
        migrations.AlterField(
            model_name='s1000alteracao',
            name='indett',
            field=models.CharField(choices=[(b'N', 'N - N\xe3o \xe9 Empresa de Trabalho Tempor\xe1rio'), (b'S', 'S - Empresa de Trabalho Tempor\xe1rio.')], max_length=1, null=True),
        ),
        migrations.AlterField(
            model_name='s1000alteracao',
            name='indoptregeletron',
            field=models.IntegerField(choices=[(0, '0 - N\xe3o optou pelo registro eletr\xf4nico de empregados'), (1, '1 - Optou pelo registro eletr\xf4nico de empregados.')], null=True),
        ),
        migrations.AlterField(
            model_name='s1000alteracao',
            name='inivalid',
        ...
        migrations.AlterField(
            model_name='s1000alteracaoinfoente',
            name='subteto',
            field=models.IntegerField(choices=[(1, '1 - Executivo'), (2, '2 - Judici\xe1rio'), (3, '3 - Legislativo'), (9, '9 - Todos os poderes.')], null=True),
        ),
        migrations.AlterField(
            model_name='s1000alteracaoinfoente',
            name='uf',
        ...
        migrations.AlterField(
            model_name='s1000alteracaoinfoop',
            name='poderop',
            field=models.IntegerField(choices=[(1, '1 - Executivo'), (2, '2 - Judici\xe1rio'), (3, '3 - Legislativo'), (4, '4 - Minist\xe9rio P\xfablico'), (5, '5 - Tribunal de Contas'), (6, '6 - Defensoria P\xfablica.')], null=True),
        ),
        migrations.AlterField(
            model_name='s1000alteracaoinfoop',
            name='vrtetorem',
        ...
        migrations.AlterField(
            ...
            name='indsitpf',
            field=models.IntegerField(choices=[(0, '0 - Situa\xe7\xe3o Normal'), (1, '1 - Encerramento de esp\xf3lio'), (2, '2 - Sa\xedda do pa\xeds em car\xe1ter permanente.')], null=True),
        ),
        migrations.AlterField(
            model_name='s1000alteracaosituacaopj',
            name='indsitpj',
            field=models.IntegerField(choices=[(0, '0 - Situa\xe7\xe3o Normal'), (1, '1 - Extin\xe7\xe3o'), (2, '2 - Fus\xe3o'), (3, '3 - Cis\xe3o'), (4, '4 - Incorpora\xe7\xe3o.')], null=True),
        ),
        migrations.AlterField(
