...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s1200_sucessaovinc.evento()
    ...
    if request.user.has_perm('s1200.can_see_s1200sucessaoVinc'):
        ...
        if request.method == 'POST':
            ...
            if s1200_sucessaovinc_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's1200-sucessaovinc' not in request.session['return_page']:
