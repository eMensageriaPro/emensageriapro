    ...
    if request.user.has_perm('r3010.can_see_r3010outrasReceitas'):
        ...
        if request.method == 'POST':
            ...
            if r3010_outrasreceitas_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 'r3010-outrasreceitas' not in request.session['return_page']:
        ...
        r3010_outrasreceitas_form = disabled_form_fields(
            r3010_outrasreceitas_form,
            request.user.has_perm('r3010.change_r3010outrasReceitas'))
