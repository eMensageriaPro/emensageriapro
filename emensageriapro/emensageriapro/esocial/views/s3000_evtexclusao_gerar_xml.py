...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s3000_evtexclusao.status in STATUS_ANT:
        ...
        if 'Signature' in xml_assinado and s3000_evtexclusao.status in STATUS_ANT:
