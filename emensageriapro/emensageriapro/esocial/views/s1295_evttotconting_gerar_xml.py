...
def gerar_xml_s1295_func(pk, versao=None):
...
def gerar_xml_s1295(request, pk, versao=None):
    ...
    return gerar_xml_s1295_func(pk, versao)
...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s1295_evttotconting.status in STATUS_ANT:
        ...
        if 'Signature' in xml_assinado and s1295_evttotconting.status in STATUS_ANT:
