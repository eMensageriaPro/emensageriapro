    ...
    if request.user.has_perm('esocial.can_see_s1298evtReabreEvPer'):
        ...
        if request.method == 'POST':
            ...
            if s1298_evtreabreevper_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's1298-evtreabreevper' not in request.session['return_page']:
                ...
                if pk != obj.id:
                    ...
                    return redirect(
                        's1298_evtreabreevper_salvar',
                        pk=obj.id)

            else:
                messages.error(request, u'Erro ao salvar!')

        s1298_evtreabreevper_form = disabled_form_fields(
             s1298_evtreabreevper_form,
             request.user.has_perm('esocial.change_s1298evtReabreEvPer'))
