...
def gerar_xml_s2299_func(pk, versao=None):
...
def gerar_xml_s2299(request, pk, versao=None):
    ...
    return gerar_xml_s2299_func(pk, versao)
...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s2299_evtdeslig.status in STATUS_ANT:
        ...
        if 'Signature' in xml_assinado and s2299_evtdeslig.status in STATUS_ANT:
