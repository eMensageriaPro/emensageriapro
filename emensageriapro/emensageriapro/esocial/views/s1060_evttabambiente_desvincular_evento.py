...
def desvincular_evento(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s1060evtTabAmbiente'):
        ...
        if s1060_evttabambiente.status in status_list:
            ...
            transmissor_lote_esocial_id = s1060_evttabambiente.transmissor_lote_esocial_id

            s1060evtTabAmbiente.objects.filter(id=pk).update(
