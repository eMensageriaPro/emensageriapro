...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if s3000_evtexclusao.status == STATUS_EVENTO_CADASTRADO:
            ...
            situacao_anterior = json.dumps(model_to_dict(s3000_evtexclusao), sort_keys=True, default=str)
        ...
        if 'return_page' in request.session and request.session['return_page'] and 's3000-evtexclusao' in request.session['return_page']:
