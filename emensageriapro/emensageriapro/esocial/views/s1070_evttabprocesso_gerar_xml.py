...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s1070_evttabprocesso.status in STATUS_ANT:
        ...
        if 'Signature' in xml_assinado and s1070_evttabprocesso.status in STATUS_ANT:
