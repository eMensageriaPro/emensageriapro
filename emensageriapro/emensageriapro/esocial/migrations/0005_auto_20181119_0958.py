    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('versao', models.CharField(choices=[(b'v02_04_02', 'Vers\xe3o 2.04.02'), (b'v02_05', 'Vers\xe3o 2.05')], default=b'v02_04_02', max_length=20)),
                ...
                ('status', models.IntegerField(choices=[(0, 'Cadastrado'), (1, 'Importado'), (10, 'XML Assinado'), (11, 'XML Gerado'), (12, 'Retorno'), (13, 'Erro - Ocorr\xeancias'), (14, 'Processado'), (15, 'Aguardando consulta'), (2, 'Duplicado'), (3, 'Erro na valida\xe7\xe3o'), (4, 'Validado'), (6, 'Aguardando envio')], default=0)),
                ...
                ('nrrecarqbase', models.CharField(default=b'A', max_length=40)),
                ('perapur', models.CharField(default=b'A', max_length=7)),
                ('tpinsc', models.IntegerField(choices=[(1, '1 - CNPJ'), (2, '2 - CPF')], default=0)),
                ('nrinsc', models.CharField(default=b'A', max_length=15)),
                ('cpftrab', models.CharField(default=b'A', max_length=11)),
                ('nistrab', models.CharField(blank=True, max_length=11, null=True)),
                ('criado_em', models.DateTimeField()),
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.BooleanField()),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s5003evtbasesfgts_criado_por', to='controle_de_acesso.Usuarios')),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s5003evtbasesfgts_modificado_por', to='controle_de_acesso.Usuarios')),
                ('retornos_eventos', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s5003evtbasesfgts_retornos_eventos', to='mensageiro.RetornosEventos')),
                ('transmissor_lote_esocial', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s5003evtbasesfgts_transmissor_lote_esocial', to='mensageiro.TransmissorLoteEsocial')),
            ],
            options={
                'ordering': ['identidade', 'nrrecarqbase', 'perapur', 'tpinsc', 'nrinsc', 'cpftrab'],
                'db_table': 's5003_evtbasesfgts',
                'managed': True,
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nrinsc', models.CharField(default=b'A', max_length=15)),
                ('nrrecarqbase', models.CharField(default=b'A', max_length=40)),
                ('indexistinfo', models.IntegerField(choices=[(1, '1 - H\xe1 informa\xe7\xf5es de FGTS'), (2, '2 - H\xe1 movimento')], default=0)),
                ('criado_em', models.DateTimeField()),
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.BooleanField()),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s5013evtfgts_criado_por', to='controle_de_acesso.Usuarios')),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s5013evtfgts_modificado_por', to='controle_de_acesso.Usuarios')),
                ('retornos_eventos', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s5013evtfgts_retornos_eventos', to='mensageiro.RetornosEventos')),
                ('transmissor_lote_esocial', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s5013evtfgts_transmissor_lote_esocial', to='mensageiro.TransmissorLoteEsocial')),
            ],
            options={
                'ordering': ['identidade', 'perapur', 'tpinsc', 'nrinsc', 'nrrecarqbase', 'indexistinfo'],
                'db_table': 's5013_evtfgts',
                'managed': True,
            },
        ),
        migrations.AlterModelOptions(
            name='s1200evtremun',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'indapuracao', 'perapur', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab']},
        ),
        migrations.AlterModelOptions(
        ...
        migrations.AlterModelOptions(
            ...
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'indapuracao', 'perapur', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpfbenef']},
        ),
        migrations.AlterModelOptions(
            name='s1210evtpgtos',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'indapuracao', 'perapur', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpfbenef']},
        ...
        migrations.AlterModelOptions(
            name='s1250evtaqprod',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'indapuracao', 'perapur', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'tpinscadq', 'nrinscadq']},
        ),
        migrations.AlterModelOptions(
            name='s1260evtcomprod',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'indapuracao', 'perapur', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'nrinscestabrural']},
        ),
        migrations.AlterModelOptions(
            name='s1270evtcontratavnp',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'indapuracao', 'perapur', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc']},
        ),
        migrations.AlterModelOptions(
        ...
        migrations.AlterModelOptions(
            ...
            options={'managed': True, 'ordering': ['identidade', 'indapuracao', 'perapur', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'evtremun', 'evtpgtos', 'evtaqprod', 'evtcomprod', 'evtcontratavnp', 'evtinfocomplper']},
        ),
        migrations.AlterModelOptions(
        ...
        migrations.AlterModelOptions(
            ...
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'nistrab', 'nmtrab', 'sexo', 'racacor', 'grauinstr', 'dtnascto', 'paisnascto', 'paisnac', 'matricula', 'tpregtrab', 'tpregprev', 'cadini', 'codcateg', 'vrsalfx', 'undsalfixo', 'tpcontr']},
        ),
        migrations.AlterModelOptions(
            name='s2205evtaltcadastral',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'dtalteracao', 'nmtrab', 'sexo', 'racacor', 'grauinstr', 'dtnascto', 'paisnascto', 'paisnac']},
        ),
        migrations.AlterModelOptions(
            name='s2206evtaltcontratual',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'nistrab', 'matricula', 'dtalteracao', 'tpregprev', 'codcateg', 'vrsalfx', 'undsalfixo', 'tpcontr']},
        ),
        migrations.AlterModelOptions(
            name='s2210evtcat',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'dtacid', 'tpacid', 'hrstrabantesacid', 'tpcat', 'indcatobito', 'indcomunpolicia', 'codsitgeradora', 'iniciatcat', 'tplocal', 'tplograd', 'dsclograd', 'nrlograd']},
        ),
        migrations.AlterModelOptions(
            name='s2220evtmonit',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'tpexameocup', 'dtaso', 'tpaso', 'resaso', 'nmmed', 'nrcrm', 'ufcrm', 'nisresp', 'nrconsclasse', 'nmresp', 'nrcrm', 'ufcrm']},
        ),
        migrations.AlterModelOptions(
            name='s2221evttoxic',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'dtexame', 'indrecusa']},
        ),
        migrations.AlterModelOptions(
            name='s2230evtafasttemp',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab']},
        ),
        migrations.AlterModelOptions(
            name='s2231evtcessao',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'nistrab', 'matricula']},
        ),
        migrations.AlterModelOptions(
            name='s2240evtexprisco',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'dtinicondicao', 'dscativdes']},
        ),
        migrations.AlterModelOptions(
            name='s2241evtinsapo',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab']},
        ...
        migrations.AlterModelOptions(
            ...
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'codtreicap']},
        ),
        migrations.AlterModelOptions(
        ...
        migrations.AlterModelOptions(
            ...
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'nistrab', 'matricula', 'codconv', 'dtinicio', 'dtfim', 'dtprevpgto', 'indlocal']},
        ),
        migrations.AlterModelOptions(
            name='s2298evtreintegr',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'nistrab', 'matricula', 'tpreint', 'dtefetretorno', 'dtefeito', 'indpagtojuizo']},
        ),
        migrations.AlterModelOptions(
            name='s2299evtdeslig',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'nistrab', 'matricula', 'mtvdeslig', 'dtdeslig', 'indpagtoapi', 'pensalim', 'indcumprparc']},
        ),
        migrations.AlterModelOptions(
            name='s2300evttsvinicio',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'nmtrab', 'sexo', 'racacor', 'grauinstr', 'dtnascto', 'paisnascto', 'paisnac', 'cadini', 'codcateg', 'dtinicio']},
        ),
        migrations.AlterModelOptions(
            name='s2306evttsvaltcontr',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'codcateg', 'dtalteracao']},
        ),
        migrations.AlterModelOptions(
            name='s2399evttsvtermino',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'codcateg', 'dtterm']},
        ),
        migrations.AlterModelOptions(
            name='s2400evtcdbenefin',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpfbenef', 'nmbenefic', 'dtinicio', 'sexo', 'racacor', 'incfismen', 'dtnascto', 'paisnac']},
        ),
        migrations.AlterModelOptions(
            name='s2405evtcdbenefalt',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpfbenef', 'dtalteracao', 'nmbenefic', 'sexo', 'racacor', 'incfismen', 'paisnac']},
        ),
        migrations.AlterModelOptions(
            name='s2410evtcdbenin',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpfbenef', 'cadini', 'nrbeneficio', 'dtinibeneficio', 'tpbeneficio', 'vrbeneficio', 'tpplanrp', 'inddecjud', 'indhomologtc']},
        ),
        migrations.AlterModelOptions(
            name='s2416evtcdbenalt',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpfbenef', 'nrbeneficio', 'dtaltbeneficio', 'tpbeneficio', 'tpplanrp', 'inddecjud', 'indhomologtc', 'indsuspensao']},
        ),
        migrations.AlterModelOptions(
            name='s2420evtcdbenterm',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpfbenef', 'nrbeneficio', 'dttermbeneficio', 'mtvtermino']},
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='pensalim',
            field=models.IntegerField(blank=True, choices=[(1, '1 - Percentual de pens\xe3o aliment\xedcia'), (2, '2 - Valor de pens\xe3o aliment\xedcia'), (3, '3 - Percentual e valor de pens\xe3o aliment\xedcia')], null=True),
        ),
        migrations.AddField(
            model_name='s2399evttsvtermino',
            name='percaliment',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=15, max_length=5, null=True),
        ),
        migrations.AddField(
            model_name='s2399evttsvtermino',
            name='vralim',
        ...
        migrations.AlterField(
            model_name='s1000evtinfoempregador',
            name='versao',
            field=models.CharField(choices=[(b'v02_04_02', 'Vers\xe3o 2.04.02'), (b'v02_05', 'Vers\xe3o 2.05')], default=b'v02_04_02', max_length=20),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s1200evtremun',
            name='indretif',
            field=models.IntegerField(choices=[(1, '1 - para arquivo original'), (2, '2 - para arquivo de retifica\xe7\xe3o')], default=0),
        ),
        migrations.AlterField(
            model_name='s1200evtremun',
            name='nrinsc',
        ...
        migrations.AlterField(
            model_name='s2200evtadmissao',
            name='racacor',
            field=models.IntegerField(choices=[(1, '1 - Branca'), (2, '2 - Negra'), (3, '3 - Parda (parda ou declarada como mulata, cabocla, cafuza, mameluca ou mesti\xe7a de negro com pessoa de outra cor ou ra\xe7a)'), (4, '4 - Amarela (de origem japonesa, chinesa, coreana etc)'), (5, '5 - Ind\xedgena'), (6, '6 - N\xe3o informado')], default=0),
        ),
        migrations.AlterField(
            model_name='s2200evtadmissao',
            name='sexo',
        ...
        migrations.AlterField(
            model_name='s2200evtadmissao',
            name='tpcontr',
            field=models.IntegerField(choices=[(1, '1 - Prazo indeterminado'), (2, '2 - Prazo determinado')], default=0),
        ),
        migrations.AlterField(
            model_name='s2200evtadmissao',
            name='tpinsc',
        ...
        migrations.AlterField(
            model_name='s2210evtcat',
            name='iniciatcat',
            field=models.IntegerField(choices=[(1, '1 - Iniciativa do Registrador (identificado em {ideRegistrador})'), (2, '2 - Ordem judicial'), (3, '3 - Determina\xe7\xe3o de \xf3rg\xe3o fiscalizador')], default=0),
        ),
        migrations.AlterField(
            model_name='s2210evtcat',
            name='nrinsc',
        ...
        migrations.AlterField(
            model_name='s5011evtcs',
            name='indexistinfo',
            field=models.IntegerField(choices=[(1, '1 - H\xe1 informa\xe7\xf5es com apura\xe7\xe3o de contribui\xe7\xf5es sociais'), (2, '2 - H\xe1 movimento por\xe9m sem apura\xe7\xe3o de contribui\xe7\xf5es sociais'), (3, '3 - N\xe3o h\xe1 movimento no per\xedodo informado em {perApur}.')], default=0),
        ),
        migrations.AlterField(
            model_name='s5011evtcs',
            name='nrinsc',
