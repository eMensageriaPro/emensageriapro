...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('esocial', '0023_auto_20190223_1123'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='s2245evttreicap',
            options={'managed': True, 'ordering': ['identidade', 'indretif', 'tpamb', 'procemi', 'verproc', 'tpinsc', 'nrinsc', 'cpftrab', 'codtreicap', 'dttreicap', 'tptreicap'], 'permissions': (('can_view_s2245_evttreicap', 'Can view s2245_evttreicap'),)},
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            ...
            name='indexistinfo',
            field=models.IntegerField(choices=[(1, '1 - H\xe1 informa\xe7\xf5es de FGTS'), (2, '2 - H\xe1 movimento')], default=0),
        ),
        migrations.AlterField(
            model_name='s5013evtfgts',
            name='nrinsc',
