# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-18 23:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='s1040alteracao',
            options={'managed': True, 'ordering': ['s1040_evttabfuncao', 'codfuncao', 'inivalid', 'dscfuncao', 'codcbo']},
        ),
        migrations.AlterModelOptions(
            name='s1040alteracaonovavalidade',
            options={'managed': True, 'ordering': ['s1040_alteracao', 'inivalid']},
        ),
        migrations.AlterModelOptions(
            name='s1040exclusao',
            options={'managed': True, 'ordering': ['s1040_evttabfuncao', 'codfuncao', 'inivalid']},
        ),
        migrations.AlterModelOptions(
            name='s1040inclusao',
            options={'managed': True, 'ordering': ['s1040_evttabfuncao', 'codfuncao', 'inivalid', 'dscfuncao', 'codcbo']},
        ...
        migrations.AlterField(
            ...
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1040alteracao_s1040_evttabfuncao', to='esocial.s1040evtTabFuncao'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1040alteracaonovavalidade_s1040_alteracao', to='s1040.s1040alteracao'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s1040exclusao',
            name='s1040_evttabfuncao',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1040exclusao_s1040_evttabfuncao', to='esocial.s1040evtTabFuncao'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s1040inclusao',
            name='s1040_evttabfuncao',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1040inclusao_s1040_evttabfuncao', to='esocial.s1040evtTabFuncao'),
        ),
    ]
