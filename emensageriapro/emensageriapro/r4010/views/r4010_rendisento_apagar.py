...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if dados_evento['status'] == STATUS_EVENTO_CADASTRADO:
            ...
            situacao_anterior = json.dumps(model_to_dict(r4010_rendisento), sort_keys=True, default=str)
        ...
        if 'return_page' in request.session and request.session['return_page'] and 'r4010-rendisento' in request.session['return_page']:
