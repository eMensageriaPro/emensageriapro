...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = r4020_infopgtoext.evento()
    ...
    if request.user.has_perm('r4020.can_see_r4020infoPgtoExt'):
        ...
        if request.method == 'POST':
            ...
            if r4020_infopgtoext_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 'r4020-infopgtoext' not in request.session['return_page']:
