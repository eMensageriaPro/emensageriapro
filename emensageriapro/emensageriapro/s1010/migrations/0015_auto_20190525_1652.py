...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='s1010alteracao',
            name='tprubr',
            field=models.IntegerField(choices=[(1, '1 - Vencimento, provento ou pens\xe3o'), (2, '2 - Desconto'), (3, '3 - Informativa'), (4, '4 - Informativa dedutora.')], null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s1010alteracaoideprocessocp',
            name='extdecisao',
            field=models.IntegerField(choices=[(1, '1 - Contribui\xe7\xe3o Previdenci\xe1ria Patronal'), (2, '2 - Contribui\xe7\xe3o Previdenci\xe1ria Patronal + Descontada dos Segurados.')], null=True),
        ),
        migrations.AlterField(
            model_name='s1010alteracaoideprocessocp',
            name='nrproc',
