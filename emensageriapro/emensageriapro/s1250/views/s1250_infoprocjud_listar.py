...
def listar(request, output=None):
    ...
    if request.user.has_perm('s1250.can_see_s1250infoProcJud'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's1250_ideprodutor__icontains': 's1250_ideprodutor__icontains',
        ...
        s1250_infoprocjud_lista = s1250infoProcJud.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s1250_ideprodutor_lista = s1250ideProdutor.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1250_infoprocjud.csv', context)
