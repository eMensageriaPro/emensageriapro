# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-18 23:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='s1050alteracao',
            options={'managed': True, 'ordering': ['s1050_evttabhortur', 'codhorcontrat', 'inivalid', 'hrentr', 'hrsaida', 'durjornada', 'perhorflexivel']},
        ),
        migrations.AlterModelOptions(
            name='s1050alteracaohorariointervalo',
            options={'managed': True, 'ordering': ['s1050_alteracao', 'tpinterv', 'durinterv']},
        ),
        migrations.AlterModelOptions(
            name='s1050alteracaonovavalidade',
            options={'managed': True, 'ordering': ['s1050_alteracao', 'inivalid']},
        ),
        migrations.AlterModelOptions(
            name='s1050exclusao',
            options={'managed': True, 'ordering': ['s1050_evttabhortur', 'codhorcontrat', 'inivalid']},
        ),
        migrations.AlterModelOptions(
            name='s1050inclusao',
            options={'managed': True, 'ordering': ['s1050_evttabhortur', 'codhorcontrat', 'inivalid', 'hrentr', 'hrsaida', 'durjornada', 'perhorflexivel']},
        ...
        migrations.AlterModelOptions(
            ...
            options={'managed': True, 'ordering': ['s1050_inclusao', 'tpinterv', 'durinterv']},
        ),
        ...
        migrations.AlterField(
            ...
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1050alteracao_s1050_evttabhortur', to='esocial.s1050evtTabHorTur'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s1050alteracaonovavalidade',
            name='s1050_alteracao',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1050alteracaonovavalidade_s1050_alteracao', to='s1050.s1050alteracao'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s1050exclusao',
            name='s1050_evttabhortur',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1050exclusao_s1050_evttabhortur', to='esocial.s1050evtTabHorTur'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s1050inclusao',
            name='s1050_evttabhortur',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1050inclusao_s1050_evttabhortur', to='esocial.s1050evtTabHorTur'),
        ),
        migrations.AlterField(
