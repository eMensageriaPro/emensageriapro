    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s2300documentos_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s2300documentos_modificado_por', to=settings.AUTH_USER_MODEL)),
                ('s2300_evttsvinicio', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300documentos_s2300_evttsvinicio', to='esocial.s2300evtTSVInicio')),
            ],
            options={
                'managed': True,
                'ordering': ['s2300_evttsvinicio'],
                'db_table': 's2300_documentos',
                'permissions': (('can_view_s2300_documentos', 'Can view s2300_documentos'),),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s2300infocomplementares_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s2300infocomplementares_modificado_por', to=settings.AUTH_USER_MODEL)),
                ('s2300_evttsvinicio', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300infocomplementares_s2300_evttsvinicio', to='esocial.s2300evtTSVInicio')),
            ],
            options={
                'managed': True,
                'ordering': ['s2300_evttsvinicio'],
                'db_table': 's2300_infocomplementares',
                'permissions': (('can_view_s2300_infocomplementares', 'Can view s2300_infocomplementares'),),
            },
        ),
        migrations.AlterModelOptions(
            name='s2300cargofuncao',
            options={'managed': True, 'ordering': ['s2300_infocomplementares', 'codcargo'], 'permissions': (('can_view_s2300_cargofuncao', 'Can view s2300_cargofuncao'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300cnh',
            options={'managed': True, 'ordering': ['s2300_documentos', 'nrregcnh', 'ufcnh', 'dtvalid', 'categoriacnh'], 'permissions': (('can_view_s2300_cnh', 'Can view s2300_cnh'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300ctps',
            options={'managed': True, 'ordering': ['s2300_documentos', 'nrctps', 'seriectps', 'ufctps'], 'permissions': (('can_view_s2300_ctps', 'Can view s2300_ctps'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300fgts',
            options={'managed': True, 'ordering': ['s2300_infocomplementares', 'opcfgts'], 'permissions': (('can_view_s2300_fgts', 'Can view s2300_fgts'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300infodirigentesindical',
            options={'managed': True, 'ordering': ['s2300_infocomplementares', 'categorig'], 'permissions': (('can_view_s2300_infodirigentesindical', 'Can view s2300_infodirigentesindical'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300infoestagiario',
            options={'managed': True, 'ordering': ['s2300_infocomplementares', 'natestagio', 'nivestagio', 'dtprevterm', 'nmrazao'], 'permissions': (('can_view_s2300_infoestagiario', 'Can view s2300_infoestagiario'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300infotrabcedido',
            options={'managed': True, 'ordering': ['s2300_infocomplementares', 'categorig', 'cnpjcednt', 'matricced', 'dtadmced', 'tpregtrab', 'tpregprev', 'infonus'], 'permissions': (('can_view_s2300_infotrabcedido', 'Can view s2300_infotrabcedido'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300oc',
            options={'managed': True, 'ordering': ['s2300_documentos', 'nroc', 'orgaoemissor'], 'permissions': (('can_view_s2300_oc', 'Can view s2300_oc'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300remuneracao',
            options={'managed': True, 'ordering': ['s2300_infocomplementares', 'vrsalfx', 'undsalfixo'], 'permissions': (('can_view_s2300_remuneracao', 'Can view s2300_remuneracao'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300rg',
            options={'managed': True, 'ordering': ['s2300_documentos', 'nrrg', 'orgaoemissor'], 'permissions': (('can_view_s2300_rg', 'Can view s2300_rg'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300ric',
            options={'managed': True, 'ordering': ['s2300_documentos', 'nrric', 'orgaoemissor'], 'permissions': (('can_view_s2300_ric', 'Can view s2300_ric'),)},
        ),
        migrations.AlterModelOptions(
            name='s2300rne',
            options={'managed': True, 'ordering': ['s2300_documentos', 'nrrne', 'orgaoemissor'], 'permissions': (('can_view_s2300_rne', 'Can view s2300_rne'),)},
        ),
        ...
        migrations.AlterField(
            model_name='s2300mudancacpf',
            name='s2300_evttsvinicio',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300mudancacpf_s2300_evttsvinicio', to='esocial.s2300evtTSVInicio'),
        ),
        migrations.AlterField(
            model_name='s2300oc',
            name='nroc',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300cargofuncao_s2300_infocomplementares', to='s2300.s2300infoComplementares'),
        ),
        migrations.AddField(
            model_name='s2300cnh',
            name='s2300_documentos',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300cnh_s2300_documentos', to='s2300.s2300documentos'),
        ),
        migrations.AddField(
            model_name='s2300ctps',
            name='s2300_documentos',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300ctps_s2300_documentos', to='s2300.s2300documentos'),
        ),
        migrations.AddField(
            model_name='s2300fgts',
            name='s2300_infocomplementares',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300fgts_s2300_infocomplementares', to='s2300.s2300infoComplementares'),
        ),
        migrations.AddField(
            model_name='s2300infodirigentesindical',
            name='s2300_infocomplementares',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300infodirigentesindical_s2300_infocomplementares', to='s2300.s2300infoComplementares'),
        ),
        migrations.AddField(
            model_name='s2300infoestagiario',
            name='s2300_infocomplementares',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300infoestagiario_s2300_infocomplementares', to='s2300.s2300infoComplementares'),
        ),
        migrations.AddField(
            model_name='s2300infotrabcedido',
            name='s2300_infocomplementares',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300infotrabcedido_s2300_infocomplementares', to='s2300.s2300infoComplementares'),
        ),
        migrations.AddField(
            model_name='s2300oc',
            name='s2300_documentos',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300oc_s2300_documentos', to='s2300.s2300documentos'),
        ),
        migrations.AddField(
            model_name='s2300remuneracao',
            name='s2300_infocomplementares',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300remuneracao_s2300_infocomplementares', to='s2300.s2300infoComplementares'),
        ),
        migrations.AddField(
            model_name='s2300rg',
            name='s2300_documentos',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300rg_s2300_documentos', to='s2300.s2300documentos'),
        ),
        migrations.AddField(
            model_name='s2300ric',
            name='s2300_documentos',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300ric_s2300_documentos', to='s2300.s2300documentos'),
        ),
        migrations.AddField(
            model_name='s2300rne',
            name='s2300_documentos',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2300rne_s2300_documentos', to='s2300.s2300documentos'),
        ),
    ]
