...
def criar_alteracao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_create_change_r9012evtRetCons'):
        ...
        dados = read_r9012_evtretcons_string(request, {}, texto.encode('utf-8'), 0)
        ...
        gravar_auditoria(u'{}',
            u'{"funcao": "Evento de de alteração de identidade %s criado a partir da duplicação do evento %s"}' % (nova_identidade, r9012_evtretcons.identidade),
        ...
        return redirect('r9012_evtretcons_salvar', pk=return_pk)
