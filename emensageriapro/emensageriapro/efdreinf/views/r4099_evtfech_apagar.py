...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if r4099_evtfech.status == STATUS_EVENTO_CADASTRADO:
            ...
            situacao_anterior = json.dumps(model_to_dict(r4099_evtfech), sort_keys=True, default=str)
        ...
        if 'return_page' in request.session and request.session['return_page'] and 'r4099-evtfech' in request.session['return_page']:
