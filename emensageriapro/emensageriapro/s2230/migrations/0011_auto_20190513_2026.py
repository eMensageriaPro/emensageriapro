...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2230emitente_s2230_infoatestado', to='s2230.s2230infoAtestado'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2230fimafastamento_s2230_evtafasttemp', to='esocial.s2230evtAfastTemp'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s2230infocessao',
            name='s2230_iniafastamento',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2230infocessao_s2230_iniafastamento', to='s2230.s2230iniAfastamento'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s2230infomandsind',
            name='s2230_iniafastamento',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2230infomandsind_s2230_iniafastamento', to='s2230.s2230iniAfastamento'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s2230inforetif',
            name='s2230_evtafasttemp',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2230inforetif_s2230_evtafasttemp', to='esocial.s2230evtAfastTemp'),
        ),
        migrations.AlterField(
            model_name='s2230inforetif',
            name='tpproc',
            field=models.IntegerField(blank=True, choices=[(1, '1 - Administrativo'), (2, '2 - Judicial'), (3, '3 - N\xfamero de Benef\xedcio (NB) do INSS.')], null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s2230iniafastamento',
            name='s2230_evtafasttemp',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2230iniafastamento_s2230_evtafasttemp', to='esocial.s2230evtAfastTemp'),
        ),
        migrations.AlterField(
            model_name='s2230iniafastamento',
            name='tpacidtransito',
            field=models.IntegerField(blank=True, choices=[(1, '1 - Atropelamento'), (2, '2 - Colis\xe3o'), (3, '3 - Outros.')], null=True),
        ),
    ]
