...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if dados_evento['status'] == STATUS_EVENTO_CADASTRADO:
            ...
            obj = s5001ideEstabLot.objects.get(id=pk)
        ...
        if 's5001_ideestablot' in request.session['return_page']:
        
            return redirect('s5001_ideestablot')
