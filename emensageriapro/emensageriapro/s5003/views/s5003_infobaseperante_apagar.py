...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if dados_evento['status'] == STATUS_EVENTO_CADASTRADO:
            ...
            obj = s5003infoBasePerAntE.objects.get(id=pk)
        ...
        if 's5003_infobaseperante' in request.session['return_page']:
        
            return redirect('s5003_infobaseperante')
    ...
    return render(request, 
                  's5003_infobaseperante_apagar.html', 
                  context)