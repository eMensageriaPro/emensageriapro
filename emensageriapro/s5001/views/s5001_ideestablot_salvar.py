...
def salvar(request, hash):
    ...
    if s5001_ideestablot_id:
        ...
        s5001_ideestablot = get_object_or_404(s5001ideEstabLot, id=s5001_ideestablot_id)
        dados_evento = s5001_ideestablot.evento()

    if request.user.has_perm('s5001.can_view_s5001ideEstabLot'):
        ...
        s5001_ideestablot_form = disabled_form_fields(s5001_ideestablot_form, request.user.has_perm('s5001.change_s5001ideEstabLot'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5001_ideestablot_id, tabela='s5001_ideestablot').all()
