...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5001_ideestablot')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s5001_ideestablot_id:
            s5001_ideestablot_form = form_s5001_ideestablot(request.POST or None, instance = s5001_ideestablot,  
