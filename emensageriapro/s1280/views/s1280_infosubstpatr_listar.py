...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1280_infosubstpatr')
    ...
    if permissao.permite_listar:
        ...
        s1280_infosubstpatr_lista = s1280infoSubstPatr.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1280_infosubstpatr_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1280_infosubstpatr.csv', context)
