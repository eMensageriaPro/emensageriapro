...
def salvar(request, hash):
    ...
    if s1280_infoativconcom_id:
        ...
        s1280_infoativconcom = get_object_or_404(s1280infoAtivConcom, id=s1280_infoativconcom_id)
        dados_evento = s1280_infoativconcom.evento()

    if request.user.has_perm('s1280.can_view_s1280infoAtivConcom'):
        ...
        if request.method == 'POST':
            ...
            if s1280_infoativconcom_form.is_valid():
                ...
                if not s1280_infoativconcom_id:
        ...
        s1280_infoativconcom_form = disabled_form_fields(s1280_infoativconcom_form, request.user.has_perm('s1280.change_s1280infoAtivConcom'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1280_infoativconcom_id, tabela='s1280_infoativconcom').all()
