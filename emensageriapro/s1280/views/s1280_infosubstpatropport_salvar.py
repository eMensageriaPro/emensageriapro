...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s1280_infosubstpatropport.evento()
    ...
    if request.user.has_perm('s1280.can_see_s1280infoSubstPatrOpPort'):
        ...
        if request.method == 'POST':
            ...
            if s1280_infosubstpatropport_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's1280-infosubstpatropport' not in request.session['return_page']:
