...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r9011_infototalcontrib = get_object_or_404(r9011infoTotalContrib, id=pk)
        evento_dados = r9011_infototalcontrib.evento()
    ...
    if request.user.has_perm('r9011.can_see_r9011infoTotalContrib'):
        ...
        if pk:
            ...
            r9011_infototalcontrib_form = form_r9011_infototalcontrib(
                ...
                instance=r9011_infototalcontrib)
        ...
        if request.method == 'POST':
            ...
            if r9011_infototalcontrib_form.is_valid():
                ...
                if not pk:
                    ...
                    gravar_auditoria(
                        json.dumps(
                            model_to_dict(r9011_infototalcontrib), 
                            indent=4, 
                            sort_keys=True, 
                            default=str),
                        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r9011_infototalcontrib_apagar', 
                    'r9011_infototalcontrib_salvar', 
                    'r9011_infototalcontrib'):
        ...
        r9011_infototalcontrib_form = disabled_form_fields(
            r9011_infototalcontrib_form, 
            request.user.has_perm('r9011.change_r9011infoTotalContrib'))
        ...
        if tab or 'r9011_infototalcontrib' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r9011_infototalcontrib_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r9011_infototalcontrib').all()
