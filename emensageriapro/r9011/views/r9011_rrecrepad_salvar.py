...
def salvar(request, hash):
    ...
    if request.user.has_perm('r9011.can_view_r9011RRecRepAD'):
        ...
        r9011_rrecrepad_form = disabled_form_fields(r9011_rrecrepad_form, request.user.has_perm('r9011.change_r9011RRecRepAD'))
