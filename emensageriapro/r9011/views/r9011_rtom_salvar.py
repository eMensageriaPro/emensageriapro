...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r9011_rtom = get_object_or_404(r9011RTom, id=pk)
        evento_dados = r9011_rtom.evento()
    ...
    if request.user.has_perm('r9011.can_see_r9011RTom'):
        ...
        r9011_rtom_form = disabled_form_fields(
            r9011_rtom_form, 
            request.user.has_perm('r9011.change_r9011RTom'))
        ...
        if tab or 'r9011_rtom' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r9011_rtom_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r9011_rtom').all()
