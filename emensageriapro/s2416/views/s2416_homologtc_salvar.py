...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        s2416_homologtc = get_object_or_404(s2416homologTC, id=pk)
        evento_dados = s2416_homologtc.evento()
    ...
    if request.user.has_perm('s2416.can_see_s2416homologTC'):
        ...
        if pk:
            ...
            s2416_homologtc_form = form_s2416_homologtc(
                ...
                instance=s2416_homologtc)
                                         
        else:
        
            s2416_homologtc_form = form_s2416_homologtc(request.POST or None)
        ...
        if request.method == 'POST':
            ...
            if s2416_homologtc_form.is_valid():
                ...
                if request.session['return_page'] not in (
                    's2416_homologtc_apagar', 
                    's2416_homologtc_salvar', 
                    's2416_homologtc'):
        ...
        s2416_homologtc_form = disabled_form_fields(
            s2416_homologtc_form, 
            request.user.has_perm('s2416.change_s2416homologTC'))
        ...
        if tab or 's2416_homologtc' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 's2416_homologtc_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='s2416_homologtc').all()
