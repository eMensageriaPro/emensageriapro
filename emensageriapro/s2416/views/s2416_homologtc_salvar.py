...
def salvar(request, hash):
    ...
    if s2416_homologtc_id:
        ...
        s2416_homologtc = get_object_or_404(s2416homologTC, id=s2416_homologtc_id)
        dados_evento = s2416_homologtc.evento()

    if request.user.has_perm('s2416.can_view_s2416homologTC'):
        ...
        s2416_homologtc_form = disabled_form_fields(s2416_homologtc_form, request.user.has_perm('s2416.change_s2416homologTC'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2416_homologtc_id, tabela='s2416_homologtc').all()
