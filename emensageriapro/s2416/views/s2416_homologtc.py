...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s2416homologTC.objects.using( db_slug ).filter(id = s2416_homologtc_id).delete()
            ...
            if s2416_homologtc_form.is_valid():
                ...
                if s2416_homologtc_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s2416_homologtc_campos_multiple_passo1
                        s2416homologTC.objects.using(db_slug).filter(id=s2416_homologtc_id).update(**dados)
                        obj = s2416homologTC.objects.using(db_slug).get(id=s2416_homologtc_id)
                        #s2416_homologtc_editar_custom
                        #s2416_homologtc_campos_multiple_passo2
                    ...
                    #s2416_homologtc_cadastrar_campos_multiple_passo1
                    obj = s2416homologTC(**dados)
                    obj.save(using = db_slug)
                    #s2416_homologtc_cadastrar_custom
                    #s2416_homologtc_cadastrar_campos_multiple_passo2
