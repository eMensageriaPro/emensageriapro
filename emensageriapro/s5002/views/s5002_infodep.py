            ...
            if s5002_infodep_form.is_valid():
                ...
                if s5002_infodep_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s5002_infodep_campos_multiple_passo1
                        s5002infoDep.objects.using(db_slug).filter(id=s5002_infodep_id).update(**dados)
                        obj = s5002infoDep.objects.using(db_slug).get(id=s5002_infodep_id)
                        #s5002_infodep_editar_custom
                        #s5002_infodep_campos_multiple_passo2
                    ...
                    #s5002_infodep_cadastrar_campos_multiple_passo1
                    obj = s5002infoDep(**dados)
                    obj.save(using = db_slug)
                    #s5002_infodep_cadastrar_custom
                    #s5002_infodep_cadastrar_campos_multiple_passo2
...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s5002infoDep.objects.using( db_slug ).filter(id = s5002_infodep_id).delete()
