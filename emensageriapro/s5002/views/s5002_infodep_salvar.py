...
def salvar(request, hash):
    ...
    if s5002_infodep_id:
        ...
        s5002_infodep = get_object_or_404(s5002infoDep, id=s5002_infodep_id)
        dados_evento = s5002_infodep.evento()

    if request.user.has_perm('s5002.can_view_s5002infoDep'):
        ...
        s5002_infodep_form = disabled_form_fields(s5002_infodep_form, request.user.has_perm('s5002.change_s5002infoDep'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5002_infodep_id, tabela='s5002_infodep').all()
