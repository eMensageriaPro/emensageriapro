...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if request.user.has_perm('r4010.can_see_r4010rendIsento'):
        ...
        if request.method == 'POST':
            ...
            if r4010_rendisento_form.is_valid():
                ...
                if not pk:
                    ...
                    gravar_auditoria(
                        json.dumps(
                            model_to_dict(r4010_rendisento), 
                            indent=4, 
                            sort_keys=True, 
                            default=str),
                        json.dumps(
        ...
        if tab or 'r4010_rendisento' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r4010_rendisento_salvar'
