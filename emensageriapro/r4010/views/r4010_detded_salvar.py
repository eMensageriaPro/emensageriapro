...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r4010_detded = get_object_or_404(r4010detDed, id=pk)
        evento_dados = r4010_detded.evento()
    ...
    if request.user.has_perm('r4010.can_see_r4010detDed'):
        ...
        if request.method == 'POST':
            ...
            if r4010_detded_form.is_valid():
                ...
                if 'r4010-detded' not in request.session['return']:
        ...
        r4010_detded_form = disabled_form_fields(
            r4010_detded_form,
            request.user.has_perm('r4010.change_r4010detDed'))
        ...
        #if tab or 'r4010_detded' in request.session['return_page']:
        #
        #    request.session['return_pk'] = pk
        #    request.session['return_tab'] = tab
        #    request.session['return_page'] = 'r4010_detded_salvar'

        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r4010_detded').all()
