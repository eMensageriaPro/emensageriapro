...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r4010_detded_id:
            r4010_detded_form = form_r4010_detded(request.POST or None, instance = r4010_detded,  
        ...
        r4010_detded_form = disabled_form_fields(r4010_detded_form, permissao.permite_editar)
