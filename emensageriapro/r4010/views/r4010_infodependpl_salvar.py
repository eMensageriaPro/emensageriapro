...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = r4010_infodependpl.evento()
    ...
    if request.user.has_perm('r4010.can_see_r4010infoDependPl'):
        ...
        if request.method == 'POST':
            ...
            if r4010_infodependpl_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 'r4010-infodependpl' not in request.session['return_page']:
