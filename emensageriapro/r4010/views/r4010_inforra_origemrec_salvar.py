...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r4010_inforra_origemrec_id:
            r4010_inforra_origemrec_form = form_r4010_inforra_origemrec(request.POST or None, instance = r4010_inforra_origemrec,  
        ...
        r4010_inforra_origemrec_form = disabled_form_fields(r4010_inforra_origemrec_form, permissao.permite_editar)
        
        if r4010_inforra_origemrec_id:
            if dados_evento['status'] != 0:
                r4010_inforra_origemrec_form = disabled_form_fields(r4010_inforra_origemrec_form, 0)
        ...
        if r4010_inforra_origemrec_id:
            ...
            r4010_inforra_origemrec = None
            
        #r4010_inforra_origemrec_salvar_custom_variaveis#
        tabelas_secundarias = []
