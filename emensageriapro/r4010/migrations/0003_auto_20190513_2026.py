    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vlrdespcustas', models.DecimalField(decimal_places=2, default=0, max_digits=15)),
                ('vlrdespadvogados', models.DecimalField(decimal_places=2, default=0, max_digits=15)),
                ('criado_em', models.DateTimeField(blank=True, null=True)),
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjuddespprocjud_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjuddespprocjud_modificado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'managed': True,
                'ordering': ['r4010_infoprocjud', 'vlrdespcustas', 'vlrdespadvogados'],
                'db_table': 'r4010_infoprocjud_despprocjud',
                'permissions': (('can_view_r4010_infoprocjud_despprocjud', 'Can view r4010_infoprocjud_despprocjud'),),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tpinscadv', models.IntegerField(choices=[(1, '1 - Pessoa F\xedsica'), (2, '2 - Pessoa Jur\xeddica.')], default=0)),
                ('nrinscadv', models.CharField(default=b'A', max_length=14)),
                ('vlradv', models.DecimalField(decimal_places=2, default=0, max_digits=15)),
                ('criado_em', models.DateTimeField(blank=True, null=True)),
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjudideadv_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjudideadv_modificado_por', to=settings.AUTH_USER_MODEL)),
                ('r4010_infoprocjud_despprocjud', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjudideadv_r4010_infoprocjud_despprocjud', to='r4010.r4010infoProcJuddespProcJud')),
            ],
            options={
                'managed': True,
                'ordering': ['r4010_infoprocjud_despprocjud', 'tpinscadv', 'nrinscadv', 'vlradv'],
                'db_table': 'r4010_infoprocjud_ideadv',
                'permissions': (('can_view_r4010_infoprocjud_ideadv', 'Can view r4010_infoprocjud_ideadv'),),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjudorigemrec_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjudorigemrec_modificado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'managed': True,
                'ordering': ['r4010_infoprocjud', 'cnpjorigrecurso'],
                'db_table': 'r4010_infoprocjud_origemrec',
                'permissions': (('can_view_r4010_infoprocjud_origemrec', 'Can view r4010_infoprocjud_origemrec'),),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforradespprocjud_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforradespprocjud_modificado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'managed': True,
                'ordering': ['r4010_inforra', 'vlrdespcustas', 'vlrdespadvogados'],
                'db_table': 'r4010_inforra_despprocjud',
                'permissions': (('can_view_r4010_inforra_despprocjud', 'Can view r4010_inforra_despprocjud'),),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforraideadv_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforraideadv_modificado_por', to=settings.AUTH_USER_MODEL)),
                ('r4010_inforra_despprocjud', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforraideadv_r4010_inforra_despprocjud', to='r4010.r4010infoRRAdespProcJud')),
            ],
            options={
                'managed': True,
                'ordering': ['r4010_inforra_despprocjud', 'tpinscadv', 'nrinscadv', 'vlradv'],
                'db_table': 'r4010_inforra_ideadv',
                'permissions': (('can_view_r4010_inforra_ideadv', 'Can view r4010_inforra_ideadv'),),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(blank=True, null=True)),
                ('excluido', models.NullBooleanField(default=False)),
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforraorigemrec_criado_por', to=settings.AUTH_USER_MODEL)),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforraorigemrec_modificado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'managed': True,
                'ordering': ['r4010_inforra', 'cnpjorigrecurso'],
                'db_table': 'r4010_inforra_origemrec',
                'permissions': (('can_view_r4010_inforra_origemrec', 'Can view r4010_inforra_origemrec'),),
            },
        ),
        ...
        migrations.AlterField(
            model_name='r4010benefpen',
            name='reldep',
            field=models.IntegerField(choices=[(1, '1 - Neto, bisneto'), (2, '2 - Irm\xe3o'), (3, '3 - C\xf4njuge/companheiro'), (4, '4 - Filho'), (5, '5 - Pais, av\xf3s e bisav\xf3s'), (6, '6 - Enteado'), (7, '7 - Sogro'), (99, '99 - Agregado/Outros.')], default=0),
        ),
        migrations.AlterField(
            model_name='r4010detded',
            name='indtpdeducao',
            field=models.IntegerField(choices=[(1, '1 - Previd\xeancia Oficial'), (2, '2 - Previd\xeancia Privada'), (3, '3 - Fapi'), (4, '4 - Funpresp'), (5, '5 - Pens\xe3o Aliment\xedcia'), (6, '6 - Contribui\xe7\xe3o do ente p\xfablico patrocinador'), (7, '7 - Dependentes.')], default=0),
        ),
        migrations.AlterField(
            model_name='r4010detded',
            name='r4010_infopgto',
        ...
        migrations.AlterField(
            model_name='r4010fci',
            name='r4010_infopgto',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010fci_r4010_infopgto', to='r4010.r4010infoPgto'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='r4010ideopsaude',
            name='r4010_evtretpf',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010ideopsaude_r4010_evtretpf', to='efdreinf.r4010evtRetPF'),
        ),
        migrations.AlterField(
            model_name='r4010ideopsaude',
            name='vlrsaude',
        ...
        migrations.AlterField(
            model_name='r4010idepgto',
            name='r4010_evtretpf',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010idepgto_r4010_evtretpf', to='efdreinf.r4010evtRetPF'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infodependpl_r4010_ideopsaude', to='r4010.r4010ideOpSaude'),
        ),
        migrations.AlterField(
            model_name='r4010infodependpl',
            name='reldep',
        ...
        migrations.AlterField(
            model_name='r4010infopgto',
            name='r4010_idepgto',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infopgto_r4010_idepgto', to='r4010.r4010idePgto'),
        ),
        migrations.AlterField(
            model_name='r4010infopgto',
            name='vlrcompanoant',
        ...
        migrations.AlterField(
            model_name='r4010infopgtoext',
            name='r4010_idepgto',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infopgtoext_r4010_idepgto', to='r4010.r4010idePgto'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='r4010infoprocjud',
            name='r4010_infopgto',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjud_r4010_infopgto', to='r4010.r4010infoPgto'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='r4010infoprocret',
            name='r4010_infopgto',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocret_r4010_infopgto', to='r4010.r4010infoPgto'),
        ),
        migrations.AlterField(
            model_name='r4010infoprocret',
            name='tpprocret',
        ...
        migrations.AlterField(
            model_name='r4010inforeemb',
            name='r4010_ideopsaude',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforeemb_r4010_ideopsaude', to='r4010.r4010ideOpSaude'),
        ),
        migrations.AlterField(
            model_name='r4010inforeemb',
            name='tpinsc',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforeembdep_r4010_infodependpl', to='r4010.r4010infoDependPl'),
        ),
        migrations.AlterField(
            model_name='r4010inforeembdep',
            name='tpinsc',
        ...
        migrations.AlterField(
            model_name='r4010inforra',
            name='r4010_infopgto',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforra_r4010_infopgto', to='r4010.r4010infoPgto'),
        ),
        migrations.AlterField(
            model_name='r4010inforra',
            name='tpprocrra',
        ...
        migrations.AlterField(
            model_name='r4010scp',
            name='r4010_infopgto',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010scp_r4010_infopgto', to='r4010.r4010infoPgto'),
        ),
        ...
        migrations.AddField(
            ...
            name='r4010_inforra',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforraorigemrec_r4010_inforra', to='r4010.r4010infoRRA'),
        ),
        migrations.AddField(
            model_name='r4010inforradespprocjud',
            name='r4010_inforra',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010inforradespprocjud_r4010_inforra', to='r4010.r4010infoRRA'),
        ),
        migrations.AddField(
            model_name='r4010infoprocjudorigemrec',
            name='r4010_infoprocjud',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjudorigemrec_r4010_infoprocjud', to='r4010.r4010infoProcJud'),
        ),
        migrations.AddField(
            model_name='r4010infoprocjuddespprocjud',
            name='r4010_infoprocjud',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='r4010infoprocjuddespprocjud_r4010_infoprocjud', to='r4010.r4010infoProcJud'),
        ),
    ]
