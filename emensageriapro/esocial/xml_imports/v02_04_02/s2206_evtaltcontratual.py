...
def read_s2206_evtaltcontratual(dados, arquivo, validar=False):
    ...
    if validar:
        s2206_evtaltcontratual_dados['status'] = 1
    else:
        s2206_evtaltcontratual_dados['status'] = 0
    s2206_evtaltcontratual_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % s2206_evtaltcontratual_dados['identidade'], True)
    ...
    dados['evento'] = 's2206'
    dados['identidade'] = s2206_evtaltcontratual_id
