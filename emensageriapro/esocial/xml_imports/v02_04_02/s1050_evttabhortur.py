...
def read_s1050_evttabhortur(dados, arquivo, validar=False):
    ...
    if validar:
        s1050_evttabhortur_dados['status'] = 1
    else:
        s1050_evttabhortur_dados['status'] = 0
    s1050_evttabhortur_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % s1050_evttabhortur_dados['identidade'], True)
    ...
    dados['evento'] = 's1050'
    dados['identidade'] = s1050_evttabhortur_id
