...
def read_s2240_evtexprisco(dados, arquivo, validar=False):
    ...
    if validar:
        s2240_evtexprisco_dados['status'] = 1
    else:
        s2240_evtexprisco_dados['status'] = 0
    s2240_evtexprisco_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % s2240_evtexprisco_dados['identidade'], True)
    ...
    dados['evento'] = 's2240'
    dados['identidade'] = s2240_evtexprisco_id
