...
def read_s1207_evtbenprrp(dados, arquivo, validar=False):
    ...
    if validar:
        s1207_evtbenprrp_dados['status'] = 1
    else:
        s1207_evtbenprrp_dados['status'] = 0
    s1207_evtbenprrp_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % s1207_evtbenprrp_dados['identidade'], True)
    ...
    dados['evento'] = 's1207'
    dados['identidade'] = s1207_evtbenprrp_id
