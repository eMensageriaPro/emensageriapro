...
def read_s1200_evtremun(dados, arquivo, validar=False):
    ...
    if validar:
        s1200_evtremun_dados['status'] = 1
    else:
        s1200_evtremun_dados['status'] = 0
    s1200_evtremun_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % s1200_evtremun_dados['identidade'], True)
    ...
    dados['evento'] = 's1200'
    dados['identidade'] = s1200_evtremun_id
