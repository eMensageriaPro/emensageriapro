...
def read_s2400_evtcdbenprrp_obj(doc):
    s2400_evtcdbenprrp_dados = {}
    s2400_evtcdbenprrp_dados['versao'] = 'v02_04_02'
    s2400_evtcdbenprrp_dados['status'] = 12
    ...
    dados = s2400_evtcdbenprrp_dados
    dados['evento'] = 's2400'
    dados['id'] = s2400_evtcdbenprrp_id
