...
def read_s2399_evttsvtermino(dados, arquivo, validar=False):
    ...
    if validar:
        s2399_evttsvtermino_dados['status'] = 1
    else:
        s2399_evttsvtermino_dados['status'] = 0
    s2399_evttsvtermino_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % s2399_evttsvtermino_dados['identidade'], True)
    ...
    dados['evento'] = 's2399'
    dados['identidade'] = s2399_evttsvtermino_id
