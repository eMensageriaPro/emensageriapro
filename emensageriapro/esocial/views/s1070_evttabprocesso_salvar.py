...
def salvar(request, hash):
    ...
    if request.user.has_perm('esocial.can_view_s1070evtTabProcesso'):
        ...
        s1070_evttabprocesso_form = disabled_form_fields(s1070_evttabprocesso_form, request.user.has_perm('esocial.change_s1070evtTabProcesso'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1070_evttabprocesso_id, tabela='s1070_evttabprocesso').all()
