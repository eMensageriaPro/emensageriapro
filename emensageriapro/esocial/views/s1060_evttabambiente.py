...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if not evento_totalizador:
            ...
            s1060_evttabambiente_form.fields['status'].widget.attrs['disabled'] = True
            s1060_evttabambiente_form.fields['status'].widget.attrs['readonly'] = True
            s1060_evttabambiente_form.fields['transmissor_lote_esocial'].widget.attrs['disabled'] = True
