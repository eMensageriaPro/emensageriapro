...
def gerar_identidade(request, chave, evento_id):
    ...
    if chave == PASS_SCRIPT:
        db_slug = 'default'
        obj = get_object_or_404(s1060evtTabAmbiente.objects.using( db_slug ), excluido = False, id = evento_id)
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1060_evttabambiente_id:
            ...
            s1060_evttabambiente_form = form_s1060_evttabambiente(request.POST or None, slug = db_slug,
