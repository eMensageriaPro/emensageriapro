...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'esocial/%s/evtCdBenTerm.xsd' % (s2420_evtcdbenterm.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 's2420_evtcdbenterm' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('s2420_evtcdbenterm', pk)
