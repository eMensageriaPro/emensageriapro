...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s2400_evtcdbenefin.status in STATUS_ANT:
        ...
        if not s2400_evtcdbenefin.transmissor_lote_esocial:
        ...
        if 'Signature' in xml_assinado and s2400_evtcdbenefin.status in STATUS_ANT:
