...
def criar_alteracao(request, pk):
    ...
    from emensageriapro.esocial.views.s5001_evtbasestrab_gerar_xml import gerar_xml_s5001
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('esocial.can_create_change_s5001evtBasesTrab'):
        ...
        return redirect('s5001_evtbasestrab_salvar', pk=return_pk, tab='master')
