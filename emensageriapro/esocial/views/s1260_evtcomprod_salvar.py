...
def salvar(request, hash):
    ...
    if s1260_evtcomprod_id:
        ...
        s1260_evtcomprod = get_object_or_404(s1260evtComProd, id=s1260_evtcomprod_id)
    ...
    if request.user.has_perm('esocial.can_view_s1260evtComProd'):
        ...
        s1260_evtcomprod_form = disabled_form_fields(s1260_evtcomprod_form, request.user.has_perm('esocial.change_s1260evtComProd'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1260_evtcomprod_id, tabela='s1260_evtcomprod').all()
