...
def gerar_xml_s1070(request, s1070_evttabprocesso_id, versao=None):
    ...
    if s1070_evttabprocesso_id:
        ...
        s1070_evttabprocesso_lista = s1070evtTabProcesso.objects. \
            filter(id=s1070_evttabprocesso_id, excluido = False).all()
...
def gerar_xml_assinado(request, s1070_evttabprocesso_id):
    ...
    if s1070_evttabprocesso.arquivo_original:
        ...
        xml = gerar_xml_s1070(request, s1070_evttabprocesso_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_esocial(request, xml, s1070_evttabprocesso.transmissor_lote_esocial_id)
    ...
    if s1070_evttabprocesso.status in (
        ...
        s1070evtTabProcesso.objects.\
            filter(id=s1070_evttabprocesso_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s1070_evttabprocesso_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s1070_evttabprocesso_id)
