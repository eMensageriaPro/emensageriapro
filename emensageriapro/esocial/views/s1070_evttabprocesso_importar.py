...
def read_s1070_evttabprocesso_obj(doc, status, validar=False):
    ...
    try: s1070_evttabprocesso_dados['tpamb'] = evtTabProcesso.ideEvento.tpAmb.cdata
    except AttributeError: pass
    try: s1070_evttabprocesso_dados['procemi'] = evtTabProcesso.ideEvento.procEmi.cdata
    except AttributeError: pass
    try: s1070_evttabprocesso_dados['verproc'] = evtTabProcesso.ideEvento.verProc.cdata
    except AttributeError: pass
    try: s1070_evttabprocesso_dados['tpinsc'] = evtTabProcesso.ideEmpregador.tpInsc.cdata
    except AttributeError: pass
    try: s1070_evttabprocesso_dados['nrinsc'] = evtTabProcesso.ideEmpregador.nrInsc.cdata
    except AttributeError: pass
    ...
    if 'inclusao' in dir(evtTabProcesso.infoProcesso) and evtTabProcesso.infoProcesso.inclusao.cdata != '':
        for inclusao in evtTabProcesso.infoProcesso.inclusao:
            ...
            try: s1070_inclusao_dados['tpproc'] = inclusao.ideProcesso.tpProc.cdata
            except AttributeError: pass
            try: s1070_inclusao_dados['nrproc'] = inclusao.ideProcesso.nrProc.cdata
            except AttributeError: pass
            try: s1070_inclusao_dados['inivalid'] = inclusao.ideProcesso.iniValid.cdata
            except AttributeError: pass
            try: s1070_inclusao_dados['fimvalid'] = inclusao.ideProcesso.fimValid.cdata
            except AttributeError: pass
            try: s1070_inclusao_dados['indautoria'] = inclusao.dadosProc.indAutoria.cdata
            except AttributeError: pass
            try: s1070_inclusao_dados['indmatproc'] = inclusao.dadosProc.indMatProc.cdata
            except AttributeError: pass
            try: s1070_inclusao_dados['observacao'] = inclusao.dadosProc.observacao.cdata
            except AttributeError: pass
            ...
            if 'dadosProcJud' in dir(inclusao.dadosProc) and inclusao.dadosProc.dadosProcJud.cdata != '':
                for dadosProcJud in inclusao.dadosProc.dadosProcJud:
                    ...
                    try: s1070_inclusao_dadosprocjud_dados['ufvara'] = dadosProcJud.ufVara.cdata
                    except AttributeError: pass
                    try: s1070_inclusao_dadosprocjud_dados['codmunic'] = dadosProcJud.codMunic.cdata
                    except AttributeError: pass
                    try: s1070_inclusao_dadosprocjud_dados['idvara'] = dadosProcJud.idVara.cdata
                    except AttributeError: pass
            ...
            if 'infoSusp' in dir(inclusao.dadosProc) and inclusao.dadosProc.infoSusp.cdata != '':
                for infoSusp in inclusao.dadosProc.infoSusp:
                    ...
                    try: s1070_inclusao_infosusp_dados['codsusp'] = infoSusp.codSusp.cdata
                    except AttributeError: pass
                    try: s1070_inclusao_infosusp_dados['indsusp'] = infoSusp.indSusp.cdata
                    except AttributeError: pass
                    try: s1070_inclusao_infosusp_dados['dtdecisao'] = infoSusp.dtDecisao.cdata
                    except AttributeError: pass
                    try: s1070_inclusao_infosusp_dados['inddeposito'] = infoSusp.indDeposito.cdata
                    except AttributeError: pass
    ...
    if 'alteracao' in dir(evtTabProcesso.infoProcesso) and evtTabProcesso.infoProcesso.alteracao.cdata != '':
        for alteracao in evtTabProcesso.infoProcesso.alteracao:
            ...
            try: s1070_alteracao_dados['tpproc'] = alteracao.ideProcesso.tpProc.cdata
            except AttributeError: pass
            try: s1070_alteracao_dados['nrproc'] = alteracao.ideProcesso.nrProc.cdata
            except AttributeError: pass
            try: s1070_alteracao_dados['inivalid'] = alteracao.ideProcesso.iniValid.cdata
            except AttributeError: pass
            try: s1070_alteracao_dados['fimvalid'] = alteracao.ideProcesso.fimValid.cdata
            except AttributeError: pass
            try: s1070_alteracao_dados['indautoria'] = alteracao.dadosProc.indAutoria.cdata
            except AttributeError: pass
            try: s1070_alteracao_dados['indmatproc'] = alteracao.dadosProc.indMatProc.cdata
            except AttributeError: pass
            try: s1070_alteracao_dados['observacao'] = alteracao.dadosProc.observacao.cdata
            except AttributeError: pass
            ...
            if 'dadosProcJud' in dir(alteracao.dadosProc) and alteracao.dadosProc.dadosProcJud.cdata != '':
                for dadosProcJud in alteracao.dadosProc.dadosProcJud:
                    ...
                    try: s1070_alteracao_dadosprocjud_dados['ufvara'] = dadosProcJud.ufVara.cdata
                    except AttributeError: pass
                    try: s1070_alteracao_dadosprocjud_dados['codmunic'] = dadosProcJud.codMunic.cdata
                    except AttributeError: pass
                    try: s1070_alteracao_dadosprocjud_dados['idvara'] = dadosProcJud.idVara.cdata
                    except AttributeError: pass
            ...
            if 'infoSusp' in dir(alteracao.dadosProc) and alteracao.dadosProc.infoSusp.cdata != '':
                for infoSusp in alteracao.dadosProc.infoSusp:
                    ...
                    try: s1070_alteracao_infosusp_dados['codsusp'] = infoSusp.codSusp.cdata
                    except AttributeError: pass
                    try: s1070_alteracao_infosusp_dados['indsusp'] = infoSusp.indSusp.cdata
                    except AttributeError: pass
                    try: s1070_alteracao_infosusp_dados['dtdecisao'] = infoSusp.dtDecisao.cdata
                    except AttributeError: pass
                    try: s1070_alteracao_infosusp_dados['inddeposito'] = infoSusp.indDeposito.cdata
                    except AttributeError: pass
            ...
            if 'novaValidade' in dir(alteracao) and alteracao.novaValidade.cdata != '':
                for novaValidade in alteracao.novaValidade:
                    ...
                    try: s1070_alteracao_novavalidade_dados['inivalid'] = novaValidade.iniValid.cdata
                    except AttributeError: pass
                    try: s1070_alteracao_novavalidade_dados['fimvalid'] = novaValidade.fimValid.cdata
                    except AttributeError: pass
    ...
    if 'exclusao' in dir(evtTabProcesso.infoProcesso) and evtTabProcesso.infoProcesso.exclusao.cdata != '':
        for exclusao in evtTabProcesso.infoProcesso.exclusao:
            ...
            try: s1070_exclusao_dados['tpproc'] = exclusao.ideProcesso.tpProc.cdata
            except AttributeError: pass
            try: s1070_exclusao_dados['nrproc'] = exclusao.ideProcesso.nrProc.cdata
            except AttributeError: pass
            try: s1070_exclusao_dados['inivalid'] = exclusao.ideProcesso.iniValid.cdata
            except AttributeError: pass
            try: s1070_exclusao_dados['fimvalid'] = exclusao.ideProcesso.fimValid.cdata
            except AttributeError: pass
