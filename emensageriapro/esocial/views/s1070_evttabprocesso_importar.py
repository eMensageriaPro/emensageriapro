...
def read_s1070_evttabprocesso(request, dados, arquivo, validar=False):
    ...
    s1070evtTabProcesso.objects.filter(id=dados['id']).update(arquivo=arquivo)
...
def read_s1070_evttabprocesso_obj(request, doc, status, validar=False):
    ...
    s1070_evttabprocesso_dados['status'] = STATUS_EVENTO_IMPORTADO
