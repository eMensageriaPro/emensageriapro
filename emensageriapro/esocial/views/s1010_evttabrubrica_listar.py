...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s1010_evttabrubrica_lista = s1010evtTabRubrica.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s1010_evttabrubrica.csv', context)
