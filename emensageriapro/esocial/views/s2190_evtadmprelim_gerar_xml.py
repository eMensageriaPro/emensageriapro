...
def gerar_xml_s2190(request, s2190_evtadmprelim_id, versao=None):
    ...
    if s2190_evtadmprelim_id:
        ...
        s2190_evtadmprelim_lista = s2190evtAdmPrelim.objects. \
            filter(id=s2190_evtadmprelim_id, excluido = False).all()
...
def gerar_xml_assinado(request, s2190_evtadmprelim_id):
    ...
    if s2190_evtadmprelim.arquivo_original:
        ...
        xml = gerar_xml_s2190(request, s2190_evtadmprelim_id)
    ...
    if 'Signature' in xml:
        ...
        if not s2190_evtadmprelim.transmissor_lote_esocial:
            ...
            grupo = get_grupo(s2190evtAdmPrelim)
        ...
        xml_assinado = assinar_esocial(request, xml, s2190_evtadmprelim.transmissor_lote_esocial_id)
    ...
    if s2190_evtadmprelim.status in (
        ...
        s2190evtAdmPrelim.objects.\
            filter(id=s2190_evtadmprelim_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s2190_evtadmprelim_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s2190_evtadmprelim_id)
