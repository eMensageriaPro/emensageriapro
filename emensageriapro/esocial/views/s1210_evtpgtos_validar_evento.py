...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'esocial/%s/evtPgtos.xsd' % (s1210_evtpgtos.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 's1210_evtpgtos' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('s1210_evtpgtos', pk)
