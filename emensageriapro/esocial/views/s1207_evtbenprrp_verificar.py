...
def verificar(request, hash):
    ...
    if request.user.has_perm('esocial.can_view_s1207evtBenPrRP'):
        ...
        s1207_evtbenprrp_lista = s1207evtBenPrRP.objects.filter(id=s1207_evtbenprrp_id).all()
        ...
        s1207_infoperapur_lista = s1207infoPerApur.objects.filter(s1207_dmdev_id__in = listar_ids(s1207_dmdev_lista) ).all()
        s1207_infoperapur_ideestab_lista = s1207infoPerApurideEstab.objects.filter(s1207_infoperapur_id__in = listar_ids(s1207_infoperapur_lista) ).all()
        s1207_infoperapur_remunperapur_lista = s1207infoPerApurremunPerApur.objects.filter(s1207_infoperapur_ideestab_id__in = listar_ids(s1207_infoperapur_ideestab_lista) ).all()
        s1207_infoperapur_itensremun_lista = s1207infoPerApuritensRemun.objects.filter(s1207_infoperapur_remunperapur_id__in = listar_ids(s1207_infoperapur_remunperapur_lista) ).all()
        s1207_infoperant_lista = s1207infoPerAnt.objects.filter(s1207_dmdev_id__in = listar_ids(s1207_dmdev_lista) ).all()
        s1207_infoperant_ideadc_lista = s1207infoPerAntideADC.objects.filter(s1207_infoperant_id__in = listar_ids(s1207_infoperant_lista) ).all()
        s1207_infoperant_ideperiodo_lista = s1207infoPerAntidePeriodo.objects.filter(s1207_infoperant_ideadc_id__in = listar_ids(s1207_infoperant_ideadc_lista) ).all()
        s1207_infoperant_ideestab_lista = s1207infoPerAntideEstab.objects.filter(s1207_infoperant_ideperiodo_id__in = listar_ids(s1207_infoperant_ideperiodo_lista) ).all()
        s1207_infoperant_remunperant_lista = s1207infoPerAntremunPerAnt.objects.filter(s1207_infoperant_ideestab_id__in = listar_ids(s1207_infoperant_ideestab_lista) ).all()
