...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'esocial/%s/evtTabRubrica.xsd' % (s1010_evttabrubrica.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 's1010_evttabrubrica' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('s1010_evttabrubrica', pk)
