...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'esocial/%s/evtTabEstab.xsd' % (s1005_evttabestab.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 's1005_evttabestab' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('s1005_evttabestab', pk)
