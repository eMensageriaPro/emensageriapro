...
class s1005evtTabEstabList(generics.ListCreateAPIView):
    db_slug = 'default'
    queryset = s1005evtTabEstab.objects.using(db_slug).all()
    serializer_class = s1005evtTabEstabSerializer
    permission_classes = (IsAdminUser,)


class s1005evtTabEstabDetail(generics.RetrieveUpdateDestroyAPIView):
    db_slug = 'default'
    queryset = s1005evtTabEstab.objects.using(db_slug).all()
    serializer_class = s1005evtTabEstabSerializer
    permission_classes = (IsAdminUser,)
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if not evento_totalizador:
            ...
            s1005_evttabestab_form.fields['status'].widget.attrs['disabled'] = True
            s1005_evttabestab_form.fields['status'].widget.attrs['readonly'] = True
            s1005_evttabestab_form.fields['transmissor_lote_esocial'].widget.attrs['disabled'] = True
