...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1005_evttabestab_id:
            ...
            s1005_evttabestab_form = form_s1005_evttabestab(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_ESOCIAL, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
