...
def gerar_identidade(request, chave, evento_id):
    ...
    if chave == PASS_SCRIPT:
        db_slug = 'default'
        obj = get_object_or_404(s1005evtTabEstab.objects.using( db_slug ), excluido = False, id = evento_id)
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1005_evttabestab_id:
            ...
            s1005_evttabestab_form = form_s1005_evttabestab(request.POST or None, slug = db_slug,
