...
def read_s2210_evtcat(request, dados, arquivo, validar=False):
    ...
    s2210evtCAT.objects.filter(id=dados['id']).update(arquivo=arquivo)
...
def read_s2210_evtcat_obj(request, doc, status, validar=False):
    ...
    s2210_evtcat_dados['status'] = STATUS_EVENTO_IMPORTADO
