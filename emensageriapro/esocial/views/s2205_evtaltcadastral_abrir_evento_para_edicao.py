...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s2205evtAltCadastral'):
        ...
        if s2205_evtaltcadastral.status in status_list:
            ...
            s2205evtAltCadastral.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's2205_evtaltcadastral', pk, request.user.id, 1)
    ...
    return redirect('s2205_evtaltcadastral_salvar', pk=pk, tab='master')