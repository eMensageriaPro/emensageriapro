    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'durtreicap__icontains': 'durtreicap__icontains',
                'modtreicap__icontains': 'modtreicap__icontains',
                'tptreicap__icontains': 'tptreicap__icontains',
                'indtreinant__icontains': 'indtreinant__icontains',
        ...
        s2245_evttreicap_lista = s2245evtTreiCap.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s2245_evttreicap.csv', context)
