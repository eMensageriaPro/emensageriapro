...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1207_evtbenprrp_id:
            ...
            s1207_evtbenprrp_form = form_s1207_evtbenprrp(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_ESOCIAL, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
