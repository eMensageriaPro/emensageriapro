...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1270_evtcontratavnp')
    ...
    if permissao.permite_listar:
        ...
        s1270_evtcontratavnp_lista = s1270evtContratAvNP.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s1270_evtcontratavnp.csv', context)
