...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s2245evtTreiCap'):
        ...
        if s2245_evttreicap.status in status_list:
            ...
            s2245evtTreiCap.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's2245_evttreicap', pk, request.user.id, 1)
    ...
    return redirect('s2245_evttreicap_salvar', pk=pk, tab='master')