...
def validar_evento_funcao(request, pk):
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO:
            ...
            quant = validar_precedencia('esocial', 's2231_evtcessao', pk)
...
def validar_evento(request, pk):
    ...
    if s2231_evtcessao.status in STATUS_VALIDACAO:
    ...
    return redirect('s2231_evtcessao_salvar', pk=pk, tab='master')