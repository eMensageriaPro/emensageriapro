...
def listar(request, hash):
    ...
    if request.user.has_perm('esocial.can_view_s2306evtTSVAltContr'):
        ...
        s2306_evttsvaltcontr_lista = s2306evtTSVAltContr.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s2306_evttsvaltcontr.csv', context)
