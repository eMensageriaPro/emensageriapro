...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s1040_evttabfuncao_lista = s1040evtTabFuncao.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s1040_evttabfuncao.csv', context)
