...
def criar_exclusao(request, pk):
    ...
    from emensageriapro.esocial.views.s5012_evtirrf_gerar_xml import gerar_xml_s5012
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('esocial.can_create_delete_s5012evtIrrf'):
        ...
        return redirect('s5012_evtirrf_salvar', pk=return_pk, tab='master')
        ...
        return redirect('s5012_evtirrf_salvar', pk=pk, tab='master')