...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'esocial/%s/evtCAT.xsd' % (s2210_evtcat.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 's2210_evtcat' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('s2210_evtcat', pk)
