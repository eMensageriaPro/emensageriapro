...
def criar_alteracao(request, pk):
    ...
    from emensageriapro.esocial.views.s2299_evtdeslig_gerar_xml import gerar_xml_s2299
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('esocial.can_create_change_s2299evtDeslig'):
        ...
        return redirect('s2299_evtdeslig_salvar', pk=return_pk, tab='master')
        ...
        return redirect('s2299_evtdeslig_salvar', pk=pk, tab='master')