...
def gerar_xml_s1298(s1298_evtreabreevper_id, db_slug, versao=None):
...
def gerar_xml_assinado(s1298_evtreabreevper_id, db_slug):
    ...
    if s1298_evtreabreevper.status in (0,1,2,11):
        ...
        s1298evtReabreEvPer.objects.using(db_slug).\
            filter(id=s1298_evtreabreevper_id,excluido=False).update(status=10)
...
def alterar_identidade(request, hash):
    ...
    if s1298_evtreabreevper_id:
        ...
        if s1298_evtreabreevper.status == 0:
            ...
            nova_identidade = identidade_evento(s1298_evtreabreevper_id, db_slug)
            ...
            gravar_auditoria(u'{}',
                ...
                's1298_evtreabreevper', s1298_evtreabreevper_id, request.user.id, 1)
...
def validar_evento_funcao(s1298_evtreabreevper_id, db_slug):
    ...
    s1298evtReabreEvPer.objects.using( db_slug ).\
        filter(id=s1298_evtreabreevper_id, excluido = False).\
    ...
    if os.path.exists(BASE_DIR + '/' + arquivo):
        ...
        from emensageriapro.esocial.views.s1298_evtreabreevper_validar import validacoes_s1298_evtreabreevper
...
<<<<<<< HEAD
        if s1298_evtreabreevper.versao in VERSOES_ESOCIAL:
=======
        if s1298_evtreabreevper.versao in VERSAO_ATUAL:
>>>>>>> 3217f7abcc9a9c37261d88e43626ba3e9fb91ee3

            validar_evento_funcao(s1298_evtreabreevper_id, db_slug)
