...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s3000_evtexclusao_id:
            ...
            s3000_evtexclusao_form = form_s3000_evtexclusao(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_ESOCIAL, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
