...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s1080_evttaboperport_lista = s1080evtTabOperPort.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s1080_evttaboperport.csv', context)
