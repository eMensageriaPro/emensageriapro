...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s2241_evtinsapo_id:
            ...
            s2241_insalperic_form = form_s2241_insalperic(initial={ 's2241_evtinsapo': s2241_evtinsapo }, slug=db_slug)
            s2241_insalperic_form.fields['s2241_evtinsapo'].widget.attrs['readonly'] = True
            s2241_insalperic_lista = s2241insalPeric.objects.using( db_slug ).filter(excluido = False, s2241_evtinsapo_id=s2241_evtinsapo.id).all()
            s2241_aposentesp_form = form_s2241_aposentesp(initial={ 's2241_evtinsapo': s2241_evtinsapo }, slug=db_slug)
            s2241_aposentesp_form.fields['s2241_evtinsapo'].widget.attrs['readonly'] = True
            s2241_aposentesp_lista = s2241aposentEsp.objects.using( db_slug ).filter(excluido = False, s2241_evtinsapo_id=s2241_evtinsapo.id).all()
        else:
