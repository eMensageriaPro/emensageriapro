...
def verificar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get(endereco='s2210_evtcat')
    ...
    if permissao.permite_listar:
        ...
        s2210_evtcat_lista = s2210evtCAT.objects.filter(id=s2210_evtcat_id).all()
        ...
        s2210_atestado_lista = s2210atestado.objects.filter(s2210_evtcat_id__in = listar_ids(s2210_evtcat_lista) ).all()
