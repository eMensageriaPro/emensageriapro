...
def gerar_xml_s1005(request, s1005_evttabestab_id, versao=None):
    ...
    if s1005_evttabestab_id:
        ...
        s1005_evttabestab_lista = s1005evtTabEstab.objects. \
            filter(id=s1005_evttabestab_id, excluido = False).all()
...
def gerar_xml_assinado(request, s1005_evttabestab_id):
    ...
    if s1005_evttabestab.arquivo_original:
        ...
        xml = gerar_xml_s1005(request, s1005_evttabestab_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_esocial(request, xml, s1005_evttabestab.transmissor_lote_esocial_id)
    ...
    if s1005_evttabestab.status in (
        ...
        s1005evtTabEstab.objects.\
            filter(id=s1005_evttabestab_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s1005_evttabestab_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s1005_evttabestab_id)
