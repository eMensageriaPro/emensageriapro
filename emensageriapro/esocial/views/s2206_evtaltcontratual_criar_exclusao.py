...
def criar_exclusao(request, pk):
    ...
    from emensageriapro.esocial.views.s2206_evtaltcontratual_gerar_xml import gerar_xml_s2206
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('esocial.can_create_delete_s2206evtAltContratual'):
        ...
        return redirect('s2206_evtaltcontratual_salvar', pk=return_pk, tab='master')
        ...
        return redirect('s2206_evtaltcontratual_salvar', pk=pk, tab='master')