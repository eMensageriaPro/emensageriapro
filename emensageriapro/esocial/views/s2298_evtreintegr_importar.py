...
def read_s2298_evtreintegr(request, dados, arquivo, validar=False):
    ...
    s2298evtReintegr.objects.filter(id=dados['id']).update(arquivo=arquivo)
...
def read_s2298_evtreintegr_obj(request, doc, status, validar=False):
    ...
    s2298_evtreintegr_dados['status'] = STATUS_EVENTO_IMPORTADO
