    ...
    if permissao.permite_listar:
        ...
        if for_print in (0,1):
            ...
            response = PDFTemplateResponse(#request=request,
                                           template='tables/s1000_evtinfoempregador_pdf_xls.html',
            ...
            response = render_to_response('tables/s1000_evtinfoempregador_pdf_xls.html', context)
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        s1000_evtinfoempregador_ocorrencias_form = None
        ...
        if s1000_evtinfoempregador_id:
            ...
            s1000_evtinfoempregador_ocorrencias_form = form_s1000_evtinfoempregador_ocorrencias(initial={ 'evento': s1000_evtinfoempregador }, slug=db_slug)
            s1000_evtinfoempregador_ocorrencias_form.fields['evento'].widget.attrs['readonly'] = True
            s1000_evtinfoempregador_ocorrencias_lista = s1000evtInfoEmpregadorOcorrencias.objects.using( db_slug ).filter(excluido = False, evento_id=s1000_evtinfoempregador.id).all()
