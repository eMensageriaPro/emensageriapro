...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s2250evtAvPrevio'):
        ...
        if s2250_evtavprevio.status in status_list:
            ...
            s2250evtAvPrevio.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's2250_evtavprevio', pk, request.user.id, 1)
    ...
    return redirect('s2250_evtavprevio_salvar', pk=pk, tab='master')