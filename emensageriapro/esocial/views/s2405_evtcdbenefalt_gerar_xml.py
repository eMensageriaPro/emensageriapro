...
def gerar_xml_s2405(request, s2405_evtcdbenefalt_id, versao=None):
    ...
    if s2405_evtcdbenefalt_id:
        ...
        s2405_evtcdbenefalt_lista = s2405evtCdBenefAlt.objects. \
            filter(id=s2405_evtcdbenefalt_id, excluido = False).all()
...
def gerar_xml_assinado(request, s2405_evtcdbenefalt_id):
    ...
    if s2405_evtcdbenefalt.arquivo_original:
        ...
        xml = gerar_xml_s2405(request, s2405_evtcdbenefalt_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_esocial(request, xml, s2405_evtcdbenefalt.transmissor_lote_esocial_id)
    ...
    if s2405_evtcdbenefalt.status in (
        ...
        s2405evtCdBenefAlt.objects.\
            filter(id=s2405_evtcdbenefalt_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s2405_evtcdbenefalt_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s2405_evtcdbenefalt_id)
