...
def gerar_xml_s2245(request, s2245_evttreicap_id, versao=None):
    ...
    if s2245_evttreicap_id:
        ...
        s2245_evttreicap_lista = s2245evtTreiCap.objects. \
            filter(id=s2245_evttreicap_id, excluido = False).all()
...
def gerar_xml_assinado(request, s2245_evttreicap_id):
    ...
    if s2245_evttreicap.arquivo_original:
        ...
        xml = gerar_xml_s2245(request, s2245_evttreicap_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_esocial(request, xml, s2245_evttreicap.transmissor_lote_esocial_id)
        
    if s2245_evttreicap.status in (
        ...
        s2245evtTreiCap.objects.\
            filter(id=s2245_evttreicap_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s2245_evttreicap_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s2245_evttreicap_id)
