    ...
    if request.user.has_perm('esocial.can_see_s2410evtCdBenIn'):
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'vrbeneficio__icontains': 'vrbeneficio__icontains',
        ...
        s2410_evtcdbenin_lista = s2410evtCdBenIn.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            response = render_to_response('csv/s2410_evtcdbenin.csv', context)
