...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s5002evtIrrfBenef'):
        ...
        if s5002_evtirrfbenef.status in status_list:
            ...
            s5002evtIrrfBenef.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's5002_evtirrfbenef', pk, request.user.id, 1)
    ...
    return redirect('s5002_evtirrfbenef_salvar', pk=pk)