...
def salvar(request, hash):
    ...
    if request.user.has_perm('esocial.can_view_s2405evtCdBenefAlt'):
        ...
        s2405_evtcdbenefalt_form = disabled_form_fields(s2405_evtcdbenefalt_form, request.user.has_perm('esocial.change_s2405evtCdBenefAlt'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2405_evtcdbenefalt_id, tabela='s2405_evtcdbenefalt').all()
