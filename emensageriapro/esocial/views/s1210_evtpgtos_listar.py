...
def listar(request, output=None):
    ...
    if request.user.has_perm('esocial.can_see_s1210evtPgtos'):
        ...
        s1210_evtpgtos_lista = s1210evtPgtos.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        retornos_s5002_lista = s5002evtIrrfBenef.objects.all()
        ...
        context = {
            ...
            'retornos_s5002_lista': retornos_s5002_lista,
