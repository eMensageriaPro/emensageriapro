    ...
    if request.user.has_perm('esocial.can_see_s1250evtAqProd'):
        ...
        if request.method == 'POST':
            ...
            dict_fields = {
                ...
                'tpinscadq__icontains': 'tpinscadq__icontains',
        ...
        s1250_evtaqprod_lista = s1250evtAqProd.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            response = render_to_response('csv/s1250_evtaqprod.csv', context)
