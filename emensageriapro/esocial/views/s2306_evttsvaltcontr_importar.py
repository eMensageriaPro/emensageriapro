...
def read_s2306_evttsvaltcontr(request, dados, arquivo, validar=False):
    ...
    s2306evtTSVAltContr.objects.filter(id=dados['id']).update(arquivo=arquivo)
...
def read_s2306_evttsvaltcontr_obj(request, doc, status, validar=False):
    ...
    s2306_evttsvaltcontr_dados['status'] = STATUS_EVENTO_IMPORTADO
