...
def validacoes_s2400_evtcdbenefin(arquivo):
    ...
    if 'indRetif' in dir(evtCdBenefIn.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.ideEvento.indRetif', evtCdBenefIn.ideEvento.indRetif.cdata, 1, u'1;2')
    if 'nrRecibo' in dir(evtCdBenefIn.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.ideEvento.nrRecibo', evtCdBenefIn.ideEvento.nrRecibo.cdata, 0, u'')
    if 'tpAmb' in dir(evtCdBenefIn.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.ideEvento.tpAmb', evtCdBenefIn.ideEvento.tpAmb.cdata, 1, u'1;2')
    if 'procEmi' in dir(evtCdBenefIn.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.ideEvento.procEmi', evtCdBenefIn.ideEvento.procEmi.cdata, 1, u'1;2;3;4;5')
    if 'verProc' in dir(evtCdBenefIn.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.ideEvento.verProc', evtCdBenefIn.ideEvento.verProc.cdata, 1, u'')
    if 'tpInsc' in dir(evtCdBenefIn.ideEmpregador): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.ideEmpregador.tpInsc', evtCdBenefIn.ideEmpregador.tpInsc.cdata, 1, u'1')
    if 'nrInsc' in dir(evtCdBenefIn.ideEmpregador): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.ideEmpregador.nrInsc', evtCdBenefIn.ideEmpregador.nrInsc.cdata, 1, u'')
    if 'cpfBenef' in dir(evtCdBenefIn.beneficiario): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.cpfBenef', evtCdBenefIn.beneficiario.cpfBenef.cdata, 1, u'')
    if 'nisBenef' in dir(evtCdBenefIn.beneficiario): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.nisBenef', evtCdBenefIn.beneficiario.nisBenef.cdata, 0, u'')
    if 'nmBenefic' in dir(evtCdBenefIn.beneficiario): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.nmBenefic', evtCdBenefIn.beneficiario.nmBenefic.cdata, 1, u'')
    if 'dtInicio' in dir(evtCdBenefIn.beneficiario): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.dtInicio', evtCdBenefIn.beneficiario.dtInicio.cdata, 1, u'')
    if 'sexo' in dir(evtCdBenefIn.beneficiario): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.sexo', evtCdBenefIn.beneficiario.sexo.cdata, 1, u'M;F')
    if 'racaCor' in dir(evtCdBenefIn.beneficiario): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.racaCor', evtCdBenefIn.beneficiario.racaCor.cdata, 1, u'1;2;3;4;5;6')
    if 'estCiv' in dir(evtCdBenefIn.beneficiario): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.estCiv', evtCdBenefIn.beneficiario.estCiv.cdata, 0, u'1;2;3;4;5')
    if 'incFisMen' in dir(evtCdBenefIn.beneficiario): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.incFisMen', evtCdBenefIn.beneficiario.incFisMen.cdata, 1, u'S;N')
    if 'dtIncFisMen' in dir(evtCdBenefIn.beneficiario): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.dtIncFisMen', evtCdBenefIn.beneficiario.dtIncFisMen.cdata, 0, u'')
    if 'dtNascto' in dir(evtCdBenefIn.beneficiario.dadosNasc): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.dadosNasc.dtNascto', evtCdBenefIn.beneficiario.dadosNasc.dtNascto.cdata, 1, u'')
    if 'codMunic' in dir(evtCdBenefIn.beneficiario.dadosNasc): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.dadosNasc.codMunic', evtCdBenefIn.beneficiario.dadosNasc.codMunic.cdata, 0, u'')
    if 'uf' in dir(evtCdBenefIn.beneficiario.dadosNasc): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.dadosNasc.uf', evtCdBenefIn.beneficiario.dadosNasc.uf.cdata, 0, u'')
    if 'paisNascto' in dir(evtCdBenefIn.beneficiario.dadosNasc): validacoes_lista = validar_campo(validacoes_lista,'evtCdBenefIn.beneficiario.dadosNasc.paisNascto', evtCdBenefIn.beneficiario.dadosNasc.paisNascto.cdata, 0, u'008;040;329;331;334;337;341;345;351;355;357;358;041;359;361;365;367;369;372;375;379;383;386;043;388;391;395;396;399;403;411;420;423;426;047;427;431;434;438;440;442;445;447;449;450;053;452;455;458;461;464;467;472;474;476;477;059;485;488;490;493;494;495;497;499;501;505;063;507;508;511;517;521;525;528;531;535;538;064;542;545;548;551;556;563;566;569;573;575;065;576;578;580;583;586;589;593;599;603;607;069;611;623;625;628;640;647;660;665;670;675;009;072;676;677;678;685;687;690;691;695;697;700;073;705;710;715;720;728;731;735;738;741;744;077;748;750;754;756;759;764;767;770;772;776;080;780;782;783;785;788;790;791;795;800;805;081;810;815;820;823;824;827;828;831;833;840;083;845;847;848;850;855;858;863;866;870;873;085;875;888;890;087;088;090;013;093;097;098;100;101;105;106;108;111;115;017;119;127;131;137;141;145;149;150;151;152;020;153;154;158;160;161;163;165;169;173;177;023;183;187;190;193;195;196;198;199;229;232;025;235;237;239;240;243;244;245;246;247;249;031;251;253;255;259;263;267;271;275;281;285;037;289;291;293;297;301;305;309;313;317;325')
    ...
    if 'dependente' in dir(evtCdBenefIn.beneficiario):
        for dependente in evtCdBenefIn.beneficiario.dependente:
            ...
            if 'tpDep' in dir(dependente): validacoes_lista = validar_campo(validacoes_lista,'dependente.tpDep', dependente.tpDep.cdata, 1, u'')
            ...
            if 'sexoDep' in dir(dependente): validacoes_lista = validar_campo(validacoes_lista,'dependente.sexoDep', dependente.sexoDep.cdata, 1, u'M;F')
            ...
            if 'incFisMen' in dir(dependente): validacoes_lista = validar_campo(validacoes_lista,'dependente.incFisMen', dependente.incFisMen.cdata, 1, u'S;N')
            if 'depFinsPrev' in dir(dependente): validacoes_lista = validar_campo(validacoes_lista,'dependente.depFinsPrev', dependente.depFinsPrev.cdata, 1, u'S;N')
