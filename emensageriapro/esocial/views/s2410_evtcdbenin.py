...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if request.method == 'POST':
            if s2410_evtcdbenin_form.is_valid():
                ...
                if s2410_evtcdbenin_id:
                    ...
                    s2410_evtcdbenin_form = form_s2410_evtcdbenin(request.POST or None, instance = obj, slug = db_slug)
                    gravar_auditoria('{}',
                                     json.dumps(model_to_dict(obj), indent=4, sort_keys=True, default=str),
        ...
        if not evento_totalizador:
            ...
            s2410_evtcdbenin_form.fields['status'].widget.attrs['disabled'] = True
            s2410_evtcdbenin_form.fields['status'].widget.attrs['readonly'] = True
            s2410_evtcdbenin_form.fields['transmissor_lote_esocial'].widget.attrs['disabled'] = True
