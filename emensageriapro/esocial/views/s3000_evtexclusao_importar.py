...
def read_s3000_evtexclusao_obj(doc, status, validar=False):
    ...
    try: s3000_evtexclusao_dados['tpamb'] = evtExclusao.ideEvento.tpAmb.cdata
    except AttributeError: pass
    try: s3000_evtexclusao_dados['procemi'] = evtExclusao.ideEvento.procEmi.cdata
    except AttributeError: pass
    try: s3000_evtexclusao_dados['verproc'] = evtExclusao.ideEvento.verProc.cdata
    except AttributeError: pass
    try: s3000_evtexclusao_dados['tpinsc'] = evtExclusao.ideEmpregador.tpInsc.cdata
    except AttributeError: pass
    try: s3000_evtexclusao_dados['nrinsc'] = evtExclusao.ideEmpregador.nrInsc.cdata
    except AttributeError: pass
    try: s3000_evtexclusao_dados['tpevento'] = evtExclusao.infoExclusao.tpEvento.cdata
    except AttributeError: pass
    try: s3000_evtexclusao_dados['nrrecevt'] = evtExclusao.infoExclusao.nrRecEvt.cdata
    except AttributeError: pass
    ...
    if 'ideTrabalhador' in dir(evtExclusao.infoExclusao) and evtExclusao.infoExclusao.ideTrabalhador.cdata != '':
        for ideTrabalhador in evtExclusao.infoExclusao.ideTrabalhador:
            ...
            try: s3000_idetrabalhador_dados['cpftrab'] = ideTrabalhador.cpfTrab.cdata
            except AttributeError: pass
            try: s3000_idetrabalhador_dados['nistrab'] = ideTrabalhador.nisTrab.cdata
            except AttributeError: pass
    ...
    if 'ideFolhaPagto' in dir(evtExclusao.infoExclusao) and evtExclusao.infoExclusao.ideFolhaPagto.cdata != '':
        for ideFolhaPagto in evtExclusao.infoExclusao.ideFolhaPagto:
            ...
            try: s3000_idefolhapagto_dados['indapuracao'] = ideFolhaPagto.indApuracao.cdata
            except AttributeError: pass
            try: s3000_idefolhapagto_dados['perapur'] = ideFolhaPagto.perApur.cdata
            except AttributeError: pass
