...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5001_evtbasestrab')
    ...
    if permissao.permite_listar:
        ...
        s5001_evtbasestrab_lista = s5001evtBasesTrab.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s5001_evtbasestrab.csv', context)
