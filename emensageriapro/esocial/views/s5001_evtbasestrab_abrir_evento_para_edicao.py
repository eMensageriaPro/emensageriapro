...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s5001evtBasesTrab'):
        ...
        if s5001_evtbasestrab.status in status_list:
            ...
            s5001evtBasesTrab.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's5001_evtbasestrab', pk, request.user.id, 1)
    ...
    return redirect('s5001_evtbasestrab_salvar', pk=pk, tab='master')