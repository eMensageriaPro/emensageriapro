...
def gerar_xml_s5011(request, s5011_evtcs_id, versao=None):
    ...
    if s5011_evtcs_id:
        ...
        s5011_evtcs_lista = s5011evtCS.objects. \
            filter(id=s5011_evtcs_id, excluido = False).all()
...
def gerar_xml_assinado(request, s5011_evtcs_id):
    ...
    if s5011_evtcs.arquivo_original:
        ...
        xml = gerar_xml_s5011(request, s5011_evtcs_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_esocial(request, xml, s5011_evtcs.transmissor_lote_esocial_id)
    ...
    if s5011_evtcs.status in (
        ...
        s5011evtCS.objects.\
            filter(id=s5011_evtcs_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s5011_evtcs_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s5011_evtcs_id)
