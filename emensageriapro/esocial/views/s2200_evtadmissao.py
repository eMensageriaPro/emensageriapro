...
def gerar_identidade(request, chave, evento_id):
    ...
    if chave == PASS_SCRIPT:
        db_slug = 'default'
        obj = get_object_or_404(s2200evtAdmissao.objects.using( db_slug ), excluido = False, id = evento_id)
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s2200_evtadmissao_id:
            ...
            s2200_evtadmissao_form = form_s2200_evtadmissao(request.POST or None, slug = db_slug,
