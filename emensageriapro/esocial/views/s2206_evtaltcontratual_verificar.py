...
def verificar(request, pk, output=None):
    ...
    if request.user.has_perm('esocial.can_see_s2206evtAltContratual'):
        ...
        s2206_infoestatutario_lista = s2206infoEstatutario.objects.filter(s2206_evtaltcontratual_id__in = listar_ids(s2206_evtaltcontratual_lista) ).all()
        s2206_localtrabgeral_lista = s2206localTrabGeral.objects.filter(s2206_evtaltcontratual_id__in = listar_ids(s2206_evtaltcontratual_lista) ).all()
        s2206_localtrabdom_lista = s2206localTrabDom.objects.filter(s2206_evtaltcontratual_id__in = listar_ids(s2206_evtaltcontratual_lista) ).all()
        s2206_horcontratual_lista = s2206horContratual.objects.filter(s2206_evtaltcontratual_id__in = listar_ids(s2206_evtaltcontratual_lista) ).all()
        s2206_horario_lista = s2206horario.objects.filter(s2206_horcontratual_id__in = listar_ids(s2206_horcontratual_lista) ).all()
        s2206_filiacaosindical_lista = s2206filiacaoSindical.objects.filter(s2206_evtaltcontratual_id__in = listar_ids(s2206_evtaltcontratual_lista) ).all()
        s2206_alvarajudicial_lista = s2206alvaraJudicial.objects.filter(s2206_evtaltcontratual_id__in = listar_ids(s2206_evtaltcontratual_lista) ).all()
