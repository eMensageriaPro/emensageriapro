...
def validacoes_s2399_evttsvtermino(arquivo):
    ...
    if 'pensAlim' in dir(evtTSVTermino.infoTSVTermino): validacoes_lista = validar_campo(validacoes_lista,'evtTSVTermino.infoTSVTermino.pensAlim', evtTSVTermino.infoTSVTermino.pensAlim.cdata, 0, '0;1;2;3')
    if 'percAliment' in dir(evtTSVTermino.infoTSVTermino): validacoes_lista = validar_campo(validacoes_lista,'evtTSVTermino.infoTSVTermino.percAliment', evtTSVTermino.infoTSVTermino.percAliment.cdata, 0, '')
