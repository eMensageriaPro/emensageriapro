...
def listar(request, hash):
    ...
    if request.user.has_perm('esocial.can_view_s2190evtAdmPrelim'):
        ...
        s2190_evtadmprelim_lista = s2190evtAdmPrelim.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s2190_evtadmprelim.csv', context)
