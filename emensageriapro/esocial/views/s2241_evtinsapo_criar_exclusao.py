...
def criar_exclusao(request, pk):
    ...
    from emensageriapro.esocial.views.s2241_evtinsapo_gerar_xml import gerar_xml_s2241
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('esocial.can_create_delete_s2241evtInsApo'):
        ...
        return redirect('s2241_evtinsapo_salvar', pk=return_pk, tab='master')
