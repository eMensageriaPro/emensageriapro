...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1070_evttabprocesso')
    ...
    if permissao.permite_listar:
        ...
        s1070_evttabprocesso_lista = s1070evtTabProcesso.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s1070_evttabprocesso.csv', context)
