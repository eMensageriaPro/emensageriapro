...
def gerar_xml_s2399(request, s2399_evttsvtermino_id, versao=None):
    ...
    if s2399_evttsvtermino_id:
        ...
        s2399_evttsvtermino_lista = s2399evtTSVTermino.objects. \
            filter(id=s2399_evttsvtermino_id, excluido = False).all()
...
def gerar_xml_assinado(request, s2399_evttsvtermino_id):
    ...
    if s2399_evttsvtermino.arquivo_original:
        ...
        xml = gerar_xml_s2399(request, s2399_evttsvtermino_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_esocial(request, xml, s2399_evttsvtermino.transmissor_lote_esocial_id)
        
    if s2399_evttsvtermino.status in (
        ...
        s2399evtTSVTermino.objects.\
            filter(id=s2399_evttsvtermino_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s2399_evttsvtermino_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s2399_evttsvtermino_id)
