...
def validacoes_s2210_evtcat(arquivo):
    ...
    if 'tpInsc' in dir(evtCAT.ideEmpregador): validacoes_lista = validar_campo(validacoes_lista,'evtCAT.ideEmpregador.tpInsc', evtCAT.ideEmpregador.tpInsc.cdata, 1, '1;2')
    ...
    if 'cpfTrab' in dir(evtCAT.ideVinculo): validacoes_lista = validar_campo(validacoes_lista,'evtCAT.ideVinculo.cpfTrab', evtCAT.ideVinculo.cpfTrab.cdata, 1, '')
    if 'nisTrab' in dir(evtCAT.ideVinculo): validacoes_lista = validar_campo(validacoes_lista,'evtCAT.ideVinculo.nisTrab', evtCAT.ideVinculo.nisTrab.cdata, 0, '')
    if 'matricula' in dir(evtCAT.ideVinculo): validacoes_lista = validar_campo(validacoes_lista,'evtCAT.ideVinculo.matricula', evtCAT.ideVinculo.matricula.cdata, 0, '')
    ...
    if 'bairro' in dir(evtCAT.cat.localAcidente): validacoes_lista = validar_campo(validacoes_lista,'evtCAT.cat.localAcidente.bairro', evtCAT.cat.localAcidente.bairro.cdata, 0, '')
    if 'cep' in dir(evtCAT.cat.localAcidente): validacoes_lista = validar_campo(validacoes_lista,'evtCAT.cat.localAcidente.cep', evtCAT.cat.localAcidente.cep.cdata, 0, '')
    ...
    if 'ideLocalAcid' in dir(evtCAT.cat.localAcidente):
        for ideLocalAcid in evtCAT.cat.localAcidente.ideLocalAcid:
            ...
            if 'tpInsc' in dir(ideLocalAcid): validacoes_lista = validar_campo(validacoes_lista,'ideLocalAcid.tpInsc', ideLocalAcid.tpInsc.cdata, 1, '1;3;4')
            if 'nrInsc' in dir(ideLocalAcid): validacoes_lista = validar_campo(validacoes_lista,'ideLocalAcid.nrInsc', ideLocalAcid.nrInsc.cdata, 1, '')
