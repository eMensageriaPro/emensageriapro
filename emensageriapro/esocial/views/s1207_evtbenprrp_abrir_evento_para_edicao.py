...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s1207evtBenPrRP'):
        ...
        if s1207_evtbenprrp.status in status_list:
            ...
            s1207evtBenPrRP.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's1207_evtbenprrp', pk, request.user.id, 1)
    ...
    return redirect('s1207_evtbenprrp_salvar', pk=pk, tab='master')