...
def validar_evento_funcao(request, pk):
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO:
            ...
            quant = validar_precedencia('esocial', 's2241_evtinsapo', pk)
...
def validar_evento(request, pk, tab=None):
    ...
    if s2241_evtinsapo.status in STATUS_VALIDACAO:
    ...
    if tab == 'mapa':
        ...
        return redirect('s2241_evtinsapo_salvar', pk=pk, tab='master')