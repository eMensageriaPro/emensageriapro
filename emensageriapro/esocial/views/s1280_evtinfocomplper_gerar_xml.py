...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s1280_evtinfocomplper.status in STATUS_ANT:
        ...
        if not s1280_evtinfocomplper.transmissor_lote_esocial:
        ...
        if 'Signature' in xml_assinado and s1280_evtinfocomplper.status in STATUS_ANT:
