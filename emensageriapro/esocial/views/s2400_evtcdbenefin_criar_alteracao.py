...
def criar_alteracao(request, pk):
    ...
    from emensageriapro.esocial.views.s2400_evtcdbenefin_gerar_xml import gerar_xml_s2400
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('esocial.can_create_change_s2400evtCdBenefIn'):
        ...
        return redirect('s2400_evtcdbenefin_salvar', pk=return_pk, tab='master')
        ...
        return redirect('s2400_evtcdbenefin_salvar', pk=pk, tab='master')