...
def read_s1040_evttabfuncao(request, dados, arquivo, validar=False):
    ...
    s1040evtTabFuncao.objects.filter(id=dados['id']).update(arquivo=arquivo)
...
def read_s1040_evttabfuncao_obj(request, doc, status, validar=False):
    ...
    s1040_evttabfuncao_dados['status'] = STATUS_EVENTO_IMPORTADO
