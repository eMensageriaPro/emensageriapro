...
def read_s1040_evttabfuncao_obj(doc, status, validar=False):
    ...
    try: s1040_evttabfuncao_dados['tpamb'] = evtTabFuncao.ideEvento.tpAmb.cdata
    except AttributeError: pass
    try: s1040_evttabfuncao_dados['procemi'] = evtTabFuncao.ideEvento.procEmi.cdata
    except AttributeError: pass
    try: s1040_evttabfuncao_dados['verproc'] = evtTabFuncao.ideEvento.verProc.cdata
    except AttributeError: pass
    try: s1040_evttabfuncao_dados['tpinsc'] = evtTabFuncao.ideEmpregador.tpInsc.cdata
    except AttributeError: pass
    try: s1040_evttabfuncao_dados['nrinsc'] = evtTabFuncao.ideEmpregador.nrInsc.cdata
    except AttributeError: pass
    ...
    if 'inclusao' in dir(evtTabFuncao.infoFuncao) and evtTabFuncao.infoFuncao.inclusao.cdata != '':
        for inclusao in evtTabFuncao.infoFuncao.inclusao:
            ...
            try: s1040_inclusao_dados['codfuncao'] = inclusao.ideFuncao.codFuncao.cdata
            except AttributeError: pass
            try: s1040_inclusao_dados['inivalid'] = inclusao.ideFuncao.iniValid.cdata
            except AttributeError: pass
            try: s1040_inclusao_dados['fimvalid'] = inclusao.ideFuncao.fimValid.cdata
            except AttributeError: pass
            try: s1040_inclusao_dados['dscfuncao'] = inclusao.dadosFuncao.dscFuncao.cdata
            except AttributeError: pass
            try: s1040_inclusao_dados['codcbo'] = inclusao.dadosFuncao.codCBO.cdata
            except AttributeError: pass
    ...
    if 'alteracao' in dir(evtTabFuncao.infoFuncao) and evtTabFuncao.infoFuncao.alteracao.cdata != '':
        for alteracao in evtTabFuncao.infoFuncao.alteracao:
            ...
            try: s1040_alteracao_dados['codfuncao'] = alteracao.ideFuncao.codFuncao.cdata
            except AttributeError: pass
            try: s1040_alteracao_dados['inivalid'] = alteracao.ideFuncao.iniValid.cdata
            except AttributeError: pass
            try: s1040_alteracao_dados['fimvalid'] = alteracao.ideFuncao.fimValid.cdata
            except AttributeError: pass
            try: s1040_alteracao_dados['dscfuncao'] = alteracao.dadosFuncao.dscFuncao.cdata
            except AttributeError: pass
            try: s1040_alteracao_dados['codcbo'] = alteracao.dadosFuncao.codCBO.cdata
            except AttributeError: pass
            ...
            if 'novaValidade' in dir(alteracao) and alteracao.novaValidade.cdata != '':
                for novaValidade in alteracao.novaValidade:
                    ...
                    try: s1040_alteracao_novavalidade_dados['inivalid'] = novaValidade.iniValid.cdata
                    except AttributeError: pass
                    try: s1040_alteracao_novavalidade_dados['fimvalid'] = novaValidade.fimValid.cdata
                    except AttributeError: pass
    ...
    if 'exclusao' in dir(evtTabFuncao.infoFuncao) and evtTabFuncao.infoFuncao.exclusao.cdata != '':
        for exclusao in evtTabFuncao.infoFuncao.exclusao:
            ...
            try: s1040_exclusao_dados['codfuncao'] = exclusao.ideFuncao.codFuncao.cdata
            except AttributeError: pass
            try: s1040_exclusao_dados['inivalid'] = exclusao.ideFuncao.iniValid.cdata
            except AttributeError: pass
            try: s1040_exclusao_dados['fimvalid'] = exclusao.ideFuncao.fimValid.cdata
            except AttributeError: pass
