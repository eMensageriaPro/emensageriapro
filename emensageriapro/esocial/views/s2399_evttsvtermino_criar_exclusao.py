...
def criar_exclusao(request, pk):
    ...
    from emensageriapro.esocial.views.s2399_evttsvtermino_gerar_xml import gerar_xml_s2399
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('esocial.can_create_delete_s2399evtTSVTermino'):
        ...
        return redirect('s2399_evttsvtermino_salvar', pk=return_pk, tab='master')
        ...
        return redirect('s2399_evttsvtermino_salvar', pk=pk, tab='master')