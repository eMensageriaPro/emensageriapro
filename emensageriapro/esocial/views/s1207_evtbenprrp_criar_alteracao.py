...
def criar_alteracao(request, pk):
    ...
    from emensageriapro.esocial.views.s1207_evtbenprrp_gerar_xml import gerar_xml_s1207
    from emensageriapro.functions import identidade_evento

    if request.user.has_perm('esocial.can_create_change_s1207evtBenPrRP'):
        ...
        nova_identidade = identidade_evento(s1207_evtbenprrp, 'esocial')
        ...
        return redirect('s1207_evtbenprrp_salvar', pk=return_pk)
