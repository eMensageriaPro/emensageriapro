...
def gerar_xml_s3000(request, s3000_evtexclusao_id, versao=None):
    ...
    if s3000_evtexclusao_id:
        ...
        s3000_evtexclusao_lista = s3000evtExclusao.objects. \
            filter(id=s3000_evtexclusao_id, excluido = False).all()
...
def gerar_xml_assinado(request, s3000_evtexclusao_id):
    ...
    if s3000_evtexclusao.arquivo_original:
        ...
        xml = gerar_xml_s3000(request, s3000_evtexclusao_id)
    ...
    if 'Signature' in xml:
        ...
        if not s3000_evtexclusao.transmissor_lote_esocial:
            ...
            grupo = get_grupo(s3000evtExclusao)
        ...
        xml_assinado = assinar_esocial(request, xml, s3000_evtexclusao.transmissor_lote_esocial_id)
    ...
    if s3000_evtexclusao.status in (
        ...
        s3000evtExclusao.objects.\
            filter(id=s3000_evtexclusao_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s3000_evtexclusao_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s3000_evtexclusao_id)
