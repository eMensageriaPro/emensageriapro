...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s5011_evtcs_id:
            ...
            s5011_evtcs_form = form_s5011_evtcs(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_ESOCIAL, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
