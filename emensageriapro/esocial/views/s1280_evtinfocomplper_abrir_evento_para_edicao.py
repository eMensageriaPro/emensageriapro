...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s1280evtInfoComplPer'):
        ...
        if s1280_evtinfocomplper.status in status_list:
            ...
            s1280evtInfoComplPer.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's1280_evtinfocomplper', pk, request.user.id, 1)
