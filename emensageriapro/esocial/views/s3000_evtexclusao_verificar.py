...
def validar_evento_funcao(s3000_evtexclusao_id, db_slug):
    ...
    lista_validacoes = []
    s3000_evtexclusao = get_object_or_404(s3000evtExclusao.objects.using(db_slug), excluido=False, id=s3000_evtexclusao_id)
    if s3000_evtexclusao.transmissor_lote_esocial:
        if s3000_evtexclusao.transmissor_lote_esocial.transmissor:
            if s3000_evtexclusao.transmissor_lote_esocial.transmissor.verificar_predecessao:
