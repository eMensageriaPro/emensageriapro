...
def criar_alteracao(request, pk):
    ...
    from emensageriapro.esocial.views.s1035_evttabcarreira_gerar_xml import gerar_xml_s1035
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('esocial.can_create_change_s1035evtTabCarreira'):
        ...
        return redirect('s1035_evttabcarreira_salvar', pk=return_pk, tab='master')
