...
def read_s1030_evttabcargo(request, dados, arquivo, validar=False):
    ...
    s1030evtTabCargo.objects.filter(id=dados['id']).update(arquivo=arquivo)
...
def read_s1030_evttabcargo_obj(request, doc, status, validar=False):
    ...
    s1030_evttabcargo_dados['status'] = STATUS_EVENTO_IMPORTADO
