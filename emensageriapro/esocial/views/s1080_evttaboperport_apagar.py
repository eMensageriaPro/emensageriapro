...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if s1080_evttaboperport.status == STATUS_EVENTO_CADASTRADO:
            ...
            situacao_anterior = json.dumps(model_to_dict(s1080_evttaboperport), sort_keys=True, default=str)
        ...
        if 'return_page' in request.session and request.session['return_page'] and 's1080-evttaboperport' in request.session['return_page']:
