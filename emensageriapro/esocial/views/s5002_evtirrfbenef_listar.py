...
def listar(request, output=None):
    ...
    if request.user.has_perm('esocial.can_see_s5002evtIrrfBenef'):
        ...
        s5002_evtirrfbenef_lista = s5002evtIrrfBenef.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            response = render_to_response('csv/s5002_evtirrfbenef.csv', context)
