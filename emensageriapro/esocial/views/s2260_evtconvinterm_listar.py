...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s2260_evtconvinterm_lista = s2260evtConvInterm.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s2260_evtconvinterm.csv', context)
