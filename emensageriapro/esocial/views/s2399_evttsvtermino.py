...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        #             s2399_evttsvtermino_form.fields['status'].widget.attrs['disabled'] = True
        #             s2399_evttsvtermino_form.fields['status'].widget.attrs['readonly'] = True
        #             s2399_evttsvtermino_form.fields['transmissor_lote_esocial'].widget.attrs['disabled'] = True
