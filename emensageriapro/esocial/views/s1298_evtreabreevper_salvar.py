...
def salvar(request, hash):
    ...
    if request.user.has_perm('esocial.can_view_s1298evtReabreEvPer'):
        ...
        s1298_evtreabreevper_form = disabled_form_fields(s1298_evtreabreevper_form, request.user.has_perm('esocial.change_s1298evtReabreEvPer'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1298_evtreabreevper_id, tabela='s1298_evtreabreevper').all()
