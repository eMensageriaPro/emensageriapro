...
def validar_evento_funcao(s1000_evtinfoempregador_id, db_slug):
    ...
    lista_validacoes = []
    s1000_evtinfoempregador = get_object_or_404(s1000evtInfoEmpregador.objects.using(db_slug), excluido=False, id=s1000_evtinfoempregador_id)
    if s1000_evtinfoempregador.transmissor_lote_esocial:
        if s1000_evtinfoempregador.transmissor_lote_esocial.transmissor:
            if s1000_evtinfoempregador.transmissor_lote_esocial.transmissor.verificar_predecessao:
