...
def desvincular_evento(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s2240evtExpRisco'):
        ...
        if s2240_evtexprisco.status in status_list:
            ...
            transmissor_lote_esocial_id = s2240_evtexprisco.transmissor_lote_esocial_id

            s2240evtExpRisco.objects.filter(id=pk).update(
