...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s2206evtAltContratual'):
        ...
        if s2206_evtaltcontratual.status in status_list:
            ...
            s2206evtAltContratual.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's2206_evtaltcontratual', pk, request.user.id, 1)
