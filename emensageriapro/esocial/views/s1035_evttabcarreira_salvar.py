...
def salvar(request, hash):
    ...
    if s1035_evttabcarreira_id:
        ...
        s1035_evttabcarreira = get_object_or_404(s1035evtTabCarreira, id=s1035_evttabcarreira_id)
    ...
    if request.user.has_perm('esocial.can_view_s1035evtTabCarreira'):
        ...
        if request.method == 'POST':
            ...
            if s1035_evttabcarreira_form.is_valid():
                ...
                if not s1035_evttabcarreira_id:
        ...
        s1035_evttabcarreira_form = disabled_form_fields(s1035_evttabcarreira_form, request.user.has_perm('esocial.change_s1035evtTabCarreira'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1035_evttabcarreira_id, tabela='s1035_evttabcarreira').all()
