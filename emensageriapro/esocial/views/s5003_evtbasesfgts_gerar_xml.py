...
def gerar_xml_s5003(request, s5003_evtbasesfgts_id, versao=None):
    ...
    if s5003_evtbasesfgts_id:
        ...
        s5003_evtbasesfgts_lista = s5003evtBasesFGTS.objects. \
            filter(id=s5003_evtbasesfgts_id, excluido = False).all()
...
def gerar_xml_assinado(request, s5003_evtbasesfgts_id):
    ...
    if s5003_evtbasesfgts.arquivo_original:
        ...
        xml = gerar_xml_s5003(request, s5003_evtbasesfgts_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_esocial(request, xml, s5003_evtbasesfgts.transmissor_lote_esocial_id)
    ...
    if s5003_evtbasesfgts.status in (
        ...
        s5003evtBasesFGTS.objects.\
            filter(id=s5003_evtbasesfgts_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s5003_evtbasesfgts_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s5003_evtbasesfgts_id)
