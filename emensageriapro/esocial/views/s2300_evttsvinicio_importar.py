...
def read_s2300_evttsvinicio(request, dados, arquivo, validar=False):
    ...
    s2300evtTSVInicio.objects.filter(id=dados['id']).update(arquivo=arquivo)
...
def read_s2300_evttsvinicio_obj(request, doc, status, validar=False):
    ...
    s2300_evttsvinicio_dados['status'] = STATUS_EVENTO_IMPORTADO
