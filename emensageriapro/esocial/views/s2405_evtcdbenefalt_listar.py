...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s2405_evtcdbenefalt_lista = s2405evtCdBenefAlt.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s2405_evtcdbenefalt.csv', context)
