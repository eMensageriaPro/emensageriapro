...
def listar(request, hash):
    ...
    if request.user.has_perm('esocial.can_view_s2231evtCessao'):
        ...
        s2231_evtcessao_lista = s2231evtCessao.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s2231_evtcessao.csv', context)
