...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if request.method == 'POST':
            if s2210_evtcat_form.is_valid():
                ...
                if s2210_evtcat_id:
                    ...
                    s2210_evtcat_form = form_s2210_evtcat(request.POST or None, instance = obj, slug = db_slug)
                    gravar_auditoria('{}',
                                     json.dumps(model_to_dict(obj), indent=4, sort_keys=True, default=str),
        ...
        #             s2210_evtcat_form.fields['status'].widget.attrs['disabled'] = True
        #             s2210_evtcat_form.fields['status'].widget.attrs['readonly'] = True
        #             s2210_evtcat_form.fields['transmissor_lote_esocial'].widget.attrs['disabled'] = True
