...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if request.method == 'POST':
            if s5012_evtirrf_form.is_valid():
                ...
                if s5012_evtirrf_id:
                    ...
                    s5012_evtirrf_form = form_s5012_evtirrf(request.POST or None, instance = obj, slug = db_slug)
                    gravar_auditoria('{}',
                                     json.dumps(model_to_dict(obj), indent=4, sort_keys=True, default=str),
        ...
        #             s5012_evtirrf_form.fields['status'].widget.attrs['disabled'] = True
        #             s5012_evtirrf_form.fields['status'].widget.attrs['readonly'] = True
        #             s5012_evtirrf_form.fields['transmissor_lote_esocial'].widget.attrs['disabled'] = True
