...
def verificar(request, pk, output=None):
    ...
    if request.user.has_perm('esocial.can_see_s5002evtIrrfBenef'):
        ...
        s5002_infoirrf_lista = s5002infoIrrf.objects.filter(s5002_evtirrfbenef_id__in = listar_ids(s5002_evtirrfbenef_lista) ).all()
        s5002_basesirrf_lista = s5002basesIrrf.objects.filter(s5002_infoirrf_id__in = listar_ids(s5002_infoirrf_lista) ).all()
