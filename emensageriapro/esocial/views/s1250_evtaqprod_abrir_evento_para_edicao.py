...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s1250evtAqProd'):
        ...
        if s1250_evtaqprod.status in status_list:
            ...
            s1250evtAqProd.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's1250_evtaqprod', pk, request.user.id, 1)
    ...
    return redirect('s1250_evtaqprod_salvar', pk=pk, tab='master')