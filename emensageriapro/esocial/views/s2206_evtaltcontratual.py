...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        #             s2206_evtaltcontratual_form.fields['status'].widget.attrs['disabled'] = True
        #             s2206_evtaltcontratual_form.fields['status'].widget.attrs['readonly'] = True
        #             s2206_evtaltcontratual_form.fields['transmissor_lote_esocial'].widget.attrs['disabled'] = True
