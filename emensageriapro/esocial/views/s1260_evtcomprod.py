...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1260_evtcomprod_id:
            ...
            s1260_evtcomprod_form = form_s1260_evtcomprod(request.POST or None, slug = db_slug, initial={'versao': VERSAO_MODELO, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
