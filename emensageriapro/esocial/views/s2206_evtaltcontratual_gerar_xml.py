...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s2206_evtaltcontratual.status in STATUS_ANT:
        ...
        if 'Signature' in xml_assinado and s2206_evtaltcontratual.status in STATUS_ANT:
