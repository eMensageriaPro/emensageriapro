...
def validacoes_s2300_evttsvinicio(arquivo):
    ...
    if 'indRetif' in dir(evtTSVInicio.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.ideEvento.indRetif', evtTSVInicio.ideEvento.indRetif.cdata, 1, u'1;2')
    if 'nrRecibo' in dir(evtTSVInicio.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.ideEvento.nrRecibo', evtTSVInicio.ideEvento.nrRecibo.cdata, 0, u'')
    if 'tpAmb' in dir(evtTSVInicio.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.ideEvento.tpAmb', evtTSVInicio.ideEvento.tpAmb.cdata, 1, u'1;2')
    if 'procEmi' in dir(evtTSVInicio.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.ideEvento.procEmi', evtTSVInicio.ideEvento.procEmi.cdata, 1, u'1;2;3;4;5')
    if 'verProc' in dir(evtTSVInicio.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.ideEvento.verProc', evtTSVInicio.ideEvento.verProc.cdata, 1, u'')
    if 'tpInsc' in dir(evtTSVInicio.ideEmpregador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.ideEmpregador.tpInsc', evtTSVInicio.ideEmpregador.tpInsc.cdata, 1, u'1;2;3;4')
    if 'nrInsc' in dir(evtTSVInicio.ideEmpregador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.ideEmpregador.nrInsc', evtTSVInicio.ideEmpregador.nrInsc.cdata, 1, u'')
    if 'cpfTrab' in dir(evtTSVInicio.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.cpfTrab', evtTSVInicio.trabalhador.cpfTrab.cdata, 1, u'')
    if 'nisTrab' in dir(evtTSVInicio.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nisTrab', evtTSVInicio.trabalhador.nisTrab.cdata, 0, u'')
    if 'nmTrab' in dir(evtTSVInicio.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nmTrab', evtTSVInicio.trabalhador.nmTrab.cdata, 1, u'')
    if 'sexo' in dir(evtTSVInicio.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.sexo', evtTSVInicio.trabalhador.sexo.cdata, 1, u'M;F')
    if 'racaCor' in dir(evtTSVInicio.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.racaCor', evtTSVInicio.trabalhador.racaCor.cdata, 1, u'1;2;3;4;5;6')
    if 'estCiv' in dir(evtTSVInicio.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.estCiv', evtTSVInicio.trabalhador.estCiv.cdata, 0, u'1;2;3;4;5')
    if 'grauInstr' in dir(evtTSVInicio.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.grauInstr', evtTSVInicio.trabalhador.grauInstr.cdata, 1, u'01;02;03;04;05;06;07;08;09;10;11;12')
    if 'nmSoc' in dir(evtTSVInicio.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nmSoc', evtTSVInicio.trabalhador.nmSoc.cdata, 0, u'')
    if 'dtNascto' in dir(evtTSVInicio.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nascimento.dtNascto', evtTSVInicio.trabalhador.nascimento.dtNascto.cdata, 1, u'')
    if 'codMunic' in dir(evtTSVInicio.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nascimento.codMunic', evtTSVInicio.trabalhador.nascimento.codMunic.cdata, 0, u'')
    if 'uf' in dir(evtTSVInicio.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nascimento.uf', evtTSVInicio.trabalhador.nascimento.uf.cdata, 0, u'')
    if 'paisNascto' in dir(evtTSVInicio.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nascimento.paisNascto', evtTSVInicio.trabalhador.nascimento.paisNascto.cdata, 1, u'008;040;329;331;334;337;341;345;351;355;357;358;041;359;361;365;367;369;372;375;379;383;386;043;388;391;395;396;399;403;411;420;423;426;047;427;431;434;438;440;442;445;447;449;450;053;452;455;458;461;464;467;472;474;476;477;059;485;488;490;493;494;495;497;499;501;505;063;507;508;511;517;521;525;528;531;535;538;064;542;545;548;551;556;563;566;569;573;575;065;576;578;580;583;586;589;593;599;603;607;069;611;623;625;628;640;647;660;665;670;675;009;072;676;677;678;685;687;690;691;695;697;700;073;705;710;715;720;728;731;735;738;741;744;077;748;750;754;756;759;764;767;770;772;776;080;780;782;783;785;788;790;791;795;800;805;081;810;815;820;823;824;827;828;831;833;840;083;845;847;848;850;855;858;863;866;870;873;085;875;888;890;087;088;090;013;093;097;098;100;101;105;106;108;111;115;017;119;127;131;137;141;145;149;150;151;152;020;153;154;158;160;161;163;165;169;173;177;023;183;187;190;193;195;196;198;199;229;232;025;235;237;239;240;243;244;245;246;247;249;031;251;253;255;259;263;267;271;275;281;285;037;289;291;293;297;301;305;309;313;317;325')
    if 'paisNac' in dir(evtTSVInicio.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nascimento.paisNac', evtTSVInicio.trabalhador.nascimento.paisNac.cdata, 1, u'008;040;329;331;334;337;341;345;351;355;357;358;041;359;361;365;367;369;372;375;379;383;386;043;388;391;395;396;399;403;411;420;423;426;047;427;431;434;438;440;442;445;447;449;450;053;452;455;458;461;464;467;472;474;476;477;059;485;488;490;493;494;495;497;499;501;505;063;507;508;511;517;521;525;528;531;535;538;064;542;545;548;551;556;563;566;569;573;575;065;576;578;580;583;586;589;593;599;603;607;069;611;623;625;628;640;647;660;665;670;675;009;072;676;677;678;685;687;690;691;695;697;700;073;705;710;715;720;728;731;735;738;741;744;077;748;750;754;756;759;764;767;770;772;776;080;780;782;783;785;788;790;791;795;800;805;081;810;815;820;823;824;827;828;831;833;840;083;845;847;848;850;855;858;863;866;870;873;085;875;888;890;087;088;090;013;093;097;098;100;101;105;106;108;111;115;017;119;127;131;137;141;145;149;150;151;152;020;153;154;158;160;161;163;165;169;173;177;023;183;187;190;193;195;196;198;199;229;232;025;235;237;239;240;243;244;245;246;247;249;031;251;253;255;259;263;267;271;275;281;285;037;289;291;293;297;301;305;309;313;317;325')
    if 'nmMae' in dir(evtTSVInicio.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nascimento.nmMae', evtTSVInicio.trabalhador.nascimento.nmMae.cdata, 0, u'')
    if 'nmPai' in dir(evtTSVInicio.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.trabalhador.nascimento.nmPai', evtTSVInicio.trabalhador.nascimento.nmPai.cdata, 0, u'')
    if 'cadIni' in dir(evtTSVInicio.infoTSVInicio): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.infoTSVInicio.cadIni', evtTSVInicio.infoTSVInicio.cadIni.cdata, 1, u'S;N')
    if 'codCateg' in dir(evtTSVInicio.infoTSVInicio): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.infoTSVInicio.codCateg', evtTSVInicio.infoTSVInicio.codCateg.cdata, 1, u'101;102;103;104;105;106;111;201;202;301;302;303;305;306;307;308;309;401;410;701;711;712;721;722;723;731;734;738;741;751;761;771;781;901;902;903;904;905')
    if 'dtInicio' in dir(evtTSVInicio.infoTSVInicio): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.infoTSVInicio.dtInicio', evtTSVInicio.infoTSVInicio.dtInicio.cdata, 1, u'')
    if 'natAtividade' in dir(evtTSVInicio.infoTSVInicio): validacoes_lista = validar_campo(validacoes_lista,'evtTSVInicio.infoTSVInicio.natAtividade', evtTSVInicio.infoTSVInicio.natAtividade.cdata, 0, u'1;2')
    ...
    if 'cargoFuncao' in dir(evtTSVInicio.infoTSVInicio.infoComplementares):
        for cargoFuncao in evtTSVInicio.infoTSVInicio.infoComplementares.cargoFuncao:
            ...
            if 'codCargo' in dir(cargoFuncao): validacoes_lista = validar_campo(validacoes_lista,'cargoFuncao.codCargo', cargoFuncao.codCargo.cdata, 1, u'')
            if 'codFuncao' in dir(cargoFuncao): validacoes_lista = validar_campo(validacoes_lista,'cargoFuncao.codFuncao', cargoFuncao.codFuncao.cdata, 0, u'')
    ...
    if 'remuneracao' in dir(evtTSVInicio.infoTSVInicio.infoComplementares):
        for remuneracao in evtTSVInicio.infoTSVInicio.infoComplementares.remuneracao:
            ...
            if 'vrSalFx' in dir(remuneracao): validacoes_lista = validar_campo(validacoes_lista,'remuneracao.vrSalFx', remuneracao.vrSalFx.cdata, 1, u'')
            if 'undSalFixo' in dir(remuneracao): validacoes_lista = validar_campo(validacoes_lista,'remuneracao.undSalFixo', remuneracao.undSalFixo.cdata, 1, u'1;2;3;4;5;6;7')
            if 'dscSalVar' in dir(remuneracao): validacoes_lista = validar_campo(validacoes_lista,'remuneracao.dscSalVar', remuneracao.dscSalVar.cdata, 0, u'')
    ...
    if 'fgts' in dir(evtTSVInicio.infoTSVInicio.infoComplementares):
        for fgts in evtTSVInicio.infoTSVInicio.infoComplementares.fgts:
            ...
            if 'opcFGTS' in dir(fgts): validacoes_lista = validar_campo(validacoes_lista,'fgts.opcFGTS', fgts.opcFGTS.cdata, 1, u'1;2')
            if 'dtOpcFGTS' in dir(fgts): validacoes_lista = validar_campo(validacoes_lista,'fgts.dtOpcFGTS', fgts.dtOpcFGTS.cdata, 0, u'')
    ...
    if 'infoDirigenteSindical' in dir(evtTSVInicio.infoTSVInicio.infoComplementares):
        for infoDirigenteSindical in evtTSVInicio.infoTSVInicio.infoComplementares.infoDirigenteSindical:
            ...
            if 'categOrig' in dir(infoDirigenteSindical): validacoes_lista = validar_campo(validacoes_lista,'infoDirigenteSindical.categOrig', infoDirigenteSindical.categOrig.cdata, 1, u'')
            if 'cnpjOrigem' in dir(infoDirigenteSindical): validacoes_lista = validar_campo(validacoes_lista,'infoDirigenteSindical.cnpjOrigem', infoDirigenteSindical.cnpjOrigem.cdata, 0, u'')
            if 'dtAdmOrig' in dir(infoDirigenteSindical): validacoes_lista = validar_campo(validacoes_lista,'infoDirigenteSindical.dtAdmOrig', infoDirigenteSindical.dtAdmOrig.cdata, 0, u'')
            if 'matricOrig' in dir(infoDirigenteSindical): validacoes_lista = validar_campo(validacoes_lista,'infoDirigenteSindical.matricOrig', infoDirigenteSindical.matricOrig.cdata, 0, u'')
    ...
    if 'infoTrabCedido' in dir(evtTSVInicio.infoTSVInicio.infoComplementares):
        for infoTrabCedido in evtTSVInicio.infoTSVInicio.infoComplementares.infoTrabCedido:
            ...
            if 'categOrig' in dir(infoTrabCedido): validacoes_lista = validar_campo(validacoes_lista,'infoTrabCedido.categOrig', infoTrabCedido.categOrig.cdata, 1, u'')
            if 'cnpjCednt' in dir(infoTrabCedido): validacoes_lista = validar_campo(validacoes_lista,'infoTrabCedido.cnpjCednt', infoTrabCedido.cnpjCednt.cdata, 1, u'')
            if 'matricCed' in dir(infoTrabCedido): validacoes_lista = validar_campo(validacoes_lista,'infoTrabCedido.matricCed', infoTrabCedido.matricCed.cdata, 1, u'')
            if 'dtAdmCed' in dir(infoTrabCedido): validacoes_lista = validar_campo(validacoes_lista,'infoTrabCedido.dtAdmCed', infoTrabCedido.dtAdmCed.cdata, 1, u'')
            if 'tpRegTrab' in dir(infoTrabCedido): validacoes_lista = validar_campo(validacoes_lista,'infoTrabCedido.tpRegTrab', infoTrabCedido.tpRegTrab.cdata, 1, u'1;2')
            if 'tpRegPrev' in dir(infoTrabCedido): validacoes_lista = validar_campo(validacoes_lista,'infoTrabCedido.tpRegPrev', infoTrabCedido.tpRegPrev.cdata, 1, u'1;2;3')
            if 'infOnus' in dir(infoTrabCedido): validacoes_lista = validar_campo(validacoes_lista,'infoTrabCedido.infOnus', infoTrabCedido.infOnus.cdata, 1, u'1;2;3')
            if 'indRemunCargo' in dir(infoTrabCedido): validacoes_lista = validar_campo(validacoes_lista,'infoTrabCedido.indRemunCargo', infoTrabCedido.indRemunCargo.cdata, 0, u'S;N')
    ...
    if 'infoEstagiario' in dir(evtTSVInicio.infoTSVInicio.infoComplementares):
        for infoEstagiario in evtTSVInicio.infoTSVInicio.infoComplementares.infoEstagiario:
            ...
            if 'natEstagio' in dir(infoEstagiario): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.natEstagio', infoEstagiario.natEstagio.cdata, 1, u'O;N')
            if 'nivEstagio' in dir(infoEstagiario): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.nivEstagio', infoEstagiario.nivEstagio.cdata, 1, u'1;2;3;4;8;9')
            if 'areaAtuacao' in dir(infoEstagiario): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.areaAtuacao', infoEstagiario.areaAtuacao.cdata, 0, u'')
            if 'nrApol' in dir(infoEstagiario): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.nrApol', infoEstagiario.nrApol.cdata, 0, u'')
            if 'vlrBolsa' in dir(infoEstagiario): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.vlrBolsa', infoEstagiario.vlrBolsa.cdata, 0, u'')
            if 'dtPrevTerm' in dir(infoEstagiario): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.dtPrevTerm', infoEstagiario.dtPrevTerm.cdata, 1, u'')
            if 'cnpjInstEnsino' in dir(infoEstagiario.instEnsino): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.instEnsino.cnpjInstEnsino', infoEstagiario.instEnsino.cnpjInstEnsino.cdata, 0, u'')
            if 'nmRazao' in dir(infoEstagiario.instEnsino): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.instEnsino.nmRazao', infoEstagiario.instEnsino.nmRazao.cdata, 1, u'')
            if 'dscLograd' in dir(infoEstagiario.instEnsino): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.instEnsino.dscLograd', infoEstagiario.instEnsino.dscLograd.cdata, 0, u'')
            if 'nrLograd' in dir(infoEstagiario.instEnsino): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.instEnsino.nrLograd', infoEstagiario.instEnsino.nrLograd.cdata, 0, u'')
            if 'bairro' in dir(infoEstagiario.instEnsino): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.instEnsino.bairro', infoEstagiario.instEnsino.bairro.cdata, 0, u'')
            if 'cep' in dir(infoEstagiario.instEnsino): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.instEnsino.cep', infoEstagiario.instEnsino.cep.cdata, 0, u'')
            if 'codMunic' in dir(infoEstagiario.instEnsino): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.instEnsino.codMunic', infoEstagiario.instEnsino.codMunic.cdata, 0, u'')
            if 'uf' in dir(infoEstagiario.instEnsino): validacoes_lista = validar_campo(validacoes_lista,'infoEstagiario.instEnsino.uf', infoEstagiario.instEnsino.uf.cdata, 0, u'')

            if 'ageIntegracao' in dir(infoEstagiario):
                for ageIntegracao in infoEstagiario.ageIntegracao:

                    if 'cnpjAgntInteg' in dir(ageIntegracao): validacoes_lista = validar_campo(validacoes_lista,'ageIntegracao.cnpjAgntInteg', ageIntegracao.cnpjAgntInteg.cdata, 1, u'')
                    if 'nmRazao' in dir(ageIntegracao): validacoes_lista = validar_campo(validacoes_lista,'ageIntegracao.nmRazao', ageIntegracao.nmRazao.cdata, 1, u'')
                    if 'dscLograd' in dir(ageIntegracao): validacoes_lista = validar_campo(validacoes_lista,'ageIntegracao.dscLograd', ageIntegracao.dscLograd.cdata, 1, u'')
                    if 'nrLograd' in dir(ageIntegracao): validacoes_lista = validar_campo(validacoes_lista,'ageIntegracao.nrLograd', ageIntegracao.nrLograd.cdata, 1, u'')
                    if 'bairro' in dir(ageIntegracao): validacoes_lista = validar_campo(validacoes_lista,'ageIntegracao.bairro', ageIntegracao.bairro.cdata, 0, u'')
                    if 'cep' in dir(ageIntegracao): validacoes_lista = validar_campo(validacoes_lista,'ageIntegracao.cep', ageIntegracao.cep.cdata, 1, u'')
                    if 'codMunic' in dir(ageIntegracao): validacoes_lista = validar_campo(validacoes_lista,'ageIntegracao.codMunic', ageIntegracao.codMunic.cdata, 0, u'')
                    if 'uf' in dir(ageIntegracao): validacoes_lista = validar_campo(validacoes_lista,'ageIntegracao.uf', ageIntegracao.uf.cdata, 1, u'')

            if 'supervisorEstagio' in dir(infoEstagiario):
                for supervisorEstagio in infoEstagiario.supervisorEstagio:

                    if 'cpfSupervisor' in dir(supervisorEstagio): validacoes_lista = validar_campo(validacoes_lista,'supervisorEstagio.cpfSupervisor', supervisorEstagio.cpfSupervisor.cdata, 1, u'')
                    if 'nmSuperv' in dir(supervisorEstagio): validacoes_lista = validar_campo(validacoes_lista,'supervisorEstagio.nmSuperv', supervisorEstagio.nmSuperv.cdata, 1, u'')
    ...
    if 'termino' in dir(evtTSVInicio.infoTSVInicio):
        for termino in evtTSVInicio.infoTSVInicio.termino:
            ...
            if 'dtTerm' in dir(termino): validacoes_lista = validar_campo(validacoes_lista,'termino.dtTerm', termino.dtTerm.cdata, 1, u'')
