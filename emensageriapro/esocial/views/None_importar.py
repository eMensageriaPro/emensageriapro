...
def read_None_obj(doc, status, validar=False):
    ...
    None_dados['identidade'] = doc.eSocial.evtFGTS['Id']
    None_dados['processamento_codigo_resposta'] = 1
    evtFGTS = doc.eSocial.evtFGTS

    if 'inclusao' in dir(evtFGTS.infoFGTS): None_dados['operacao'] = 1
    elif 'alteracao' in dir(evtFGTS.infoFGTS): None_dados['operacao'] = 2
    elif 'exclusao' in dir(evtFGTS.infoFGTS): None_dados['operacao'] = 3
    #print dados
    ...
    from emensageriapro.esocial.views.None_verificar import validar_evento_funcao
