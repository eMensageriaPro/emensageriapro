    ...
    if request.user.has_perm('esocial.can_see_s1202evtRmnRPPS'):
        ...
        if request.method == 'POST':
            ...
            dict_fields = {
                ...
                'qtddepfp__icontains': 'qtddepfp__icontains',
        ...
        s1202_evtrmnrpps_lista = s1202evtRmnRPPS.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            response = render_to_response('csv/s1202_evtrmnrpps.csv', context)
