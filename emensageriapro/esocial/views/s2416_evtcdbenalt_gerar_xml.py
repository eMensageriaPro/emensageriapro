...
def gerar_xml_s2416(request, pk, versao=None):
    ...
    return gerar_xml_s2416_func(pk, versao)
...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s2416_evtcdbenalt.status in STATUS_ANT:
        ...
        if not s2416_evtcdbenalt.transmissor_lote_esocial:
        ...
        if 'Signature' in xml_assinado and s2416_evtcdbenalt.status in STATUS_ANT:
