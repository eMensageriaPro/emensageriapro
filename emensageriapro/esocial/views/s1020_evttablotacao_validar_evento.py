...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'esocial/%s/evtTabLotacao.xsd' % (s1020_evttablotacao.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 's1020_evttablotacao' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('s1020_evttablotacao', pk)
