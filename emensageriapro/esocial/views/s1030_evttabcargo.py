...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1030_evttabcargo_id:
            ...
            s1030_evttabcargo_form = form_s1030_evttabcargo(request.POST or None, slug = db_slug, initial={'versao': VERSAO_MODELO, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
