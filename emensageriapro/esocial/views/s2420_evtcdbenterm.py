...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s2420_evtcdbenterm_id:
            ...
            s2420_evtcdbenterm_form = form_s2420_evtcdbenterm(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_ESOCIAL, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
