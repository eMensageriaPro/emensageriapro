...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s1030evtTabCargo'):
        ...
        if s1030_evttabcargo.status in status_list:
            ...
            s1030evtTabCargo.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's1030_evttabcargo', pk, request.user.id, 1)
    ...
    return redirect('s1030_evttabcargo_salvar', pk=pk, tab='master')