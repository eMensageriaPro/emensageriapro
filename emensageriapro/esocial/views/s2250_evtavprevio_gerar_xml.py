...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s2250_evtavprevio.status in STATUS_ANT:
        ...
        if not s2250_evtavprevio.transmissor_lote_esocial:
        ...
        if 'Signature' in xml_assinado and s2250_evtavprevio.status in STATUS_ANT:
