...
def validacoes_s2221_evttoxic(arquivo):
    ...
    if 'cnpjLab' in dir(evtToxic.toxicologico): validacoes_lista = validar_campo(validacoes_lista,'evtToxic.toxicologico.cnpjLab', evtToxic.toxicologico.cnpjLab.cdata, 0, '')
    if 'codSeqExame' in dir(evtToxic.toxicologico): validacoes_lista = validar_campo(validacoes_lista,'evtToxic.toxicologico.codSeqExame', evtToxic.toxicologico.codSeqExame.cdata, 0, '')
    if 'nmMed' in dir(evtToxic.toxicologico): validacoes_lista = validar_campo(validacoes_lista,'evtToxic.toxicologico.nmMed', evtToxic.toxicologico.nmMed.cdata, 0, '')
    if 'nrCRM' in dir(evtToxic.toxicologico): validacoes_lista = validar_campo(validacoes_lista,'evtToxic.toxicologico.nrCRM', evtToxic.toxicologico.nrCRM.cdata, 0, '')
    if 'ufCRM' in dir(evtToxic.toxicologico): validacoes_lista = validar_campo(validacoes_lista,'evtToxic.toxicologico.ufCRM', evtToxic.toxicologico.ufCRM.cdata, 0, '')
    if 'indRecusa' in dir(evtToxic.toxicologico): validacoes_lista = validar_campo(validacoes_lista,'evtToxic.toxicologico.indRecusa', evtToxic.toxicologico.indRecusa.cdata, 1, '')
