...
def verificar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get(endereco='s1020_evttablotacao')
    ...
    if permissao.permite_listar:
        ...
        s1020_inclusao_infoprocjudterceiros_lista = s1020inclusaoinfoProcJudTerceiros.objects.filter(s1020_inclusao_id__in = listar_ids(s1020_inclusao_lista) ).all()
        s1020_inclusao_procjudterceiro_lista = s1020inclusaoprocJudTerceiro.objects.filter(s1020_inclusao_infoprocjudterceiros_id__in = listar_ids(s1020_inclusao_infoprocjudterceiros_lista) ).all()
        s1020_inclusao_infoemprparcial_lista = s1020inclusaoinfoEmprParcial.objects.filter(s1020_inclusao_id__in = listar_ids(s1020_inclusao_lista) ).all()
        s1020_alteracao_lista = s1020alteracao.objects.filter(s1020_evttablotacao_id__in = listar_ids(s1020_evttablotacao_lista) ).all()
        s1020_alteracao_infoprocjudterceiros_lista = s1020alteracaoinfoProcJudTerceiros.objects.filter(s1020_alteracao_id__in = listar_ids(s1020_alteracao_lista) ).all()
        s1020_alteracao_procjudterceiro_lista = s1020alteracaoprocJudTerceiro.objects.filter(s1020_alteracao_infoprocjudterceiros_id__in = listar_ids(s1020_alteracao_infoprocjudterceiros_lista) ).all()
        s1020_alteracao_infoemprparcial_lista = s1020alteracaoinfoEmprParcial.objects.filter(s1020_alteracao_id__in = listar_ids(s1020_alteracao_lista) ).all()
