...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'esocial/%s/evtExpRisco.xsd' % (s2240_evtexprisco.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 's2240_evtexprisco' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('s2240_evtexprisco', pk)
