...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2416_evtcdbenalt')
    ...
    if permissao.permite_listar:
        ...
        s2416_evtcdbenalt_lista = s2416evtCdBenAlt.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s2416_evtcdbenalt.csv', context)
