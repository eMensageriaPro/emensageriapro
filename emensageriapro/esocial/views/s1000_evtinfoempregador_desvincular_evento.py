...
def desvincular_evento(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s1000evtInfoEmpregador'):
        ...
        if s1000_evtinfoempregador.status in status_list:
            ...
            transmissor_lote_esocial_id = s1000_evtinfoempregador.transmissor_lote_esocial_id

            s1000evtInfoEmpregador.objects.filter(id=pk).update(
