...
def read_s5002_evtirrfbenef(request, dados, arquivo, validar=False):
    ...
    s5002evtIrrfBenef.objects.filter(id=dados['id']).update(arquivo=arquivo)
...
def read_s5002_evtirrfbenef_obj(request, doc, status, validar=False):
    ...
    s5002_evtirrfbenef_dados['status'] = STATUS_EVENTO_IMPORTADO
