...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1298_evtreabreevper_id:
            ...
            s1298_evtreabreevper_form = form_s1298_evtreabreevper(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_ESOCIAL, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
