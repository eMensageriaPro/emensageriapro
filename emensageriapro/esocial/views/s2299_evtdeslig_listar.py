    ...
    if request.user.has_perm('esocial.can_see_s2299evtDeslig'):
        ...
        if request.method == 'POST':
            ...
            dict_fields = {
                ...
                'indcumprparc__icontains': 'indcumprparc__icontains',
        ...
        s2299_evtdeslig_lista = s2299evtDeslig.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        retornos_s5001_lista = s5001evtBasesTrab.objects.all()
        retornos_s5003_lista = s5003evtBasesFGTS.objects.all()
        ...
        context = {
            ...
            'retornos_s5001_lista': retornos_s5001_lista,
            'retornos_s5003_lista': retornos_s5003_lista,
        ...
        if output == 'pdf':
            ...
            response = render_to_response('csv/s2299_evtdeslig.csv', context)
