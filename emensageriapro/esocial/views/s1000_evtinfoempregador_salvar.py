...
def salvar(request, hash):
    ...
    if request.user.has_perm('esocial.can_view_s1000evtInfoEmpregador'):
        ...
        s1000_evtinfoempregador_form = disabled_form_fields(s1000_evtinfoempregador_form, request.user.has_perm('esocial.change_s1000evtInfoEmpregador'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1000_evtinfoempregador_id, tabela='s1000_evtinfoempregador').all()
