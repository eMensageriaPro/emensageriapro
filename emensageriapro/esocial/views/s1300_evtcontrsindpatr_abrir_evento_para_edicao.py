...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('esocial.can_open_s1300evtContrSindPatr'):
        ...
        if s1300_evtcontrsindpatr.status in status_list:
            ...
            s1300evtContrSindPatr.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                's1300_evtcontrsindpatr', pk, request.user.id, 1)
    ...
    return redirect('s1300_evtcontrsindpatr_salvar', pk=pk, tab='master')