...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s1298_evtreabreevper_lista = s1298evtReabreEvPer.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s1298_evtreabreevper.csv', context)
