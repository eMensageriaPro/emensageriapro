...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s5002_evtirrfbenef_id:
            ...
            s5002_evtirrfbenef_form = form_s5002_evtirrfbenef(request.POST or None, slug = db_slug, initial={'versao': VERSAO_MODELO, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
