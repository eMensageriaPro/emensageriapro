...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if s5002_evtirrfbenef.status == 0:
            ...
            s5002evtIrrfBenef.objects.using( db_slug ).filter(id = s5002_evtirrfbenef_id).delete()
...
class s5002evtIrrfBenefList(generics.ListCreateAPIView):
    db_slug = 'default'
    queryset = s5002evtIrrfBenef.objects.using(db_slug).all()
...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s5002_evtirrfbenef_lista = s5002evtIrrfBenef.objects.using( db_slug ).filter(**dict_qs).filter(excluido = False).exclude(id=0).all()
        if not post and len(s5002_evtirrfbenef_lista) > 100:
            filtrar = True
        ...
        if for_print in (0,1):
            ...
            response = PDFTemplateResponse(
                request=request,
                template='s5002_evtirrfbenef_listar.html',
            ...
            response = render_to_response('s5002_evtirrfbenef_listar.html', context)
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('tables/s5002_evtirrfbenef_csv.html', context)
            filename = "s5002_evtirrfbenef.csv"
            response['Content-Disposition'] = 'attachment; filename=' + filename
...
def identidade_evento(s5002_evtirrfbenef_id, db_slug):
    from emensageriapro.mensageiro.models import TransmissorEventosEsocial
    dados_evento = s5002evtIrrfBenef.objects.using( db_slug ).get(id=s5002_evtirrfbenef_id)
    identidade = 'ID'
    ...
    while existe:
        ...
        if not lista_eventos:
            s5002evtIrrfBenef.objects.using(db_slug).filter(id=s5002_evtirrfbenef_id).update(identidade=identidade_temp)
            existe = False
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s5002_evtirrfbenef_id:
            ...
            s5002_evtirrfbenef_form = form_s5002_evtirrfbenef(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_ESOCIAL, 'status': 0, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
        if request.method == 'POST':
            if s5002_evtirrfbenef_form.is_valid():
                ...
                if s5002_evtirrfbenef_id:
                    if s5002_evtirrfbenef.status == 0:
                        ...
                        #s5002_evtirrfbenef_campos_multiple_passo1
                        s5002evtIrrfBenef.objects.using(db_slug).filter(id=s5002_evtirrfbenef_id).update(**dados)
                        obj = s5002evtIrrfBenef.objects.using(db_slug).get(id=s5002_evtirrfbenef_id)
                        #s5002_evtirrfbenef_editar_custom
                        #s5002_evtirrfbenef_campos_multiple_passo2
                    ...
                    #s5002_evtirrfbenef_cadastrar_campos_multiple_passo1
                    obj = s5002evtIrrfBenef(**dados)
                    obj.save(using = db_slug)
                    #s5002_evtirrfbenef_cadastrar_custom
                    #s5002_evtirrfbenef_cadastrar_campos_multiple_passo2
                    identidade_evento(obj.id, db_slug)
                    messages.success(request, 'Cadastrado com sucesso!')
                    s5002_evtirrfbenef_form = form_s5002_evtirrfbenef(request.POST or None, instance = obj, slug = db_slug)
                    gravar_auditoria('{}',
                                     json.dumps(model_to_dict(obj), indent=4, sort_keys=True, default=str),
        ...
        if s5002_evtirrfbenef_id:
            ...
            s5002_infoirrf_form = form_s5002_infoirrf(initial={ 's5002_evtirrfbenef': s5002_evtirrfbenef }, slug=db_slug)
            s5002_infoirrf_form.fields['s5002_evtirrfbenef'].widget.attrs['readonly'] = True
            s5002_infoirrf_lista = s5002infoIrrf.objects.using( db_slug ).filter(excluido = False, s5002_evtirrfbenef_id=s5002_evtirrfbenef.id).all()
        else:
        ...
        #             s5002_evtirrfbenef_form.fields['tpamb'].widget.attrs['disabled'] = True
        #             s5002_evtirrfbenef_form.fields['tpamb'].widget.attrs['readonly'] = True
        #             s5002_evtirrfbenef_form.fields['tpamb'].value = TP_AMB
        #             s5002_evtirrfbenef_form.fields['procemi'].widget.attrs['disabled'] = True
        #             s5002_evtirrfbenef_form.fields['procemi'].widget.attrs['readonly'] = True
        ...
        #             s5002_evtirrfbenef_form.fields['status'].widget.attrs['disabled'] = True
        #             s5002_evtirrfbenef_form.fields['status'].widget.attrs['readonly'] = True
        #             s5002_evtirrfbenef_form.fields['transmissor_lote_esocial'].widget.attrs['disabled'] = True
        ...
        controle_alteracoes = Auditoria.objects.using( db_slug ).filter(identidade=s5002_evtirrfbenef_id, tabela='s5002_evtirrfbenef').all()
        context = {
