...
def criar_exclusao(request, pk):
    ...
    from emensageriapro.esocial.views.s1202_evtrmnrpps_gerar_xml import gerar_xml_s1202
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('esocial.can_create_delete_s1202evtRmnRPPS'):
        ...
        return redirect('s1202_evtrmnrpps_salvar', pk=return_pk, tab='master')
