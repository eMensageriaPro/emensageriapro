...
def gerar_xml_s1040(request, s1040_evttabfuncao_id, versao=None):
    ...
    if s1040_evttabfuncao_id:
        ...
        s1040_evttabfuncao_lista = s1040evtTabFuncao.objects. \
            filter(id=s1040_evttabfuncao_id, excluido = False).all()
...
def gerar_xml_assinado(request, s1040_evttabfuncao_id):
    ...
    if s1040_evttabfuncao.arquivo_original:
        ...
        xml = gerar_xml_s1040(request, s1040_evttabfuncao_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_esocial(request, xml, s1040_evttabfuncao.transmissor_lote_esocial_id)
    ...
    if s1040_evttabfuncao.status in (
        ...
        s1040evtTabFuncao.objects.\
            filter(id=s1040_evttabfuncao_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if s1040_evttabfuncao_id:
        ...
        xml_assinado = gerar_xml_assinado(request, s1040_evttabfuncao_id)
