...
def gerar_xml_s1040_func(pk, versao=None):
...
def gerar_xml_s1040(request, pk, versao=None):
    ...
    return gerar_xml_s1040_func(pk, versao)
...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and s1040_evttabfuncao.status in STATUS_ANT:
        ...
        if 'Signature' in xml_assinado and s1040_evttabfuncao.status in STATUS_ANT:
