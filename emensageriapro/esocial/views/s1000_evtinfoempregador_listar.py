...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s1000_evtinfoempregador_lista = s1000evtInfoEmpregador.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s1000_evtinfoempregador.csv', context)
