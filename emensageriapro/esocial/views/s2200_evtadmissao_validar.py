...
def validacoes_s2200_evtadmissao(arquivo):
    ...
    if 'indRetif' in dir(evtAdmissao.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.ideEvento.indRetif', evtAdmissao.ideEvento.indRetif.cdata, 1, '1;2')
    if 'nrRecibo' in dir(evtAdmissao.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.ideEvento.nrRecibo', evtAdmissao.ideEvento.nrRecibo.cdata, 0, '')
    if 'tpAmb' in dir(evtAdmissao.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.ideEvento.tpAmb', evtAdmissao.ideEvento.tpAmb.cdata, 1, '1;2')
    if 'procEmi' in dir(evtAdmissao.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.ideEvento.procEmi', evtAdmissao.ideEvento.procEmi.cdata, 1, '1;2;3;4;5')
    if 'verProc' in dir(evtAdmissao.ideEvento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.ideEvento.verProc', evtAdmissao.ideEvento.verProc.cdata, 1, '')
    if 'tpInsc' in dir(evtAdmissao.ideEmpregador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.ideEmpregador.tpInsc', evtAdmissao.ideEmpregador.tpInsc.cdata, 1, '1;2;3;4')
    if 'nrInsc' in dir(evtAdmissao.ideEmpregador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.ideEmpregador.nrInsc', evtAdmissao.ideEmpregador.nrInsc.cdata, 1, '')
    if 'cpfTrab' in dir(evtAdmissao.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.cpfTrab', evtAdmissao.trabalhador.cpfTrab.cdata, 1, '')
    if 'nisTrab' in dir(evtAdmissao.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nisTrab', evtAdmissao.trabalhador.nisTrab.cdata, 1, '')
    if 'nmTrab' in dir(evtAdmissao.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nmTrab', evtAdmissao.trabalhador.nmTrab.cdata, 1, '')
    if 'sexo' in dir(evtAdmissao.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.sexo', evtAdmissao.trabalhador.sexo.cdata, 1, 'M;F')
    if 'racaCor' in dir(evtAdmissao.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.racaCor', evtAdmissao.trabalhador.racaCor.cdata, 1, '1;2;3;4;5;6')
    if 'estCiv' in dir(evtAdmissao.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.estCiv', evtAdmissao.trabalhador.estCiv.cdata, 0, '1;2;3;4;5')
    if 'grauInstr' in dir(evtAdmissao.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.grauInstr', evtAdmissao.trabalhador.grauInstr.cdata, 1, '01;02;03;04;05;06;07;08;09;10;11;12')
    if 'indPriEmpr' in dir(evtAdmissao.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.indPriEmpr', evtAdmissao.trabalhador.indPriEmpr.cdata, 0, 'S;N')
    if 'nmSoc' in dir(evtAdmissao.trabalhador): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nmSoc', evtAdmissao.trabalhador.nmSoc.cdata, 0, '')
    if 'dtNascto' in dir(evtAdmissao.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nascimento.dtNascto', evtAdmissao.trabalhador.nascimento.dtNascto.cdata, 1, '')
    if 'codMunic' in dir(evtAdmissao.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nascimento.codMunic', evtAdmissao.trabalhador.nascimento.codMunic.cdata, 0, '')
    if 'uf' in dir(evtAdmissao.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nascimento.uf', evtAdmissao.trabalhador.nascimento.uf.cdata, 0, '')
    if 'paisNascto' in dir(evtAdmissao.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nascimento.paisNascto', evtAdmissao.trabalhador.nascimento.paisNascto.cdata, 1, '008;040;329;331;334;337;341;345;351;355;357;358;041;359;361;365;367;369;372;375;379;383;386;043;388;391;395;396;399;403;411;420;423;426;047;427;431;434;438;440;442;445;447;449;450;053;452;455;458;461;464;467;472;474;476;477;059;485;488;490;493;494;495;497;499;501;505;063;507;508;511;517;521;525;528;531;535;538;064;542;545;548;551;556;563;566;569;573;575;065;576;578;580;583;586;589;593;599;603;607;069;611;623;625;628;640;647;660;665;670;675;009;072;676;677;678;685;687;690;691;695;697;700;073;705;710;715;720;728;731;735;738;741;744;077;748;750;754;756;759;764;767;770;772;776;080;780;782;783;785;788;790;791;795;800;805;081;810;815;820;823;824;827;828;831;833;840;083;845;847;848;850;855;858;863;866;870;873;085;875;888;890;087;088;090;013;093;097;098;100;101;105;106;108;111;115;017;119;127;131;137;141;145;149;150;151;152;020;153;154;158;160;161;163;165;169;173;177;023;183;187;190;193;195;196;198;199;229;232;025;235;237;239;240;243;244;245;246;247;249;031;251;253;255;259;263;267;271;275;281;285;037;289;291;293;297;301;305;309;313;317;325')
    if 'paisNac' in dir(evtAdmissao.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nascimento.paisNac', evtAdmissao.trabalhador.nascimento.paisNac.cdata, 1, '008;040;329;331;334;337;341;345;351;355;357;358;041;359;361;365;367;369;372;375;379;383;386;043;388;391;395;396;399;403;411;420;423;426;047;427;431;434;438;440;442;445;447;449;450;053;452;455;458;461;464;467;472;474;476;477;059;485;488;490;493;494;495;497;499;501;505;063;507;508;511;517;521;525;528;531;535;538;064;542;545;548;551;556;563;566;569;573;575;065;576;578;580;583;586;589;593;599;603;607;069;611;623;625;628;640;647;660;665;670;675;009;072;676;677;678;685;687;690;691;695;697;700;073;705;710;715;720;728;731;735;738;741;744;077;748;750;754;756;759;764;767;770;772;776;080;780;782;783;785;788;790;791;795;800;805;081;810;815;820;823;824;827;828;831;833;840;083;845;847;848;850;855;858;863;866;870;873;085;875;888;890;087;088;090;013;093;097;098;100;101;105;106;108;111;115;017;119;127;131;137;141;145;149;150;151;152;020;153;154;158;160;161;163;165;169;173;177;023;183;187;190;193;195;196;198;199;229;232;025;235;237;239;240;243;244;245;246;247;249;031;251;253;255;259;263;267;271;275;281;285;037;289;291;293;297;301;305;309;313;317;325')
    if 'nmMae' in dir(evtAdmissao.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nascimento.nmMae', evtAdmissao.trabalhador.nascimento.nmMae.cdata, 0, '')
    if 'nmPai' in dir(evtAdmissao.trabalhador.nascimento): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.trabalhador.nascimento.nmPai', evtAdmissao.trabalhador.nascimento.nmPai.cdata, 0, '')
    if 'matricula' in dir(evtAdmissao.vinculo): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.vinculo.matricula', evtAdmissao.vinculo.matricula.cdata, 1, '')
    if 'tpRegTrab' in dir(evtAdmissao.vinculo): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.vinculo.tpRegTrab', evtAdmissao.vinculo.tpRegTrab.cdata, 1, '1;2')
    if 'tpRegPrev' in dir(evtAdmissao.vinculo): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.vinculo.tpRegPrev', evtAdmissao.vinculo.tpRegPrev.cdata, 1, '1;2;3')
    ...
    if 'undSalFixo' in dir(evtAdmissao.vinculo.infoContrato.remuneracao): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.vinculo.infoContrato.remuneracao.undSalFixo', evtAdmissao.vinculo.infoContrato.remuneracao.undSalFixo.cdata, 1, '1;2;3;4;5;6;7')
    if 'dscSalVar' in dir(evtAdmissao.vinculo.infoContrato.remuneracao): validacoes_lista = validar_campo(validacoes_lista,'evtAdmissao.vinculo.infoContrato.remuneracao.dscSalVar', evtAdmissao.vinculo.infoContrato.remuneracao.dscSalVar.cdata, 0, '')
    ...
    if 'infoDeficiencia' in dir(evtAdmissao.trabalhador):
        for infoDeficiencia in evtAdmissao.trabalhador.infoDeficiencia:
            ...
            if 'infoCota' in dir(infoDeficiencia): validacoes_lista = validar_campo(validacoes_lista,'infoDeficiencia.infoCota', infoDeficiencia.infoCota.cdata, 1, 'S;N')
    ...
    if 'infoCeletista' in dir(evtAdmissao.vinculo.infoRegimeTrab):
        for infoCeletista in evtAdmissao.vinculo.infoRegimeTrab.infoCeletista:
            ...
            if 'dtAdm' in dir(infoCeletista): validacoes_lista = validar_campo(validacoes_lista,'infoCeletista.dtAdm', infoCeletista.dtAdm.cdata, 1, '')
            if 'tpAdmissao' in dir(infoCeletista): validacoes_lista = validar_campo(validacoes_lista,'infoCeletista.tpAdmissao', infoCeletista.tpAdmissao.cdata, 1, '1;2;3;4;5')
            if 'indAdmissao' in dir(infoCeletista): validacoes_lista = validar_campo(validacoes_lista,'infoCeletista.indAdmissao', infoCeletista.indAdmissao.cdata, 1, '1;2;3')
            ...
            if 'opcFGTS' in dir(infoCeletista.FGTS): validacoes_lista = validar_campo(validacoes_lista,'infoCeletista.FGTS.opcFGTS', infoCeletista.FGTS.opcFGTS.cdata, 1, '1;2')
            if 'dtOpcFGTS' in dir(infoCeletista.FGTS): validacoes_lista = validar_campo(validacoes_lista,'infoCeletista.FGTS.dtOpcFGTS', infoCeletista.FGTS.dtOpcFGTS.cdata, 0, '')

            if 'trabTemporario' in dir(infoCeletista):
                for trabTemporario in infoCeletista.trabTemporario:
               
                    if 'hipLeg' in dir(trabTemporario): validacoes_lista = validar_campo(validacoes_lista,'trabTemporario.hipLeg', trabTemporario.hipLeg.cdata, 1, '1;2')
                    if 'justContr' in dir(trabTemporario): validacoes_lista = validar_campo(validacoes_lista,'trabTemporario.justContr', trabTemporario.justContr.cdata, 1, '')
                    if 'tpInclContr' in dir(trabTemporario): validacoes_lista = validar_campo(validacoes_lista,'trabTemporario.tpInclContr', trabTemporario.tpInclContr.cdata, 1, '1;2;3')
                    if 'tpInsc' in dir(trabTemporario): validacoes_lista = validar_campo(validacoes_lista,'trabTemporario.tpInsc', trabTemporario.tpInsc.cdata, 1, '1;2;3;4')
                    if 'nrInsc' in dir(trabTemporario): validacoes_lista = validar_campo(validacoes_lista,'trabTemporario.nrInsc', trabTemporario.nrInsc.cdata, 1, '')
    ...
    if 'infoEstatutario' in dir(evtAdmissao.vinculo.infoRegimeTrab):
        for infoEstatutario in evtAdmissao.vinculo.infoRegimeTrab.infoEstatutario:
            ...
            if 'indProvim' in dir(infoEstatutario): validacoes_lista = validar_campo(validacoes_lista,'infoEstatutario.indProvim', infoEstatutario.indProvim.cdata, 1, '1;2')
            if 'tpProv' in dir(infoEstatutario): validacoes_lista = validar_campo(validacoes_lista,'infoEstatutario.tpProv', infoEstatutario.tpProv.cdata, 1, '1;2;3;4;5;6;99')
            ...
            if 'infoDecJud' in dir(infoEstatutario):
                for infoDecJud in infoEstatutario.infoDecJud:
                    ...
                    if 'nrProcJud' in dir(infoDecJud): validacoes_lista = validar_campo(validacoes_lista,'infoDecJud.nrProcJud', infoDecJud.nrProcJud.cdata, 1, '')
