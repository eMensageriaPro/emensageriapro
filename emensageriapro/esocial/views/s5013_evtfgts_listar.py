...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5013_evtfgts')
    ...
    if permissao.permite_listar:
        ...
        s5013_evtfgts_lista = s5013evtFGTS.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/s5013_evtfgts.csv', context)
