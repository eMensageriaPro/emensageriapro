...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s2298_evtreintegr_id:
            ...
            s2298_evtreintegr_form = form_s2298_evtreintegr(request.POST or None, slug = db_slug, initial={'versao': VERSAO_MODELO, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
