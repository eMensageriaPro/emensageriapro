...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if s1070_evttabprocesso.status == STATUS_EVENTO_CADASTRADO:
            ...
            situacao_anterior = json.dumps(model_to_dict(s1070_evttabprocesso), sort_keys=True, default=str)
        ...
        if 'return_page' in request.session and request.session['return_page'] and 's1070-evttabprocesso' in request.session['return_page']:
