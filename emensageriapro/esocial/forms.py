...
class form_s2420_evtcdbenterm(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['nrrecibo'].widget.attrs['required'] = True
...
class form_s2410_evtcdbenin(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['cnpjorigem'].widget.attrs['required'] = True
...
class form_s2405_evtcdbenefalt(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['nmpai'].widget.attrs['required'] = True
        
        self.fields['nmmae'].widget.attrs['required'] = True
        
        self.fields['paisnac'].widget.attrs['required'] = True
        
        self.fields['dtincfismen'].widget.attrs['required'] = True
        
        self.fields['incfismen'].widget.attrs['required'] = True
        
        self.fields['estciv'].widget.attrs['required'] = True
        ...
        self.fields['nisbenef'].widget.attrs['required'] = True
...
class form_s2399_evttsvtermino(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['vralim'].widget.attrs['required'] = True
        
        self.fields['percaliment'].widget.attrs['required'] = True
...
class form_s2300_evttsvinicio(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['nmsoc'].widget.attrs['required'] = True
...
class form_s2299_evtdeslig(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['nrproctrab'].widget.attrs['required'] = True
        
        self.fields['nrcertobito'].widget.attrs['required'] = True
        ...
        self.fields['dtprojfimapi'].widget.attrs['required'] = True
...
class form_s2298_evtreintegr(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['nrleianistia'].widget.attrs['required'] = True
...
class form_s2260_evtconvinterm(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['dscjornada'].widget.attrs['required'] = True
...
class form_s2245_evttreicap(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['obstreicap'].widget.attrs['required'] = True
...
class form_s2220_evtmonit(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['ufconsclasse'].widget.attrs['required'] = True
...
class form_s2210_evtcat(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['dtobito'].widget.attrs['required'] = True
        ...
        self.fields['obscat'].widget.attrs['required'] = True
        
        self.fields['observacao'].widget.attrs['required'] = True
        
        self.fields['tplocal'].widget.attrs['required'] = True
        
        self.fields['dsclocal'].widget.attrs['required'] = True
...
class form_s2206_evtaltcontratual(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['dtef'].widget.attrs['required'] = True
        
        self.fields['dscalt'].widget.attrs['required'] = True
        ...
        self.fields['dtingrcarr'].widget.attrs['required'] = True
        ...
        self.fields['objdet'].widget.attrs['required'] = True
...
class form_s2200_evtadmissao(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['indpriempr'].widget.attrs['required'] = True
        ...
        self.fields['nrrecinfprelim'].widget.attrs['required'] = True
        
        self.fields['cadini'].widget.attrs['required'] = True
        
        self.fields['codcargo'].widget.attrs['required'] = True
        
        self.fields['dtingrcargo'].widget.attrs['required'] = True
        ...
        self.fields['clauassec'].widget.attrs['required'] = True
...
class form_s1299_evtfechaevper(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['compsemmovto'].widget.attrs['required'] = True
...
class form_s1202_evtrmnrpps(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['qtddepfp'].widget.attrs['required'] = True
