...
def salvar(request, hash):
    ...
    if s2400_endereco_id:
        ...
        s2400_endereco = get_object_or_404(s2400endereco, id=s2400_endereco_id)
        dados_evento = s2400_endereco.evento()

    if request.user.has_perm('s2400.can_view_s2400endereco'):
        ...
        s2400_endereco_form = disabled_form_fields(s2400_endereco_form, request.user.has_perm('s2400.change_s2400endereco'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2400_endereco_id, tabela='s2400_endereco').all()
