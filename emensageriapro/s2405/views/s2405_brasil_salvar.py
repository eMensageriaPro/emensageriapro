...
def salvar(request, hash):
    ...
    if s2405_brasil_id:
        ...
        s2405_brasil = get_object_or_404(s2405brasil, id=s2405_brasil_id)
        dados_evento = s2405_brasil.evento()

    if request.user.has_perm('s2405.can_view_s2405brasil'):
        ...
        s2405_brasil_form = disabled_form_fields(s2405_brasil_form, request.user.has_perm('s2405.change_s2405brasil'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2405_brasil_id, tabela='s2405_brasil').all()
