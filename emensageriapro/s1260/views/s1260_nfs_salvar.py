...
def salvar(request, hash):
    ...
    if s1260_nfs_id:
        ...
        s1260_nfs = get_object_or_404(s1260nfs, id=s1260_nfs_id)
    ...
    if request.user.has_perm('s1260.can_view_s1260nfs'):
        ...
        s1260_nfs_form = disabled_form_fields(s1260_nfs_form, request.user.has_perm('s1260.change_s1260nfs'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1260_nfs_id, tabela='s1260_nfs').all()
