...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1260_tpcomerc')
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = { 
                's1260_evtcomprod__icontains': 's1260_evtcomprod__icontains',
                'indcomerc__icontains': 'indcomerc__icontains',
                'vrtotcom__icontains': 'vrtotcom__icontains', }
        ...
        s1260_tpcomerc_lista = s1260tpComerc.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1260_tpcomerc_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1260_tpcomerc.csv', context)
