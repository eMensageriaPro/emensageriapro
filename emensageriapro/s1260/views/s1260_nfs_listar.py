...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1260_nfs')
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = { 
                's1260_ideadquir__icontains': 's1260_ideadquir__icontains',
        ...
        s1260_nfs_lista = s1260nfs.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1260_nfs_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1260_nfs.csv', context)
