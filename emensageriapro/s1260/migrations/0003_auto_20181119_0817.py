# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-19 08:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('s1260', '0002_auto_20181010_2107'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='s1260infoprocjud',
            options={'managed': True, 'ordering': ['s1260_tpcomerc', 'tpproc', 'nrproc', 'codsusp']},
        ),
        migrations.AlterModelOptions(
            name='s1260nfs',
            options={'managed': True, 'ordering': ['s1260_ideadquir', 'nrdocto', 'dtemisnf', 'vlrbruto', 'vrcpdescpr', 'vrratdescpr', 'vrsenardesc']},
        ),
