...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r9001_infototal_id:
            r9001_infototal_form = form_r9001_infototal(request.POST or None, instance = r9001_infototal,  
        ...
        r9001_infototal_form = disabled_form_fields(r9001_infototal_form, permissao.permite_editar)
