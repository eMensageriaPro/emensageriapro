...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r9001_rrecrepad_id:
            r9001_rrecrepad_form = form_r9001_rrecrepad(request.POST or None, instance = r9001_rrecrepad,  
        ...
        r9001_rrecrepad_form = disabled_form_fields(r9001_rrecrepad_form, permissao.permite_editar)
