...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r9001_rcprb = get_object_or_404(r9001RCPRB, id=pk)
        evento_dados = r9001_rcprb.evento()
    ...
    if request.user.has_perm('r9001.can_see_r9001RCPRB'):
        ...
        r9001_rcprb_form = disabled_form_fields(
            r9001_rcprb_form, 
            request.user.has_perm('r9001.change_r9001RCPRB'))
        ...
        if tab or 'r9001_rcprb' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r9001_rcprb_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r9001_rcprb').all()
