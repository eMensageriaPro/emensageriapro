...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r9001_infocrtom = get_object_or_404(r9001infoCRTom, id=pk)
        evento_dados = r9001_infocrtom.evento()
    ...
    if request.user.has_perm('r9001.can_see_r9001infoCRTom'):
        ...
        if request.method == 'POST':
            ...
            if r9001_infocrtom_form.is_valid():
                ...
                if request.session['return_page'] not in (
                    'r9001_infocrtom_apagar', 
                    'r9001_infocrtom_salvar', 
                    'r9001_infocrtom'):
        ...
        r9001_infocrtom_form = disabled_form_fields(
            r9001_infocrtom_form, 
            request.user.has_perm('r9001.change_r9001infoCRTom'))
        ...
        if tab or 'r9001_infocrtom' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r9001_infocrtom_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r9001_infocrtom').all()
