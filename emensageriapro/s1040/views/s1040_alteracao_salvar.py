...
def salvar(request, hash):
    ...
    if s1040_alteracao_id:
        ...
        s1040_alteracao = get_object_or_404(s1040alteracao, id=s1040_alteracao_id)
        dados_evento = s1040_alteracao.evento()

    if request.user.has_perm('s1040.can_view_s1040alteracao'):
        ...
        s1040_alteracao_form = disabled_form_fields(s1040_alteracao_form, request.user.has_perm('s1040.change_s1040alteracao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1040_alteracao_id, tabela='s1040_alteracao').all()
