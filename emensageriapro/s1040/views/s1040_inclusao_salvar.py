...
def salvar(request, hash):
    ...
    if s1040_inclusao_id:
        ...
        s1040_inclusao = get_object_or_404(s1040inclusao, id=s1040_inclusao_id)
        dados_evento = s1040_inclusao.evento()

    if request.user.has_perm('s1040.can_view_s1040inclusao'):
        ...
        s1040_inclusao_form = disabled_form_fields(s1040_inclusao_form, request.user.has_perm('s1040.change_s1040inclusao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1040_inclusao_id, tabela='s1040_inclusao').all()
