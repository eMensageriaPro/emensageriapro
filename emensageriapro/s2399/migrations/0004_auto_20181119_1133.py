# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-19 11:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s2399mudancacpf_criado_por', to='controle_de_acesso.Usuarios')),
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='s2399mudancacpf_modificado_por', to='controle_de_acesso.Usuarios')),
                ('s2399_evttsvtermino', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2399mudancacpf_s2399_evttsvtermino', to='esocial.s2399evtTSVTermino')),
            ],
            options={
                'ordering': ['s2399_evttsvtermino', 'novocpf'],
                'db_table': 's2399_mudancacpf',
                'managed': True,
            },
        ),
        ...
        migrations.AlterModelOptions(
            name='s2399detoper',
            options={'managed': True, 'ordering': ['s2399_ideestablot', 'cnpjoper', 'regans', 'vrpgtit']},
        ),
        migrations.AlterModelOptions(
            name='s2399detplano',
            options={'managed': True, 'ordering': ['s2399_detoper', 'tpdep', 'nmdep', 'dtnascto', 'vlrpgdep']},
        ),
        migrations.AlterModelOptions(
            name='s2399detverbas',
            options={'managed': True, 'ordering': ['s2399_ideestablot', 'codrubr', 'idetabrubr', 'vrrubr']},
        ),
        migrations.AlterModelOptions(
            name='s2399dmdev',
            options={'managed': True, 'ordering': ['s2399_evttsvtermino', 'idedmdev']},
        ),
        migrations.AlterModelOptions(
            name='s2399infomv',
            options={'managed': True, 'ordering': ['s2399_evttsvtermino', 'indmv']},
        ),
        migrations.AlterModelOptions(
            name='s2399procjudtrab',
            options={'managed': True, 'ordering': ['s2399_evttsvtermino', 'tptrib', 'nrprocjud']},
        ),
        migrations.RemoveField(
        ...
        migrations.AddField(
            model_name='s2399detoper',
            name='s2399_ideestablot',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2399detoper_s2399_ideestablot', to='s2399.s2399ideEstabLot'),
        ),
        migrations.AddField(
            model_name='s2399dmdev',
            name='s2399_evttsvtermino',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2399dmdev_s2399_evttsvtermino', to='esocial.s2399evtTSVTermino'),
        ),
        migrations.AddField(
            model_name='s2399infomv',
            name='s2399_evttsvtermino',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2399infomv_s2399_evttsvtermino', to='esocial.s2399evtTSVTermino'),
        ),
        migrations.AddField(
            model_name='s2399procjudtrab',
            name='s2399_evttsvtermino',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s2399procjudtrab_s2399_evttsvtermino', to='esocial.s2399evtTSVTermino'),
        ),
