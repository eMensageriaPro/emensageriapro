...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2399_detverbas')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s2399_detverbas_id:
        s2399_detverbas = get_object_or_404(s2399detVerbas, id = s2399_detverbas_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2399_detverbas_id, tabela='s2399_detverbas').all()
        context = {
