...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2399_infosaudecolet')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2399_infosaudecolet_id:
            s2399_infosaudecolet_form = form_s2399_infosaudecolet(request.POST or None, instance = s2399_infosaudecolet,  
