...
def salvar(request, hash):
    ...
    if s2399_infosaudecolet_id:
        ...
        s2399_infosaudecolet = get_object_or_404(s2399infoSaudeColet, id=s2399_infosaudecolet_id)
        dados_evento = s2399_infosaudecolet.evento()

    if request.user.has_perm('s2399.can_view_s2399infoSaudeColet'):
        ...
        if request.method == 'POST':
            ...
            if s2399_infosaudecolet_form.is_valid():
                ...
                if not s2399_infosaudecolet_id:
        ...
        s2399_infosaudecolet_form = disabled_form_fields(s2399_infosaudecolet_form, request.user.has_perm('s2399.change_s2399infoSaudeColet'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2399_infosaudecolet_id, tabela='s2399_infosaudecolet').all()
