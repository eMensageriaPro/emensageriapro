...
def salvar(request, hash):
    ...
    if request.user.has_perm('s2399.can_view_s2399detOper'):
        ...
        s2399_detoper_form = disabled_form_fields(s2399_detoper_form, request.user.has_perm('s2399.change_s2399detOper'))
