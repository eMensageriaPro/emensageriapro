...
def listar(request, output=None):
    ...
    if request.user.has_perm('s2399.can_see_s2399infoSaudeColet'):
        ...
        s2399_infosaudecolet_lista = s2399infoSaudeColet.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s2399_infosaudecolet.csv', context)
