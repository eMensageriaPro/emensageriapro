...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2399_remunoutrempr')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2399_remunoutrempr_id:
            s2399_remunoutrempr_form = form_s2399_remunoutrempr(request.POST or None, instance = s2399_remunoutrempr,  
