...
def listar(request, output=None):
    ...
    if request.user.has_perm('s2399.can_see_s2399procJudTrab'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's2399_verbasresc__icontains': 's2399_verbasresc__icontains',
        ...
        s2399_procjudtrab_lista = s2399procJudTrab.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s2399_verbasresc_lista = s2399verbasResc.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s2399_procjudtrab.csv', context)
