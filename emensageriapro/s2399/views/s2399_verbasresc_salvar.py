...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2399_verbasresc')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s2399_verbasresc_id:
        s2399_verbasresc = get_object_or_404(s2399verbasResc, id = s2399_verbasresc_id)
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2399_verbasresc_id:
            s2399_verbasresc_form = form_s2399_verbasresc(request.POST or None, instance = s2399_verbasresc,  
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2399_verbasresc_id, tabela='s2399_verbasresc').all()
        context = {
