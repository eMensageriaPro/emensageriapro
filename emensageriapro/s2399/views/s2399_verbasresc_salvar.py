...
def salvar(request, hash):
    ...
    if request.user.has_perm('s2399.can_view_s2399verbasResc'):
        ...
        s2399_verbasresc_form = disabled_form_fields(s2399_verbasresc_form, request.user.has_perm('s2399.change_s2399verbasResc'))
