...
def salvar(request, hash):
    ...
    if s2399_procjudtrab_id:
        ...
        s2399_procjudtrab = get_object_or_404(s2399procJudTrab, id=s2399_procjudtrab_id)
        dados_evento = s2399_procjudtrab.evento()

    if request.user.has_perm('s2399.can_view_s2399procJudTrab'):
        ...
        s2399_procjudtrab_form = disabled_form_fields(s2399_procjudtrab_form, request.user.has_perm('s2399.change_s2399procJudTrab'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2399_procjudtrab_id, tabela='s2399_procjudtrab').all()
