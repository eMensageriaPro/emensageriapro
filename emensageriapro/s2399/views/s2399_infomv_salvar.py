...
def salvar(request, hash):
    ...
    if s2399_infomv_id:
        ...
        s2399_infomv = get_object_or_404(s2399infoMV, id=s2399_infomv_id)
        dados_evento = s2399_infomv.evento()

    if request.user.has_perm('s2399.can_view_s2399infoMV'):
        ...
        s2399_infomv_form = disabled_form_fields(s2399_infomv_form, request.user.has_perm('s2399.change_s2399infoMV'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2399_infomv_id, tabela='s2399_infomv').all()
