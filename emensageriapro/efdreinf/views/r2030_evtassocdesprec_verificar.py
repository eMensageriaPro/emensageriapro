...
def gerar_xml_assinado(r2030_evtassocdesprec_id, db_slug):
    ...
    if r2030_evtassocdesprec.status in (0,1,2,11):
        ...
        r2030evtAssocDespRec.objects.using(db_slug).\
            filter(id=r2030_evtassocdesprec_id,excluido=False).update(status=10)
...
def alterar_identidade(request, hash):
    ...
    if r2030_evtassocdesprec_id:
        ...
        if r2030_evtassocdesprec.status == 0:
            ...
            nova_identidade = identidade_evento(r2030_evtassocdesprec_id, db_slug)
...
def abrir_evento_para_edicao(request, hash):
    ...
    if r2030_evtassocdesprec_id:
        ...
        if r2030_evtassocdesprec.status in (0, 1, 2, 3, 4, 10, 11) or r2030_evtassocdesprec.processamento_codigo_resposta in (401,402):
...
def validar_evento_funcao(r2030_evtassocdesprec_id, db_slug):
    ...
    r2030_evtassocdesprec = get_object_or_404(r2030evtAssocDespRec.objects.using(db_slug), excluido=False, id=r2030_evtassocdesprec_id)
<<<<<<< HEAD
    if r2030_evtassocdesprec.transmissor_lote_efdreinf:
        if r2030_evtassocdesprec.transmissor_lote_efdreinf.transmissor:
            if r2030_evtassocdesprec.transmissor_lote_efdreinf.transmissor.verificar_predecessao:
=======
    if r2030_evtassocdesprec.transmissor_lote_esocial:
        if r2030_evtassocdesprec.transmissor_lote_esocial.transmissor:
            if r2030_evtassocdesprec.transmissor_lote_esocial.transmissor.verificar_predecessao:
