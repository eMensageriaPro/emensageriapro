...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if r2030_evtassocdesprec.status == 0:
            ...
            situacao_anterior = json.dumps(model_to_dict(r2030_evtassocdesprec), indent=4, sort_keys=True, default=str)
            r2030evtAssocDespRec.objects.using( db_slug ).filter(id = r2030_evtassocdesprec_id).delete()
            #r2030_evtassocdesprec_apagar_custom
            #r2030_evtassocdesprec_apagar_custom
...
>>>>>>> 3217f7abcc9a9c37261d88e43626ba3e9fb91ee3
    ...
    return render(request, 'r2030_evtassocdesprec_apagar.html', context)

from rest_framework import generics
from rest_framework.permissions import IsAdminUser


class r2030evtAssocDespRecList(generics.ListCreateAPIView):
    db_slug = 'default'
    queryset = r2030evtAssocDespRec.objects.using(db_slug).all()
...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = {
                'evtassocdesprec': 'evtassocdesprec',
                'idecontri': 'idecontri',
                'ideestab': 'ideestab',
                'ideevento': 'ideevento',
        ...
        r2030_evtassocdesprec_lista = r2030evtAssocDespRec.objects.using( db_slug ).filter(**dict_qs).filter(excluido = False).exclude(id=0).all()
        if not post and len(r2030_evtassocdesprec_lista) > 100:
            filtrar = True
...
>>>>>>> 3217f7abcc9a9c37261d88e43626ba3e9fb91ee3
        ...
        if for_print in (0,1):
            ...
            response = PDFTemplateResponse(
                request=request,
                template='r2030_evtassocdesprec_listar.html',
            ...
            response = render_to_response('r2030_evtassocdesprec_listar.html', context)
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('tables/r2030_evtassocdesprec_csv.html', context)
            filename = "r2030_evtassocdesprec.csv"
            response['Content-Disposition'] = 'attachment; filename=' + filename
...
def identidade_evento(r2030_evtassocdesprec_id, db_slug):
    from emensageriapro.mensageiro.models import TransmissorEventosEfdreinf
    dados_evento = r2030evtAssocDespRec.objects.using( db_slug ).get(id=r2030_evtassocdesprec_id)
    identidade = 'ID'
    ...
    while existe:
        ...
        if not lista_eventos:
            r2030evtAssocDespRec.objects.using(db_slug).filter(id=r2030_evtassocdesprec_id).update(identidade=identidade_temp)
            existe = False
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r2030_evtassocdesprec_id:
            ...
            r2030_evtassocdesprec_form = form_r2030_evtassocdesprec(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_EFDREINF, 'status': 0, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
        if request.method == 'POST':
            if r2030_evtassocdesprec_form.is_valid():
                ...
                if r2030_evtassocdesprec_id:
                    if r2030_evtassocdesprec.status == 0:
                        ...
                        #r2030_evtassocdesprec_campos_multiple_passo1
                        r2030evtAssocDespRec.objects.using(db_slug).filter(id=r2030_evtassocdesprec_id).update(**dados)
                        obj = r2030evtAssocDespRec.objects.using(db_slug).get(id=r2030_evtassocdesprec_id)
                        #r2030_evtassocdesprec_editar_custom
                        #r2030_evtassocdesprec_campos_multiple_passo2
                    ...
                    #r2030_evtassocdesprec_cadastrar_campos_multiple_passo1
                    obj = r2030evtAssocDespRec(**dados)
                    obj.save(using = db_slug)
                    #r2030_evtassocdesprec_cadastrar_custom
                    #r2030_evtassocdesprec_cadastrar_campos_multiple_passo2
                    identidade_evento(obj.id, db_slug)
                    messages.success(request, 'Cadastrado com sucesso!')
                    r2030_evtassocdesprec_form = form_r2030_evtassocdesprec(request.POST or None, instance = obj, slug = db_slug)
                    gravar_auditoria('{}',
                                     json.dumps(model_to_dict(obj), indent=4, sort_keys=True, default=str),
...
>>>>>>> 3217f7abcc9a9c37261d88e43626ba3e9fb91ee3
        ...
        if not evento_totalizador:
            r2030_evtassocdesprec_form.fields['tpamb'].widget.attrs['disabled'] = True
            r2030_evtassocdesprec_form.fields['tpamb'].widget.attrs['readonly'] = True
            r2030_evtassocdesprec_form.fields['tpamb'].value = TP_AMB
            r2030_evtassocdesprec_form.fields['procemi'].widget.attrs['disabled'] = True
            r2030_evtassocdesprec_form.fields['procemi'].widget.attrs['readonly'] = True
...
>>>>>>> 3217f7abcc9a9c37261d88e43626ba3e9fb91ee3
        ...
        controle_alteracoes = Auditoria.objects.using( db_slug ).filter(identidade=r2030_evtassocdesprec_id, tabela='r2030_evtassocdesprec').all()
        context = {
