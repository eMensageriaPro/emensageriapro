...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r2030_evtassocdesprec_id:
            ...
            r2030_evtassocdesprec_form = form_r2030_evtassocdesprec(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_EFDREINF, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
