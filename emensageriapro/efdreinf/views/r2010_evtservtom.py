...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r2010_evtservtom_id:
            ...
            r2010_evtservtom_form = form_r2010_evtservtom(request.POST or None, slug = db_slug, initial={'versao': VERSAO_MODELO, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
