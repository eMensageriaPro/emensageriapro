...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r2010_evtservtom_id:
            ...
            r2010_evtservtom_form = form_r2010_evtservtom(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_EFDREINF, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
            ...
            if r2010_evtservtom_form.is_valid():
                ...
                if r2010_evtservtom_id:
                    if r2010_evtservtom.status == 0:
                        ...
                        #r2010_evtservtom_campos_multiple_passo1
                        r2010evtServTom.objects.using(db_slug).filter(id=r2010_evtservtom_id).update(**dados)
                        obj = r2010evtServTom.objects.using(db_slug).get(id=r2010_evtservtom_id)
                        #r2010_evtservtom_editar_custom
                        #r2010_evtservtom_campos_multiple_passo2
                    ...
                    #r2010_evtservtom_cadastrar_campos_multiple_passo1
                    obj = r2010evtServTom(**dados)
...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if r2010_evtservtom.status == 0:
            ...
            r2010evtServTom.objects.using( db_slug ).filter(id = r2010_evtservtom_id).delete()
