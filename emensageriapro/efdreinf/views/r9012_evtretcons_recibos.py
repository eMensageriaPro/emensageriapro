...
def recibo(request, hash, tipo):
    ...
    pagina = ConfigPaginas.objects.get(excluido = False, endereco='r9012_evtretcons')
    ...
    if permissao.permite_listar:
        ...
        r9012_evtretcons = get_object_or_404(
            r9012evtRetCons,
            excluido = False, id = r9012_evtretcons_id)
        ...
        retorno = get_object_or_404( RetornosEventos,
            id=r9012_evtretcons.retornos_eventos_id, excluido=False)
