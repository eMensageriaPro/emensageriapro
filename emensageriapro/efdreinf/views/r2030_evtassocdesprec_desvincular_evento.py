...
def desvincular_evento(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r2030evtAssocDespRec'):
        ...
        if r2030_evtassocdesprec.status in status_list:
            ...
            transmissor_lote_efdreinf_id = r2030_evtassocdesprec.transmissor_lote_efdreinf_id

            r2030evtAssocDespRec.objects.filter(id=pk).update(
