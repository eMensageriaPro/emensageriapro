...
def validar_evento_funcao(request, pk):
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO:
            ...
            quant = validar_precedencia('efdreinf', 'r1070_evttabprocesso', pk)
...
def validar_evento(request, pk):
    ...
    if r1070_evttabprocesso.status in STATUS_VALIDACAO:
    ...
    return redirect('r1070_evttabprocesso_salvar', pk=pk, tab='master')