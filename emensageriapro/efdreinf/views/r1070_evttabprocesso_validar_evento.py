...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'efdreinf/%s/evtTabProcesso.xsd' % (r1070_evttabprocesso.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 'r1070_evttabprocesso' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('r1070_evttabprocesso', pk)
