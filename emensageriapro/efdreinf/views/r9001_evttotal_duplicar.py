...
def duplicar(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_duplicate_r9001evtTotal'):
        ...
        if pk:
            ...
            texto = gerar_xml_r9001(request, pk, versao="|")
            dados = read_r9001_evttotal_string(request, {}, texto.encode('utf-8'), 0)
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento de identidade %s criado a partir da duplicação do evento %s"}' % (nova_identidade, r9001_evttotal.identidade),
            ...
            return redirect('r9001_evttotal_salvar', pk=return_pk, tab='master')
