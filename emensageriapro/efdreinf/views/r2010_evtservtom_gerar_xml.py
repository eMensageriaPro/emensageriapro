...
def gerar_xml_r2010(request, r2010_evtservtom_id, versao=None):
    ...
    if r2010_evtservtom_id:
        ...
        r2010_evtservtom_lista = r2010evtServTom.objects. \
            filter(id=r2010_evtservtom_id, excluido = False).all()
...
def gerar_xml_assinado(request, r2010_evtservtom_id):
    ...
    if r2010_evtservtom.arquivo_original:
        ...
        xml = gerar_xml_r2010(request, r2010_evtservtom_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_efdreinf(request, xml, r2010_evtservtom.transmissor_lote_efdreinf_id)
    ...
    if r2010_evtservtom.status in (
        ...
        r2010evtServTom.objects.\
            filter(id=r2010_evtservtom_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if r2010_evtservtom_id:
        ...
        xml_assinado = gerar_xml_assinado(request, r2010_evtservtom_id)
