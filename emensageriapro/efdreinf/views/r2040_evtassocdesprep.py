...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r2040_evtassocdesprep_id:
            ...
            r2040_evtassocdesprep_form = form_r2040_evtassocdesprep(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_EFDREINF, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
