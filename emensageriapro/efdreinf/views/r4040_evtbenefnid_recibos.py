...
def recibo(request, hash, tipo):
    ...
    pagina = ConfigPaginas.objects.get(excluido = False, endereco='r4040_evtbenefnid')
    ...
    if permissao.permite_listar:
        ...
        r4040_evtbenefnid = get_object_or_404(
            r4040evtBenefNId,
            excluido = False, id = r4040_evtbenefnid_id)
        ...
        retorno = get_object_or_404( RetornosEventos,
            id=r4040_evtbenefnid.retornos_eventos_id, excluido=False)
