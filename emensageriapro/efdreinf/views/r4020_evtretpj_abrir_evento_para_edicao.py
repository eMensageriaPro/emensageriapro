...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r4020evtRetPJ'):
        ...
        if r4020_evtretpj.status in status_list:
            ...
            r4020evtRetPJ.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                'r4020_evtretpj', pk, request.user.id, 1)
    ...
    return redirect('r4020_evtretpj_salvar', pk=pk, tab='master')