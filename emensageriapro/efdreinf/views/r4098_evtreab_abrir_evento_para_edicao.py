...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r4098evtReab'):
        ...
        if r4098_evtreab.status in status_list:
            ...
            r4098evtReab.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                'r4098_evtreab', pk, request.user.id, 1)
    ...
    return redirect('r4098_evtreab_salvar', pk=pk)