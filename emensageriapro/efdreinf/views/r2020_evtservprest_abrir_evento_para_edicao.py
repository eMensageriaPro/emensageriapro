...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r2020evtServPrest'):
        ...
        if r2020_evtservprest.status in status_list:
            ...
            r2020evtServPrest.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                'r2020_evtservprest', pk, request.user.id, 2)
    ...
    return redirect('r2020_evtservprest_salvar', pk=pk)