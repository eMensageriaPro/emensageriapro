...
def recibo(request, hash, tipo):
    ...
    pagina = ConfigPaginas.objects.get(excluido = False, endereco='r4099_evtfech')
    ...
    if permissao.permite_listar:
        ...
        r4099_evtfech = get_object_or_404(
            r4099evtFech,
            excluido = False, id = r4099_evtfech_id)
        ...
        retorno = get_object_or_404( RetornosEventos,
            id=r4099_evtfech.retornos_eventos_id, excluido=False)
        ...
        context = {
            'r4099_evtfech_id': r4099_evtfech_id,
