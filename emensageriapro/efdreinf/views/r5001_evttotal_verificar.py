...
=======
    if r5001_evttotal.transmissor_lote_esocial:
        if r5001_evttotal.transmissor_lote_esocial.transmissor:
            if r5001_evttotal.transmissor_lote_esocial.transmissor.verificar_predecessao:
