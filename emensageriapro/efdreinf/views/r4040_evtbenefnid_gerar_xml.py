...
def gerar_xml_r4040(request, pk, versao=None):
    ...
    return gerar_xml_r4040_func(pk, versao)
...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and r4040_evtbenefnid.status in STATUS_ANT:
        ...
        if 'Signature' in xml_assinado and r4040_evtbenefnid.status in STATUS_ANT:
