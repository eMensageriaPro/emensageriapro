...
def verificar(request, hash):
    ...
    if request.user.has_perm('efdreinf.can_view_r1000evtInfoContri'):
        ...
        r1000_alteracao_lista = r1000alteracao.objects.filter(r1000_evtinfocontri_id__in = listar_ids(r1000_evtinfocontri_lista) ).all()
        r1000_alteracao_softhouse_lista = r1000alteracaosoftHouse.objects.filter(r1000_alteracao_id__in = listar_ids(r1000_alteracao_lista) ).all()
        r1000_alteracao_infoefr_lista = r1000alteracaoinfoEFR.objects.filter(r1000_alteracao_id__in = listar_ids(r1000_alteracao_lista) ).all()
