...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r2098_evtreabreevper_id:
            ...
            r2098_evtreabreevper_form = form_r2098_evtreabreevper(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_EFDREINF, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
