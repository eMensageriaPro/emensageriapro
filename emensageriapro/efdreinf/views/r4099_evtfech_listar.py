    ...
    if request.user.has_perm('efdreinf.can_see_r4099evtFech'):
        ...
        if request.method == 'POST':
            ...
            dict_fields = {
                ...
                'infofech': 'infofech',
                'evtretpf__icontains': 'evtretpf__icontains',
                'evtretpj__icontains': 'evtretpj__icontains',
                'evtpgtosnid__icontains': 'evtpgtosnid__icontains',
        ...
        if output == 'pdf':
            ...
            response = PDFTemplateResponse(
                request=request,
                template='r4099_evtfech_listar.html',
