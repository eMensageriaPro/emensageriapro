...
def gerar_xml_r2040(request, pk, versao=None):
    ...
    return gerar_xml_r2040_func(pk, versao)
...
def gerar_xml_assinado(request, pk):
    ...
    if 'Signature' in xml and r2040_evtassocdesprep.status in STATUS_ANT:
        ...
        if 'Signature' in xml_assinado and r2040_evtassocdesprep.status in STATUS_ANT:
