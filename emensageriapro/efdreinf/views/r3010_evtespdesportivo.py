...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r3010_evtespdesportivo_id:
            ...
            r3010_evtespdesportivo_form = form_r3010_evtespdesportivo(request.POST or None, slug = db_slug, initial={'versao': VERSAO_MODELO, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
