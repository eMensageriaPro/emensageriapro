...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r5001_evttotal_id:
            ...
            r5001_evttotal_form = form_r5001_evttotal(request.POST or None, slug = db_slug, initial={'versao': VERSAO_MODELO, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
