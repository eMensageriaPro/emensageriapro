...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        #             r9000_evtexclusao_form.fields['status'].widget.attrs['disabled'] = True
        #             r9000_evtexclusao_form.fields['status'].widget.attrs['readonly'] = True
        #             r9000_evtexclusao_form.fields['transmissor_lote_efdreinf'].widget.attrs['disabled'] = True
