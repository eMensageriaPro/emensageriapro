...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'efdreinf/%s/evtPgtosDivs.xsd' % (r2070_evtpgtosdivs.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 'r2070_evtpgtosdivs' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('r2070_evtpgtosdivs', pk)
...
def validar_evento(request, pk, tab=None):
    ...
    if r2070_evtpgtosdivs.status in STATUS_VALIDACAO:
