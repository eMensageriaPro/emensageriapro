...
def validar_evento_funcao(request, r2070_evtpgtosdivs_id):
    ...
    if not os.path.exists(BASE_DIR + '/' + arquivo):
        ...
        gerar_xml_assinado(request, r2070_evtpgtosdivs_id)
...
def validar_evento(request, hash):
    ...
    if r2070_evtpgtosdivs_id:
        ...
        if r2070_evtpgtosdivs.versao in VERSOES_EFDREINF:
            ...
            validar_evento_funcao(request, r2070_evtpgtosdivs_id)
            
            if r2070_evtpgtosdivs.transmissor_lote_efdreinf and not VERIFICAR_PREDECESSAO_ANTES_ENVIO:
                r2070evtPgtosDivs.objects.\
                    filter(id=r2070_evtpgtosdivs_id).update(status=STATUS_EVENTO_AGUARD_ENVIO)

            elif r2070_evtpgtosdivs.transmissor_lote_efdreinf and VERIFICAR_PREDECESSAO_ANTES_ENVIO:
                r2070evtPgtosDivs.objects.\
                    filter(id=r2070_evtpgtosdivs_id).update(status=STATUS_EVENTO_AGUARD_PRECEDENCIA)
