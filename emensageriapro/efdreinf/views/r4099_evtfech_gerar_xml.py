...
def gerar_xml_r4099(request, r4099_evtfech_id, versao=None):
    ...
    if r4099_evtfech_id:
        ...
        r4099_evtfech_lista = r4099evtFech.objects. \
            filter(id=r4099_evtfech_id, excluido = False).all()
...
def gerar_xml_assinado(request, r4099_evtfech_id):
    ...
    if r4099_evtfech.arquivo_original:
        ...
        xml = gerar_xml_r4099(request, r4099_evtfech_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_efdreinf(request, xml, r4099_evtfech.transmissor_lote_efdreinf_id)
    ...
    if r4099_evtfech.status in (
        ...
        r4099evtFech.objects.\
            filter(id=r4099_evtfech_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if r4099_evtfech_id:
        ...
        xml_assinado = gerar_xml_assinado(request, r4099_evtfech_id)
