...
def criar_alteracao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_create_change_r4098evtReab'):
        ...
        gravar_auditoria(u'{}',
            u'{"funcao": "Evento de de alteração de identidade %s criado a partir da duplicação do evento %s"}' % (nova_identidade, r4098_evtreab.identidade),
        ...
        return redirect('r4098_evtreab_salvar', pk=return_pk)
