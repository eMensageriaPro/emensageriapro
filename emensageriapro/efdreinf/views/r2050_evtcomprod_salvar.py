...
def salvar(request, hash):
    ...
    if request.user.has_perm('efdreinf.can_view_r2050evtComProd'):
        ...
        r2050_evtcomprod_form = disabled_form_fields(r2050_evtcomprod_form, request.user.has_perm('efdreinf.change_r2050evtComProd'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2050_evtcomprod_id, tabela='r2050_evtcomprod').all()
