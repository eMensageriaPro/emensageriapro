...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r9001evtTotal'):
        ...
        if r9001_evttotal.status in status_list:
            ...
            r9001evtTotal.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                'r9001_evttotal', pk, request.user.id, 1)
    ...
    return redirect('r9001_evttotal_salvar', pk=pk, tab='master')