...
from emensageriapro.r9011.forms import form_r9011_infototalcontrib
...
def salvar(request, hash):
    ...
    if request.user.has_perm('efdreinf.can_view_r9011evtTotalContrib'):
        ...
        if r9011_evttotalcontrib_id:
            ...
            r9011_evttotalcontrib_form = form_r9011_evttotalcontrib(request.POST or None, instance = r9011_evttotalcontrib, 
                                         initial={'excluido': False})
                                         
        else:
        
            r9011_evttotalcontrib_form = form_r9011_evttotalcontrib(request.POST or None, 
        ...
        if request.method == 'POST':
            ...
            if r9011_evttotalcontrib_form.is_valid():
                ...
                dados = r9011_evttotalcontrib_form.cleaned_data
                obj = r9011_evttotalcontrib_form.save(request=request)
                messages.success(request, u'Salvo com sucesso!')
                
                if not r9011_evttotalcontrib_id:
                    ...
                    gravar_auditoria('{}',
                                 ...
                                 'r9011_evttotalcontrib', obj.id, usuario_id, 1)
                else:
                
                    gravar_auditoria(json.dumps(model_to_dict(r9011_evttotalcontrib), indent=4, sort_keys=True, default=str),
                                     json.dumps(model_to_dict(obj), indent=4, sort_keys=True, default=str), 
                                     'r9011_evttotalcontrib', r9011_evttotalcontrib_id, usuario_id, 2)
                                 
                if request.session['retorno_pagina'] not in ('r9011_evttotalcontrib_apagar', 'r9011_evttotalcontrib_salvar', 'r9011_evttotalcontrib'):
                    return redirect(request.session['retorno_pagina'], hash=request.session['retorno_hash'])
                    
                if r9011_evttotalcontrib_id != obj.id:
                    url_hash = base64.urlsafe_b64encode( '{"print": "0", "id": "%s"}' % (obj.id) )
                    return redirect('r9011_evttotalcontrib_salvar', hash=url_hash)

            else:
                messages.error(request, u'Erro ao salvar!')
                
        r9011_evttotalcontrib_form = disabled_form_fields(r9011_evttotalcontrib_form, request.user.has_perm('efdreinf.change_r9011evtTotalContrib'))
        
        if r9011_evttotalcontrib_id:
            if r9011_evttotalcontrib.status != 0:
                r9011_evttotalcontrib_form = disabled_form_fields(r9011_evttotalcontrib_form, False)
        #r9011_evttotalcontrib_campos_multiple_passo3

        for field in r9011_evttotalcontrib_form.fields.keys():
            r9011_evttotalcontrib_form.fields[field].widget.attrs['ng-model'] = 'r9011_evttotalcontrib_'+field
            
        if int(dict_hash['print']):
            r9011_evttotalcontrib_form = disabled_form_for_print(r9011_evttotalcontrib_form)
        ...
        if r9011_evttotalcontrib_id:
            ...
            r9011_regocorrs_form.fields['r9011_evttotalcontrib'].widget.attrs['readonly'] = True
            ...
            r9011_infototalcontrib_form = form_r9011_infototalcontrib(
                initial={ 'r9011_evttotalcontrib': r9011_evttotalcontrib })
            r9011_infototalcontrib_form.fields['r9011_evttotalcontrib'].widget.attrs['readonly'] = True
            ...
            r1000_evtinfocontri_form.fields['retornos_r9011'].widget.attrs['readonly'] = True
        ...
        if dict_hash['tab'] or 'r9011_evttotalcontrib' in request.session['retorno_pagina']:
            request.session["retorno_hash"] = hash
            request.session["retorno_pagina"] = 'r9011_evttotalcontrib_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=r9011_evttotalcontrib_id, tabela='r9011_evttotalcontrib').all()
        ...
        context = {
            ...
            'r9011_evttotalcontrib_id': int(r9011_evttotalcontrib_id),
            'usuario': usuario, 
            'hash': hash, 
        ...
        if for_print in (0, 1):
            ...
            return render(request, 'r9011_evttotalcontrib_salvar.html', context)
            ...
            response = render_to_response('r9011_evttotalcontrib_salvar.html', context)
