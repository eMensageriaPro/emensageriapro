    ...
    if request.user.has_perm('efdreinf.can_see_r4020evtRetPJ'):
        ...
        if request.method == 'POST':
            ...
            dict_fields = {
                ...
                'idebenef': 'idebenef',
                'cnpjbenef__icontains': 'cnpjbenef__icontains',
                'nmbenef__icontains': 'nmbenef__icontains',
                'isenimun__icontains': 'isenimun__icontains',
        ...
        r4020_evtretpj_lista = r4020evtRetPJ.objects.filter(**dict_qs).filter().exclude(id=0).all()

        if not post and len(r4020_evtretpj_lista) > 100:
            filtrar = True
            r4020_evtretpj_lista = None
            messages.warning(request, u'Listagem com mais de 100 resultados! Filtre os resultados um melhor desempenho!')

        #[VARIAVEIS_LISTA_FILTRO_RELATORIO]
        #r4020_evtretpj_listar_custom
        ...
        if output == 'pdf':
            ...
            response = PDFTemplateResponse(
                request=request,
                template='r4020_evtretpj_listar.html',
            ...
            response = render_to_response('r4020_evtretpj_listar.html', context)
            ...
            response = render_to_response('csv/r4020_evtretpj.csv', context)
            filename = "r4020_evtretpj.csv"
            response['Content-Disposition'] = 'attachment; filename=' + filename
            ...
            return render(request, 'r4020_evtretpj_listar.html', context)
