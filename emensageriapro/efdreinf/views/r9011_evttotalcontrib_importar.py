...
def read_r9011_evttotalcontrib_string(dados, xml, validar=False):
    ...
    dados = read_r9011_evttotalcontrib_obj(doc, status, validar)
    return dados



def read_r9011_evttotalcontrib(dados, arquivo, validar=False):
...
def read_r9011_evttotalcontrib_obj(doc, status, validar=False):
    ...
    if validar:
        validar_evento_funcao(r9011_evttotalcontrib.id)
