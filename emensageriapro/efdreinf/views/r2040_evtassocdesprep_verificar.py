...
def validar_evento_funcao(r2040_evtassocdesprep_id, db_slug):
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO:
            ...
            quant = validar_precedencia('esocial', 'r2040_evtassocdesprep', r2040_evtassocdesprep_id)
...
def validar_evento(request, hash):
    ...
    if r2040_evtassocdesprep_id:
        ...
        if r2040_evtassocdesprep.versao in VERSOES_EFDREINF:
            ...
            if r2040_evtassocdesprep.transmissor_lote_esocial and not VERIFICAR_PREDECESSAO_ANTES_ENVIO:
                r2040evtAssocDespRep.objects.using(db_slug).\
                    filter(excluido=False, id=r2040_evtassocdesprep_id).update(status=STATUS_EVENTO_AGUARD_ENVIO)

            elif r2040_evtassocdesprep.transmissor_lote_esocial and VERIFICAR_PREDECESSAO_ANTES_ENVIO:
                r2040evtAssocDespRep.objects.using(db_slug).\
