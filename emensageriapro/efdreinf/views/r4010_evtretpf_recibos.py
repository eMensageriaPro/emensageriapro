...
def recibo(request, hash, tipo):
    ...
    pagina = ConfigPaginas.objects.get(excluido = False, endereco='r4010_evtretpf')
    ...
    if permissao.permite_listar:
        ...
        r4010_evtretpf = get_object_or_404(
            r4010evtRetPF,
            excluido = False, id = r4010_evtretpf_id)
        ...
        retorno = get_object_or_404( RetornosEventos,
            id=r4010_evtretpf.retornos_eventos_id, excluido=False)
