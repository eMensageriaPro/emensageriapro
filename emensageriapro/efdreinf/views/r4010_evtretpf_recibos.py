...
def recibo(request, pk, output=None):
    ...
    if request.user.has_perm('efdreinf.can_see_r4010evtRetPF'):
        ...
        if r4010_evtretpf.retornos_r5001_id:
            r5001_evttotal = get_object_or_404(r5001evtTotal,
                id=r4010_evtretpf.retornos_r5001_id)
        else:
            r5001_evttotal = None
            
        if r4010_evtretpf.retornos_r5011_id:
            r5011_evttotalcontrib = get_object_or_404(r5011evtTotalContrib,
                id=r4010_evtretpf.retornos_r5011_id)
        else:
            r5011_evttotalcontrib = None
            
        if r4010_evtretpf.retornos_r9001_id:
            r9001_evttotal = get_object_or_404(r9001evtTotal,
                id=r4010_evtretpf.retornos_r9001_id)
        else:
            r9001_evttotal = None
            
        if r4010_evtretpf.retornos_r9002_id:
            r9002_evtret = get_object_or_404(r9002evtRet,
                id=r4010_evtretpf.retornos_r9002_id)
        else:
            r9002_evtret = None
            
        if r4010_evtretpf.retornos_r9011_id:
            r9011_evttotalcontrib = get_object_or_404(r9011evtTotalContrib,
                id=r4010_evtretpf.retornos_r9011_id)
        else:
            r9011_evttotalcontrib = None
            
        if r4010_evtretpf.retornos_r9012_id:
            r9012_evtretcons = get_object_or_404(r9012evtRetCons,
                id=r4010_evtretpf.retornos_r9012_id)
        else:
        ...
        if output == 'xls':
            ...
            response =  render_to_response('r4010_evtretpf_recibo_pdf.html', context)
            ...
            response =  render_to_response('r4010_evtretpf_recibo_csv.html', context)
            ...
            return render_to_pdf('r4010_evtretpf_recibo_pdf.html', context)

        else:
        
            return render(request, 'r4010_evtretpf_recibo_pdf.html', context)
