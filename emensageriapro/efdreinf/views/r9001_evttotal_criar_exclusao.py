...
def criar_exclusao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_create_delete_r9001evtTotal'):
        ...
        gravar_auditoria(u'{}',
            u'{"funcao": "Evento de exclusão de identidade %s criado a partir da duplicação do evento %s"}' % (nova_identidade, r9001_evttotal.identidade),
