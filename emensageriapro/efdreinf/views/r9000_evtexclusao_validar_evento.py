...
def validar_evento_funcao(request, pk):
    ...
    if not r9000_evtexclusao.identidade:
        ...
        ident = identidade_evento(r9000_evtexclusao, 'efdreinf')
        r9000_evtexclusao = get_object_or_404(r9000evtExclusao, id=pk)
    ...
    schema_filename = 'efdreinf/%s/evtExclusao.xsd' % (r9000_evtexclusao.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 'r9000_evtexclusao' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('r9000_evtexclusao', pk)
