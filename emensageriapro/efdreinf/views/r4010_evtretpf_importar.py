...
def read_r4010_evtretpf_string(dados, xml, validar=False):
    ...
    dados = read_r4010_evtretpf_obj(doc, status, validar)
    return dados



def read_r4010_evtretpf(dados, arquivo, validar=False):
...
def read_r4010_evtretpf_obj(doc, status, validar=False):
    ...
    if validar:
        validar_evento_funcao(r4010_evtretpf.id)
