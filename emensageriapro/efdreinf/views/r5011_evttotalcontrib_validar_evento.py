...
def validar_evento_funcao(request, r5011_evttotalcontrib_id):
    ...
    if not os.path.exists(BASE_DIR + '/' + arquivo):
        ...
        gerar_xml_assinado(request, r5011_evttotalcontrib_id)
...
def validar_evento(request, hash):
    ...
    if r5011_evttotalcontrib_id:
        ...
        if r5011_evttotalcontrib.versao in VERSOES_EFDREINF:
            ...
            validar_evento_funcao(request, r5011_evttotalcontrib_id)
            
            if r5011_evttotalcontrib.transmissor_lote_efdreinf and not VERIFICAR_PREDECESSAO_ANTES_ENVIO:
                r5011evtTotalContrib.objects.\
                    filter(id=r5011_evttotalcontrib_id).update(status=STATUS_EVENTO_AGUARD_ENVIO)

            elif r5011_evttotalcontrib.transmissor_lote_efdreinf and VERIFICAR_PREDECESSAO_ANTES_ENVIO:
                r5011evtTotalContrib.objects.\
                    filter(id=r5011_evttotalcontrib_id).update(status=STATUS_EVENTO_AGUARD_PRECEDENCIA)
