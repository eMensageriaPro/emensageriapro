...
def recibo(request, hash, tipo):
    ...
    pagina = ConfigPaginas.objects.get(excluido = False, endereco='r4098_evtreab')
    ...
    if permissao.permite_listar:
        ...
        r4098_evtreab = get_object_or_404(
            r4098evtReab,
            excluido = False, id = r4098_evtreab_id)
        ...
        retorno = get_object_or_404( RetornosEventos,
            id=r4098_evtreab.retornos_eventos_id, excluido=False)
