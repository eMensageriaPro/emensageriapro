...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if r4010_evtretpf.status == STATUS_EVENTO_CADASTRADO:
            ...
            situacao_anterior = json.dumps(model_to_dict(r4010_evtretpf), sort_keys=True, default=str)
        ...
        if 'return_page' in request.session and request.session['return_page'] and 'r4010-evtretpf' in request.session['return_page']:
