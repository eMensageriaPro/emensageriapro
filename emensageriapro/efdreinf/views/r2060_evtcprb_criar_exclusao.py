...
def criar_exclusao(request, pk):
    ...
    from emensageriapro.efdreinf.views.r2060_evtcprb_gerar_xml import gerar_xml_r2060
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('efdreinf.can_create_delete_r2060evtCPRB'):
        ...
        return redirect('r2060_evtcprb_salvar', pk=return_pk)
