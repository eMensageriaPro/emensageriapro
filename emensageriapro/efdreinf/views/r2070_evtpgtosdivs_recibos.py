...
def recibo(request, pk, output=None):
    ...
    if request.user.has_perm('efdreinf.can_see_r2070evtPgtosDivs'):
        ...
        if r2070_evtpgtosdivs.retornos_r5001_id:
            r5001_evttotal = get_object_or_404(r5001evtTotal,
                id=r2070_evtpgtosdivs.retornos_r5001_id)
        else:
            r5001_evttotal = None
            
        if r2070_evtpgtosdivs.retornos_r5011_id:
            r5011_evttotalcontrib = get_object_or_404(r5011evtTotalContrib,
                id=r2070_evtpgtosdivs.retornos_r5011_id)
        else:
        ...
        if output == 'xls':
            ...
            return render(request, 'r2070_evtpgtosdivs_recibo_pdf.html', context)
