...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r9012evtRetCons'):
        ...
        if r9012_evtretcons.status in status_list:
            ...
            r9012evtRetCons.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                'r9012_evtretcons', pk, request.user.id, 1)
    ...
    return redirect('r9012_evtretcons_salvar', pk=pk)