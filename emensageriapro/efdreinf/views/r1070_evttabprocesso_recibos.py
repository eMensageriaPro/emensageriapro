...
def recibo(request, pk, output=None):
    ...
    if request.user.has_perm('efdreinf.can_see_r1070evtTabProcesso'):
        ...
        if r1070_evttabprocesso.retornos_r9001_id:
            r9001_evttotal = get_object_or_404(r9001evtTotal,
                id=r1070_evttabprocesso.retornos_r9001_id)
        else:
            r9001_evttotal = None
            
        if r1070_evttabprocesso.retornos_r9002_id:
            r9002_evtret = get_object_or_404(r9002evtRet,
                id=r1070_evttabprocesso.retornos_r9002_id)
        else:
            r9002_evtret = None
            
        if r1070_evttabprocesso.retornos_r9011_id:
            r9011_evttotalcontrib = get_object_or_404(r9011evtTotalContrib,
                id=r1070_evttabprocesso.retornos_r9011_id)
        else:
            r9011_evttotalcontrib = None
            
        if r1070_evttabprocesso.retornos_r9012_id:
            r9012_evtretcons = get_object_or_404(r9012evtRetCons,
                id=r1070_evttabprocesso.retornos_r9012_id)
        else:
