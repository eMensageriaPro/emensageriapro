    ...
    if request.user.has_perm('efdreinf.can_see_r2010evtServTom'):
        ...
        if request.method == 'POST':
            ...
            dict_fields = {
                ...
                'indcprb__icontains': 'indcprb__icontains',
        ...
        r2010_evtservtom_lista = r2010evtServTom.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            response = render_to_response('csv/r2010_evtservtom.csv', context)
