...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r9011evtTotalContrib'):
        ...
        if r9011_evttotalcontrib.status in status_list:
            ...
            r9011evtTotalContrib.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                'r9011_evttotalcontrib', pk, request.user.id, 1)
    ...
    return redirect('r9011_evttotalcontrib_salvar', pk=pk, tab='master')