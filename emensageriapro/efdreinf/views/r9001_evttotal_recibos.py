...
def recibo(request, hash, tipo):
    ...
    pagina = ConfigPaginas.objects.get(excluido = False, endereco='r9001_evttotal')
    ...
    if permissao.permite_listar:
        ...
        r9001_evttotal = get_object_or_404(
            r9001evtTotal,
            excluido = False, id = r9001_evttotal_id)
        ...
        retorno = get_object_or_404( RetornosEventos,
            id=r9001_evttotal.retornos_eventos_id, excluido=False)
