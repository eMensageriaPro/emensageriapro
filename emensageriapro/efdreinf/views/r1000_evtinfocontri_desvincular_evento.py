...
def desvincular_evento(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r1000evtInfoContri'):
        ...
        if r1000_evtinfocontri.status in status_list:
            ...
            transmissor_lote_efdreinf_id = r1000_evtinfocontri.transmissor_lote_efdreinf_id

            r1000evtInfoContri.objects.filter(id=pk).update(
