...
def recibo(request, hash, tipo):
    ...
    pagina = ConfigPaginas.objects.get(excluido = False, endereco='r4020_evtretpj')
    ...
    if permissao.permite_listar:
        ...
        r4020_evtretpj = get_object_or_404(
            r4020evtRetPJ,
            excluido = False, id = r4020_evtretpj_id)
        ...
        retorno = get_object_or_404( RetornosEventos,
            id=r4020_evtretpj.retornos_eventos_id, excluido=False)
