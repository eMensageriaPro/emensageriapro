...
def recibo(request, hash, tipo):
    ...
    pagina = ConfigPaginas.objects.get(excluido = False, endereco='r9011_evttotalcontrib')
    ...
    if permissao.permite_listar:
        ...
        r9011_evttotalcontrib = get_object_or_404(
            ...
            excluido = False, id = r9011_evttotalcontrib_id)
        ...
        retorno = get_object_or_404( RetornosEventos,
            id=r9011_evttotalcontrib.retornos_eventos_id, excluido=False)
