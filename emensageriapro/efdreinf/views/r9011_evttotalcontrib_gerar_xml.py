...
def gerar_xml_r9011(request, r9011_evttotalcontrib_id, versao=None):
    ...
    if r9011_evttotalcontrib_id:
        ...
        r9011_evttotalcontrib_lista = r9011evtTotalContrib.objects. \
            filter(id=r9011_evttotalcontrib_id, excluido = False).all()
...
def gerar_xml_assinado(request, r9011_evttotalcontrib_id):
    ...
    if r9011_evttotalcontrib.arquivo_original:
        ...
        xml = gerar_xml_r9011(request, r9011_evttotalcontrib_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_efdreinf(request, xml, r9011_evttotalcontrib.transmissor_lote_efdreinf_id)
    ...
    if r9011_evttotalcontrib.status in (
        ...
        r9011evtTotalContrib.objects.\
            filter(id=r9011_evttotalcontrib_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if r9011_evttotalcontrib_id:
        ...
        xml_assinado = gerar_xml_assinado(request, r9011_evttotalcontrib_id)
