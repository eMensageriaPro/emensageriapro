...
def listar(request, output=None):
    ...
    if request.user.has_perm('efdreinf.can_see_r2030evtAssocDespRec'):
        ...
        r2030_evtassocdesprec_lista = r2030evtAssocDespRec.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            response = render_to_response('csv/r2030_evtassocdesprec.csv', context)
