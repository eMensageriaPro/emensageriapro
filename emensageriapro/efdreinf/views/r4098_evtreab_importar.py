...
def read_r4098_evtreab_string(dados, xml, validar=False):
    ...
    dados = read_r4098_evtreab_obj(doc, status, validar)
    return dados



def read_r4098_evtreab(dados, arquivo, validar=False):
...
def read_r4098_evtreab_obj(doc, status, validar=False):
    ...
    if validar:
        validar_evento_funcao(r4098_evtreab.id)
