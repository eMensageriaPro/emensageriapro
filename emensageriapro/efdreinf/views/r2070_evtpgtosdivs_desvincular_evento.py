...
def desvincular_evento(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r2070evtPgtosDivs'):
        ...
        if r2070_evtpgtosdivs.status in status_list:
            ...
            transmissor_lote_efdreinf_id = r2070_evtpgtosdivs.transmissor_lote_efdreinf_id

            r2070evtPgtosDivs.objects.filter(id=pk).update(
