...
def listar(request, output=None):
    ...
    if request.user.has_perm('efdreinf.can_see_r2099evtFechaEvPer'):
        ...
        r2099_evtfechaevper_lista = r2099evtFechaEvPer.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            response = render_to_response('csv/r2099_evtfechaevper.csv', context)
