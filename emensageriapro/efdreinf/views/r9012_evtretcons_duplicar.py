...
def duplicar(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_duplicate_r9012evtRetCons'):
        ...
        if pk:
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento de identidade %s criado a partir da duplicação do evento %s"}' % (nova_identidade, r9012_evtretcons.identidade),
