...
def validar_evento_funcao(request, pk):
    ...
    schema_filename = 'efdreinf/%s/evtEspDesportivo.xsd' % (r3010_evtespdesportivo.versao)
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 'r3010_evtespdesportivo' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('r3010_evtespdesportivo', pk)
