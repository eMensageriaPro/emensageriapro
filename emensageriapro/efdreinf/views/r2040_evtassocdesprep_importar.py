...
def read_r2040_evtassocdesprep(request, dados, arquivo, validar=False):
    ...
    r2040evtAssocDespRep.objects.filter(id=dados['id']).update(arquivo=arquivo)
...
def read_r2040_evtassocdesprep_obj(request, doc, status, validar=False):
    ...
    if 'recursosRep' in dir(evtAssocDespRep.ideContri.ideEstab):
        ...
        for recursosRep in evtAssocDespRep.ideContri.ideEstab.recursosRep:
            ...
            try:
                r2040_recursosrep_dados['vlrtotalrep'] = recursosRep.vlrTotalRep.cdata
            except AttributeError: 
                pass
            
            try:
                r2040_recursosrep_dados['vlrtotalret'] = recursosRep.vlrTotalRet.cdata
            except AttributeError: 
                pass
            
            try:
                r2040_recursosrep_dados['vlrtotalnret'] = recursosRep.vlrTotalNRet.cdata
            except AttributeError: 
                pass
            ...
            if 'infoRecurso' in dir(recursosRep):
                ...
                for infoRecurso in recursosRep.infoRecurso:
                    ...
                    try:
                        r2040_inforecurso_dados['vlrbruto'] = infoRecurso.vlrBruto.cdata
                    except AttributeError: 
                        pass
                    
                    try:
                        r2040_inforecurso_dados['vlrretapur'] = infoRecurso.vlrRetApur.cdata
                    except AttributeError: 
                        pass
            ...
            if 'infoProc' in dir(recursosRep):
                ...
                for infoProc in recursosRep.infoProc:
                    ...
                    try:
                        r2040_infoproc_dados['vlrnret'] = infoProc.vlrNRet.cdata
                    except AttributeError: 
                        pass
    ...
    r2040_evtassocdesprep_dados['status'] = STATUS_EVENTO_IMPORTADO
