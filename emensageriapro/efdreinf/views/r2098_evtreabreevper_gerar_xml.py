...
def gerar_xml_r2098(request, r2098_evtreabreevper_id, versao=None):
    ...
    if r2098_evtreabreevper_id:
        ...
        r2098_evtreabreevper_lista = r2098evtReabreEvPer.objects. \
            filter(id=r2098_evtreabreevper_id, excluido = False).all()
...
def gerar_xml_assinado(request, r2098_evtreabreevper_id):
    ...
    if r2098_evtreabreevper.arquivo_original:
        ...
        xml = gerar_xml_r2098(request, r2098_evtreabreevper_id)
    ...
    if 'Signature' in xml:
        ...
        xml_assinado = assinar_efdreinf(request, xml, r2098_evtreabreevper.transmissor_lote_efdreinf_id)
    ...
    if r2098_evtreabreevper.status in (
        ...
        r2098evtReabreEvPer.objects.\
            filter(id=r2098_evtreabreevper_id).update(status=STATUS_EVENTO_ASSINADO)
...
def gerar_xml(request, hash):
    ...
    if r2098_evtreabreevper_id:
        ...
        xml_assinado = gerar_xml_assinado(request, r2098_evtreabreevper_id)
