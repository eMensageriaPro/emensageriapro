...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r2050_evtcomprod_id:
            ...
            r2050_evtcomprod_form = form_r2050_evtcomprod(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_EFDREINF, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
