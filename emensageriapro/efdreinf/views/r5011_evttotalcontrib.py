...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r5011_evttotalcontrib_id:
            ...
            r5011_evttotalcontrib_form = form_r5011_evttotalcontrib(request.POST or None, slug = db_slug, initial={'versao': VERSAO_MODELO, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
