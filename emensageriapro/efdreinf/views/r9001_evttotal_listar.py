...
def listar(request, hash):
    ...
    if request.user.has_perm('efdreinf.can_view_r9001evtTotal'):
        ...
        r9001_evttotal_lista = r9001evtTotal.objects.filter(**dict_qs).filter().exclude(id=0).all()
        
        if not post and len(r9001_evttotal_lista) > 100:
            filtrar = True
            r9001_evttotal_lista = None
            messages.warning(request, u'Listagem com mais de 100 resultados! Filtre os resultados um melhor desempenho!')
            
        #[VARIAVEIS_LISTA_FILTRO_RELATORIO]
        #r9001_evttotal_listar_custom
        ...
        if for_print in (0,1):
            ...
            return render(request, 'r9001_evttotal_listar.html', context)
            ...
            response = PDFTemplateResponse(
                request=request,
                template='r9001_evttotal_listar.html',
            ...
            response = render_to_response('r9001_evttotal_listar.html', context)
            ...
            response = render_to_response('csv/r9001_evttotal.csv', context)
            filename = "r9001_evttotal.csv"
            response['Content-Disposition'] = 'attachment; filename=' + filename
