...
def criar_exclusao(request, pk):
    ...
    from emensageriapro.efdreinf.views.r5001_evttotal_gerar_xml import gerar_xml_r5001
    from emensageriapro.functions import identidade_evento
    
    if request.user.has_perm('efdreinf.can_create_delete_r5001evtTotal'):
        ...
        return redirect('r5001_evttotal_salvar', pk=return_pk, tab='master')
        ...
        return redirect('r5001_evttotal_salvar', pk=pk, tab='master')