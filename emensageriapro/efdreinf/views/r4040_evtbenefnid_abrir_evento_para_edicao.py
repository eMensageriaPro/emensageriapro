...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r4040evtBenefNId'):
        ...
        if r4040_evtbenefnid.status in status_list:
            ...
            r4040evtBenefNId.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                'r4040_evtbenefnid', pk, request.user.id, 1)
    ...
    return redirect('r4040_evtbenefnid_salvar', pk=pk, tab='master')