...
def criar_exclusao(request, hash):
    ...
    if request.user.has_perm('efdreinf.can_create_delete_event_r9011evtTotalContrib'):
        ...
        if r9011_evttotalcontrib_id:
            ...
            gravar_auditoria(u'{}',
                u'{"funcao": "Evento de exclusão de identidade %s criado a partir da duplicação do evento %s"}' % (nova_identidade, r9011_evttotalcontrib.identidade),
