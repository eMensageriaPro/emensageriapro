...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r2070_evtpgtosdivs_id:
            ...
            r2070_evtpgtosdivs_form = form_r2070_evtpgtosdivs(request.POST or None, slug = db_slug, initial={'versao': VERSAO_LAYOUT_EFDREINF, 'status': 0, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
        if request.method == 'POST':
            if r2070_evtpgtosdivs_form.is_valid():
                ...
                if r2070_evtpgtosdivs_id:
                    ...
                    r2070_evtpgtosdivs_form = form_r2070_evtpgtosdivs(request.POST or None, instance = obj, slug = db_slug)
                    gravar_auditoria('{}',
                                     json.dumps(model_to_dict(obj), indent=4, sort_keys=True, default=str),
        ...
        #             r2070_evtpgtosdivs_form.fields['status'].widget.attrs['disabled'] = True
        #             r2070_evtpgtosdivs_form.fields['status'].widget.attrs['readonly'] = True
        #             r2070_evtpgtosdivs_form.fields['transmissor_lote_efdreinf'].widget.attrs['disabled'] = True
