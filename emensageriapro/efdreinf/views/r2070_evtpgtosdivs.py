...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if r2070_evtpgtosdivs_id:
            ...
            r2070_evtpgtosdivs_form = form_r2070_evtpgtosdivs(request.POST or None, slug = db_slug, initial={'versao': VERSAO_MODELO, 'processamento_codigo_resposta': 0, 'tpamb': TP_AMB, 'procemi': 1, 'verproc': VERSAO_EMENSAGERIA})
