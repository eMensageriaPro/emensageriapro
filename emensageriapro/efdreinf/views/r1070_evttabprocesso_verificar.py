...
=======
    if r1070_evttabprocesso.transmissor_lote_esocial:
        if r1070_evttabprocesso.transmissor_lote_esocial.transmissor:
            if r1070_evttabprocesso.transmissor_lote_esocial.transmissor.verificar_predecessao:
