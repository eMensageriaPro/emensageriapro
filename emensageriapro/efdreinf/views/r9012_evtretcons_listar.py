...
def listar(request, output=None):
    ...
    if request.user.has_perm('efdreinf.can_see_r9012evtRetCons'):
        ...
        r9012_evtretcons_lista = r9012evtRetCons.objects.filter(**dict_qs).filter().exclude(id=0).all()

        if not post and len(r9012_evtretcons_lista) > 100:
            filtrar = True
            r9012_evtretcons_lista = None
            messages.warning(request, u'Listagem com mais de 100 resultados! Filtre os resultados um melhor desempenho!')

        #[VARIAVEIS_LISTA_FILTRO_RELATORIO]
        #r9012_evtretcons_listar_custom
        ...
        if output == 'pdf':
            ...
            response = PDFTemplateResponse(
                request=request,
                template='r9012_evtretcons_listar.html',
            ...
            response = render_to_response('r9012_evtretcons_listar.html', context)
            ...
            response = render_to_response('csv/r9012_evtretcons.csv', context)
            filename = "r9012_evtretcons.csv"
            response['Content-Disposition'] = 'attachment; filename=' + filename
            ...
            return render(request, 'r9012_evtretcons_listar.html', context)
