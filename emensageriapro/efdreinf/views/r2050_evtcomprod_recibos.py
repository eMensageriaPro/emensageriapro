...
def recibo(request, pk, output=None):
    ...
    if request.user.has_perm('efdreinf.can_see_r2050evtComProd'):
        ...
        if r2050_evtcomprod.retornos_r5001_id:
            r5001_evttotal = get_object_or_404(r5001evtTotal,
                id=r2050_evtcomprod.retornos_r5001_id)
        else:
            r5001_evttotal = None
            
        if r2050_evtcomprod.retornos_r5011_id:
            r5011_evttotalcontrib = get_object_or_404(r5011evtTotalContrib,
                id=r2050_evtcomprod.retornos_r5011_id)
        else:
            r5011_evttotalcontrib = None
            
        if r2050_evtcomprod.retornos_r9001_id:
            r9001_evttotal = get_object_or_404(r9001evtTotal,
                id=r2050_evtcomprod.retornos_r9001_id)
        else:
            r9001_evttotal = None
            
        if r2050_evtcomprod.retornos_r9002_id:
            r9002_evtret = get_object_or_404(r9002evtRet,
                id=r2050_evtcomprod.retornos_r9002_id)
        else:
            r9002_evtret = None
            
        if r2050_evtcomprod.retornos_r9011_id:
            r9011_evttotalcontrib = get_object_or_404(r9011evtTotalContrib,
                id=r2050_evtcomprod.retornos_r9011_id)
        else:
            r9011_evttotalcontrib = None
            
        if r2050_evtcomprod.retornos_r9012_id:
            r9012_evtretcons = get_object_or_404(r9012evtRetCons,
                id=r2050_evtcomprod.retornos_r9012_id)
        else:
        ...
        if output == 'xls':
            ...
            return render(request, 'r2050_evtcomprod_recibo_pdf.html', context)
