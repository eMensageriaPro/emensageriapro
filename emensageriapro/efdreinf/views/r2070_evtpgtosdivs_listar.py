    ...
    if request.user.has_perm('efdreinf.can_see_r2070evtPgtosDivs'):
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'idebenef': 'idebenef',
                'codpgto__icontains': 'codpgto__icontains',
                'tpinscbenef__icontains': 'tpinscbenef__icontains',
        ...
        r2070_evtpgtosdivs_lista = r2070evtPgtosDivs.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            response = render_to_response('csv/r2070_evtpgtosdivs.csv', context)
