...
def read_r9012_evtretcons_string(dados, xml, validar=False):
    ...
    dados = read_r9012_evtretcons_obj(doc, status, validar)
    return dados



def read_r9012_evtretcons(dados, arquivo, validar=False):
...
def read_r9012_evtretcons_obj(doc, status, validar=False):
    ...
    if validar:
        validar_evento_funcao(r9012_evtretcons.id)
