...
def listar(request, hash):
    ...
    if request.user.has_perm('efdreinf.can_view_r2098evtReabreEvPer'):
        ...
        r2098_evtreabreevper_lista = r2098evtReabreEvPer.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            response = render_to_response('csv/r2098_evtreabreevper.csv', context)
