...
def abrir_evento_para_edicao(request, pk):
    ...
    if request.user.has_perm('efdreinf.can_open_r2098evtReabreEvPer'):
        ...
        if r2098_evtreabreevper.status in status_list:
            ...
            r2098evtReabreEvPer.objects.filter(id=pk).update(
            ...
            gravar_auditoria(u'{}', u'{"funcao": "Evento aberto para edição"}',
                'r2098_evtreabreevper', pk, request.user.id, 1)
    ...
    return redirect('r2098_evtreabreevper_salvar', pk=pk, tab='master')