...
def validar_evento_funcao(request, pk):
    ...
    if lista_validacoes:
        ...
        if VERIFICAR_PREDECESSAO_ANTES_ENVIO and 'r4020_evtretpj' not in EVENTOS_SEM_PREDECESSAO:

            quant = validar_precedencia('r4020_evtretpj', pk)
...
def validar_evento(request, pk, tab=None):
    ...
    if r4020_evtretpj.status in STATUS_VALIDACAO:
