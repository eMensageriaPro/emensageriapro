...
def alterar_identidade(request, hash):
    ...
    if r2070_evtpgtosdivs_id:
        ...
        if r2070_evtpgtosdivs.status == 0:
            ...
            nova_identidade = identidade_evento(r2070_evtpgtosdivs_id, db_slug)
...
def validar_evento_funcao(r2070_evtpgtosdivs_id, db_slug):
    ...
    lista_validacoes = []
    r2070_evtpgtosdivs = get_object_or_404(r2070evtPgtosDivs.objects.using(db_slug), excluido=False, id=r2070_evtpgtosdivs_id)
    if r2070_evtpgtosdivs.transmissor_lote_esocial:
        if r2070_evtpgtosdivs.transmissor_lote_esocial.transmissor:
            if r2070_evtpgtosdivs.transmissor_lote_esocial.transmissor.verificar_predecessao:
