...
class form_r3010_evtespdesportivo(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['vlrcpsusptotal'].widget.attrs['required'] = True
...
class form_r2070_evtpgtosdivs(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['nrinscbenef'].widget.attrs['required'] = True
        
        self.fields['tpinscbenef'].widget.attrs['required'] = True
...
class form_r2060_evtcprb(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['vlrcprbsusptotal'].widget.attrs['required'] = True
...
class form_r2050_evtcomprod(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['vlrsenarsusptotal'].widget.attrs['required'] = True
        
        self.fields['vlrratsusptotal'].widget.attrs['required'] = True
