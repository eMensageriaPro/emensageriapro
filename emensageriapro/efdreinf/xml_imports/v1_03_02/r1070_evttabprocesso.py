...
def read_r1070_evttabprocesso(dados, arquivo, validar=False):
    ...
    if validar:
        r1070_evttabprocesso_dados['status'] = 1
    else:
        r1070_evttabprocesso_dados['status'] = 0
    r1070_evttabprocesso_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % r1070_evttabprocesso_dados['identidade'], True)
    ...
    dados['evento'] = 'r1070'
    dados['identidade'] = r1070_evttabprocesso_id
