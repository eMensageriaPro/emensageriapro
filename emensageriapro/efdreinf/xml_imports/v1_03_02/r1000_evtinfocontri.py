...
def read_r1000_evtinfocontri(dados, arquivo, validar=False):
    ...
    if validar:
        r1000_evtinfocontri_dados['status'] = 1
    else:
        r1000_evtinfocontri_dados['status'] = 0
    r1000_evtinfocontri_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % r1000_evtinfocontri_dados['identidade'], True)
    ...
    dados['evento'] = 'r1000'
    dados['identidade'] = r1000_evtinfocontri_id
