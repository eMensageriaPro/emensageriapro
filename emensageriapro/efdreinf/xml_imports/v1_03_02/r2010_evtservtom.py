...
def read_r2010_evtservtom(dados, arquivo, validar=False):
    ...
    if validar:
        r2010_evtservtom_dados['status'] = 1
    else:
        r2010_evtservtom_dados['status'] = 0
    r2010_evtservtom_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % r2010_evtservtom_dados['identidade'], True)
    ...
    dados['evento'] = 'r2010'
    dados['identidade'] = r2010_evtservtom_id
