...
def read_r3010_evtespdesportivo(dados, arquivo, validar=False):
    ...
    if validar:
        r3010_evtespdesportivo_dados['status'] = 1
    else:
        r3010_evtespdesportivo_dados['status'] = 0
    r3010_evtespdesportivo_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % r3010_evtespdesportivo_dados['identidade'], True)
    ...
    dados['evento'] = 'r3010'
    dados['identidade'] = r3010_evtespdesportivo_id
