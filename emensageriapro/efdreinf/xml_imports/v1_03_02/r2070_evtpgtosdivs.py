...
def read_r2070_evtpgtosdivs(dados, arquivo, validar=False):
    ...
    if validar:
        r2070_evtpgtosdivs_dados['status'] = 1
    else:
        r2070_evtpgtosdivs_dados['status'] = 0
    r2070_evtpgtosdivs_dados['versao'] = xmlns[len(xmlns)-1]
    ...
    #     """ % r2070_evtpgtosdivs_dados['identidade'], True)
    ...
    dados['evento'] = 'r2070'
    dados['identidade'] = r2070_evtpgtosdivs_id
