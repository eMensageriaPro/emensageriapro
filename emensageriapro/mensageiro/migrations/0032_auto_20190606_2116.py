# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-06-06 21:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mensageiro', '0031_auto_20190602_0930'),
    ]
...
UNION
 SELECT r4010_evtretpf.id,
   ...
   FROM r4010_evtretpf
  WHERE r4010_evtretpf.excluido = false
UNION
 SELECT r4020_evtretpj.id,
   ...
   FROM r4020_evtretpj
  WHERE r4020_evtretpj.excluido = false
UNION
 SELECT r4040_evtbenefnid.id,
  ...
  WHERE r4040_evtbenefnid.excluido = false
UNION
 SELECT r4098_evtreab.id,
   ...
   FROM r4098_evtreab
  WHERE r4098_evtreab.excluido = false
UNION
 SELECT r4099_evtfech.id,
   ...
   FROM r4099_evtfech
  WHERE r4099_evtfech.excluido = false
UNION
...
CREATE OR REPLACE VIEW public.transmissor_eventos_efdreinf_totalizacoes AS 
 SELECT r5001_evttotal.id,
    ...
    r5001_evttotal.retornos_r5001_id,
    r5001_evttotal.retornos_r5011_id,
    r5001_evttotal.retornos_r9001_id,
    r5001_evttotal.retornos_r9002_id,
    r5001_evttotal.retornos_r9011_id,
    r5001_evttotal.retornos_r9012_id,
...
UNION
 SELECT r5011_evttotalcontrib.id,
    ...
    r5011_evttotalcontrib.retornos_r5001_id,
    r5011_evttotalcontrib.retornos_r5011_id,
    r5011_evttotalcontrib.retornos_r9001_id,
    r5011_evttotalcontrib.retornos_r9002_id,
    r5011_evttotalcontrib.retornos_r9011_id,
    r5011_evttotalcontrib.retornos_r9012_id,
...
UNION
 SELECT r9001_evttotal.id,
    ...
    r9001_evttotal.retornos_r5001_id,
    r9001_evttotal.retornos_r5011_id,
    r9001_evttotal.retornos_r9001_id,
    r9001_evttotal.retornos_r9002_id,
    r9001_evttotal.retornos_r9011_id,
    r9001_evttotal.retornos_r9012_id,
    r9001_evttotal.ocorrencias
   FROM r9001_evttotal
  WHERE r9001_evttotal.excluido = false
UNION
 SELECT r9002_evtret.id,
    ...
    r9002_evtret.status,
    r9002_evtret.retornos_r5001_id,
    r9002_evtret.retornos_r5011_id,
    r9002_evtret.retornos_r9001_id,
    r9002_evtret.retornos_r9002_id,
    r9002_evtret.retornos_r9011_id,
    r9002_evtret.retornos_r9012_id,
    r9002_evtret.ocorrencias
   FROM r9002_evtret
  WHERE r9002_evtret.excluido = false
UNION
 SELECT r9011_evttotalcontrib.id,
    ...
    r9011_evttotalcontrib.excluido,
    3 AS grupo,
    ...
    r9011_evttotalcontrib.retornos_r5001_id,
    r9011_evttotalcontrib.retornos_r5011_id,
    r9011_evttotalcontrib.retornos_r9001_id,
    r9011_evttotalcontrib.retornos_r9002_id,
    r9011_evttotalcontrib.retornos_r9011_id,
    r9011_evttotalcontrib.retornos_r9012_id,
    r9011_evttotalcontrib.ocorrencias
   FROM r9011_evttotalcontrib
  WHERE r9011_evttotalcontrib.excluido = false
UNION
 SELECT r9012_evtretcons.id,
    ...
    r9012_evtretcons.retornos_r5001_id,
    r9012_evtretcons.retornos_r5011_id,
    r9012_evtretcons.retornos_r9001_id,
    r9012_evtretcons.retornos_r9002_id,
    r9012_evtretcons.retornos_r9011_id,
    r9012_evtretcons.retornos_r9012_id,
    r9012_evtretcons.ocorrencias
   FROM r9012_evtretcons
  WHERE r9012_evtretcons.excluido = false;
...
UNION
 SELECT s2221_evttoxic.id,
   ...
   FROM s2221_evttoxic
  WHERE s2221_evttoxic.excluido = false
UNION
...
UNION
 SELECT s2245_evttreicap.id,
  ...
  WHERE s2245_evttreicap.excluido = false
UNION
...
UNION
 SELECT s2400_evtcdbenefin.id,
  ...
  WHERE s2400_evtcdbenefin.excluido = false
UNION
 SELECT s2405_evtcdbenefalt.id,
  ...
  WHERE s2405_evtcdbenefalt.excluido = false
UNION
 SELECT s2410_evtcdbenin.id,
  ...
  WHERE s2410_evtcdbenin.excluido = false
UNION
 SELECT s2416_evtcdbenalt.id,
  ...
  WHERE s2416_evtcdbenalt.excluido = false
UNION
 SELECT s2420_evtcdbenterm.id,
  ...
  WHERE s2420_evtcdbenterm.excluido = false
UNION
...
ALTER TABLE public.transmissor_eventos_esocial_totalizacoes
  OWNER TO postgres;
