...
class form_retornos_eventos_intervalos(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['retornos_eventos_horarios'].widget.attrs['required'] = True
...
class form_transmissor_lote_efdreinf(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['transmissor'].widget.attrs['required'] = True
...
class form_transmissores(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['logotipo'].widget.attrs['required'] = True
...
class form_relatorios(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['sql'].widget.attrs['required'] = True
