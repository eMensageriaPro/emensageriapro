...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='transmissor_lote_esocial')
    ...
    if permissao.permite_listar:
        ...
        transmissor_lote_esocial_lista = TransmissorLoteEsocial.objects.filter(**dict_qs).filter().exclude(id=0).all()
