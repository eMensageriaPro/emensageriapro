...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='transmissor_lote_esocial_ocorrencias')
    ...
    if permissao.permite_listar:
        ...
        transmissor_lote_esocial_ocorrencias_lista = TransmissorLoteEsocialOcorrencias.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/transmissor_lote_esocial_ocorrencias.csv', context)
