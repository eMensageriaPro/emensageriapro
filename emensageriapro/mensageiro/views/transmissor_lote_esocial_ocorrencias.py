...
class TransmissorLoteEsocialOcorrenciasList(generics.ListCreateAPIView):
    db_slug = 'default'
    queryset = TransmissorLoteEsocialOcorrencias.objects.using(db_slug).all()
    serializer_class = TransmissorLoteEsocialOcorrenciasSerializer
    # permission_classes = (IsAdminUser,)


class TransmissorLoteEsocialOcorrenciasDetail(generics.RetrieveUpdateDestroyAPIView):
    db_slug = 'default'
    queryset = TransmissorLoteEsocialOcorrencias.objects.using(db_slug).all()
    serializer_class = TransmissorLoteEsocialOcorrenciasSerializer
    # permission_classes = (IsAdminUser,)
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if transmissor_lote_esocial_ocorrencias_id:
            ...
            transmissor_lote_esocial_ocorrencias_form = form_transmissor_lote_esocial_ocorrencias(request.POST or None, slug = db_slug,
                                initial = {'excluido': False})
        if request.method == 'POST':
