...
def salvar(request, hash):
    ...
    if s1070_inclusao_id:
        ...
        s1070_inclusao = get_object_or_404(s1070inclusao, id=s1070_inclusao_id)
        dados_evento = s1070_inclusao.evento()

    if request.user.has_perm('s1070.can_view_s1070inclusao'):
        ...
        s1070_inclusao_form = disabled_form_fields(s1070_inclusao_form, request.user.has_perm('s1070.change_s1070inclusao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1070_inclusao_id, tabela='s1070_inclusao').all()
