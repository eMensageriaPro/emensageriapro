...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s1070_inclusao_lista = s1070inclusao.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1070_inclusao_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1070_inclusao.csv', context)
