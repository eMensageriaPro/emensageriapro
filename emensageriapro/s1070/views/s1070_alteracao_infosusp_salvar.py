...
def salvar(request, hash):
    ...
    if s1070_alteracao_infosusp_id:
        ...
        s1070_alteracao_infosusp = get_object_or_404(s1070alteracaoinfoSusp, id=s1070_alteracao_infosusp_id)
    ...
    if request.user.has_perm('s1070.can_view_s1070alteracaoinfoSusp'):
        ...
        s1070_alteracao_infosusp_form = disabled_form_fields(s1070_alteracao_infosusp_form, request.user.has_perm('s1070.change_s1070alteracaoinfoSusp'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1070_alteracao_infosusp_id, tabela='s1070_alteracao_infosusp').all()
