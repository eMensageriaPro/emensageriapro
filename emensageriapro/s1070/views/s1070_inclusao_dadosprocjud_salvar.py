...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1070_inclusao_dadosprocjud')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1070_inclusao_dadosprocjud_id:
        s1070_inclusao_dadosprocjud = get_object_or_404(s1070inclusaodadosProcJud, id = s1070_inclusao_dadosprocjud_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1070_inclusao_dadosprocjud_id, tabela='s1070_inclusao_dadosprocjud').all()
        context = {
