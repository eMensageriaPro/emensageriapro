...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1070.can_view_s1070inclusaodadosProcJud'):
        ...
        s1070_inclusao_dadosprocjud_form = disabled_form_fields(s1070_inclusao_dadosprocjud_form, request.user.has_perm('s1070.change_s1070inclusaodadosProcJud'))
