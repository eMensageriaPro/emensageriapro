...
def salvar(request, hash):
    ...
    if r2040_infoproc_id:
        ...
        r2040_infoproc = get_object_or_404(r2040infoProc, id=r2040_infoproc_id)
        dados_evento = r2040_infoproc.evento()

    if request.user.has_perm('r2040.can_view_r2040infoProc'):
        ...
        r2040_infoproc_form = disabled_form_fields(r2040_infoproc_form, request.user.has_perm('r2040.change_r2040infoProc'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2040_infoproc_id, tabela='r2040_infoproc').all()
