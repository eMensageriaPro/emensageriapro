...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            r2040infoProc.objects.using( db_slug ).filter(id = r2040_infoproc_id).delete()
            ...
            if r2040_infoproc_form.is_valid():
                ...
                if r2040_infoproc_id:
                    if dados_evento['status'] == 0:
                        ...
                        #r2040_infoproc_campos_multiple_passo1
                        r2040infoProc.objects.using(db_slug).filter(id=r2040_infoproc_id).update(**dados)
                        obj = r2040infoProc.objects.using(db_slug).get(id=r2040_infoproc_id)
                        #r2040_infoproc_editar_custom
                        #r2040_infoproc_campos_multiple_passo2
                    ...
                    #r2040_infoproc_cadastrar_campos_multiple_passo1
                    obj = r2040infoProc(**dados)
                    obj.save(using = db_slug)
                    #r2040_infoproc_cadastrar_custom
                    #r2040_infoproc_cadastrar_campos_multiple_passo2
