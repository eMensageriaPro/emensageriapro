...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = { 
                'r2040_evtassocdesprep__icontains': 'r2040_evtassocdesprep__icontains',
        ...
        r2040_recursosrep_lista = r2040recursosRep.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/r2040_recursosrep_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r2040_recursosrep.csv', context)
