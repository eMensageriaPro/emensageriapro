...
class s2230emitente(models.Model):
    ...
    def __unicode__(self):
        return unicode(self.s2230_infoatestado) + ' - ' + unicode(self.nmemit) + ' - ' + unicode(self.ideoc) + ' - ' + unicode(self.nroc) + ' - ' + unicode(self.ufoc)
...
class s2230infoAtestado(models.Model):
    ...
    excluido = models.BooleanField(blank=True)
    def __unicode__(self):
        return unicode(self.s2230_iniafastamento) + ' - ' + unicode(self.codcid) + ' - ' + unicode(self.qtddiasafast)
...
class s2230infoRetif(models.Model):
    ...
    excluido = models.BooleanField(blank=True)
    def __unicode__(self):
        return unicode(self.s2230_evtafasttemp) + ' - ' + unicode(self.origretif) + ' - ' + unicode(self.tpproc) + ' - ' + unicode(self.nrproc)
...
class s2230iniAfastamento(models.Model):
    ...
    excluido = models.BooleanField(blank=True)
    def __unicode__(self):
        return unicode(self.s2230_evtafasttemp) + ' - ' + unicode(self.dtiniafast) + ' - ' + unicode(self.codmotafast) + ' - ' + unicode(self.infomesmomtv) + ' - ' + unicode(self.tpacidtransito) + ' - ' + unicode(self.observacao)
