...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='ideoc',
            field=models.IntegerField(choices=[(1, '1 - Conselho Regional de Medicina (CRM)'), (2, '2 - Conselho Regional de Odontologia (CRO)'), (3, '3 - Registro do Minist\xe9rio da Sa\xfade (RMS).')]),
        ),
        migrations.AlterField(
            model_name='s2230emitente',
            name='nmemit',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='s2230emitente_s2230_infoatestado', to='s2230.s2230infoAtestado'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='s2230fimafastamento_s2230_evtafasttemp', to='esocial.s2230evtAfastTemp'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='s2230infoatestado_s2230_iniafastamento', to='s2230.s2230iniAfastamento'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s2230infocessao',
            name='s2230_iniafastamento',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='s2230infocessao_s2230_iniafastamento', to='s2230.s2230iniAfastamento'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s2230infomandsind',
            name='infonusremun',
            field=models.IntegerField(choices=[(1, '1 - Apenas do Empregador'), (2, '2 - Apenas do Sindicato'), (3, '3 - Parte do Empregador, sendo a diferen\xe7a e/ou complementa\xe7\xe3o salarial paga pelo Sindicato.')]),
        ),
        migrations.AlterField(
            model_name='s2230infomandsind',
            name='s2230_iniafastamento',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='s2230infomandsind_s2230_iniafastamento', to='s2230.s2230iniAfastamento'),
        ),
        migrations.AlterField(
            model_name='s2230inforetif',
            name='origretif',
            field=models.IntegerField(choices=[(1, '1 - Por iniciativa do empregador'), (2, '2 - Revis\xe3o Administrativa'), (3, '3 - Determina\xe7\xe3o Judicial.')]),
        ),
        migrations.AlterField(
            model_name='s2230inforetif',
            name='s2230_evtafasttemp',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='s2230inforetif_s2230_evtafasttemp', to='esocial.s2230evtAfastTemp'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s2230iniafastamento',
            name='s2230_evtafasttemp',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='s2230iniafastamento_s2230_evtafasttemp', to='esocial.s2230evtAfastTemp'),
        ),
    ]
