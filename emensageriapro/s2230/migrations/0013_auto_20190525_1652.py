...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='ideoc',
            field=models.IntegerField(choices=[(1, '1 - Conselho Regional de Medicina (CRM)'), (2, '2 - Conselho Regional de Odontologia (CRO)'), (3, '3 - Registro do Minist\xe9rio da Sa\xfade (RMS).')], null=True),
        ),
        migrations.AlterField(
            model_name='s2230emitente',
            name='nmemit',
        ...
        migrations.AlterField(
            model_name='s2230infomandsind',
            name='infonusremun',
            field=models.IntegerField(choices=[(1, '1 - Apenas do Empregador'), (2, '2 - Apenas do Sindicato'), (3, '3 - Parte do Empregador, sendo a diferen\xe7a e/ou complementa\xe7\xe3o salarial paga pelo Sindicato.')], null=True),
        ),
        migrations.AlterField(
            model_name='s2230inforetif',
            name='origretif',
            field=models.IntegerField(choices=[(1, '1 - Por iniciativa do empregador'), (2, '2 - Revis\xe3o Administrativa'), (3, '3 - Determina\xe7\xe3o Judicial.')], null=True),
        ),
        migrations.AlterField(
