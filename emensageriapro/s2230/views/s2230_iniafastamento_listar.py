...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2230_iniafastamento')
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'tpacidtransito__icontains': 'tpacidtransito__icontains',
        ...
        s2230_iniafastamento_lista = s2230iniAfastamento.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s2230_iniafastamento_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s2230_iniafastamento.csv', context)
