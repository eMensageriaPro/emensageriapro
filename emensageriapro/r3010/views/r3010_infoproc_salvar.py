...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r3010_infoproc = get_object_or_404(r3010infoProc, id=pk)
        evento_dados = r3010_infoproc.evento()

    if request.user.has_perm('r3010.can_see_r3010infoProc'):
        ...
        if request.method == 'POST':
            ...
            if r3010_infoproc_form.is_valid():
                ...
                if request.session['return_page'] not in (
                    'r3010_infoproc_apagar', 
                    'r3010_infoproc_salvar', 
                    'r3010_infoproc'):
        ...
        r3010_infoproc_form = disabled_form_fields(
            r3010_infoproc_form, 
            request.user.has_perm('r3010.change_r3010infoProc'))
        ...
        if tab or 'r3010_infoproc' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r3010_infoproc_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r3010_infoproc').all()
