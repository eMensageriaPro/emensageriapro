    ...
    if request.user.has_perm('r3010.can_view_r3010outrasReceitas'):
        ...
        if request.method == 'POST':
            ...
            if r3010_outrasreceitas_form.is_valid():
                ...
                if not r3010_outrasreceitas_id:
        ...
        r3010_outrasreceitas_form = disabled_form_fields(r3010_outrasreceitas_form, request.user.has_perm('r3010.change_r3010outrasReceitas'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r3010_outrasreceitas_id, tabela='r3010_outrasreceitas').all()
