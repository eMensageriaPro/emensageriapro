...
class form_r2070_rendisento(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['descrendimento'].widget.attrs['required'] = True
...
class form_r2070_inforesidext(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['relfontepagad'].widget.attrs['required'] = True
...
class form_r2070_inforra(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['qtdmesesrra'].widget.attrs['required'] = True
        
        self.fields['natrra'].widget.attrs['required'] = True
        
        self.fields['codsusp'].widget.attrs['required'] = True
        
        self.fields['nrprocrra'].widget.attrs['required'] = True
        
        self.fields['tpprocrra'].widget.attrs['required'] = True
        self.fields['r2070_pgtopf'].queryset = r2070pgtoPF.objects.using( slug ).filter(excluido=False).all()
        self.fields['r2070_pgtopf'].widget.attrs['required'] = True
...
class form_r2070_depjudicial(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['vlrdepjudicial'].widget.attrs['required'] = True
...
class form_r2070_compjud(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['vlrcompanoant'].widget.attrs['required'] = True
        
        self.fields['vlrcompanocalend'].widget.attrs['required'] = True
