...
def salvar(request, hash):
    ...
    if r2070_pgtopj_id:
        ...
        r2070_pgtopj = get_object_or_404(r2070pgtoPJ, id=r2070_pgtopj_id)
        dados_evento = r2070_pgtopj.evento()

    if request.user.has_perm('r2070.can_view_r2070pgtoPJ'):
        ...
        r2070_pgtopj_form = disabled_form_fields(r2070_pgtopj_form, request.user.has_perm('r2070.change_r2070pgtoPJ'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2070_pgtopj_id, tabela='r2070_pgtopj').all()
