...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r2070_inforra_despprocjud = get_object_or_404(r2070infoRRAdespProcJud, id=pk)
        evento_dados = r2070_inforra_despprocjud.evento()

    if request.user.has_perm('r2070.can_see_r2070infoRRAdespProcJud'):
        
        if pk:
        
            r2070_inforra_despprocjud_form = form_r2070_inforra_despprocjud(
        ...
        if request.method == 'POST':
            ...
            if r2070_inforra_despprocjud_form.is_valid():
                ...
                if not pk:
                    ...
                    gravar_auditoria(
                        json.dumps(
                            model_to_dict(r2070_inforra_despprocjud), 
                            indent=4, 
                            sort_keys=True, 
                            default=str),
                        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r2070_inforra_despprocjud_apagar', 
                    'r2070_inforra_despprocjud_salvar', 
                    'r2070_inforra_despprocjud'):
        ...
        r2070_inforra_despprocjud_form = disabled_form_fields(
            r2070_inforra_despprocjud_form, 
            request.user.has_perm('r2070.change_r2070infoRRAdespProcJud'))
        ...
        if tab or 'r2070_inforra_despprocjud' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r2070_inforra_despprocjud_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r2070_inforra_despprocjud').all()
