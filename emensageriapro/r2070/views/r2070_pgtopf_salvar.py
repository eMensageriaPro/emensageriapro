...
def salvar(request, hash):
    ...
    if r2070_pgtopf_id:
        ...
        r2070_pgtopf = get_object_or_404(r2070pgtoPF, id=r2070_pgtopf_id)
    ...
    if request.user.has_perm('r2070.can_view_r2070pgtoPF'):
        ...
        r2070_pgtopf_form = disabled_form_fields(r2070_pgtopf_form, request.user.has_perm('r2070.change_r2070pgtoPF'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2070_pgtopf_id, tabela='r2070_pgtopf').all()
