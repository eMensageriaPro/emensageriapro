...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r2070_detdeducao = get_object_or_404(r2070detDeducao, id=pk)
        evento_dados = r2070_detdeducao.evento()
    ...
    if request.user.has_perm('r2070.can_see_r2070detDeducao'):
        ...
        if request.method == 'POST':
            ...
            if r2070_detdeducao_form.is_valid():
                ...
                #    gravar_auditoria(
                #        json.dumps(
                #            model_to_dict(r2070_detdeducao),
                #            indent=4,
                #            sort_keys=True,
                #            default=str),
                #        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r2070_detdeducao_apagar',
                    'r2070_detdeducao_salvar',
                    'r2070_detdeducao'):
        ...
        r2070_detdeducao_form = disabled_form_fields(
            r2070_detdeducao_form,
            request.user.has_perm('r2070.change_r2070detDeducao'))
        ...
        if tab or 'r2070_detdeducao' in request.session['return_page']:

            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r2070_detdeducao_salvar'

        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r2070_detdeducao').all()
