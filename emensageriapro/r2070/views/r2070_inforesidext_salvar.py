...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r2070_inforesidext = get_object_or_404(r2070infoResidExt, id=pk)
        evento_dados = r2070_inforesidext.evento()
    ...
    if request.user.has_perm('r2070.can_see_r2070infoResidExt'):
        ...
        if pk:
            ...
            r2070_inforesidext_form = form_r2070_inforesidext(
                ...
                instance=r2070_inforesidext)
                                         
        else:
        
            r2070_inforesidext_form = form_r2070_inforesidext(request.POST or None)
        ...
        if request.method == 'POST':
            ...
            if r2070_inforesidext_form.is_valid():
                ...
                if not pk:
                    ...
                    gravar_auditoria(
                        json.dumps(
                            model_to_dict(r2070_inforesidext), 
                            indent=4, 
                            sort_keys=True, 
                            default=str),
                        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r2070_inforesidext_apagar', 
                    'r2070_inforesidext_salvar', 
                    'r2070_inforesidext'):
        ...
        r2070_inforesidext_form = disabled_form_fields(
            r2070_inforesidext_form, 
            request.user.has_perm('r2070.change_r2070infoResidExt'))
        ...
        if tab or 'r2070_inforesidext' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r2070_inforesidext_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r2070_inforesidext').all()
