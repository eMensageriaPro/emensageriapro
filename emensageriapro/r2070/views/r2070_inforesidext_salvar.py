...
def salvar(request, hash):
    ...
    if r2070_inforesidext_id:
        ...
        r2070_inforesidext = get_object_or_404(r2070infoResidExt, id=r2070_inforesidext_id)
        dados_evento = r2070_inforesidext.evento()

    if request.user.has_perm('r2070.can_view_r2070infoResidExt'):
        ...
        r2070_inforesidext_form = disabled_form_fields(r2070_inforesidext_form, request.user.has_perm('r2070.change_r2070infoResidExt'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2070_inforesidext_id, tabela='r2070_inforesidext').all()
