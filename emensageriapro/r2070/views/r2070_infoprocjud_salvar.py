...
def salvar(request, hash):
    ...
    if request.user.has_perm('r2070.can_view_r2070infoProcJud'):
        ...
        r2070_infoprocjud_form = disabled_form_fields(r2070_infoprocjud_form, request.user.has_perm('r2070.change_r2070infoProcJud'))
