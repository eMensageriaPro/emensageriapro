...
def salvar(request, hash):
    ...
    if r2070_pgtopj_despprocjud_id:
        ...
        r2070_pgtopj_despprocjud = get_object_or_404(r2070pgtoPJdespProcJud, id=r2070_pgtopj_despprocjud_id)
        dados_evento = r2070_pgtopj_despprocjud.evento()

    if request.user.has_perm('r2070.can_view_r2070pgtoPJdespProcJud'):
        ...
        r2070_pgtopj_despprocjud_form = disabled_form_fields(r2070_pgtopj_despprocjud_form, request.user.has_perm('r2070.change_r2070pgtoPJdespProcJud'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2070_pgtopj_despprocjud_id, tabela='r2070_pgtopj_despprocjud').all()
