...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r2070_pgtopj_despprocjud = get_object_or_404(r2070pgtoPJdespProcJud, id=pk)
        evento_dados = r2070_pgtopj_despprocjud.evento()

    if request.user.has_perm('r2070.can_see_r2070pgtoPJdespProcJud'):

        if pk:

            r2070_pgtopj_despprocjud_form = form_r2070_pgtopj_despprocjud(
                request.POST or None,
                instance=r2070_pgtopj_despprocjud)
                     
        else:

            r2070_pgtopj_despprocjud_form = form_r2070_pgtopj_despprocjud(request.POST or None)
        ...
        if request.method == 'POST':
            ...
            if r2070_pgtopj_despprocjud_form.is_valid():
                ...
                #    gravar_auditoria(
                #        json.dumps(
                #            model_to_dict(r2070_pgtopj_despprocjud),
                #            indent=4,
                #            sort_keys=True,
                #            default=str),
                #        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r2070_pgtopj_despprocjud_apagar',
                    'r2070_pgtopj_despprocjud_salvar',
                    'r2070_pgtopj_despprocjud'):
        ...
        r2070_pgtopj_despprocjud_form = disabled_form_fields(
            r2070_pgtopj_despprocjud_form,
            request.user.has_perm('r2070.change_r2070pgtoPJdespProcJud'))
        ...
        if pk:
            ...
            r2070_pgtopj_ideadvogado_form = form_r2070_pgtopj_ideadvogado(
                initial={ 'r2070_pgtopj_despprocjud': r2070_pgtopj_despprocjud })
            ...
            r2070_pgtopj_ideadvogado_lista = r2070pgtoPJideAdvogado.objects.\
                filter(r2070_pgtopj_despprocjud_id=r2070_pgtopj_despprocjud.id).all()
        ...
        if tab or 'r2070_pgtopj_despprocjud' in request.session['return_page']:

            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r2070_pgtopj_despprocjud_salvar'

        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r2070_pgtopj_despprocjud').all()
        ...
        context = {
            ...
            'modulos': ['r2070', ],
            'paginas': ['r2070_pgtopj_despprocjud', ],
