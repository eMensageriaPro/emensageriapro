...
def salvar(request, hash):
    ...
    if r2070_infomolestia_id:
        ...
        r2070_infomolestia = get_object_or_404(r2070infoMolestia, id=r2070_infomolestia_id)
        dados_evento = r2070_infomolestia.evento()

    if request.user.has_perm('r2070.can_view_r2070infoMolestia'):
        ...
        r2070_infomolestia_form = disabled_form_fields(r2070_infomolestia_form, request.user.has_perm('r2070.change_r2070infoMolestia'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2070_infomolestia_id, tabela='r2070_infomolestia').all()
