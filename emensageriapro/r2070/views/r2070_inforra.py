...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            r2070infoRRA.objects.using( db_slug ).filter(id = r2070_inforra_id).delete()
            ...
            if r2070_inforra_form.is_valid():
                ...
                if r2070_inforra_id:
                    if dados_evento['status'] == 0:
                        ...
                        #r2070_inforra_campos_multiple_passo1
                        r2070infoRRA.objects.using(db_slug).filter(id=r2070_inforra_id).update(**dados)
                        obj = r2070infoRRA.objects.using(db_slug).get(id=r2070_inforra_id)
                        #r2070_inforra_editar_custom
                        #r2070_inforra_campos_multiple_passo2
                    ...
                    #r2070_inforra_cadastrar_campos_multiple_passo1
                    obj = r2070infoRRA(**dados)
                    obj.save(using = db_slug)
                    #r2070_inforra_cadastrar_custom
                    #r2070_inforra_cadastrar_campos_multiple_passo2
