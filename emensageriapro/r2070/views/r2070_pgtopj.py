...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            r2070pgtoPJ.objects.using( db_slug ).filter(id = r2070_pgtopj_id).delete()
            ...
            if r2070_pgtopj_form.is_valid():
                ...
                if r2070_pgtopj_id:
                    if dados_evento['status'] == 0:
                        ...
                        #r2070_pgtopj_campos_multiple_passo1
                        r2070pgtoPJ.objects.using(db_slug).filter(id=r2070_pgtopj_id).update(**dados)
                        obj = r2070pgtoPJ.objects.using(db_slug).get(id=r2070_pgtopj_id)
                        #r2070_pgtopj_editar_custom
                        #r2070_pgtopj_campos_multiple_passo2
                    ...
                    #r2070_pgtopj_cadastrar_campos_multiple_passo1
                    obj = r2070pgtoPJ(**dados)
                    obj.save(using = db_slug)
                    #r2070_pgtopj_cadastrar_custom
                    #r2070_pgtopj_cadastrar_campos_multiple_passo2
