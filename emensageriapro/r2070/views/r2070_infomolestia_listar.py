...
def listar(request, output=None):
    ...
    if request.user.has_perm('r2070.can_see_r2070infoMolestia'):
        ...
        r2070_infomolestia_lista = r2070infoMolestia.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r2070_infomolestia.csv', context)
