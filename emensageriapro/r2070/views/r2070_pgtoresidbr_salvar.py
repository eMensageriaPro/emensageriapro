...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='r2070_pgtoresidbr')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r2070_pgtoresidbr_id:
            r2070_pgtoresidbr_form = form_r2070_pgtoresidbr(request.POST or None, instance = r2070_pgtoresidbr,  
