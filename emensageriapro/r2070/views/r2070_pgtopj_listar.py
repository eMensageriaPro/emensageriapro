...
def listar(request, output=None):
    ...
    if request.user.has_perm('r2070.can_see_r2070pgtoPJ'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                'r2070_pgtoresidbr__icontains': 'r2070_pgtoresidbr__icontains',
        ...
        r2070_pgtopj_lista = r2070pgtoPJ.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        r2070_pgtoresidbr_lista = r2070pgtoResidBR.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r2070_pgtopj.csv', context)
