...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r2070_inforra = get_object_or_404(r2070infoRRA, id=pk)
        evento_dados = r2070_inforra.evento()

    if request.user.has_perm('r2070.can_see_r2070infoRRA'):
        ...
        if request.method == 'POST':
            ...
            if r2070_inforra_form.is_valid():
                ...
                if request.session['return_page'] not in (
                    'r2070_inforra_apagar', 
                    'r2070_inforra_salvar', 
                    'r2070_inforra'):
        ...
        r2070_inforra_form = disabled_form_fields(
            r2070_inforra_form, 
            request.user.has_perm('r2070.change_r2070infoRRA'))
        ...
        if pk:
            ...
            r2070_inforra_despprocjud_form = form_r2070_inforra_despprocjud(
                initial={ 'r2070_inforra': r2070_inforra })
            ...
            r2070_inforra_despprocjud_lista = r2070infoRRAdespProcJud.objects.\
                filter(r2070_inforra_id=r2070_inforra.id).all()
        ...
        if tab or 'r2070_inforra' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r2070_inforra_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r2070_inforra').all()
