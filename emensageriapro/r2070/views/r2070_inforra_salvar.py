...
def salvar(request, hash):
    ...
    if r2070_inforra_id:
        ...
        r2070_inforra = get_object_or_404(r2070infoRRA, id=r2070_inforra_id)
        dados_evento = r2070_inforra.evento()

    if request.user.has_perm('r2070.can_view_r2070infoRRA'):
        ...
        r2070_inforra_form = disabled_form_fields(r2070_inforra_form, request.user.has_perm('r2070.change_r2070infoRRA'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2070_inforra_id, tabela='r2070_inforra').all()
