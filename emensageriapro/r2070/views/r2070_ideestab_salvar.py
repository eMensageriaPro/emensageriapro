...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='r2070_ideestab')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if r2070_ideestab_id:
        r2070_ideestab = get_object_or_404(r2070ideEstab, id = r2070_ideestab_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2070_ideestab_id, tabela='r2070_ideestab').all()
        context = {
