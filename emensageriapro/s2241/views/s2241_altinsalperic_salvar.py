...
def salvar(request, hash):
    ...
    if s2241_altinsalperic_id:
        ...
        s2241_altinsalperic = get_object_or_404(s2241altInsalPeric, id=s2241_altinsalperic_id)
        dados_evento = s2241_altinsalperic.evento()

    if request.user.has_perm('s2241.can_view_s2241altInsalPeric'):
        ...
        s2241_altinsalperic_form = disabled_form_fields(s2241_altinsalperic_form, request.user.has_perm('s2241.change_s2241altInsalPeric'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2241_altinsalperic_id, tabela='s2241_altinsalperic').all()
