...
def salvar(request, hash):
    ...
    if s2241_fiminsalperic_id:
        ...
        s2241_fiminsalperic = get_object_or_404(s2241fimInsalPeric, id=s2241_fiminsalperic_id)
        dados_evento = s2241_fiminsalperic.evento()

    if request.user.has_perm('s2241.can_view_s2241fimInsalPeric'):
        ...
        s2241_fiminsalperic_form = disabled_form_fields(s2241_fiminsalperic_form, request.user.has_perm('s2241.change_s2241fimInsalPeric'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2241_fiminsalperic_id, tabela='s2241_fiminsalperic').all()
