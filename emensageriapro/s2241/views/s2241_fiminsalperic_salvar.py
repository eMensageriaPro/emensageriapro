...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2241_fiminsalperic')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2241_fiminsalperic_id:
            s2241_fiminsalperic_form = form_s2241_fiminsalperic(request.POST or None, instance = s2241_fiminsalperic,  
