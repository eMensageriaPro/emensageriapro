...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2241_altaposentesp_fatrisco')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s2241_altaposentesp_fatrisco_id:
        s2241_altaposentesp_fatrisco = get_object_or_404(s2241altAposentEspfatRisco, id = s2241_altaposentesp_fatrisco_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2241_altaposentesp_fatrisco_id, tabela='s2241_altaposentesp_fatrisco').all()
        context = {
