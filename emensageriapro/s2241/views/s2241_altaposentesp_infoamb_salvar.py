...
def salvar(request, hash):
    ...
    if request.user.has_perm('s2241.can_view_s2241altAposentEspinfoamb'):
        ...
        s2241_altaposentesp_infoamb_form = disabled_form_fields(s2241_altaposentesp_infoamb_form, request.user.has_perm('s2241.change_s2241altAposentEspinfoamb'))
