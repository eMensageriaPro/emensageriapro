            ...
            if s1210_detpgtoant_infopgtoant_form.is_valid():
                ...
                if s1210_detpgtoant_infopgtoant_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s1210_detpgtoant_infopgtoant_campos_multiple_passo1
                        s1210detPgtoAntinfoPgtoAnt.objects.using(db_slug).filter(id=s1210_detpgtoant_infopgtoant_id).update(**dados)
                        obj = s1210detPgtoAntinfoPgtoAnt.objects.using(db_slug).get(id=s1210_detpgtoant_infopgtoant_id)
                        #s1210_detpgtoant_infopgtoant_editar_custom
                        #s1210_detpgtoant_infopgtoant_campos_multiple_passo2
                    ...
                    #s1210_detpgtoant_infopgtoant_cadastrar_campos_multiple_passo1
                    obj = s1210detPgtoAntinfoPgtoAnt(**dados)
                    obj.save(using = db_slug)
                    #s1210_detpgtoant_infopgtoant_cadastrar_custom
                    #s1210_detpgtoant_infopgtoant_cadastrar_campos_multiple_passo2
...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s1210detPgtoAntinfoPgtoAnt.objects.using( db_slug ).filter(id = s1210_detpgtoant_infopgtoant_id).delete()
...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s1210_detpgtoant_lista = s1210detPgtoAnt.objects.using( db_slug ).filter(excluido = False).all()
