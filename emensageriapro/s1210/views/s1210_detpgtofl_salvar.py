...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s1210_detpgtofl.evento()

    if request.user.has_perm('s1210.can_see_s1210detPgtoFl'):
        ...
        if request.method == 'POST':
            ...
            if s1210_detpgtofl_form.is_valid():
                ...
                if request.session['return_page'] not in (
                    's1210_detpgtofl_apagar', 
                    's1210_detpgtofl_salvar', 
                    's1210_detpgtofl'):
        ...
        s1210_detpgtofl_form = disabled_form_fields(
            s1210_detpgtofl_form, 
            request.user.has_perm('s1210.change_s1210detPgtoFl'))
        ...
        if tab or 's1210_detpgtofl' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 's1210_detpgtofl_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='s1210_detpgtofl').all()
