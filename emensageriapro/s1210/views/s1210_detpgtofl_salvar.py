...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1210_detpgtofl')
    ...
    if permissao.permite_visualizar:
        ...
        if s1210_detpgtofl_id:
            ...
            s1210_detpgtofl_retpgtotot_form = form_s1210_detpgtofl_retpgtotot(
                initial={ 's1210_detpgtofl': s1210_detpgtofl })
            ...
            s1210_detpgtofl_retpgtotot_lista = s1210detPgtoFlretPgtoTot.objects.\
                filter(s1210_detpgtofl_id=s1210_detpgtofl.id).all()
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1210_detpgtofl_id, tabela='s1210_detpgtofl').all()
        context = {
