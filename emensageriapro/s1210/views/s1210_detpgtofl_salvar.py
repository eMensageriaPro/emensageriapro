...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1210.can_view_s1210detPgtoFl'):
        ...
        s1210_detpgtofl_form = disabled_form_fields(s1210_detpgtofl_form, request.user.has_perm('s1210.change_s1210detPgtoFl'))
