    ...
    if request.user.has_perm('s1210.can_see_s1210detPgtoFer'):
        ...
        if request.method == 'POST':
            ...
            if s1210_detpgtofer_form.is_valid():
                ...
                #    gravar_auditoria(
                #        json.dumps(
                #            model_to_dict(s1210_detpgtofer), 
                #            indent=4, 
                #            sort_keys=True, 
                #            default=str),
                #        json.dumps(
        ...
        if tab or 's1210_detpgtofer' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 's1210_detpgtofer_salvar'
