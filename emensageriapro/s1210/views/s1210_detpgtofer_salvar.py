...
def salvar(request, hash):
    ...
    if s1210_detpgtofer_id:
        ...
        s1210_detpgtofer = get_object_or_404(s1210detPgtoFer, id=s1210_detpgtofer_id)
        dados_evento = s1210_detpgtofer.evento()

    if request.user.has_perm('s1210.can_view_s1210detPgtoFer'):
        ...
        s1210_detpgtofer_form = disabled_form_fields(s1210_detpgtofer_form, request.user.has_perm('s1210.change_s1210detPgtoFer'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1210_detpgtofer_id, tabela='s1210_detpgtofer').all()
