...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = { 
                's1210_detpgtoant__icontains': 's1210_detpgtoant__icontains',
                'tpbcirrf__icontains': 'tpbcirrf__icontains',
                'vrbcirrf__icontains': 'vrbcirrf__icontains', }
        ...
        s1210_detpgtoant_infopgtoant_lista = s1210detPgtoAntinfoPgtoAnt.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1210_detpgtoant_infopgtoant_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1210_detpgtoant_infopgtoant.csv', context)
