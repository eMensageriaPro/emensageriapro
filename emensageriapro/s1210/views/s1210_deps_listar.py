...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1210_deps')
    ...
    if permissao.permite_listar:
        ...
        s1210_deps_lista = s1210deps.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1210_deps_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1210_deps.csv', context)
