...
def salvar(request, hash):
    ...
    if s1210_detpgtoant_infopgtoant_id:
        ...
        s1210_detpgtoant_infopgtoant = get_object_or_404(s1210detPgtoAntinfoPgtoAnt, id=s1210_detpgtoant_infopgtoant_id)
        dados_evento = s1210_detpgtoant_infopgtoant.evento()

    if request.user.has_perm('s1210.can_view_s1210detPgtoAntinfoPgtoAnt'):
        ...
        s1210_detpgtoant_infopgtoant_form = disabled_form_fields(s1210_detpgtoant_infopgtoant_form, request.user.has_perm('s1210.change_s1210detPgtoAntinfoPgtoAnt'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1210_detpgtoant_infopgtoant_id, tabela='s1210_detpgtoant_infopgtoant').all()
