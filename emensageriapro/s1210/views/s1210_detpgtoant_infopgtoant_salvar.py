...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s1210_detpgtoant_infopgtoant.evento()

    if request.user.has_perm('s1210.can_see_s1210detPgtoAntinfoPgtoAnt'):
        
        if pk:
        
            s1210_detpgtoant_infopgtoant_form = form_s1210_detpgtoant_infopgtoant(
                request.POST or None, 
                instance=s1210_detpgtoant_infopgtoant)
                                         
        else:
        
            s1210_detpgtoant_infopgtoant_form = form_s1210_detpgtoant_infopgtoant(request.POST or None)
        ...
        if request.method == 'POST':
            ...
            if s1210_detpgtoant_infopgtoant_form.is_valid():
                ...
                if not pk:
                    ...
                    gravar_auditoria(
                        json.dumps(
                            model_to_dict(s1210_detpgtoant_infopgtoant), 
                            indent=4, 
                            sort_keys=True, 
                            default=str),
                        json.dumps(
                ...
                if request.session['return_page'] not in (
                    's1210_detpgtoant_infopgtoant_apagar', 
                    's1210_detpgtoant_infopgtoant_salvar', 
                    's1210_detpgtoant_infopgtoant'):
        ...
        s1210_detpgtoant_infopgtoant_form = disabled_form_fields(
            s1210_detpgtoant_infopgtoant_form, 
            request.user.has_perm('s1210.change_s1210detPgtoAntinfoPgtoAnt'))
        ...
        if tab or 's1210_detpgtoant_infopgtoant' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 's1210_detpgtoant_infopgtoant_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='s1210_detpgtoant_infopgtoant').all()
