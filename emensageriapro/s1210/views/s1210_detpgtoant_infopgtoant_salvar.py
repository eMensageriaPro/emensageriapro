...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1210_detpgtoant_infopgtoant')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1210_detpgtoant_infopgtoant_id:
            s1210_detpgtoant_infopgtoant_form = form_s1210_detpgtoant_infopgtoant(request.POST or None, instance = s1210_detpgtoant_infopgtoant,  
