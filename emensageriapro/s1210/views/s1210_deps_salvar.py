...
def salvar(request, hash):
    ...
    if s1210_deps_id:
        ...
        s1210_deps = get_object_or_404(s1210deps, id=s1210_deps_id)
        dados_evento = s1210_deps.evento()

    if request.user.has_perm('s1210.can_view_s1210deps'):
        ...
        s1210_deps_form = disabled_form_fields(s1210_deps_form, request.user.has_perm('s1210.change_s1210deps'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1210_deps_id, tabela='s1210_deps').all()
