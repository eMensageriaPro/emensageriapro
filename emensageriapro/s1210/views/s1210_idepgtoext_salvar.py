...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1210_idepgtoext')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1210_idepgtoext_id:
        s1210_idepgtoext = get_object_or_404(s1210idePgtoExt, id = s1210_idepgtoext_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1210_idepgtoext_id, tabela='s1210_idepgtoext').all()
        context = {
