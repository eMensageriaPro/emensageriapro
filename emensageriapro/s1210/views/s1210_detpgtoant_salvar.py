...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s1210_detpgtoant.evento()
    ...
    if request.user.has_perm('s1210.can_see_s1210detPgtoAnt'):
        ...
        if request.method == 'POST':
            ...
            if s1210_detpgtoant_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's1210-detpgtoant' not in request.session['return_page']:
