...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1210_infopgto_id:
            s1210_infopgto_form = form_s1210_infopgto(request.POST or None, instance = s1210_infopgto,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            s1210_infopgto_form = form_s1210_infopgto(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
