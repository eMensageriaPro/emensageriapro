...
def salvar(request, hash):
    ...
    if s1210_detpgtofer_penalim_id:
        ...
        s1210_detpgtofer_penalim = get_object_or_404(s1210detPgtoFerpenAlim, id=s1210_detpgtofer_penalim_id)
        dados_evento = s1210_detpgtofer_penalim.evento()

    if request.user.has_perm('s1210.can_view_s1210detPgtoFerpenAlim'):
        ...
        if request.method == 'POST':
            ...
            if s1210_detpgtofer_penalim_form.is_valid():
                ...
                if not s1210_detpgtofer_penalim_id:
        ...
        s1210_detpgtofer_penalim_form = disabled_form_fields(s1210_detpgtofer_penalim_form, request.user.has_perm('s1210.change_s1210detPgtoFerpenAlim'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1210_detpgtofer_penalim_id, tabela='s1210_detpgtofer_penalim').all()
