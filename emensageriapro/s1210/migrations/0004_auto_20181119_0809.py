...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('s1210', '0003_auto_20181010_2105'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='s1210detpgtobenprinfopgtoparc',
            options={'managed': True, 'ordering': ['s1210_detpgtobenpr', 'codrubr', 'idetabrubr', 'vrrubr']},
        ),
        migrations.AlterModelOptions(
        ...
        migrations.AlterModelOptions(
            ...
            options={'managed': True, 'ordering': ['s1210_infopgto', 'codcateg', 'dtinigoz', 'qtdias', 'vrliq']},
        ),
        migrations.AlterModelOptions(
            name='s1210detpgtoferdetrubrfer',
            options={'managed': True, 'ordering': ['s1210_detpgtofer', 'codrubr', 'idetabrubr', 'vrrubr']},
        ),
        migrations.AlterModelOptions(
            name='s1210detpgtoferpenalim',
            options={'managed': True, 'ordering': ['s1210_detpgtofer_detrubrfer', 'cpfbenef', 'nmbenefic', 'vlrpensao']},
        ),
        migrations.AlterModelOptions(
            name='s1210detpgtofl',
            options={'managed': True, 'ordering': ['s1210_infopgto', 'idedmdev', 'indpgtott', 'vrliq']},
        ),
        migrations.AlterModelOptions(
            name='s1210detpgtoflinfopgtoparc',
            options={'managed': True, 'ordering': ['s1210_detpgtofl', 'codrubr', 'idetabrubr', 'vrrubr']},
        ),
        migrations.AlterModelOptions(
            name='s1210detpgtoflpenalim',
            options={'managed': True, 'ordering': ['s1210_detpgtofl_retpgtotot', 'cpfbenef', 'nmbenefic', 'vlrpensao']},
        ),
        migrations.AlterModelOptions(
        ...
        migrations.AlterModelOptions(
            ...
            options={'managed': True, 'ordering': ['s1210_infopgto', 'codpais', 'indnif', 'dsclograd', 'nmcid']},
        ),
        ...
        migrations.AlterField(
            model_name='s1210deps',
            name='s1210_evtpgtos',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1210deps_s1210_evtpgtos', to='esocial.s1210evtPgtos'),
        ),
        migrations.AlterField(
            model_name='s1210deps',
            name='vrdeddep',
        ...
        migrations.AlterField(
            model_name='s1210detpgtobenpr',
            name='s1210_infopgto',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1210detpgtobenpr_s1210_infopgto', to='s1210.s1210infoPgto'),
        ),
        migrations.AlterField(
            model_name='s1210detpgtobenpr',
            name='vrliq',
        ...
        migrations.AlterField(
            model_name='s1210idepgtoext',
            name='s1210_infopgto',
            field=models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1210idepgtoext_s1210_infopgto', to='s1210.s1210infoPgto'),
        ),
        migrations.AlterField(
