...
url(r'^s1210-deps/api/$',
            s1210_deps_views.s1210depsList.as_view() ),

        url(r'^s1210-deps/api/(?P<pk>[0-9]+)/$',
            s1210_deps_views.s1210depsDetail.as_view() ),
...
url(r'^s1210-infopgto/api/$',
            s1210_infopgto_views.s1210infoPgtoList.as_view() ),

        url(r'^s1210-infopgto/api/(?P<pk>[0-9]+)/$',
            s1210_infopgto_views.s1210infoPgtoDetail.as_view() ),
...
url(r'^s1210-detpgtofl/api/$',
            s1210_detpgtofl_views.s1210detPgtoFlList.as_view() ),

        url(r'^s1210-detpgtofl/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtofl_views.s1210detPgtoFlDetail.as_view() ),
...
url(r'^s1210-detpgtofl-retpgtotot/api/$',
            s1210_detpgtofl_retpgtotot_views.s1210detPgtoFlretPgtoTotList.as_view() ),

        url(r'^s1210-detpgtofl-retpgtotot/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtofl_retpgtotot_views.s1210detPgtoFlretPgtoTotDetail.as_view() ),
...
url(r'^s1210-detpgtofl-penalim/api/$',
            s1210_detpgtofl_penalim_views.s1210detPgtoFlpenAlimList.as_view() ),

        url(r'^s1210-detpgtofl-penalim/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtofl_penalim_views.s1210detPgtoFlpenAlimDetail.as_view() ),
...
url(r'^s1210-detpgtofl-infopgtoparc/api/$',
            s1210_detpgtofl_infopgtoparc_views.s1210detPgtoFlinfoPgtoParcList.as_view() ),

        url(r'^s1210-detpgtofl-infopgtoparc/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtofl_infopgtoparc_views.s1210detPgtoFlinfoPgtoParcDetail.as_view() ),
...
url(r'^s1210-detpgtobenpr/api/$',
            s1210_detpgtobenpr_views.s1210detPgtoBenPrList.as_view() ),

        url(r'^s1210-detpgtobenpr/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtobenpr_views.s1210detPgtoBenPrDetail.as_view() ),
...
url(r'^s1210-detpgtobenpr-retpgtotot/api/$',
            s1210_detpgtobenpr_retpgtotot_views.s1210detPgtoBenPrretPgtoTotList.as_view() ),

        url(r'^s1210-detpgtobenpr-retpgtotot/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtobenpr_retpgtotot_views.s1210detPgtoBenPrretPgtoTotDetail.as_view() ),
...
url(r'^s1210-detpgtobenpr-infopgtoparc/api/$',
            s1210_detpgtobenpr_infopgtoparc_views.s1210detPgtoBenPrinfoPgtoParcList.as_view() ),

        url(r'^s1210-detpgtobenpr-infopgtoparc/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtobenpr_infopgtoparc_views.s1210detPgtoBenPrinfoPgtoParcDetail.as_view() ),
...
url(r'^s1210-detpgtofer/api/$',
            s1210_detpgtofer_views.s1210detPgtoFerList.as_view() ),

        url(r'^s1210-detpgtofer/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtofer_views.s1210detPgtoFerDetail.as_view() ),
...
url(r'^s1210-detpgtofer-detrubrfer/api/$',
            s1210_detpgtofer_detrubrfer_views.s1210detPgtoFerdetRubrFerList.as_view() ),

        url(r'^s1210-detpgtofer-detrubrfer/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtofer_detrubrfer_views.s1210detPgtoFerdetRubrFerDetail.as_view() ),
...
url(r'^s1210-detpgtoant/api/$',
            s1210_detpgtoant_views.s1210detPgtoAntList.as_view() ),

        url(r'^s1210-detpgtoant/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtoant_views.s1210detPgtoAntDetail.as_view() ),
...
url(r'^s1210-detpgtoant-infopgtoant/api/$',
            s1210_detpgtoant_infopgtoant_views.s1210detPgtoAntinfoPgtoAntList.as_view() ),

        url(r'^s1210-detpgtoant-infopgtoant/api/(?P<pk>[0-9]+)/$',
            s1210_detpgtoant_infopgtoant_views.s1210detPgtoAntinfoPgtoAntDetail.as_view() ),
...
url(r'^s1210-idepgtoext/api/$',
            s1210_idepgtoext_views.s1210idePgtoExtList.as_view() ),

        url(r'^s1210-idepgtoext/api/(?P<pk>[0-9]+)/$',
            s1210_idepgtoext_views.s1210idePgtoExtDetail.as_view() ),
