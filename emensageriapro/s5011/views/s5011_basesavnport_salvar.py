...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5011_basesavnport')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s5011_basesavnport_id:
        s5011_basesavnport = get_object_or_404(s5011basesAvNPort, id = s5011_basesavnport_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5011_basesavnport_id, tabela='s5011_basesavnport').all()
        context = {
