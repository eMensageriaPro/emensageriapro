...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        s5011_basesremun = get_object_or_404(s5011basesRemun, id=pk)
        evento_dados = s5011_basesremun.evento()
    ...
    if request.user.has_perm('s5011.can_see_s5011basesRemun'):
        ...
        if pk:
            ...
            s5011_basesremun_form = form_s5011_basesremun(
                ...
                instance=s5011_basesremun)
                                         
        else:
        
            s5011_basesremun_form = form_s5011_basesremun(request.POST or None)
        ...
        if request.method == 'POST':
            ...
            if s5011_basesremun_form.is_valid():
                ...
                if not pk:
                    ...
                    gravar_auditoria(
                        json.dumps(
                            model_to_dict(s5011_basesremun), 
                            indent=4, 
                            sort_keys=True, 
                            default=str),
                        json.dumps(
                ...
                if request.session['return_page'] not in (
                    's5011_basesremun_apagar', 
                    's5011_basesremun_salvar', 
                    's5011_basesremun'):
        ...
        s5011_basesremun_form = disabled_form_fields(
            s5011_basesremun_form, 
            request.user.has_perm('s5011.change_s5011basesRemun'))
        ...
        if tab or 's5011_basesremun' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 's5011_basesremun_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='s5011_basesremun').all()
