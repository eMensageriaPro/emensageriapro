...
def salvar(request, hash):
    ...
    if s5011_basesremun_id:
        ...
        s5011_basesremun = get_object_or_404(s5011basesRemun, id=s5011_basesremun_id)
        dados_evento = s5011_basesremun.evento()

    if request.user.has_perm('s5011.can_view_s5011basesRemun'):
        ...
        s5011_basesremun_form = disabled_form_fields(s5011_basesremun_form, request.user.has_perm('s5011.change_s5011basesRemun'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5011_basesremun_id, tabela='s5011_basesremun').all()
