...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if dados_evento['status'] == STATUS_EVENTO_CADASTRADO:
            ...
            obj = s5011infoTercSusp.objects.get(id=pk)
        ...
        if 's5011_infotercsusp' in request.session['return_page']:
        
            return redirect('s5011_infotercsusp')
    ...
    return render(request, 
                  's5011_infotercsusp_apagar.html', 
                  context)