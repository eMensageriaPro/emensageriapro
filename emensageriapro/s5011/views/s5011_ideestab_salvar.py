...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if request.user.has_perm('s5011.can_see_s5011ideEstab'):
        ...
        s5011_ideestab_form = disabled_form_fields(
            s5011_ideestab_form, 
            request.user.has_perm('s5011.change_s5011ideEstab'))
        ...
        if pk:
            ...
            s5011_basesaquis_form = form_s5011_basesaquis(
                initial={ 's5011_ideestab': s5011_ideestab })
            ...
            s5011_infocrestab_form = form_s5011_infocrestab(
                initial={ 's5011_ideestab': s5011_ideestab })
        ...
        if tab or 's5011_ideestab' in request.session['return_page']:
            ...
            request.session['return_page'] = 's5011_ideestab_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='s5011_ideestab').all()
