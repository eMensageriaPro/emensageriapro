...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5011_infocrestab')
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'vrsuspcr__icontains': 'vrsuspcr__icontains', }
        ...
        s5011_infocrestab_lista = s5011infoCREstab.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s5011_infocrestab_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s5011_infocrestab.csv', context)
