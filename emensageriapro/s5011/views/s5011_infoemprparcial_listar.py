...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s5011_infoemprparcial')
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'cnoobra__icontains': 'cnoobra__icontains', }
        ...
        s5011_infoemprparcial_lista = s5011infoEmprParcial.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s5011_infoemprparcial_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s5011_infoemprparcial.csv', context)
