...
def salvar(request, hash):
    ...
    if s5011_infocrestab_id:
        ...
        s5011_infocrestab = get_object_or_404(s5011infoCREstab, id=s5011_infocrestab_id)
        dados_evento = s5011_infocrestab.evento()

    if request.user.has_perm('s5011.can_view_s5011infoCREstab'):
        ...
        s5011_infocrestab_form = disabled_form_fields(s5011_infocrestab_form, request.user.has_perm('s5011.change_s5011infoCREstab'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5011_infocrestab_id, tabela='s5011_infocrestab').all()
