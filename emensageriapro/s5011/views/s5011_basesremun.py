            ...
            if s5011_basesremun_form.is_valid():
                ...
                if s5011_basesremun_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s5011_basesremun_campos_multiple_passo1
                        s5011basesRemun.objects.using(db_slug).filter(id=s5011_basesremun_id).update(**dados)
                        obj = s5011basesRemun.objects.using(db_slug).get(id=s5011_basesremun_id)
                        #s5011_basesremun_editar_custom
                        #s5011_basesremun_campos_multiple_passo2
                    ...
                    #s5011_basesremun_cadastrar_campos_multiple_passo1
                    obj = s5011basesRemun(**dados)
                    obj.save(using = db_slug)
                    #s5011_basesremun_cadastrar_custom
                    #s5011_basesremun_cadastrar_campos_multiple_passo2
...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s5011basesRemun.objects.using( db_slug ).filter(id = s5011_basesremun_id).delete()
