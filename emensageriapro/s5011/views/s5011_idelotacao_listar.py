...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s5011_idelotacao_lista = s5011ideLotacao.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s5011_idelotacao_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s5011_idelotacao.csv', context)
