...
def salvar(request, hash):
    ...
    if s5011_basesaquis_id:
        ...
        s5011_basesaquis = get_object_or_404(s5011basesAquis, id=s5011_basesaquis_id)
    ...
    if request.user.has_perm('s5011.can_view_s5011basesAquis'):
        ...
        s5011_basesaquis_form = disabled_form_fields(s5011_basesaquis_form, request.user.has_perm('s5011.change_s5011basesAquis'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5011_basesaquis_id, tabela='s5011_basesaquis').all()
