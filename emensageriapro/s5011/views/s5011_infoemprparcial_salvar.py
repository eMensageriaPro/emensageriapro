...
def salvar(request, hash):
    ...
    if s5011_infoemprparcial_id:
        ...
        s5011_infoemprparcial = get_object_or_404(s5011infoEmprParcial, id=s5011_infoemprparcial_id)
        dados_evento = s5011_infoemprparcial.evento()

    if request.user.has_perm('s5011.can_view_s5011infoEmprParcial'):
        ...
        if request.method == 'POST':
            ...
            if s5011_infoemprparcial_form.is_valid():
                ...
                if not s5011_infoemprparcial_id:
        ...
        s5011_infoemprparcial_form = disabled_form_fields(s5011_infoemprparcial_form, request.user.has_perm('s5011.change_s5011infoEmprParcial'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s5011_infoemprparcial_id, tabela='s5011_infoemprparcial').all()
