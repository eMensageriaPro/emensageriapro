...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if dados_evento['status'] == STATUS_EVENTO_CADASTRADO:
            ...
            obj = s5011infoCREstab.objects.get(id=pk)
        ...
        if 's5011_infocrestab' in request.session['return_page']:
        
            return redirect('s5011_infocrestab')
