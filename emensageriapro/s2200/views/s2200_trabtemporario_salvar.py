...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s2200_trabtemporario.evento()
    ...
    if request.user.has_perm('s2200.can_see_s2200trabTemporario'):
        ...
        if request.method == 'POST':
            ...
            if s2200_trabtemporario_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's2200-trabtemporario' not in request.session['return_page']:
