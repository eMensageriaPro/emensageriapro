...
def salvar(request, hash):
    ...
    if s2200_trabtemporario_id:
        ...
        s2200_trabtemporario = get_object_or_404(s2200trabTemporario, id=s2200_trabtemporario_id)
    ...
    if request.user.has_perm('s2200.can_view_s2200trabTemporario'):
        ...
        s2200_trabtemporario_form = disabled_form_fields(s2200_trabtemporario_form, request.user.has_perm('s2200.change_s2200trabTemporario'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2200_trabtemporario_id, tabela='s2200_trabtemporario').all()
