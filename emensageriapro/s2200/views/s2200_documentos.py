...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s2200_documentos_id:
            ...
            s2200_documentos_form = form_s2200_documentos(request.POST or None, slug = db_slug, initial={})
        ...
        if s2200_documentos_id:
            ...
            s2200_ctps_form = form_s2200_ctps(initial={ 's2200_documentos': s2200_documentos }, slug=db_slug)
            ...
            s2200_ric_form = form_s2200_ric(initial={ 's2200_documentos': s2200_documentos }, slug=db_slug)
            ...
            s2200_rg_form = form_s2200_rg(initial={ 's2200_documentos': s2200_documentos }, slug=db_slug)
            ...
            s2200_rne_form = form_s2200_rne(initial={ 's2200_documentos': s2200_documentos }, slug=db_slug)
            ...
            s2200_oc_form = form_s2200_oc(initial={ 's2200_documentos': s2200_documentos }, slug=db_slug)
            ...
            s2200_cnh_form = form_s2200_cnh(initial={ 's2200_documentos': s2200_documentos }, slug=db_slug)
