...
def salvar(request, hash):
    ...
    if s2200_dependente_id:
        ...
        s2200_dependente = get_object_or_404(s2200dependente, id=s2200_dependente_id)
        dados_evento = s2200_dependente.evento()

    if request.user.has_perm('s2200.can_view_s2200dependente'):
        ...
        s2200_dependente_form = disabled_form_fields(s2200_dependente_form, request.user.has_perm('s2200.change_s2200dependente'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2200_dependente_id, tabela='s2200_dependente').all()
