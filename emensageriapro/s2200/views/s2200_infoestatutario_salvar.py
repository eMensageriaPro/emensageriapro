...
def salvar(request, hash):
    ...
    if s2200_infoestatutario_id:
        s2200_infoestatutario = get_object_or_404(s2200infoEstatutario, id = s2200_infoestatutario_id)
    ...
    if permissao.permite_visualizar:
        ...
        if s2200_infoestatutario_id:
            ...
            s2200_infodecjud_form = form_s2200_infodecjud(
                initial={ 's2200_infoestatutario': s2200_infoestatutario })
            ...
            s2200_infodecjud_lista = s2200infoDecJud.objects.\
                filter(s2200_infoestatutario_id=s2200_infoestatutario.id).all()
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2200_infoestatutario_id, tabela='s2200_infoestatutario').all()
        context = {
