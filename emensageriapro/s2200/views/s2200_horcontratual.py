...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2200_horcontratual_id:
            s2200_horcontratual_form = form_s2200_horcontratual(request.POST or None, instance = s2200_horcontratual,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            s2200_horcontratual_form = form_s2200_horcontratual(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
