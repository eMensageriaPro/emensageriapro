...
def salvar(request, hash):
    ...
    if s2200_infodecjud_id:
        ...
        s2200_infodecjud = get_object_or_404(s2200infoDecJud, id=s2200_infodecjud_id)
        dados_evento = s2200_infodecjud.evento()

    if request.user.has_perm('s2200.can_view_s2200infoDecJud'):
        ...
        s2200_infodecjud_form = disabled_form_fields(s2200_infodecjud_form, request.user.has_perm('s2200.change_s2200infoDecJud'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2200_infodecjud_id, tabela='s2200_infodecjud').all()
