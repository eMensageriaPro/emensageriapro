...
def salvar(request, hash):
    ...
    if s2200_rne_id:
        ...
        s2200_rne = get_object_or_404(s2200RNE, id=s2200_rne_id)
        dados_evento = s2200_rne.evento()

    if request.user.has_perm('s2200.can_view_s2200RNE'):
        ...
        s2200_rne_form = disabled_form_fields(s2200_rne_form, request.user.has_perm('s2200.change_s2200RNE'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2200_rne_id, tabela='s2200_rne').all()
