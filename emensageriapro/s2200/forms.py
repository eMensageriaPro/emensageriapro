...
class form_s2200_transfdom(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['matricant'].widget.attrs['required'] = True
...
class form_s2200_trabestrangeiro(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['dtchegada'].widget.attrs['required'] = True
...
class form_s2200_localtrabgeral(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['desccomp'].widget.attrs['required'] = True
...
class form_s2200_infoestatutario(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['dtiniparc'].widget.attrs['required'] = True
        
        self.fields['indparcremun'].widget.attrs['required'] = True
        
        self.fields['dtiniabono'].widget.attrs['required'] = True
        
        self.fields['indabonoperm'].widget.attrs['required'] = True
        
        self.fields['indtetorgps'].widget.attrs['required'] = True
...
class form_s2200_horcontratual(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['dsctpjorn'].widget.attrs['required'] = True
        
        self.fields['tpjornada'].widget.attrs['required'] = True
        
        self.fields['qtdhrssem'].widget.attrs['required'] = True
...
class form_s2200_contato(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['emailalternat'].widget.attrs['required'] = True
        
        self.fields['emailprinc'].widget.attrs['required'] = True
        
        self.fields['fonealternat'].widget.attrs['required'] = True
        
        self.fields['foneprinc'].widget.attrs['required'] = True
...
class form_s2200_rne(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['dtexped'].widget.attrs['required'] = True
...
class form_s2200_cnh(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['dtprihab'].widget.attrs['required'] = True
