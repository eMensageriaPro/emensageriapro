...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='s2200horario',
            name='dia',
            field=models.IntegerField(choices=[(1, '1 - Segunda-Feira'), (2, '2 - Ter\xe7a-Feira'), (3, '3 - Quarta-Feira'), (4, '4 - Quinta-Feira'), (5, '5 - Sexta-Feira'), (6, '6 - S\xe1bado'), (7, '7 - Domingo'), (8, '8 - Dia vari\xe1vel.')], null=True),
        ),
        migrations.AlterField(
            model_name='s2200horcontratual',
            name='tmpparc',
            field=models.IntegerField(choices=[(0, '0 - N\xe3o \xe9 contrato em tempo parcial'), (1, '1 - Limitado a 25 horas semanais'), (2, '2 - Limitado a 30 horas semanais'), (3, '3 - Limitado a 26 horas semanais.')], null=True),
        ),
        migrations.AlterField(
            model_name='s2200horcontratual',
            name='tpjornada',
            field=models.IntegerField(choices=[(1, '1 - Jornada com hor\xe1rio di\xe1rio e folga fixos'), (2, '2 - Jornada 12 x 36 (12 horas de trabalho seguidas de 36 horas ininterruptas de descanso)'), (3, '3 - Jornada com hor\xe1rio di\xe1rio fixo e folga vari\xe1vel'), (9, '9 - Demais tipos de jornada.')], null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s2200infoceletista',
            name='indadmissao',
            field=models.IntegerField(choices=[(1, '1 - Normal'), (2, '2 - Decorrente de A\xe7\xe3o Fiscal'), (3, '3 - Decorrente de Decis\xe3o Judicial.')], null=True),
        ),
        migrations.AlterField(
            model_name='s2200infoceletista',
            name='natatividade',
            field=models.IntegerField(choices=[(1, '1 - Trabalho Urbano'), (2, '2 - Trabalho Rural.')], null=True),
        ),
        migrations.AlterField(
            model_name='s2200infoceletista',
            name='opcfgts',
        ...
        migrations.AlterField(
            model_name='s2200infoceletista',
            name='tpregjor',
            field=models.IntegerField(choices=[(1, '1 - Submetidos a Hor\xe1rio de Trabalho (Cap. II da CLT)'), (2, '2 - Atividade Externa especificada no Inciso I do Art. 62 da CLT'), (3, '3 - Fun\xe7\xf5es especificadas no Inciso II do Art. 62 da CLT'), (4, '4 - Teletrabalho, previsto no Inciso III do Art. 62 da CLT.')], null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='s2200infoestatutario',
            name='indprovim',
            field=models.IntegerField(choices=[(1, '1 - Normal'), (2, '2 - Decorrente de Decis\xe3o Judicial.')], null=True),
        ),
        migrations.AlterField(
            model_name='s2200infoestatutario',
            name='tpprov',
            field=models.IntegerField(choices=[(1, '1 - Nomea\xe7\xe3o em cargo efetivo'), (2, '2 - Nomea\xe7\xe3o em cargo em comiss\xe3o'), (3, '3 - Incorpora\xe7\xe3o (militar)'), (4, '4 - Matr\xedcula (militar)'), (5, '5 - Reinclus\xe3o (militar)'), (6, '6 - Diploma\xe7\xe3o'), (99, '99 - Outros n\xe3o relacionados acima.')], null=True),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='hipleg',
            field=models.IntegerField(choices=[(1, '1 - Necessidade de substitui\xe7\xe3o transit\xf3ria de pessoal permanente'), (2, '2 - Demanda complementar de servi\xe7os.')], null=True),
        ),
        migrations.AlterField(
            model_name='s2200trabtemporario',
            name='justcontr',
        ...
        migrations.AlterField(
            model_name='s2200trabtemporario',
            name='tpinclcontr',
            field=models.IntegerField(choices=[(1, '1 - Locais sem filiais'), (2, '2 - Estudo de mercado'), (3, '3 - Contrata\xe7\xe3o superior a 3 meses.')], null=True),
        ),
        migrations.AlterField(
            model_name='s2200trabtemporario',
            name='tpinsc',
