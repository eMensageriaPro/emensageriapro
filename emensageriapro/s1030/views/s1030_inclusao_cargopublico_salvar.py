...
def salvar(request, hash):
    ...
    if s1030_inclusao_cargopublico_id:
        ...
        s1030_inclusao_cargopublico = get_object_or_404(s1030inclusaocargoPublico, id=s1030_inclusao_cargopublico_id)
        dados_evento = s1030_inclusao_cargopublico.evento()

    if request.user.has_perm('s1030.can_view_s1030inclusaocargoPublico'):
        ...
        if request.method == 'POST':
            ...
            if s1030_inclusao_cargopublico_form.is_valid():
                ...
                if not s1030_inclusao_cargopublico_id:
        ...
        s1030_inclusao_cargopublico_form = disabled_form_fields(s1030_inclusao_cargopublico_form, request.user.has_perm('s1030.change_s1030inclusaocargoPublico'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1030_inclusao_cargopublico_id, tabela='s1030_inclusao_cargopublico').all()
