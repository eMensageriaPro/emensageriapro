...
def listar(request, output=None):
    ...
    if request.user.has_perm('s1030.can_see_s1030inclusaocargoPublico'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's1030_inclusao__icontains': 's1030_inclusao__icontains',
        ...
        s1030_inclusao_cargopublico_lista = s1030inclusaocargoPublico.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s1030_inclusao_lista = s1030inclusao.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1030_inclusao_cargopublico.csv', context)
