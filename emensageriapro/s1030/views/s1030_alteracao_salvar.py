...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1030_alteracao')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1030_alteracao_id:
        s1030_alteracao = get_object_or_404(s1030alteracao, id = s1030_alteracao_id)
    ...
    if permissao.permite_visualizar:
        ...
        if s1030_alteracao_id:
            ...
            s1030_alteracao_cargopublico_form = form_s1030_alteracao_cargopublico(
                initial={ 's1030_alteracao': s1030_alteracao })
            ...
            s1030_alteracao_cargopublico_lista = s1030alteracaocargoPublico.objects.\
                filter(s1030_alteracao_id=s1030_alteracao.id).all()
            s1030_alteracao_novavalidade_form = form_s1030_alteracao_novavalidade(
                initial={ 's1030_alteracao': s1030_alteracao })
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1030_alteracao_id, tabela='s1030_alteracao').all()
        context = {
