...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1030.can_view_s1030alteracao'):
        ...
        s1030_alteracao_form = disabled_form_fields(s1030_alteracao_form, request.user.has_perm('s1030.change_s1030alteracao'))
