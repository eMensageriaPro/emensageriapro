...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s1030_inclusao.evento()
    ...
    if request.user.has_perm('s1030.can_see_s1030inclusao'):
        ...
        if request.method == 'POST':
            ...
            if s1030_inclusao_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's1030-inclusao' not in request.session['return_page']:
