...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s1010alteracao.objects.using( db_slug ).filter(id = s1010_alteracao_id).delete()
            ...
            if s1010_alteracao_form.is_valid():
                ...
                if s1010_alteracao_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s1010_alteracao_campos_multiple_passo1
                        s1010alteracao.objects.using(db_slug).filter(id=s1010_alteracao_id).update(**dados)
                        obj = s1010alteracao.objects.using(db_slug).get(id=s1010_alteracao_id)
                        #s1010_alteracao_editar_custom
                        #s1010_alteracao_campos_multiple_passo2
                    ...
                    #s1010_alteracao_cadastrar_campos_multiple_passo1
                    obj = s1010alteracao(**dados)
                    obj.save(using = db_slug)
                    #s1010_alteracao_cadastrar_custom
                    #s1010_alteracao_cadastrar_campos_multiple_passo2
