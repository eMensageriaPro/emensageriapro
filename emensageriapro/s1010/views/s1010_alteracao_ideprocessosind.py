...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1010_alteracao_ideprocessosind_id:
            s1010_alteracao_ideprocessosind_form = form_s1010_alteracao_ideprocessosind(request.POST or None, instance = s1010_alteracao_ideprocessosind, slug = db_slug)
        else:
            s1010_alteracao_ideprocessosind_form = form_s1010_alteracao_ideprocessosind(request.POST or None, slug = db_slug, initial={})
            ...
            if s1010_alteracao_ideprocessosind_form.is_valid():
                ...
                if s1010_alteracao_ideprocessosind_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s1010_alteracao_ideprocessosind_campos_multiple_passo1
                        s1010alteracaoideProcessoSIND.objects.using(db_slug).filter(id=s1010_alteracao_ideprocessosind_id).update(**dados)
                        obj = s1010alteracaoideProcessoSIND.objects.using(db_slug).get(id=s1010_alteracao_ideprocessosind_id)
                        #s1010_alteracao_ideprocessosind_editar_custom
                        #s1010_alteracao_ideprocessosind_campos_multiple_passo2
                    ...
                    #s1010_alteracao_ideprocessosind_cadastrar_campos_multiple_passo1
                    obj = s1010alteracaoideProcessoSIND(**dados)
                    obj.save(using = db_slug)
                    #s1010_alteracao_ideprocessosind_cadastrar_custom
                    #s1010_alteracao_ideprocessosind_cadastrar_campos_multiple_passo2
...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s1010alteracaoideProcessoSIND.objects.using( db_slug ).filter(id = s1010_alteracao_ideprocessosind_id).delete()
