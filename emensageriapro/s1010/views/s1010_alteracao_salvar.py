    ...
    if request.user.has_perm('s1010.can_see_s1010alteracao'):
        ...
        if request.method == 'POST':
            ...
            if s1010_alteracao_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's1010-alteracao' not in request.session['return_page']:
        ...
        s1010_alteracao_form = disabled_form_fields(
            s1010_alteracao_form,
            request.user.has_perm('s1010.change_s1010alteracao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='s1010_alteracao').all()
