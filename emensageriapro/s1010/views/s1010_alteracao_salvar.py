...
def salvar(request, hash):
    ...
    if s1010_alteracao_id:
        ...
        s1010_alteracao = get_object_or_404(s1010alteracao, id=s1010_alteracao_id)
        dados_evento = s1010_alteracao.evento()

    if request.user.has_perm('s1010.can_view_s1010alteracao'):
        
        if s1010_alteracao_id:
        
            s1010_alteracao_form = form_s1010_alteracao(request.POST or None, 
                                                          instance=s1010_alteracao,  
        ...
        s1010_alteracao_form = disabled_form_fields(s1010_alteracao_form, request.user.has_perm('s1010.change_s1010alteracao'))
        ...
        if s1010_alteracao_id:
            ...
            s1010_alteracao_ideprocessocp_form = form_s1010_alteracao_ideprocessocp(
                initial={ 's1010_alteracao': s1010_alteracao })
            ...
            s1010_alteracao_ideprocessocp_lista = s1010alteracaoideProcessoCP.objects.\
                filter(s1010_alteracao_id=s1010_alteracao.id).all()
            ...
            s1010_alteracao_ideprocessofgts_lista = s1010alteracaoideProcessoFGTS.objects.\
                filter(s1010_alteracao_id=s1010_alteracao.id).all()
            s1010_alteracao_ideprocessosind_form = form_s1010_alteracao_ideprocessosind(
                initial={ 's1010_alteracao': s1010_alteracao })
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1010_alteracao_id, tabela='s1010_alteracao').all()
