...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1010_alteracao_ideprocessosind')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1010_alteracao_ideprocessosind_id:
            s1010_alteracao_ideprocessosind_form = form_s1010_alteracao_ideprocessosind(request.POST or None, instance = s1010_alteracao_ideprocessosind,  
