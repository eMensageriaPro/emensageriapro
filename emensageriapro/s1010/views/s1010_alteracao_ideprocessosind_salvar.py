...
def salvar(request, hash):
    ...
    if s1010_alteracao_ideprocessosind_id:
        ...
        s1010_alteracao_ideprocessosind = get_object_or_404(s1010alteracaoideProcessoSIND, id=s1010_alteracao_ideprocessosind_id)
        dados_evento = s1010_alteracao_ideprocessosind.evento()

    if request.user.has_perm('s1010.can_view_s1010alteracaoideProcessoSIND'):
        ...
        s1010_alteracao_ideprocessosind_form = disabled_form_fields(s1010_alteracao_ideprocessosind_form, request.user.has_perm('s1010.change_s1010alteracaoideProcessoSIND'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1010_alteracao_ideprocessosind_id, tabela='s1010_alteracao_ideprocessosind').all()
