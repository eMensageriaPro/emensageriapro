...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1010.can_view_s1010inclusao'):
        ...
        s1010_inclusao_form = disabled_form_fields(s1010_inclusao_form, request.user.has_perm('s1010.change_s1010inclusao'))
