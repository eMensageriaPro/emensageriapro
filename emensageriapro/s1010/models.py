...
class s1010alteracao(SoftDeletionModel):
    ...
    natrubr = models.TextField(null=True, )
    tprubr = models.IntegerField(choices=CHOICES_S1010_TPRUBR_ALTERACAO, null=True, )
    codinccp = models.CharField(choices=CHOICES_S1010_CODINCCP_ALTERACAO, max_length=2, null=True, )
    codincirrf = models.CharField(choices=CHOICES_S1010_CODINCIRRF_ALTERACAO, max_length=2, null=True, )
    ...
    codinccprp = models.CharField(choices=CHOICES_S1010_CODINCCPRP_ALTERACAO, max_length=2, blank=True, null=True, )
...
class s1010inclusao(SoftDeletionModel):
    ...
    codinccp = models.CharField(choices=CHOICES_S1010_CODINCCP_INCLUSAO, max_length=2, null=True, )
    codincirrf = models.CharField(choices=CHOICES_S1010_CODINCIRRF_INCLUSAO, max_length=2, null=True, )
    ...
    codinccprp = models.CharField(choices=CHOICES_S1010_CODINCCPRP_INCLUSAO, max_length=2, blank=True, null=True, )
