...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2240_altexprisco_fatrisco')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2240_altexprisco_fatrisco_id:
            s2240_altexprisco_fatrisco_form = form_s2240_altexprisco_fatrisco(request.POST or None, instance = s2240_altexprisco_fatrisco,  
