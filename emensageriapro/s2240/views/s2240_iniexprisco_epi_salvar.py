...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2240_iniexprisco_epi')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2240_iniexprisco_epi_id:
            s2240_iniexprisco_epi_form = form_s2240_iniexprisco_epi(request.POST or None, instance = s2240_iniexprisco_epi,  
