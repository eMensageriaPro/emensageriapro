...
def salvar(request, hash):
    ...
    if s2240_iniexprisco_epi_id:
        ...
        s2240_iniexprisco_epi = get_object_or_404(s2240iniExpRiscoepi, id=s2240_iniexprisco_epi_id)
        dados_evento = s2240_iniexprisco_epi.evento()

    if request.user.has_perm('s2240.can_view_s2240iniExpRiscoepi'):
        ...
        if request.method == 'POST':
            ...
            if s2240_iniexprisco_epi_form.is_valid():
                ...
                if not s2240_iniexprisco_epi_id:
        ...
        s2240_iniexprisco_epi_form = disabled_form_fields(s2240_iniexprisco_epi_form, request.user.has_perm('s2240.change_s2240iniExpRiscoepi'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2240_iniexprisco_epi_id, tabela='s2240_iniexprisco_epi').all()
