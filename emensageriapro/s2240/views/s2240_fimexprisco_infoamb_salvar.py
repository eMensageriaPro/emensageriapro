...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2240_fimexprisco_infoamb')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s2240_fimexprisco_infoamb_id:
        s2240_fimexprisco_infoamb = get_object_or_404(s2240fimExpRiscoinfoAmb, id = s2240_fimexprisco_infoamb_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2240_fimexprisco_infoamb_id, tabela='s2240_fimexprisco_infoamb').all()
        context = {
