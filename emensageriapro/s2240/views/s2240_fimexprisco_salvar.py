...
def salvar(request, hash):
    ...
    if request.user.has_perm('s2240.can_view_s2240fimExpRisco'):
        ...
        s2240_fimexprisco_form = disabled_form_fields(s2240_fimexprisco_form, request.user.has_perm('s2240.change_s2240fimExpRisco'))
