...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2240_fimexprisco_respreg')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2240_fimexprisco_respreg_id:
            s2240_fimexprisco_respreg_form = form_s2240_fimexprisco_respreg(request.POST or None, instance = s2240_fimexprisco_respreg,  
