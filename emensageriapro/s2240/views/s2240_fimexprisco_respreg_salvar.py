...
def salvar(request, hash):
    ...
    if s2240_fimexprisco_respreg_id:
        ...
        s2240_fimexprisco_respreg = get_object_or_404(s2240fimExpRiscorespReg, id=s2240_fimexprisco_respreg_id)
        dados_evento = s2240_fimexprisco_respreg.evento()

    if request.user.has_perm('s2240.can_view_s2240fimExpRiscorespReg'):
        ...
        if request.method == 'POST':
            ...
            if s2240_fimexprisco_respreg_form.is_valid():
                ...
                if not s2240_fimexprisco_respreg_id:
        ...
        s2240_fimexprisco_respreg_form = disabled_form_fields(s2240_fimexprisco_respreg_form, request.user.has_perm('s2240.change_s2240fimExpRiscorespReg'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2240_fimexprisco_respreg_id, tabela='s2240_fimexprisco_respreg').all()
