...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2240_altexprisco_id:
            s2240_altexprisco_form = form_s2240_altexprisco(request.POST or None, instance = s2240_altexprisco,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            s2240_altexprisco_form = form_s2240_altexprisco(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
