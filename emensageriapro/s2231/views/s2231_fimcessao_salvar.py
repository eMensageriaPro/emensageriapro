...
def salvar(request, hash):
    ...
    if s2231_fimcessao_id:
        ...
        s2231_fimcessao = get_object_or_404(s2231fimCessao, id=s2231_fimcessao_id)
        dados_evento = s2231_fimcessao.evento()

    if request.user.has_perm('s2231.can_view_s2231fimCessao'):
        ...
        s2231_fimcessao_form = disabled_form_fields(s2231_fimcessao_form, request.user.has_perm('s2231.change_s2231fimCessao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2231_fimcessao_id, tabela='s2231_fimcessao').all()
