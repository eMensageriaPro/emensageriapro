...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r9002_totapurdec_id:
            r9002_totapurdec_form = form_r9002_totapurdec(request.POST or None, instance = r9002_totapurdec,  
        ...
        r9002_totapurdec_form = disabled_form_fields(r9002_totapurdec_form, permissao.permite_editar)
        
        if r9002_totapurdec_id:
            if dados_evento['status'] != 0:
                r9002_totapurdec_form = disabled_form_fields(r9002_totapurdec_form, 0)
        ...
        if r9002_totapurdec_id:
            ...
            r9002_totapurdec = None
            
        #r9002_totapurdec_salvar_custom_variaveis#
        tabelas_secundarias = []
