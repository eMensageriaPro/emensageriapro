...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r9002_totapurdia = get_object_or_404(r9002totApurDia, id=pk)
        evento_dados = r9002_totapurdia.evento()
    ...
    if request.user.has_perm('r9002.can_see_r9002totApurDia'):
        ...
        if request.method == 'POST':
            ...
            if r9002_totapurdia_form.is_valid():
                ...
                if not pk:
                    ...
                    gravar_auditoria(
                        json.dumps(
                            model_to_dict(r9002_totapurdia), 
                            indent=4, 
                            sort_keys=True, 
                            default=str),
                        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r9002_totapurdia_apagar', 
                    'r9002_totapurdia_salvar', 
                    'r9002_totapurdia'):
        ...
        r9002_totapurdia_form = disabled_form_fields(
            r9002_totapurdia_form, 
            request.user.has_perm('r9002.change_r9002totApurDia'))
        ...
        if tab or 'r9002_totapurdia' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r9002_totapurdia_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r9002_totapurdia').all()
