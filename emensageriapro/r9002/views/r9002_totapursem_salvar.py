...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r9002_totapursem_id:
            r9002_totapursem_form = form_r9002_totapursem(request.POST or None, instance = r9002_totapursem,  
        ...
        r9002_totapursem_form = disabled_form_fields(r9002_totapursem_form, permissao.permite_editar)
