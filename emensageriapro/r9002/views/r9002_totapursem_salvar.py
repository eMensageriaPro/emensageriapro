...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r9002_totapursem = get_object_or_404(r9002totApurSem, id=pk)
        evento_dados = r9002_totapursem.evento()
    ...
    if request.user.has_perm('r9002.can_see_r9002totApurSem'):
        ...
        if request.method == 'POST':
            ...
            if r9002_totapursem_form.is_valid():
                ...
                if not pk:
                    ...
                    gravar_auditoria(
                        json.dumps(
                            model_to_dict(r9002_totapursem), 
                            indent=4, 
                            sort_keys=True, 
                            default=str),
                        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r9002_totapursem_apagar', 
                    'r9002_totapursem_salvar', 
                    'r9002_totapursem'):
        ...
        r9002_totapursem_form = disabled_form_fields(
            r9002_totapursem_form, 
            request.user.has_perm('r9002.change_r9002totApurSem'))
        ...
        if tab or 'r9002_totapursem' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r9002_totapursem_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r9002_totapursem').all()
