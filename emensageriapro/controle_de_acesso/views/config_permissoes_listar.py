    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'config_paginas__icontains': 'config_paginas__icontains', }
        ...
        config_permissoes_lista = ConfigPermissoes.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/config_permissoes.csv', context)
