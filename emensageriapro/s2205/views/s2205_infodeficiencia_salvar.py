...
def salvar(request, hash):
    ...
    if s2205_infodeficiencia_id:
        ...
        s2205_infodeficiencia = get_object_or_404(s2205infoDeficiencia, id=s2205_infodeficiencia_id)
        dados_evento = s2205_infodeficiencia.evento()

    if request.user.has_perm('s2205.can_view_s2205infoDeficiencia'):
        ...
        if request.method == 'POST':
            ...
            if s2205_infodeficiencia_form.is_valid():
                ...
                if not s2205_infodeficiencia_id:
        ...
        s2205_infodeficiencia_form = disabled_form_fields(s2205_infodeficiencia_form, request.user.has_perm('s2205.change_s2205infoDeficiencia'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2205_infodeficiencia_id, tabela='s2205_infodeficiencia').all()
