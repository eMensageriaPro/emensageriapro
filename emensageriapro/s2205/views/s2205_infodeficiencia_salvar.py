...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2205_infodeficiencia')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2205_infodeficiencia_id:
            s2205_infodeficiencia_form = form_s2205_infodeficiencia(request.POST or None, instance = s2205_infodeficiencia,  
