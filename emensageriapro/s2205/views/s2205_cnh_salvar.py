...
def salvar(request, hash):
    ...
    if s2205_cnh_id:
        ...
        s2205_cnh = get_object_or_404(s2205CNH, id=s2205_cnh_id)
        dados_evento = s2205_cnh.evento()

    if request.user.has_perm('s2205.can_view_s2205CNH'):
        ...
        s2205_cnh_form = disabled_form_fields(s2205_cnh_form, request.user.has_perm('s2205.change_s2205CNH'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2205_cnh_id, tabela='s2205_cnh').all()
