...
def salvar(request, hash):
    ...
    if s2205_ric_id:
        ...
        s2205_ric = get_object_or_404(s2205RIC, id=s2205_ric_id)
        dados_evento = s2205_ric.evento()

    if request.user.has_perm('s2205.can_view_s2205RIC'):
        ...
        s2205_ric_form = disabled_form_fields(s2205_ric_form, request.user.has_perm('s2205.change_s2205RIC'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2205_ric_id, tabela='s2205_ric').all()
