...
def listar(request, output=None):
    ...
    if request.user.has_perm('s2205.can_see_s2205infoDeficiencia'):
        ...
        s2205_infodeficiencia_lista = s2205infoDeficiencia.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s2205_infodeficiencia.csv', context)
