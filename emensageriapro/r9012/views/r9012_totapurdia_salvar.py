...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r9012_totapurdia_id:
            r9012_totapurdia_form = form_r9012_totapurdia(request.POST or None, instance = r9012_totapurdia,  
        ...
        r9012_totapurdia_form = disabled_form_fields(r9012_totapurdia_form, permissao.permite_editar)
