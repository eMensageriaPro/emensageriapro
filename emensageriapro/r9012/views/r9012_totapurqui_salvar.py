...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r9012_totapurqui_id:
            r9012_totapurqui_form = form_r9012_totapurqui(request.POST or None, instance = r9012_totapurqui,  
        ...
        r9012_totapurqui_form = disabled_form_fields(r9012_totapurqui_form, permissao.permite_editar)
