...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1035.can_view_s1035alteracaonovaValidade'):
        ...
        s1035_alteracao_novavalidade_form = disabled_form_fields(s1035_alteracao_novavalidade_form, request.user.has_perm('s1035.change_s1035alteracaonovaValidade'))
