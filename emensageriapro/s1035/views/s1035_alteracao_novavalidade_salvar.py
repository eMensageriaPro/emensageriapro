...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1035_alteracao_novavalidade')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1035_alteracao_novavalidade_id:
        s1035_alteracao_novavalidade = get_object_or_404(s1035alteracaonovaValidade, id = s1035_alteracao_novavalidade_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1035_alteracao_novavalidade_id, tabela='s1035_alteracao_novavalidade').all()
        context = {
