...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = { 
                's1035_alteracao__icontains': 's1035_alteracao__icontains',
        ...
        s1035_alteracao_novavalidade_lista = s1035alteracaonovaValidade.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1035_alteracao_novavalidade_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1035_alteracao_novavalidade.csv', context)
