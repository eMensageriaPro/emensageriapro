...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1035.can_view_s1035alteracao'):
        ...
        s1035_alteracao_form = disabled_form_fields(s1035_alteracao_form, request.user.has_perm('s1035.change_s1035alteracao'))
