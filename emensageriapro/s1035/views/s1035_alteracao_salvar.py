...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1035_alteracao')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1035_alteracao_id:
        s1035_alteracao = get_object_or_404(s1035alteracao, id = s1035_alteracao_id)
    ...
    if permissao.permite_visualizar:
        ...
        if s1035_alteracao_id:
            ...
            s1035_alteracao_novavalidade_form = form_s1035_alteracao_novavalidade(
                initial={ 's1035_alteracao': s1035_alteracao })
            ...
            s1035_alteracao_novavalidade_lista = s1035alteracaonovaValidade.objects.\
                filter(s1035_alteracao_id=s1035_alteracao.id).all()
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1035_alteracao_id, tabela='s1035_alteracao').all()
        context = {
