...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        s1035_inclusao = get_object_or_404(s1035inclusao, id=pk)
        evento_dados = s1035_inclusao.evento()

    if request.user.has_perm('s1035.can_see_s1035inclusao'):
        ...
        if request.method == 'POST':
            ...
            if s1035_inclusao_form.is_valid():
                ...
                if request.session['return_page'] not in (
                    's1035_inclusao_apagar', 
                    's1035_inclusao_salvar', 
                    's1035_inclusao'):
        ...
        s1035_inclusao_form = disabled_form_fields(
            s1035_inclusao_form, 
            request.user.has_perm('s1035.change_s1035inclusao'))
        ...
        if tab or 's1035_inclusao' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 's1035_inclusao_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='s1035_inclusao').all()
