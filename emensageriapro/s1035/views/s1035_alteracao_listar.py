    ...
    if request.user.has_perm('s1035.can_see_s1035alteracao'):
        ...
        if request.method == 'POST':
            ...
            dict_fields = {
                ...
                'sitcarr__icontains': 'sitcarr__icontains', }
        ...
        s1035_alteracao_lista = s1035alteracao.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1035_alteracao.csv', context)
