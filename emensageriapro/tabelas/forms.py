...
class form_efdreinf_codigos_atividades_produtos_servicos_cprb(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['inicio_escrituracao'].widget.attrs['required'] = True
        
        self.fields['aliquota'].widget.attrs['required'] = True
        
        self.fields['ncm'].widget.attrs['required'] = True
        
        self.fields['cr'].widget.attrs['required'] = True
        
        self.fields['incidencia'].widget.attrs['required'] = True
...
class form_efdreinf_regras_pagamentos_codigos(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['tributacao_com_exigibilidade_suspensa'].widget.attrs['required'] = True
        
        self.fields['compensacao_imposto_por_decisao_judicial'].widget.attrs['required'] = True
        
        self.fields['rendimentos_isentos'].widget.attrs['required'] = True
        
        self.fields['deducoes'].widget.attrs['required'] = True
        
        self.fields['decimo_terceiro'].widget.attrs['required'] = True
...
class form_esocial_paises(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['data_extincao'].widget.attrs['required'] = True
