...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='esocial_procedimentos_diagnosticos')
    ...
    if permissao.permite_listar:
        ...
        esocial_procedimentos_diagnosticos_lista = eSocialProcedimentosDiagnosticos.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/esocial_procedimentos_diagnosticos_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/esocial_procedimentos_diagnosticos.csv', context)
