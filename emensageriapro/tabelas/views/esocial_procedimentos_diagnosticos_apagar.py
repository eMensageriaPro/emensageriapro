...
def apagar(request, hash):
    ...
    esocial_procedimentos_diagnosticos = get_object_or_404(eSocialProcedimentosDiagnosticos, id = esocial_procedimentos_diagnosticos_id)
    if request.method == 'POST':
        obj = eSocialProcedimentosDiagnosticos.objects.get(id = esocial_procedimentos_diagnosticos_id)
