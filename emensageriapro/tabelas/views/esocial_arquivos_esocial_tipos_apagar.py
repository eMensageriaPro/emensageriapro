...
def apagar(request, hash):
    ...
    esocial_arquivos_esocial_tipos = get_object_or_404(eSocialArquivosEsocialTipos, id = esocial_arquivos_esocial_tipos_id)
    if request.method == 'POST':
        obj = eSocialArquivosEsocialTipos.objects.get(id = esocial_arquivos_esocial_tipos_id)
