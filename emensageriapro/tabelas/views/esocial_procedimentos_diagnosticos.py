...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if esocial_procedimentos_diagnosticos_id:
            esocial_procedimentos_diagnosticos_form = form_esocial_procedimentos_diagnosticos(request.POST or None, instance = esocial_procedimentos_diagnosticos, slug = db_slug)
        else:
