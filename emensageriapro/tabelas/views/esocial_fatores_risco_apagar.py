...
def apagar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='esocial_fatores_risco')
    ...
    esocial_fatores_risco = get_object_or_404(eSocialFatoresRisco, id = esocial_fatores_risco_id)
    if request.method == 'POST':
        obj = eSocialFatoresRisco.objects.get(id = esocial_fatores_risco_id)
