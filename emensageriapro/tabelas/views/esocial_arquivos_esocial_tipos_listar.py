...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='esocial_arquivos_esocial_tipos')
    ...
    if permissao.permite_listar:
        ...
        esocial_arquivos_esocial_tipos_lista = eSocialArquivosEsocialTipos.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/esocial_arquivos_esocial_tipos_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/esocial_arquivos_esocial_tipos.csv', context)
