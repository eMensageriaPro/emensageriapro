...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        eSocialCodificacoesAcidenteTrabalho.objects.using( db_slug ).filter(id = esocial_codificacoes_acidente_trabalho_id).update(excluido = True)
        ...
        if request.method == 'POST':
            if esocial_codificacoes_acidente_trabalho_form.is_valid():
                ...
                if esocial_codificacoes_acidente_trabalho_id:
                    ...
                    #esocial_codificacoes_acidente_trabalho_campos_multiple_passo1
                    eSocialCodificacoesAcidenteTrabalho.objects.using(db_slug).filter(id=esocial_codificacoes_acidente_trabalho_id).update(**dados)
                    obj = eSocialCodificacoesAcidenteTrabalho.objects.using(db_slug).get(id=esocial_codificacoes_acidente_trabalho_id)
                    #esocial_codificacoes_acidente_trabalho_editar_custom
                    #esocial_codificacoes_acidente_trabalho_campos_multiple_passo2
                    ...
                    #esocial_codificacoes_acidente_trabalho_cadastrar_campos_multiple_passo1
                    obj = eSocialCodificacoesAcidenteTrabalho(**dados)
                    obj.save(using = db_slug)
                    #esocial_codificacoes_acidente_trabalho_cadastrar_custom
                    #esocial_codificacoes_acidente_trabalho_cadastrar_campos_multiple_passo2
