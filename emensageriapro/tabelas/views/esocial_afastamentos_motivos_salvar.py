...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='esocial_afastamentos_motivos')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if esocial_afastamentos_motivos_id:
        esocial_afastamentos_motivos = get_object_or_404(eSocialAfastamentosMotivos, id = esocial_afastamentos_motivos_id)
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if esocial_afastamentos_motivos_id:
            esocial_afastamentos_motivos_form = form_esocial_afastamentos_motivos(request.POST or None, instance = esocial_afastamentos_motivos, 
                                         initial = {'excluido': False})
        else:
            esocial_afastamentos_motivos_form = form_esocial_afastamentos_motivos(request.POST or None,
                                         initial = {'excluido': False})
