...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='esocial_atividades_periculosas_insalubres_especiais')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if esocial_atividades_periculosas_insalubres_especiais_id:
        esocial_atividades_periculosas_insalubres_especiais = get_object_or_404(eSocialAtividadesPericulosasInsalubresEspeciais, id = esocial_atividades_periculosas_insalubres_especiais_id)
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if esocial_atividades_periculosas_insalubres_especiais_id:
            esocial_atividades_periculosas_insalubres_especiais_form = form_esocial_atividades_periculosas_insalubres_especiais(request.POST or None, instance = esocial_atividades_periculosas_insalubres_especiais, 
