    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'ind_total__icontains': 'ind_total__icontains', }
        ...
        esocial_codigo_aliquotas_fpas_terceiros_lista = eSocialCodigoAliquotasFPASTerceiros.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/esocial_codigo_aliquotas_fpas_terceiros_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/esocial_codigo_aliquotas_fpas_terceiros.csv', context)
