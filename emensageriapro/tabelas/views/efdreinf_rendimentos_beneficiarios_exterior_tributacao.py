...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        EFDReinfRendimentosBeneficiariosExteriorTributacao.objects.using( db_slug ).filter(id = efdreinf_rendimentos_beneficiarios_exterior_tributacao_id).update(excluido = True)
        ...
        if request.method == 'POST':
            if efdreinf_rendimentos_beneficiarios_exterior_tributacao_form.is_valid():
                ...
                if efdreinf_rendimentos_beneficiarios_exterior_tributacao_id:
                    ...
                    #efdreinf_rendimentos_beneficiarios_exterior_tributacao_campos_multiple_passo1
                    EFDReinfRendimentosBeneficiariosExteriorTributacao.objects.using(db_slug).filter(id=efdreinf_rendimentos_beneficiarios_exterior_tributacao_id).update(**dados)
                    ...
                    #efdreinf_rendimentos_beneficiarios_exterior_tributacao_editar_custom
                    #efdreinf_rendimentos_beneficiarios_exterior_tributacao_campos_multiple_passo2
                    ...
                    #efdreinf_rendimentos_beneficiarios_exterior_tributacao_cadastrar_campos_multiple_passo1
                    obj = EFDReinfRendimentosBeneficiariosExteriorTributacao(**dados)
                    obj.save(using = db_slug)
                    #efdreinf_rendimentos_beneficiarios_exterior_tributacao_cadastrar_custom
                    #efdreinf_rendimentos_beneficiarios_exterior_tributacao_cadastrar_campos_multiple_passo2
