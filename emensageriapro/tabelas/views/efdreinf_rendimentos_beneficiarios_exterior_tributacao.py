...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if efdreinf_rendimentos_beneficiarios_exterior_tributacao_id:
            ...
            efdreinf_rendimentos_beneficiarios_exterior_tributacao_form = form_efdreinf_rendimentos_beneficiarios_exterior_tributacao(request.POST or None, slug = db_slug,
                                         initial = {'excluido': False})
        if request.method == 'POST':
