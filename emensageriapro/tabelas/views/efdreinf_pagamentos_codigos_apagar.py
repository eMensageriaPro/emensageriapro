...
def apagar(request, hash):
    ...
    efdreinf_pagamentos_codigos = get_object_or_404(EFDReinfPagamentosCodigos, id = efdreinf_pagamentos_codigos_id)
    if request.method == 'POST':
        obj = EFDReinfPagamentosCodigos.objects.get(id = efdreinf_pagamentos_codigos_id)
