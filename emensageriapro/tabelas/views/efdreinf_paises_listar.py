...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='efdreinf_paises')
    ...
    if permissao.permite_listar:
        ...
        efdreinf_paises_lista = EFDReinfPaises.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/efdreinf_paises_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/efdreinf_paises.csv', context)
