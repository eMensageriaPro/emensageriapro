...
class form_s1200_infoperapur_itensremun(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['vrunit'].widget.attrs['required'] = True
        
        self.fields['fatorrubr'].widget.attrs['required'] = True
        
        self.fields['qtdrubr'].widget.attrs['required'] = True
...
class form_s1200_infoperapur_ideestablot(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['qtddiasav'].widget.attrs['required'] = True
...
class form_s1200_infoperant_infocomplcont(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['qtddiastrab'].widget.attrs['required'] = True
...
class form_s1200_infoperant_ideadc(forms.ModelForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['compacconv'].widget.attrs['required'] = True
