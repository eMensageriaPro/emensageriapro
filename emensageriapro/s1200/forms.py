...
class form_s1200_infoperant(forms.ModelForm):
    ...
    def save(self, commit=True, *args, **kwargs):
        ...
        m =  super(form_s1200_infoperant, self).save(commit=True, *args, **kwargs)
...
class form_s1200_infoperapur(forms.ModelForm):
    ...
    def save(self, commit=True, *args, **kwargs):
        ...
        m =  super(form_s1200_infoperapur, self).save(commit=True, *args, **kwargs)
...
class form_s1200_infoperapur_infosaudecolet(forms.ModelForm):
    ...
    def save(self, commit=True, *args, **kwargs):
        ...
        m =  super(form_s1200_infoperapur_infosaudecolet, self).save(commit=True, *args, **kwargs)
