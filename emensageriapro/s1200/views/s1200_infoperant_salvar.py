...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1200_infoperant')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1200_infoperant_id:
        s1200_infoperant = get_object_or_404(s1200infoPerAnt, id = s1200_infoperant_id)
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1200_infoperant_id:
            s1200_infoperant_form = form_s1200_infoperant(request.POST or None, instance = s1200_infoperant,  
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1200_infoperant_id, tabela='s1200_infoperant').all()
        context = {
