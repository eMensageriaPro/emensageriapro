...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1200.can_view_s1200infoPerApurremunPerApur'):
        ...
        s1200_infoperapur_remunperapur_form = disabled_form_fields(s1200_infoperapur_remunperapur_form, request.user.has_perm('s1200.change_s1200infoPerApurremunPerApur'))
