...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1200_infoperapur_remunperapur')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1200_infoperapur_remunperapur_id:
        s1200_infoperapur_remunperapur = get_object_or_404(s1200infoPerApurremunPerApur, id = s1200_infoperapur_remunperapur_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1200_infoperapur_remunperapur_id, tabela='s1200_infoperapur_remunperapur').all()
        context = {
