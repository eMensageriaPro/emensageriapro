...
def salvar(request, hash):
    ...
    if s1200_infoperapur_ideestablot_id:
        ...
        s1200_infoperapur_ideestablot = get_object_or_404(s1200infoPerApurideEstabLot, id=s1200_infoperapur_ideestablot_id)
        dados_evento = s1200_infoperapur_ideestablot.evento()

    if request.user.has_perm('s1200.can_view_s1200infoPerApurideEstabLot'):
        ...
        s1200_infoperapur_ideestablot_form = disabled_form_fields(s1200_infoperapur_ideestablot_form, request.user.has_perm('s1200.change_s1200infoPerApurideEstabLot'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1200_infoperapur_ideestablot_id, tabela='s1200_infoperapur_ideestablot').all()
