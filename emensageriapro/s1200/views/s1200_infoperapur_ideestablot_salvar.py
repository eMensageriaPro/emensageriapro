...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1200_infoperapur_ideestablot')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1200_infoperapur_ideestablot_id:
            s1200_infoperapur_ideestablot_form = form_s1200_infoperapur_ideestablot(request.POST or None, instance = s1200_infoperapur_ideestablot,  
