...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1200_procjudtrab')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1200_procjudtrab_id:
        s1200_procjudtrab = get_object_or_404(s1200procJudTrab, id = s1200_procjudtrab_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1200_procjudtrab_id, tabela='s1200_procjudtrab').all()
        context = {
