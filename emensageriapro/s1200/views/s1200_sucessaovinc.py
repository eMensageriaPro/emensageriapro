            ...
            if s1200_sucessaovinc_form.is_valid():
                ...
                if s1200_sucessaovinc_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s1200_sucessaovinc_campos_multiple_passo1
                        s1200sucessaoVinc.objects.using(db_slug).filter(id=s1200_sucessaovinc_id).update(**dados)
                        obj = s1200sucessaoVinc.objects.using(db_slug).get(id=s1200_sucessaovinc_id)
                        #s1200_sucessaovinc_editar_custom
                        #s1200_sucessaovinc_campos_multiple_passo2
                    ...
                    #s1200_sucessaovinc_cadastrar_campos_multiple_passo1
                    obj = s1200sucessaoVinc(**dados)
                    obj.save(using = db_slug)
                    #s1200_sucessaovinc_cadastrar_custom
                    #s1200_sucessaovinc_cadastrar_campos_multiple_passo2
...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s1200sucessaoVinc.objects.using( db_slug ).filter(id = s1200_sucessaovinc_id).delete()
