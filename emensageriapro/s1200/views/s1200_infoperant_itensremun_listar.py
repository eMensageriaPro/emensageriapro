...
def listar(request, output=None):
    ...
    if request.user.has_perm('s1200.can_see_s1200infoPerAntitensRemun'):
        ...
        s1200_infoperant_itensremun_lista = s1200infoPerAntitensRemun.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1200_infoperant_itensremun.csv', context)
