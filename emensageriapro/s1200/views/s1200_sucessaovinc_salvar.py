...
def salvar(request, hash):
    ...
    if s1200_sucessaovinc_id:
        ...
        s1200_sucessaovinc = get_object_or_404(s1200sucessaoVinc, id=s1200_sucessaovinc_id)
        dados_evento = s1200_sucessaovinc.evento()

    if request.user.has_perm('s1200.can_view_s1200sucessaoVinc'):
        ...
        s1200_sucessaovinc_form = disabled_form_fields(s1200_sucessaovinc_form, request.user.has_perm('s1200.change_s1200sucessaoVinc'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1200_sucessaovinc_id, tabela='s1200_sucessaovinc').all()
