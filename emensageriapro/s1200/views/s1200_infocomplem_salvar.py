...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1200_infocomplem')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1200_infocomplem_id:
            s1200_infocomplem_form = form_s1200_infocomplem(request.POST or None, instance = s1200_infocomplem,  
