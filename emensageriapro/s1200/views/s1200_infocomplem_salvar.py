...
def salvar(request, hash):
    ...
    if s1200_infocomplem_id:
        ...
        s1200_infocomplem = get_object_or_404(s1200infoComplem, id=s1200_infocomplem_id)
        dados_evento = s1200_infocomplem.evento()

    if request.user.has_perm('s1200.can_view_s1200infoComplem'):
        ...
        s1200_infocomplem_form = disabled_form_fields(s1200_infocomplem_form, request.user.has_perm('s1200.change_s1200infoComplem'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1200_infocomplem_id, tabela='s1200_infocomplem').all()
