...
def salvar(request, hash):
    ...
    if s1200_infomv_id:
        ...
        s1200_infomv = get_object_or_404(s1200infoMV, id=s1200_infomv_id)
        dados_evento = s1200_infomv.evento()

    if request.user.has_perm('s1200.can_view_s1200infoMV'):
        
        if s1200_infomv_id:
        
            s1200_infomv_form = form_s1200_infomv(request.POST or None, 
                                                          instance=s1200_infomv,  
        ...
        if request.method == 'POST':
            ...
            if s1200_infomv_form.is_valid():
                ...
                obj = s1200_infomv_form.save(request=request)
                messages.success(request, u'Salvo com sucesso!')
                
                if not s1200_infomv_id:
        ...
        s1200_infomv_form = disabled_form_fields(s1200_infomv_form, request.user.has_perm('s1200.change_s1200infoMV'))
        ...
        if s1200_infomv_id:
            ...
            s1200_remunoutrempr_form = form_s1200_remunoutrempr(
                initial={ 's1200_infomv': s1200_infomv })
            ...
            s1200_remunoutrempr_lista = s1200remunOutrEmpr.objects.\
                filter(s1200_infomv_id=s1200_infomv.id).all()
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1200_infomv_id, tabela='s1200_infomv').all()
        ...
        if for_print in (0, 1):
            ...
            response = PDFTemplateResponse(
                request=request,
                template='s1200_infomv_salvar.html',
            ...
            response = render_to_response('s1200_infomv_salvar.html', context)
