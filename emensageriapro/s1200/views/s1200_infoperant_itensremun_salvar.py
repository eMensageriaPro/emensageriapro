...
def salvar(request, hash):
    ...
    if s1200_infoperant_itensremun_id:
        ...
        s1200_infoperant_itensremun = get_object_or_404(s1200infoPerAntitensRemun, id=s1200_infoperant_itensremun_id)
        dados_evento = s1200_infoperant_itensremun.evento()

    if request.user.has_perm('s1200.can_view_s1200infoPerAntitensRemun'):
        ...
        if request.method == 'POST':
            ...
            if s1200_infoperant_itensremun_form.is_valid():
                ...
                if not s1200_infoperant_itensremun_id:
        ...
        s1200_infoperant_itensremun_form = disabled_form_fields(s1200_infoperant_itensremun_form, request.user.has_perm('s1200.change_s1200infoPerAntitensRemun'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1200_infoperant_itensremun_id, tabela='s1200_infoperant_itensremun').all()
