...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1200_infoperant_itensremun')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1200_infoperant_itensremun_id:
            s1200_infoperant_itensremun_form = form_s1200_infoperant_itensremun(request.POST or None, instance = s1200_infoperant_itensremun,  
