...
def listar(request, output=None):
    ...
    if request.user.has_perm('s1200.can_see_s1200infoPerApurideEstabLot'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's1200_infoperapur__icontains': 's1200_infoperapur__icontains',
                'tpinsc__icontains': 'tpinsc__icontains',
                'nrinsc__icontains': 'nrinsc__icontains',
                'codlotacao__icontains': 'codlotacao__icontains',
                'qtddiasav__icontains': 'qtddiasav__icontains', }
        ...
        s1200_infoperapur_ideestablot_lista = s1200infoPerApurideEstabLot.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s1200_infoperapur_lista = s1200infoPerApur.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1200_infoperapur_ideestablot.csv', context)
