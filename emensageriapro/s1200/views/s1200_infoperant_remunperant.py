...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1200_infoperant_remunperant_id:
            s1200_infoperant_remunperant_form = form_s1200_infoperant_remunperant(request.POST or None, instance = s1200_infoperant_remunperant,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            s1200_infoperant_remunperant_form = form_s1200_infoperant_remunperant(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
