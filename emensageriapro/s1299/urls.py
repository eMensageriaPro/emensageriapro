...
from emensageriapro.s1299.views import s1299_iderespinf_apagar as s1299_iderespinf_apagar_views
from emensageriapro.s1299.views import s1299_iderespinf_listar as s1299_iderespinf_listar_views
from emensageriapro.s1299.views import s1299_iderespinf_salvar as s1299_iderespinf_salvar_views
...
urlpatterns = [
    ...
    url(r'^s1299-iderespinf/api/$',
        s1299_iderespinf_api_views.s1299ideRespInfList.as_view() ),
