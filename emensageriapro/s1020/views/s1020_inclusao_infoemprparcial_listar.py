...
def listar(request, output=None):
    ...
    if request.user.has_perm('s1020.can_see_s1020inclusaoinfoEmprParcial'):
        ...
        s1020_inclusao_infoemprparcial_lista = s1020inclusaoinfoEmprParcial.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1020_inclusao_infoemprparcial.csv', context)
