...
def salvar(request, hash):
    ...
    if s1020_alteracao_id:
        ...
        s1020_alteracao = get_object_or_404(s1020alteracao, id=s1020_alteracao_id)
        dados_evento = s1020_alteracao.evento()

    if request.user.has_perm('s1020.can_view_s1020alteracao'):
        ...
        s1020_alteracao_form = disabled_form_fields(s1020_alteracao_form, request.user.has_perm('s1020.change_s1020alteracao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1020_alteracao_id, tabela='s1020_alteracao').all()
