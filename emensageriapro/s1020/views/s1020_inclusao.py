...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1020_inclusao_id:
            s1020_inclusao_form = form_s1020_inclusao(request.POST or None, instance = s1020_inclusao,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            s1020_inclusao_form = form_s1020_inclusao(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
        ...
        if s1020_inclusao_id:
            ...
            s1020_inclusao_procjudterceiro_form = form_s1020_inclusao_procjudterceiro(initial={ 's1020_inclusao': s1020_inclusao }, slug=db_slug)
            s1020_inclusao_procjudterceiro_form.fields['s1020_inclusao'].widget.attrs['readonly'] = True
            s1020_inclusao_procjudterceiro_lista = s1020inclusaoprocJudTerceiro.objects.using( db_slug ).filter(excluido = False, s1020_inclusao_id=s1020_inclusao.id).all()
