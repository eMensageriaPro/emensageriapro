...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1020_alteracao_infoprocjudterceiros')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1020_alteracao_infoprocjudterceiros_id:
            s1020_alteracao_infoprocjudterceiros_form = form_s1020_alteracao_infoprocjudterceiros(request.POST or None, instance = s1020_alteracao_infoprocjudterceiros,  
