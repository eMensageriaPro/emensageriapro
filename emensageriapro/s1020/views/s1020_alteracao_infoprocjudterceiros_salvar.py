...
def salvar(request, hash):
    ...
    if s1020_alteracao_infoprocjudterceiros_id:
        ...
        s1020_alteracao_infoprocjudterceiros = get_object_or_404(s1020alteracaoinfoProcJudTerceiros, id=s1020_alteracao_infoprocjudterceiros_id)
        dados_evento = s1020_alteracao_infoprocjudterceiros.evento()

    if request.user.has_perm('s1020.can_view_s1020alteracaoinfoProcJudTerceiros'):
        ...
        if request.method == 'POST':
            ...
            if s1020_alteracao_infoprocjudterceiros_form.is_valid():
                ...
                if not s1020_alteracao_infoprocjudterceiros_id:
        ...
        s1020_alteracao_infoprocjudterceiros_form = disabled_form_fields(s1020_alteracao_infoprocjudterceiros_form, request.user.has_perm('s1020.change_s1020alteracaoinfoProcJudTerceiros'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1020_alteracao_infoprocjudterceiros_id, tabela='s1020_alteracao_infoprocjudterceiros').all()
