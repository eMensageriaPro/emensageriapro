...
def listar(request, output=None):
    ...
    if request.user.has_perm('s1020.can_see_s1020alteracaoprocJudTerceiro'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's1020_alteracao_infoprocjudterceiros__icontains': 's1020_alteracao_infoprocjudterceiros__icontains',
        ...
        s1020_alteracao_procjudterceiro_lista = s1020alteracaoprocJudTerceiro.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s1020_alteracao_infoprocjudterceiros_lista = s1020alteracaoinfoProcJudTerceiros.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1020_alteracao_procjudterceiro.csv', context)
