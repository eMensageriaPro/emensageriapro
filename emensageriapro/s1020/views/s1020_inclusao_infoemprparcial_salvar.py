...
def salvar(request, hash):
    ...
    if s1020_inclusao_infoemprparcial_id:
        ...
        s1020_inclusao_infoemprparcial = get_object_or_404(s1020inclusaoinfoEmprParcial, id=s1020_inclusao_infoemprparcial_id)
        dados_evento = s1020_inclusao_infoemprparcial.evento()

    if request.user.has_perm('s1020.can_view_s1020inclusaoinfoEmprParcial'):
        ...
        if request.method == 'POST':
            ...
            if s1020_inclusao_infoemprparcial_form.is_valid():
                ...
                if not s1020_inclusao_infoemprparcial_id:
        ...
        s1020_inclusao_infoemprparcial_form = disabled_form_fields(s1020_inclusao_infoemprparcial_form, request.user.has_perm('s1020.change_s1020inclusaoinfoEmprParcial'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1020_inclusao_infoemprparcial_id, tabela='s1020_inclusao_infoemprparcial').all()
