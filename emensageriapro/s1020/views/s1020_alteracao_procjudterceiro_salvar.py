...
def salvar(request, hash):
    ...
    if s1020_alteracao_procjudterceiro_id:
        ...
        s1020_alteracao_procjudterceiro = get_object_or_404(s1020alteracaoprocJudTerceiro, id=s1020_alteracao_procjudterceiro_id)
        dados_evento = s1020_alteracao_procjudterceiro.evento()

    if request.user.has_perm('s1020.can_view_s1020alteracaoprocJudTerceiro'):
        ...
        if request.method == 'POST':
            ...
            if s1020_alteracao_procjudterceiro_form.is_valid():
                ...
                if not s1020_alteracao_procjudterceiro_id:
        ...
        s1020_alteracao_procjudterceiro_form = disabled_form_fields(s1020_alteracao_procjudterceiro_form, request.user.has_perm('s1020.change_s1020alteracaoprocJudTerceiro'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1020_alteracao_procjudterceiro_id, tabela='s1020_alteracao_procjudterceiro').all()
