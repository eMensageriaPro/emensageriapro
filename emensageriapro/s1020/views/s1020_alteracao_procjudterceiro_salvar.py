...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1020_alteracao_procjudterceiro')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1020_alteracao_procjudterceiro_id:
            s1020_alteracao_procjudterceiro_form = form_s1020_alteracao_procjudterceiro(request.POST or None, instance = s1020_alteracao_procjudterceiro,  
