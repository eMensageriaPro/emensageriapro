...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            post = True
            dict_fields = { 
                's1050_inclusao__icontains': 's1050_inclusao__icontains',
        ...
        s1050_inclusao_horariointervalo_lista = s1050inclusaohorarioIntervalo.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/s1050_inclusao_horariointervalo_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1050_inclusao_horariointervalo.csv', context)
