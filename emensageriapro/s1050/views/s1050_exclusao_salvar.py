...
def salvar(request, hash):
    ...
    if s1050_exclusao_id:
        ...
        s1050_exclusao = get_object_or_404(s1050exclusao, id=s1050_exclusao_id)
        dados_evento = s1050_exclusao.evento()

    if request.user.has_perm('s1050.can_view_s1050exclusao'):
        ...
        s1050_exclusao_form = disabled_form_fields(s1050_exclusao_form, request.user.has_perm('s1050.change_s1050exclusao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1050_exclusao_id, tabela='s1050_exclusao').all()
