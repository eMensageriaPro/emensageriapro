...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1050.can_view_s1050inclusao'):
        ...
        s1050_inclusao_form = disabled_form_fields(s1050_inclusao_form, request.user.has_perm('s1050.change_s1050inclusao'))
