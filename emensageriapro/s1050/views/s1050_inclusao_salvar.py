...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1050_inclusao')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1050_inclusao_id:
        s1050_inclusao = get_object_or_404(s1050inclusao, id = s1050_inclusao_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1050_inclusao_id, tabela='s1050_inclusao').all()
        context = {
