...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1050.can_view_s1050inclusaohorarioIntervalo'):
        ...
        if request.method == 'POST':
            ...
            if s1050_inclusao_horariointervalo_form.is_valid():
                ...
                if not s1050_inclusao_horariointervalo_id:
        ...
        s1050_inclusao_horariointervalo_form = disabled_form_fields(s1050_inclusao_horariointervalo_form, request.user.has_perm('s1050.change_s1050inclusaohorarioIntervalo'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1050_inclusao_horariointervalo_id, tabela='s1050_inclusao_horariointervalo').all()
