...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1050_inclusao_horariointervalo')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1050_inclusao_horariointervalo_id:
            s1050_inclusao_horariointervalo_form = form_s1050_inclusao_horariointervalo(request.POST or None, instance = s1050_inclusao_horariointervalo,  
