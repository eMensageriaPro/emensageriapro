...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='r5011_infototalcontrib')
    ...
    if permissao.permite_listar:
        ...
        r5011_infototalcontrib_lista = r5011infoTotalContrib.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/r5011_infototalcontrib_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r5011_infototalcontrib.csv', context)
