...
def salvar(request, hash):
    ...
    if request.user.has_perm('r5011.can_view_r5011RTom'):
        ...
        r5011_rtom_form = disabled_form_fields(r5011_rtom_form, request.user.has_perm('r5011.change_r5011RTom'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r5011_rtom_id, tabela='r5011_rtom').all()
