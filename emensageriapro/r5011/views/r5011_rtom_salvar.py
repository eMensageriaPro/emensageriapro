...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = r5011_rtom.evento()

    if request.user.has_perm('r5011.can_see_r5011RTom'):
        ...
        if request.method == 'POST':
            ...
            if r5011_rtom_form.is_valid():
                ...
                obj = r5011_rtom_form.save(request=request)
        ...
        r5011_rtom_form = disabled_form_fields(
            r5011_rtom_form, 
            request.user.has_perm('r5011.change_r5011RTom'))
        ...
        if pk:
            ...
            r5011_infocrtom_form = form_r5011_infocrtom(
                initial={ 'r5011_rtom': r5011_rtom })
            r5011_infocrtom_form.fields['r5011_rtom'].widget.attrs['readonly'] = True
            r5011_infocrtom_lista = r5011infoCRTom.objects.\
                filter(r5011_rtom_id=r5011_rtom.id).all()
        ...
        if tab or 'r5011_rtom' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r5011_rtom_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r5011_rtom').all()
