...
def apagar(request, pk):
    ...
    if request.method == 'POST':
        ...
        if dados_evento['status'] == STATUS_EVENTO_CADASTRADO:
            ...
            obj = r5011infoTotalContrib.objects.get(id=pk)
        ...
        if 'r5011_infototalcontrib' in request.session['return_page']:
        
            return redirect('r5011_infototalcontrib')
    ...
    return render(request, 
                  'r5011_infototalcontrib_apagar.html', 
                  context)