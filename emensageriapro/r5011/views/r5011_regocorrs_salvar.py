...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r5011_regocorrs = get_object_or_404(r5011regOcorrs, id=pk)
        evento_dados = r5011_regocorrs.evento()
    ...
    if request.user.has_perm('r5011.can_see_r5011regOcorrs'):
        ...
        if request.method == 'POST':
            ...
            if r5011_regocorrs_form.is_valid():
                ...
                if request.session['return_page'] not in (
                    'r5011_regocorrs_apagar', 
                    'r5011_regocorrs_salvar', 
                    'r5011_regocorrs'):
        ...
        r5011_regocorrs_form = disabled_form_fields(
            r5011_regocorrs_form, 
            request.user.has_perm('r5011.change_r5011regOcorrs'))
        ...
        if tab or 'r5011_regocorrs' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r5011_regocorrs_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r5011_regocorrs').all()
