...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r5011_infototalcontrib_id:
            r5011_infototalcontrib_form = form_r5011_infototalcontrib(request.POST or None, instance = r5011_infototalcontrib,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            r5011_infototalcontrib_form = form_r5011_infototalcontrib(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
