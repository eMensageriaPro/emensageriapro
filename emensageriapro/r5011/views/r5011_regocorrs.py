...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r5011_regocorrs_id:
            r5011_regocorrs_form = form_r5011_regocorrs(request.POST or None, instance = r5011_regocorrs,
                                         slug = db_slug,
                                         initial={'excluido': False})
        else:
            r5011_regocorrs_form = form_r5011_regocorrs(request.POST or None, slug = db_slug,
                                         initial={'excluido': False})
        if request.method == 'POST':
