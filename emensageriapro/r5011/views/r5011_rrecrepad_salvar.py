...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r5011_rrecrepad = get_object_or_404(r5011RRecRepAD, id=pk)
        evento_dados = r5011_rrecrepad.evento()

    if request.user.has_perm('r5011.can_see_r5011RRecRepAD'):
        
        if pk:
        
            r5011_rrecrepad_form = form_r5011_rrecrepad(
                request.POST or None, 
                instance=r5011_rrecrepad)
        ...
        if request.method == 'POST':
            ...
            if r5011_rrecrepad_form.is_valid():
                ...
                if request.session['return_page'] not in (
                    'r5011_rrecrepad_apagar', 
                    'r5011_rrecrepad_salvar', 
                    'r5011_rrecrepad'):
        ...
        r5011_rrecrepad_form = disabled_form_fields(
            r5011_rrecrepad_form, 
            request.user.has_perm('r5011.change_r5011RRecRepAD'))
        ...
        if tab or 'r5011_rrecrepad' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r5011_rrecrepad_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r5011_rrecrepad').all()
