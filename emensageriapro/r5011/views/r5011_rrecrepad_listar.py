...
def listar(request, hash):
    ...
    if request.user.has_perm('r5011.can_view_r5011RRecRepAD'):
        ...
        r5011_rrecrepad_lista = r5011RRecRepAD.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r5011_rrecrepad.csv', context)
