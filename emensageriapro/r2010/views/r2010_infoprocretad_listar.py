...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='r2010_infoprocretad')
    ...
    if permissao.permite_listar:
        ...
        if request.method == 'POST':
            ...
            dict_fields = { 
                ...
                'tpprocretadic__icontains': 'tpprocretadic__icontains',
                'nrprocretadic__icontains': 'nrprocretadic__icontains',
                'codsuspadic__icontains': 'codsuspadic__icontains',
                'valoradic__icontains': 'valoradic__icontains', }
        ...
        r2010_infoprocretad_lista = r2010infoProcRetAd.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/r2010_infoprocretad_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r2010_infoprocretad.csv', context)
