...
def salvar(request, hash):
    ...
    if r2010_infoprocretad_id:
        ...
        r2010_infoprocretad = get_object_or_404(r2010infoProcRetAd, id=r2010_infoprocretad_id)
        dados_evento = r2010_infoprocretad.evento()

    if request.user.has_perm('r2010.can_view_r2010infoProcRetAd'):
        ...
        r2010_infoprocretad_form = disabled_form_fields(r2010_infoprocretad_form, request.user.has_perm('r2010.change_r2010infoProcRetAd'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r2010_infoprocretad_id, tabela='r2010_infoprocretad').all()
