...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r2010_infotpserv = get_object_or_404(r2010infoTpServ, id=pk)
        evento_dados = r2010_infotpserv.evento()

    if request.user.has_perm('r2010.can_see_r2010infoTpServ'):
        ...
        if request.method == 'POST':
            ...
            if r2010_infotpserv_form.is_valid():
                ...
                #    gravar_auditoria(
                #        json.dumps(
                #            model_to_dict(r2010_infotpserv), 
                #            indent=4, 
                #            sort_keys=True, 
                #            default=str),
                #        json.dumps(
                ...
                if request.session['return_page'] not in (
                    'r2010_infotpserv_apagar', 
                    'r2010_infotpserv_salvar', 
                    'r2010_infotpserv'):
        ...
        r2010_infotpserv_form = disabled_form_fields(
            r2010_infotpserv_form, 
            request.user.has_perm('r2010.change_r2010infoTpServ'))
        ...
        if tab or 'r2010_infotpserv' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r2010_infotpserv_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r2010_infotpserv').all()
