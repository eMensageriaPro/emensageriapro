...
def salvar(request, hash):
    ...
    if request.user.has_perm('r2010.can_view_r2010infoTpServ'):
        ...
        r2010_infotpserv_form = disabled_form_fields(r2010_infotpserv_form, request.user.has_perm('r2010.change_r2010infoTpServ'))
