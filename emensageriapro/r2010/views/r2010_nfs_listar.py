...
def listar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='r2010_nfs')
    ...
    if permissao.permite_listar:
        ...
        r2010_nfs_lista = r2010nfs.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/r2010_nfs_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r2010_nfs.csv', context)
