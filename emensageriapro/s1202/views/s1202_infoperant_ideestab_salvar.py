...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s1202_infoperant_ideestab.evento()
    ...
    if request.user.has_perm('s1202.can_see_s1202infoPerAntideEstab'):
        ...
        if request.method == 'POST':
            ...
            if s1202_infoperant_ideestab_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's1202-infoperant-ideestab' not in request.session['return_page']:
