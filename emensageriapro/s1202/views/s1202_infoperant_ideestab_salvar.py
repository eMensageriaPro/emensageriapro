...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1202_infoperant_ideestab')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1202_infoperant_ideestab_id:
        s1202_infoperant_ideestab = get_object_or_404(s1202infoPerAntideEstab, id = s1202_infoperant_ideestab_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1202_infoperant_ideestab_id, tabela='s1202_infoperant_ideestab').all()
        context = {
