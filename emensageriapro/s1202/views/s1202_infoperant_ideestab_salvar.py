...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1202.can_view_s1202infoPerAntideEstab'):
        ...
        s1202_infoperant_ideestab_form = disabled_form_fields(s1202_infoperant_ideestab_form, request.user.has_perm('s1202.change_s1202infoPerAntideEstab'))
