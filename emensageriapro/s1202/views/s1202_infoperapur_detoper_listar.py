...
def listar(request, output=None):
    ...
    if request.user.has_perm('s1202.can_see_s1202infoPerApurdetOper'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's1202_infoperapur_infosaudecolet__icontains': 's1202_infoperapur_infosaudecolet__icontains',
        ...
        s1202_infoperapur_detoper_lista = s1202infoPerApurdetOper.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s1202_infoperapur_infosaudecolet_lista = s1202infoPerApurinfoSaudeColet.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s1202_infoperapur_detoper.csv', context)
