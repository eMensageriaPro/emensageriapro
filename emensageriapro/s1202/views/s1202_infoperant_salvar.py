...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1202.can_view_s1202infoPerAnt'):
        ...
        s1202_infoperant_form = disabled_form_fields(s1202_infoperant_form, request.user.has_perm('s1202.change_s1202infoPerAnt'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1202_infoperant_id, tabela='s1202_infoperant').all()
