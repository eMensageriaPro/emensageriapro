...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1202_infoperapur')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1202_infoperapur_id:
        s1202_infoperapur = get_object_or_404(s1202infoPerApur, id = s1202_infoperapur_id)
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1202_infoperapur_id:
            s1202_infoperapur_form = form_s1202_infoperapur(request.POST or None, instance = s1202_infoperapur,  
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1202_infoperapur_id, tabela='s1202_infoperapur').all()
        context = {
