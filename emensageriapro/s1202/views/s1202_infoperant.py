...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1202_infoperant_id:
            ...
            s1202_infoperant_form = form_s1202_infoperant(request.POST or None, slug = db_slug, initial={})
        ...
        if s1202_infoperant_id:
            ...
            s1202_infoperant_ideadc_form = form_s1202_infoperant_ideadc(initial={ 's1202_infoperant': s1202_infoperant }, slug=db_slug)
