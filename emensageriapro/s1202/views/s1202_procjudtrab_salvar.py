...
def salvar(request, hash):
    ...
    if s1202_procjudtrab_id:
        ...
        s1202_procjudtrab = get_object_or_404(s1202procJudTrab, id=s1202_procjudtrab_id)
        dados_evento = s1202_procjudtrab.evento()

    if request.user.has_perm('s1202.can_view_s1202procJudTrab'):
        ...
        s1202_procjudtrab_form = disabled_form_fields(s1202_procjudtrab_form, request.user.has_perm('s1202.change_s1202procJudTrab'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1202_procjudtrab_id, tabela='s1202_procjudtrab').all()
