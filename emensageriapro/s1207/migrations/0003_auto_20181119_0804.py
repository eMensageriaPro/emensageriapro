# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-19 08:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={'managed': True, 'ordering': ['s1207_dmdev', 'tpacconv', 'dsc']},
        ),
        migrations.AlterModelOptions(
            name='s1207infoperantitensremun',
            options={'managed': True, 'ordering': ['s1207_infoperant_ideestab', 'codrubr', 'idetabrubr', 'vrrubr']},
        ),
        migrations.AlterModelOptions(
            name='s1207infoperapurideestab',
            options={'managed': True, 'ordering': ['s1207_dmdev', 'tpinsc', 'nrinsc']},
        ),
        migrations.AlterModelOptions(
            name='s1207infoperapuritensremun',
            options={'managed': True, 'ordering': ['s1207_infoperapur_ideestab', 'codrubr', 'idetabrubr', 'vrrubr']},
        ),
        migrations.AlterModelOptions(
            name='s1207procjudtrab',
            options={'managed': True, 'ordering': ['s1207_evtbenprrp', 'tptrib', 'nrprocjud']},
        ),
        migrations.RemoveField(
        ...
        migrations.AddField(
            model_name='s1207infoperantideadc',
            name='s1207_dmdev',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperantideadc_s1207_dmdev', to='s1207.s1207dmDev'),
        ),
        migrations.AddField(
            model_name='s1207infoperantitensremun',
            name='s1207_infoperant_ideestab',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperantitensremun_s1207_infoperant_ideestab', to='s1207.s1207infoPerAntideEstab'),
        ),
        migrations.AddField(
            model_name='s1207infoperapurideestab',
            name='s1207_dmdev',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperapurideestab_s1207_dmdev', to='s1207.s1207dmDev'),
        ),
        migrations.AddField(
            model_name='s1207infoperapuritensremun',
            name='s1207_infoperapur_ideestab',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='s1207infoperapuritensremun_s1207_infoperapur_ideestab', to='s1207.s1207infoPerApurideEstab'),
        ),
