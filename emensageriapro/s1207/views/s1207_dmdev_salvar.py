...
def salvar(request, hash):
    ...
    if s1207_dmdev_id:
        ...
        s1207_dmdev = get_object_or_404(s1207dmDev, id=s1207_dmdev_id)
        dados_evento = s1207_dmdev.evento()

    if request.user.has_perm('s1207.can_view_s1207dmDev'):
        ...
        s1207_dmdev_form = disabled_form_fields(s1207_dmdev_form, request.user.has_perm('s1207.change_s1207dmDev'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1207_dmdev_id, tabela='s1207_dmdev').all()
