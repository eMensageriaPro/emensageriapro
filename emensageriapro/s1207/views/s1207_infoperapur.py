...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1207_infoperapur_id:
            ...
            s1207_infoperapur_form = form_s1207_infoperapur(request.POST or None, slug = db_slug, initial={})
        ...
        if s1207_infoperapur_id:
            ...
            s1207_infoperapur_ideestab_form = form_s1207_infoperapur_ideestab(initial={ 's1207_infoperapur': s1207_infoperapur }, slug=db_slug)
