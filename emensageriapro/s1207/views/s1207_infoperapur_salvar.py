...
def salvar(request, hash):
    ...
    if s1207_infoperapur_id:
        ...
        s1207_infoperapur = get_object_or_404(s1207infoPerApur, id=s1207_infoperapur_id)
        dados_evento = s1207_infoperapur.evento()

    if request.user.has_perm('s1207.can_view_s1207infoPerApur'):
        ...
        s1207_infoperapur_form = disabled_form_fields(s1207_infoperapur_form, request.user.has_perm('s1207.change_s1207infoPerApur'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1207_infoperapur_id, tabela='s1207_infoperapur').all()
