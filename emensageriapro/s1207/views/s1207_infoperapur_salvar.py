...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1207_infoperapur')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1207_infoperapur_id:
            s1207_infoperapur_form = form_s1207_infoperapur(request.POST or None, instance = s1207_infoperapur,  
