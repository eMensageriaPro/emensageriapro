...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        ...
        if s1207_infoperapur_remunperapur_id:
            ...
            s1207_infoperapur_remunperapur_form = form_s1207_infoperapur_remunperapur(request.POST or None, slug = db_slug, initial={})
        ...
        if s1207_infoperapur_remunperapur_id:
            ...
            s1207_infoperapur_itensremun_form = form_s1207_infoperapur_itensremun(initial={ 's1207_infoperapur_remunperapur': s1207_infoperapur_remunperapur }, slug=db_slug)
...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        s1207_infoperapur_ideestab_lista = s1207infoPerApurideEstab.objects.using( db_slug ).filter(excluido = False).all()
