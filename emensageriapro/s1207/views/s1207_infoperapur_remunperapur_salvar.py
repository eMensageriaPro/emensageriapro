...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1207_infoperapur_remunperapur')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s1207_infoperapur_remunperapur_id:
            s1207_infoperapur_remunperapur_form = form_s1207_infoperapur_remunperapur(request.POST or None, instance = s1207_infoperapur_remunperapur,  
