...
def salvar(request, hash):
    ...
    if s1207_infoperapur_remunperapur_id:
        ...
        s1207_infoperapur_remunperapur = get_object_or_404(s1207infoPerApurremunPerApur, id=s1207_infoperapur_remunperapur_id)
        dados_evento = s1207_infoperapur_remunperapur.evento()

    if request.user.has_perm('s1207.can_view_s1207infoPerApurremunPerApur'):
        ...
        if request.method == 'POST':
            ...
            if s1207_infoperapur_remunperapur_form.is_valid():
                ...
                if not s1207_infoperapur_remunperapur_id:
        ...
        s1207_infoperapur_remunperapur_form = disabled_form_fields(s1207_infoperapur_remunperapur_form, request.user.has_perm('s1207.change_s1207infoPerApurremunPerApur'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1207_infoperapur_remunperapur_id, tabela='s1207_infoperapur_remunperapur').all()
