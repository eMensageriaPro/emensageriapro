...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s1207_infoperapur_ideestab.evento()
    ...
    if request.user.has_perm('s1207.can_see_s1207infoPerApurideEstab'):
        ...
        if request.method == 'POST':
            ...
            if s1207_infoperapur_ideestab_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 's1207-infoperapur-ideestab' not in request.session['return_page']:
