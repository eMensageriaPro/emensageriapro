...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s1207_infoperapur_ideestab')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s1207_infoperapur_ideestab_id:
        s1207_infoperapur_ideestab = get_object_or_404(s1207infoPerApurideEstab, id = s1207_infoperapur_ideestab_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s1207_infoperapur_ideestab_id, tabela='s1207_infoperapur_ideestab').all()
        context = {
