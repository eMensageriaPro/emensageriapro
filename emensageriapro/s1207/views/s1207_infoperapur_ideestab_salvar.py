...
def salvar(request, hash):
    ...
    if request.user.has_perm('s1207.can_view_s1207infoPerApurideEstab'):
        ...
        s1207_infoperapur_ideestab_form = disabled_form_fields(s1207_infoperapur_ideestab_form, request.user.has_perm('s1207.change_s1207infoPerApurideEstab'))
