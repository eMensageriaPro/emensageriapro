...
def salvar(request, hash):
    ...
    if s2250_cancavprevio_id:
        ...
        s2250_cancavprevio = get_object_or_404(s2250cancAvPrevio, id=s2250_cancavprevio_id)
        dados_evento = s2250_cancavprevio.evento()

    if request.user.has_perm('s2250.can_view_s2250cancAvPrevio'):
        ...
        s2250_cancavprevio_form = disabled_form_fields(s2250_cancavprevio_form, request.user.has_perm('s2250.change_s2250cancAvPrevio'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2250_cancavprevio_id, tabela='s2250_cancavprevio').all()
