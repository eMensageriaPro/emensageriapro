...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r5001_rtom = get_object_or_404(r5001RTom, id=pk)
        evento_dados = r5001_rtom.evento()

    if request.user.has_perm('r5001.can_see_r5001RTom'):
        ...
        r5001_rtom_form = disabled_form_fields(
            r5001_rtom_form, 
            request.user.has_perm('r5001.change_r5001RTom'))
        ...
        if tab or 'r5001_rtom' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r5001_rtom_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r5001_rtom').all()
