...
def salvar(request, hash):
    ...
    if r5001_rtom_id:
        ...
        r5001_rtom = get_object_or_404(r5001RTom, id=r5001_rtom_id)
        dados_evento = r5001_rtom.evento()

    if request.user.has_perm('r5001.can_view_r5001RTom'):
        ...
        r5001_rtom_form = disabled_form_fields(r5001_rtom_form, request.user.has_perm('r5001.change_r5001RTom'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r5001_rtom_id, tabela='r5001_rtom').all()
