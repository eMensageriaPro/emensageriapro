...
class r1000alteracao(SoftDeletionModel):
    ...
    classtrib = models.CharField(choices=CHOICES_R1000_CLASSTRIB_ALTERACAO, max_length=2, null=True, )
...
class r1000inclusao(SoftDeletionModel):
    ...
    inivalid = models.CharField(choices=PERIODOS, max_length=7, null=True, )
    fimvalid = models.CharField(choices=PERIODOS, max_length=7, blank=True, null=True, )
    classtrib = models.CharField(choices=CHOICES_R1000_CLASSTRIB_INCLUSAO, max_length=2, null=True, )
