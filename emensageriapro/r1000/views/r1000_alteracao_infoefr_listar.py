...
def listar(request, hash):
    ...
    if permissao.permite_listar:
        ...
        r1000_alteracao_infoefr_lista = r1000alteracaoinfoEFR.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if for_print in (0,1):
            ...
            #return render_to_pdf('tables/r1000_alteracao_infoefr_pdf_xls.html', context)
            from wkhtmltopdf.views import PDFTemplateResponse
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/r1000_alteracao_infoefr.csv', context)
