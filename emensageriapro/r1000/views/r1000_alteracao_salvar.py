...
def salvar(request, hash):
    ...
    if r1000_alteracao_id:
        ...
        r1000_alteracao = get_object_or_404(r1000alteracao, id=r1000_alteracao_id)
        dados_evento = r1000_alteracao.evento()

    if request.user.has_perm('r1000.can_view_r1000alteracao'):
        ...
        r1000_alteracao_form = disabled_form_fields(r1000_alteracao_form, request.user.has_perm('r1000.change_r1000alteracao'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r1000_alteracao_id, tabela='r1000_alteracao').all()
