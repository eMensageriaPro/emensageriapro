...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        r1000_alteracao = get_object_or_404(r1000alteracao, id=pk)
        evento_dados = r1000_alteracao.evento()
    ...
    if request.user.has_perm('r1000.can_see_r1000alteracao'):
        ...
        if request.method == 'POST':
            ...
            if r1000_alteracao_form.is_valid():
                ...
                obj = r1000_alteracao_form.save(request=request)
                ...
                if request.session['return_page'] not in (
                    'r1000_alteracao_apagar', 
                    'r1000_alteracao_salvar', 
                    'r1000_alteracao'):
        ...
        r1000_alteracao_form = disabled_form_fields(
            r1000_alteracao_form, 
            request.user.has_perm('r1000.change_r1000alteracao'))
        ...
        if pk:
            ...
            r1000_alteracao_softhouse_form = form_r1000_alteracao_softhouse(
                initial={ 'r1000_alteracao': r1000_alteracao })
            ...
            r1000_alteracao_softhouse_lista = r1000alteracaosoftHouse.objects.\
                filter(r1000_alteracao_id=r1000_alteracao.id).all()
                
            r1000_alteracao_infoefr_form = form_r1000_alteracao_infoefr(
                initial={ 'r1000_alteracao': r1000_alteracao })
        ...
        if tab or 'r1000_alteracao' in request.session['return_page']:
        
            request.session['return_pk'] = pk
            request.session['return_tab'] = tab
            request.session['return_page'] = 'r1000_alteracao_salvar'
            
        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='r1000_alteracao').all()
