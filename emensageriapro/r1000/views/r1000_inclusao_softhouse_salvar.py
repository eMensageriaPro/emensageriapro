...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = r1000_inclusao_softhouse.evento()
    ...
    if request.user.has_perm('r1000.can_see_r1000inclusaosoftHouse'):
        ...
        if request.method == 'POST':
            ...
            if r1000_inclusao_softhouse_form.is_valid():
                ...
                if 'return_page' in request.session and request.session['return_page'] and 'r1000-inclusao-softhouse' not in request.session['return_page']:
