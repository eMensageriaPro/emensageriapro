...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            r1000alteracaosoftHouse.objects.using( db_slug ).filter(id = r1000_alteracao_softhouse_id).delete()
...
def salvar(request, hash):
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r1000_alteracao_softhouse_id:
            r1000_alteracao_softhouse_form = form_r1000_alteracao_softhouse(request.POST or None, instance = r1000_alteracao_softhouse, slug = db_slug)
        else:
            r1000_alteracao_softhouse_form = form_r1000_alteracao_softhouse(request.POST or None, slug = db_slug, initial={})
        if request.method == 'POST':
            if r1000_alteracao_softhouse_form.is_valid():
                ...
                if r1000_alteracao_softhouse_id:
                    if dados_evento['status'] == 0:
                        ...
                        #r1000_alteracao_softhouse_campos_multiple_passo1
                        r1000alteracaosoftHouse.objects.using(db_slug).filter(id=r1000_alteracao_softhouse_id).update(**dados)
                        obj = r1000alteracaosoftHouse.objects.using(db_slug).get(id=r1000_alteracao_softhouse_id)
                        #r1000_alteracao_softhouse_editar_custom
                        #r1000_alteracao_softhouse_campos_multiple_passo2
                    ...
                    #r1000_alteracao_softhouse_cadastrar_campos_multiple_passo1
                    obj = r1000alteracaosoftHouse(**dados)
                    obj.save(using = db_slug)
                    #r1000_alteracao_softhouse_cadastrar_custom
                    #r1000_alteracao_softhouse_cadastrar_campos_multiple_passo2
