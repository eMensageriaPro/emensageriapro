...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='r1000_alteracao_infoefr')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if r1000_alteracao_infoefr_id:
            r1000_alteracao_infoefr_form = form_r1000_alteracao_infoefr(request.POST or None, instance = r1000_alteracao_infoefr,  
