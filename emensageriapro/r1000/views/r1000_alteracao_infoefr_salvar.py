...
def salvar(request, hash):
    ...
    if r1000_alteracao_infoefr_id:
        ...
        r1000_alteracao_infoefr = get_object_or_404(r1000alteracaoinfoEFR, id=r1000_alteracao_infoefr_id)
        dados_evento = r1000_alteracao_infoefr.evento()

    if request.user.has_perm('r1000.can_view_r1000alteracaoinfoEFR'):
        ...
        if request.method == 'POST':
            ...
            if r1000_alteracao_infoefr_form.is_valid():
                ...
                if not r1000_alteracao_infoefr_id:
        ...
        r1000_alteracao_infoefr_form = disabled_form_fields(r1000_alteracao_infoefr_form, request.user.has_perm('r1000.change_r1000alteracaoinfoEFR'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r1000_alteracao_infoefr_id, tabela='r1000_alteracao_infoefr').all()
