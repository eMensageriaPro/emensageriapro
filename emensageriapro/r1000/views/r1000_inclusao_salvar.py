...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='r1000_inclusao')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if r1000_inclusao_id:
        r1000_inclusao = get_object_or_404(r1000inclusao, id = r1000_inclusao_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=r1000_inclusao_id, tabela='r1000_inclusao').all()
        context = {
