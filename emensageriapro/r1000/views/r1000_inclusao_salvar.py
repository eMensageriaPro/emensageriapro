...
def salvar(request, hash):
    ...
    if request.user.has_perm('r1000.can_view_r1000inclusao'):
        ...
        r1000_inclusao_form = disabled_form_fields(r1000_inclusao_form, request.user.has_perm('r1000.change_r1000inclusao'))
