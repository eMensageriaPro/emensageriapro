...
from emensageriapro.s2300.views import s2300_mudancacpf as s2300_mudancacpf_views
...
url(r'^s2300-mudancacpf/apagar/(?P<hash>.*)/$', 
        s2300_mudancacpf_views.apagar, 
        name='s2300_mudancacpf_apagar'),

url(r'^s2300-mudancacpf/api/$',
            s2300_mudancacpf_views.s2300mudancaCPFList.as_view() ),

        url(r'^s2300-mudancacpf/api/(?P<pk>[0-9]+)/$',
            s2300_mudancacpf_views.s2300mudancaCPFDetail.as_view() ),

url(r'^s2300-mudancacpf/listar/(?P<hash>.*)/$', 
        s2300_mudancacpf_views.listar, 
        name='s2300_mudancacpf'),

url(r'^s2300-mudancacpf/salvar/(?P<hash>.*)/$', 
        s2300_mudancacpf_views.salvar, 
