...
def salvar(request, hash):
    ...
    if s2300_rg_id:
        ...
        s2300_rg = get_object_or_404(s2300RG, id=s2300_rg_id)
        dados_evento = s2300_rg.evento()

    if request.user.has_perm('s2300.can_view_s2300RG'):
        ...
        s2300_rg_form = disabled_form_fields(s2300_rg_form, request.user.has_perm('s2300.change_s2300RG'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2300_rg_id, tabela='s2300_rg').all()
