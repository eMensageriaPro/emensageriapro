...
def listar(request, output=None):
    ...
    if request.user.has_perm('s2300.can_see_s2300infoEstagiario'):
        ...
        s2300_infoestagiario_lista = s2300infoEstagiario.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s2300_infoestagiario.csv', context)
