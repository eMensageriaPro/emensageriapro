...
def salvar(request, hash):
    ...
    if s2300_exterior_id:
        ...
        s2300_exterior = get_object_or_404(s2300exterior, id=s2300_exterior_id)
        dados_evento = s2300_exterior.evento()

    if request.user.has_perm('s2300.can_view_s2300exterior'):
        ...
        s2300_exterior_form = disabled_form_fields(s2300_exterior_form, request.user.has_perm('s2300.change_s2300exterior'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2300_exterior_id, tabela='s2300_exterior').all()
