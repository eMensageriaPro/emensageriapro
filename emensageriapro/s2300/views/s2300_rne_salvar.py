...
def salvar(request, pk=None, tab='master', output=None):
    ...
    if pk:
        ...
        evento_dados = s2300_rne.evento()

    if request.user.has_perm('s2300.can_see_s2300RNE'):
        ...
        if request.method == 'POST':
            ...
            if s2300_rne_form.is_valid():
                ...
                if 's2300-rne' not in request.session['return']:
        ...
        s2300_rne_form = disabled_form_fields(
            s2300_rne_form,
            request.user.has_perm('s2300.change_s2300RNE'))
        ...
        #if tab or 's2300_rne' in request.session['return_page']:
        #
        #    request.session['return_pk'] = pk
        #    request.session['return_tab'] = tab
        #    request.session['return_page'] = 's2300_rne_salvar'

        controle_alteracoes = Auditoria.objects.filter(identidade=pk, tabela='s2300_rne').all()
