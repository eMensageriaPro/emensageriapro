...
def salvar(request, hash):
    ...
    if s2300_rne_id:
        ...
        s2300_rne = get_object_or_404(s2300RNE, id=s2300_rne_id)
        dados_evento = s2300_rne.evento()

    if request.user.has_perm('s2300.can_view_s2300RNE'):
        ...
        s2300_rne_form = disabled_form_fields(s2300_rne_form, request.user.has_perm('s2300.change_s2300RNE'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2300_rne_id, tabela='s2300_rne').all()
