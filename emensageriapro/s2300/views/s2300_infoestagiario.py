...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s2300infoEstagiario.objects.using( db_slug ).filter(id = s2300_infoestagiario_id).delete()
            ...
            if s2300_infoestagiario_form.is_valid():
                ...
                if s2300_infoestagiario_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s2300_infoestagiario_campos_multiple_passo1
                        s2300infoEstagiario.objects.using(db_slug).filter(id=s2300_infoestagiario_id).update(**dados)
                        obj = s2300infoEstagiario.objects.using(db_slug).get(id=s2300_infoestagiario_id)
                        #s2300_infoestagiario_editar_custom
                        #s2300_infoestagiario_campos_multiple_passo2
                    ...
                    #s2300_infoestagiario_cadastrar_campos_multiple_passo1
                    obj = s2300infoEstagiario(**dados)
                    obj.save(using = db_slug)
                    #s2300_infoestagiario_cadastrar_custom
                    #s2300_infoestagiario_cadastrar_campos_multiple_passo2
