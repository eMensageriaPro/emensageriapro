...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2300_cargofuncao')
    permissao = ConfigPermissoes.objects.get( config_paginas=pagina, config_perfis=usuario.config_perfis)
    if s2300_cargofuncao_id:
        s2300_cargofuncao = get_object_or_404(s2300cargoFuncao, id = s2300_cargofuncao_id)
    ...
    if permissao.permite_visualizar:
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2300_cargofuncao_id, tabela='s2300_cargofuncao').all()
        context = {
