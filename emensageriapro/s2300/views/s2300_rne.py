            ...
            if s2300_rne_form.is_valid():
                ...
                if s2300_rne_id:
                    if dados_evento['status'] == 0:
                        ...
                        #s2300_rne_campos_multiple_passo1
                        s2300RNE.objects.using(db_slug).filter(id=s2300_rne_id).update(**dados)
                        obj = s2300RNE.objects.using(db_slug).get(id=s2300_rne_id)
                        #s2300_rne_editar_custom
                        #s2300_rne_campos_multiple_passo2
                    ...
                    #s2300_rne_cadastrar_campos_multiple_passo1
                    obj = s2300RNE(**dados)
                    obj.save(using = db_slug)
                    #s2300_rne_cadastrar_custom
                    #s2300_rne_cadastrar_campos_multiple_passo2
...
def apagar(request, hash):
    ...
    if request.method == 'POST':
        if dados_evento['status'] == 0:
            ...
            s2300RNE.objects.using( db_slug ).filter(id = s2300_rne_id).delete()
