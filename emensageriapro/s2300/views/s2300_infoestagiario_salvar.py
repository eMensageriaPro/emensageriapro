...
def salvar(request, hash):
    ...
    if s2300_infoestagiario_id:
        ...
        s2300_infoestagiario = get_object_or_404(s2300infoEstagiario, id=s2300_infoestagiario_id)
        dados_evento = s2300_infoestagiario.evento()

    if request.user.has_perm('s2300.can_view_s2300infoEstagiario'):
        ...
        s2300_infoestagiario_form = disabled_form_fields(s2300_infoestagiario_form, request.user.has_perm('s2300.change_s2300infoEstagiario'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2300_infoestagiario_id, tabela='s2300_infoestagiario').all()
