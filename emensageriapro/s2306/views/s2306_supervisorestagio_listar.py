...
def listar(request, output=None):
    ...
    if request.user.has_perm('s2306.can_see_s2306supervisorEstagio'):
        ...
        if request.method == 'POST':
            ...
            post = True
            dict_fields = {
                's2306_infoestagiario__icontains': 's2306_infoestagiario__icontains',
        ...
        s2306_supervisorestagio_lista = s2306supervisorEstagio.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        s2306_infoestagiario_lista = s2306infoEstagiario.objects.all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s2306_supervisorestagio.csv', context)
