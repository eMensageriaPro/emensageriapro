...
def salvar(request, hash):
    ...
    if s2306_supervisorestagio_id:
        ...
        s2306_supervisorestagio = get_object_or_404(s2306supervisorEstagio, id=s2306_supervisorestagio_id)
        dados_evento = s2306_supervisorestagio.evento()

    if request.user.has_perm('s2306.can_view_s2306supervisorEstagio'):
        ...
        if request.method == 'POST':
            ...
            if s2306_supervisorestagio_form.is_valid():
                ...
                if not s2306_supervisorestagio_id:
        ...
        s2306_supervisorestagio_form = disabled_form_fields(s2306_supervisorestagio_form, request.user.has_perm('s2306.change_s2306supervisorEstagio'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2306_supervisorestagio_id, tabela='s2306_supervisorestagio').all()
