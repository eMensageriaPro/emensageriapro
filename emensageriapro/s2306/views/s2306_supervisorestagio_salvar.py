...
def salvar(request, hash):
    ...
    pagina = ConfigPaginas.objects.get( endereco='s2306_supervisorestagio')
    ...
    if permissao.permite_visualizar:
        mensagem = None
        if s2306_supervisorestagio_id:
            s2306_supervisorestagio_form = form_s2306_supervisorestagio(request.POST or None, instance = s2306_supervisorestagio,  
