...
def listar(request, output=None):
    ...
    if request.user.has_perm('s2306.can_see_s2306infoTrabCedido'):
        ...
        s2306_infotrabcedido_lista = s2306infoTrabCedido.objects.filter(**dict_qs).filter().exclude(id=0).all()
        ...
        if output == 'pdf':
            ...
            from django.shortcuts import render_to_response
            response = render_to_response('csv/s2306_infotrabcedido.csv', context)
