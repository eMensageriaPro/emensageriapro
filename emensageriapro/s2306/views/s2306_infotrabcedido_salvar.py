...
def salvar(request, hash):
    ...
    if s2306_infotrabcedido_id:
        ...
        s2306_infotrabcedido = get_object_or_404(s2306infoTrabCedido, id=s2306_infotrabcedido_id)
        dados_evento = s2306_infotrabcedido.evento()

    if request.user.has_perm('s2306.can_view_s2306infoTrabCedido'):
        ...
        if request.method == 'POST':
            ...
            if s2306_infotrabcedido_form.is_valid():
                ...
                if not s2306_infotrabcedido_id:
        ...
        s2306_infotrabcedido_form = disabled_form_fields(s2306_infotrabcedido_form, request.user.has_perm('s2306.change_s2306infoTrabCedido'))
        ...
        controle_alteracoes = Auditoria.objects.filter(identidade=s2306_infotrabcedido_id, tabela='s2306_infotrabcedido').all()
