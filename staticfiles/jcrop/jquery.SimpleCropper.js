...
(function ($) {
    ...
    $.fn.simpleCropper = function (onComplete) {
            ...
            if (file.type.match(imageType)) {
                ...
                reader.onload = function (e) {
                    ...
                    current_image.onload = function () {
                        ...
                        var window_height = 10 + scaled_height / 2 - scaled_height / 2 + "px";
        ...
        function preview() {
            ...
            imageFoo.name = 'foto_p';

            var imageFoo2 = document.createElement('input');
            imageFoo2.value = dataUrl;
            imageFoo2.name = 'foto';
            imageFoo2.type = 'hidden';
            ...
            file_display_area.append(imageFoo2);
